...
CRBootedReasons = {1: 'An unexpected problem has occurred.  Your connection has been lost, but you should be able to connect again and go right back into the game.',
 ...
 124: 'Your installed files are out of date! Please make sure you have pulled the latest changes from the the GITHUB Repository and restart the game!',
 125: 'Your installed files are out of date! Please make sure you have pulled the latest changes from the the GITHUB Repository and restart the game!',
 ...
 154: 'Aristotown is now temporarily closed for maintenance. Everyone who was playing has been disconnected from the game.\n\nFor more information, please visit the Project Altis website or the Discord server.',
...
SuitFireManager = {
  'choreo': ["You can't cut the star of the production!"],
  'phouse': ["Fire me? You can barely survive me."],
  'bkeeper': ["I decide who stays employed around here."],
  'wtapper': ["You should've encrypted that request."],
  'ambass': ["How uncivilized."],
  'payman': ["Your severance package has been declined."],
  'bookkeep': ["Your termination request has accounting errors."],
  'liquidr': ["Liquidating me? That's ironic."],
  'treasure': ["You can't balance this ledger without me."],
  'videog': ["Cut? No, no; keep rolling."],
  'cinema': ["Hold still. This embarrassment deserves a portrait."],
  'radiog': ["This station doesn't go off-air."],
  'racket': ["You can't fire someone this well-connected."],
  'ubuster': ["Only Corporate can terminate my employment."],
  'hustle': ["Fire hazard? I'll just post a detour."],
  'safesupervis': ["You're moments away from catastrophic failure."],
  'liquid': ["Nobody leaves without paying the toll."],
  'rkeeper': ["I've already archived this failed attempt."],
  'dking': ["Firing me would tank the market."],
  'cdirector': ["Every contingency still favors me."],
  'cbutcher': ["You cannot erase what already haunts the archives."],
  'sgoat': ["So now you're throwing me under the trolley?"],
  'caseman': ["Your case has been closed prematurely..."],
  'stenog': ["Interesting. I'll transcribe this meltdown word for word."],
  'lgator': ["You don't have the authority to dismiss me."],
  'duckshfl': ["Thorry about your luck! I've got an athe in the thleeve, HA!!"],
  'ddiver': ["Fired? Hmph, I'm more of  water Suit myself."],
  'gatekeep': ["I am most disgustedeth thou thinketh thou can rideth thyselves of mine own presence so easily."],
  'bellring': ["Ring me up some other time, I'm afraid I'm too busy right now to deal with this."],
  'mouthp': ["My word! That's no way to behave towards your elders!"],
  'fires': ["What...? But... you know I'm already on fire, right?"],
  'treek': ["OHOUTOUHA! Thah's a funny joke, Toon! BAHAHAHA!"],
  'fbed': ["...Hm..? Were you saying something...?"],
  'prethink': ["What makes you think such a simpleminded trick would work?"],
  'rainmake': ["I'm not ready to be fired... yet..."],
  'whunter': ["Mooncalves! Those contemptible playthings of yours will never be adequate in impeding my domination over you!"],
  'mslacker': ["Sorry, no way my dad's letting that happen."],
  'mplayer': ["Oooh! Hachacha-ha-ha! You can't add anymore fire to this flame, babe!"],
  'pcrat': ["Firin' me? HA! That ain't gonna work. This orbit is my home, and you're intrudin'."],
  'chainsaw': ["SUBJECT HAS ATTEMPTED MOTION TO TERMINATE. MOTION REJECTED."],
  'psetter': ["Hah! Yeah right! As if someone like you could fire someone like me!"],
       }
SuitSueManagerNone = (
       "I am outside your jurisdiction, Toon.",
)
SuitSueManager = {
  'choreo': ["If you're going to sue me, at least hit your marks."],
  'phouse': ["You think paper work can stop raw power?"],
  'bkeeper': ["Your case has been denied before it even began."],
  'wtapper': ["Careful what you submit, I'm always listening."],
  'ambass': ["You dare challenge corporate diplomacy?"],
  'payman': ["You'll be billed for wasting my time."],
  'bookkeep': ["I've already written this loss into the ledger."],
  'liquidr': ["I'll dissolve this lawsuit along with the rest of your assets."],
  'treasure': ["You're bankrupt on both funds AND luck."],
  'videog': ["This footage is going straight into the archives."],
  'cinema': ["Perfect timing. You're photogenic when panicking."],
  'radiog': ["You can't hide from the signal."],
  'racket': ["Funny. Suing me costs extra."],
  'hustle': ["I've already filed that under 'roadside noise'."],
  'ubuster': ["Your complaint has been filed straight to the shredder."],
  'safesupervis': ["The heat's getting to you already."],
  'liquid': ["Nothing passes through here for free."],
  'rkeeper': ["Ah yes... another mistake for the archives."],
  'dking': ["Shareholder confidence has never been higher."],
  'cdirector': ["Your lawsuit was anticipated several turns ago."],
  'cbutcher': ["You should've stayed buried in obscurity, Toon."],
  'sgoat': ["You'll pin this on me too? Predictable."],
  'caseman': ["Hmm... Weak evidence... Poor presentation..."],
  'stenog': ["Please slow down. I want to document your failure accurately."],
  'lgator': ["You dare challenge ME in court?"],
  'duckshfl': ["Another one? You're too kind, I already have THO many!!"],
  'ddiver': ["What? No! I'll never seas!"],
  'gatekeep': ["Ugh! That thou wouldst even try it ist a most despicable plea! Rather, I shalt see THOU in court!"],
  'bellring': ["Oh bother, not another defamation suit... we've been over this already, love, it's not happening."],
  'mouthp': ["The nerve! Don't backtalk to me, whippersnapper!"],
  'fires': ["I don't think that's very nice... I'm not good with the legal side of things..."],
  'treek': ["Yeh think thaht little paper matters to meh? What a riot! Gaheheh!"],
  'fbed': ["I'll deal with it later... can we talk about this another time? I'm sleepy..."],
  'prethink': ["I'll have you know, I would win the lawsuit anyways."],
  'rainmake': ["If I could stop fighting, I would..."],
  'whunter': ["You attempt to sue the surest attorney on this side of Cog Nation? There's more of the lurden than the Laff in you!"],
  'mslacker': ["Nah, the court's just too far a walk, y'know?"],
  'mplayer': ["Oh-no-no, babe! You can't put a full stop to this one man big band!"],
  'pcrat': ["You won't be around to see who wins the trial anyways, chump."],
  'chainsaw': ["PLAINTIFF IS OUT OF HIERARCHICAL JURISDICTION TO PERFORM THE INDICATED ACTION. IGNORING."],
  'psetter': ["Another speeding ticket? Not my problem!"],
       }
SuitDefeatTaunts = {
 # Bossbots
 'clubpres': ['Your version of "golf" disgusts me.',
         "Should've targeted me first.",
         'Next time, ask your friends "fore" help.'],
 'derrman': ['This charade is boar-ing me.',
              "I'd say that encounter went well.",
              'Perhaps that will drill in the point!',
             "Tell the Council that this is their warning."],
 'derrhand': ['You seem to be getting dizzy.',
 ...
 'fires': ["Burnt out so soon?",
              "That really went up in smoke...",
              "Couldn't take the heat?",
              "Oh, I guess your plan... backfired."],
 'fbed': ["Good night, Toon.",
           "You snooze, you lose.",
           "I won't lose sleep over this.",
           "Perhaps you should get some rest, you don't look so good."],
 'mplayer': ["Ring-a-ding this!",
          "Caught the blues, baby?",
          "Looks like someone can't catch the rhythm.",
          "Any good album has a few out-takes."],
 'chainsaw': ["EMPLOYEE TERMINATED, SEVERANCE PACKAGE NOT OFFERED.",
             "SUBJECT'S REQUEST FOR MERCY DENIED.",
             "OFFBOARDING SUCCESSFUL, RESUMING PREVIOUS INITIATIVE.",
             "HOSTILE HAS BEEN DEFEATED."],
 'chainsaw2': ["EMPLOYEE TERMINATED, SEVERANCE PACKAGE NOT OFFERED.",
              "SUBJECT'S REQUEST FOR MERCY DENIED.",
              "OFFBOARDING SUCCESSFUL, RESUMING PREVIOUS INITIATIVE.",
              "HOSTILE HAS BEEN DEFEATED."],
 'choreo': ["You couldn't keep up.",
            "That step cost you everything.",
            "Out of rhythm and out of luck.",
            "Practice harder next time."],
 'phouse': ["You weren't built for this.",
               "That's the difference between us.",
               "I don't slow down for anyone.",
               "Crushed!"],
 'bkeeper': ["Your defeat has been notarized.",
            "Another liability removed.",
            "I will enjoy archiving this.",
            "You have been officially dissolved."],
 'wtapper': ["You should've stayed silent.",
             "That signal won't be coming back.",
             "Another voice off the network.",
             "Connection terminated."],
 'ambass': ["You failed to impress me.",
             "This meeting is over!",
             "Know your place, Toon.",
            "You never mattered.",
             "You were always beneath consideration."],

 # Lawbots
 'clerk': ["Vito wins another case.",
 ...
 'erclaim': ["Begone!",
           "This vampire isn't famous for forgiveness.",
           "What is a Toon? A miserable pile of laughter.",
           "Wished you were a Stakeholder, hm? Hah!"],
 'mouthp': ["That's what you get for not calling more.",
 ...
 'rainmake': ["Sorry to rain on your parade...",
 ...
 'whunter': ["Do not show your countenance here again!",
 ...
 'lgator': ["You call yourself a member of the Resistance? Pathetic.",
             "I've survived the brutality of the Outback. You are nothing.",
             "What's wrong? Don't like it when I fire back?",
             "The real joke is your failure."],
 'stenog': ["Should I even bother documenting this display?",
            "Never underestimate my calculations.",
            "It's best you stay at the playground... For good.",
 ...
 'sgoat': ["Mess with the goat, you get the horns!!",
 ...
 'supervis': ["Mr. Dolair won't appreciate you stealing anything valuable.",
           "Money means power, Toon, and I watch it all.",
           "You can't break into this vault.",
           "Insurance can save a Suit."],
'payman': ["Payment delivered!",
             "That concludes your compensation!",
             "All accounts settled!",
             "Processed successfully!"],
'bookkeep': ["That entry satisfies me.",
            "Everything accounted for.",
            "No discrepancies.",
            "Balanced... perfectly balanced."],
'liquidr': ["You've been repurposed!",
                 "All converted.",
                 "Nothing left behind.",
                 "That was satisfying."],
'treasure': ["There it is, the final payment.",
               "Debt doesn't forget!",
               "You weren't supposed to win this... and you didn't!",
               "All things balance out... eventually."],
 'duckshfl': ["Thould'a played your cardth better!",
            "Couldn't put your money where your mouth ith, eh?",
            "AHAHA! Better luck nexth time!!",
            "The houthe ALWAYTH winth!"],
 'treek': ["Stumped on how to beat me? Hehah!",
...
'hroller2': ["WHAT A TWIFFT, BUTTERCUP BLUE!",
           "Oooo-hooo-hooo, ratingff are ffkyrocketing!",
           "Give a big one for the headline, top banana!",
           "Who'ff ready for ffome cartoon violenffe?!"],
'hrollers': ["WHAT A TWIFFT, BUTTERCUP BLUE!",
           "Oooo-hooo-hooo, ratingff are ffkyrocketing!",
           "Give a big one for the headline, top banana!",
           "Who'ff ready for ffome cartoon violenffe?!"],
 ...
 'dopr': ["DON'T- DON'T- DON'T LEAVE- LEAVE- LEAVE ME HERE!",
 ...
 'dopa': ["Sounds like your broadcast is ending; all I'm hearing is dead air.",
          "Now that's what I call good radio!",
          "Tune in next time!",
          "Goodnight, Toon. Goodnight."],
 'bellring': ["Give a ring if you'd like to try again.",
          "Bell, this has been fun, Toon.",
          "'Defeated Toon' sure has a nice ring to it.",
          "Consider your bell rung, Toon."],
 'prethink': ["You really thought you could beat me?",
              "Come back when you have a higher IQ.",
              "See? Should've planned ahead."],
 'mslacker': ["At least you don't have to go down that flight of stairs.",
              "It's best that you not, uh... I forgot how that was supposed to end.",
              "Maybe you'll think twice next time about interrupting me."],
 'psetter': ["Did anyone else see me do that? That was great.",
              "I can't wait to tell Flint about how fast I burned you out.",
              "Could you move any slower?!",
              "That was a SERIOUS waste of my time."],
 'cinema': ["Perfect! That shot's front page!",
              "Caught you at your worst.",
              "Now that's a picture-perfect defeat!",
              "That'll look great in my portfolio!"],
 'radiog': ["That concludes your broadcast.",
            "Your frequency has just been silenced.",
            "Another voice removed from the lineup.",
            "And that's a wrap, listeners!"],
 'racket': ["Looks like you couldn't afford the interest.",
             "You should've walked away while you could.",
             "The market decided you weren't viable.",
             "You just lost everything."],
 'hustle': ["Looks like you've reached the end of the road!",
             "Sorry, Toon. You're causing too much congestion.",
             "You should've stayed in your lane!",
             "That's what happens when you ignore the signs!"],
 'ubuster': ["Your position has been eliminated.",
             "You're off the schedule.",
             "That's what resistance costs!",
             "Another liability removed."],
 'safesupervis': ["Looks like you couldn't withstand the pressure!",
            "That was your breaking point.",
            "You held longer than expected.",
            "You're compressed beyond recovery now."],

 # Boardbots
 'ddiver': ["Your skills are abyssmal.",
             "Well, that performance was subpar.",
             "Fighting me was a sunk cost, Toon!",
             "You can't handle the pressure!"],
 'gatekeep': ["Now thee knoweth to keepeth thine distance, Toon.",
            "See? Thou art not strong enough to beest here.",
            "Keep thine nonse out of mine business.",
            "Thou art either in or out of business, Toon. I sayeth thou art OUT."],
 'dola': ["You broke before even the ground did! Pathetic!",
              "Why don't you acquire some Laff?!",
              "Send the Toon Council my regards!",
              "You look almost as flattened as the ground!"],
 'dold': ["Y'all cloudcookoolander's ain't gonna tie up much roundabout these parts.",
          ...
          "Yah happen to be a long lo-o-o-ohng ways from the Playground. Y'all oughtta enjoy ya land while it's still happens ta be yours."],
 'liquid': ["You were warned at the threshold.",
            "Silence would have been cheaper.",
            "The ledger will be even again.",
            "The bell does not forgive."],
 'rkeeper': ["No further entries required.",
            "I'll archive what's left.",
            "Your record ends here.",
            "You have been marked as inactive."],
 'cbutcher': ["No further entries required.",
            "I'll archive what's left.",
            "Your record ends here.",
            "You have been marked as inactive."],
 'cdirector': ["Remove them from the model!",
                  "You were never a variable.",
                  "Noncompliance has consequences.",
                  "This was the expected result."],
 'dking': ["That return exceeded expectations.",
           "Another successful acquisition.",
           "You were never a long-term investment.",
           "Your value just transferred to me."],
 'fmaker': ["Perfect ending to the scene.",
           "That performance was forgettable.",
           "Your story ends here.",
           "The audience loved that."],

 # Pressbots
 'director': ["And... scene.",
              "You're out of my production!",
              "You've been recast.",
              "Another failure of talent."],
 'videog': ["Cut! That Toon's performance was terrible!",
            "Another flop for the highlight reel.",
            "Straight to the cutting room floor!",
            "Your career just ended in post-production."],
}
SuitDefeatTauntsNone = ("Seems you had many weak links.",
                   "You'll need better synergy than that to beat us.",
                   "Toons that stay together, green together.")
SuitHealingPhrases = ("Thank you.",
                   "Much obliged.",
                   "Appreciated.",
                      "Well adjusted.")
SuitContractedPhrases = ("This wasn't in my job description.",
...
'mm': ["Don't force me to fight you."],
