...
SuitFireManager = {
  ...
  'hustle': ["Termination? that wasn't part of the arrangement."],
  ...
  'ubuster': ["Fire hazard? I'll just post a detour."],
...
SuitSueManager = {
  ...
  'hustle': ["A lawsuit? Cute. What's the angle?"],
  ...
  'ubuster': ["I've already filed that under 'roadside noise'."],
...
'hustle': ["Should've read the fine print!",
              "I already spent what I made off of you.",
              "Too slow!",
...
'erfit': ["I recommend working out more before our next encounter.",
 ...
 'ubuster': ["Looks like you've reached the end of the road!",
