...
SuitDefeatTaunts = {
 'ste': ["It's best you stay at the playground... For good.",
 ...
 'ts': ["You seem to be getting a bit dizzy.",
        "That was a spinning success.",
        "I hope this has drilled your unwanted presence in your head.",
        "I gotta hand it to you, you weren't so hard to defeat after all."],
 'cp': ["Y'all cloudcookoolander's ain't gonna tie up much roundabout these parts.",
  ...
  'fbd': ["Case closed.",
         ...
         "If you can't bare the loss, don't consider coming back.",
         "Hmph. Manage with your loss."],
 'dsk': ["Sneaking around like that dog, were you? Nice try.",
         "Mr. Bravecog wouldn't appreciate your interruptions.",
         "To get so far and fail.",
         "You can't stop production."],
 'frs': ["Hello? Anybody home?",
         "You really got your wires crossed this time.",
         "Hello from the other side, you will not be coming back this time."],
 'prr': ["Maybe you'll think twice next time about interrupting me.",
         "Hello from the other side, you will not be coming back this time."],
 'ffm': ["Perhaps that's 'persuasion' enough for ya!",
         "Time for ya to sleep with the fishes!",
         "And to think that I almost let ya join up with me!"],
 'gtk': ["You really thought you could beat me?",
         "Next time, be less predictable.",
         "Guess you didn't beat me in time."],
...
"You know, I've alwayff got an affe up my ffleeve! Ffee?"],
 'blr': ["Sounds like your broadcast is ending; all I'm hearing is dead air.",
"Now that's what I call good radio!",
"Tune in next time!",
"Goodnight, Toon. Goodnight."],
 'fd': ["Sounds like your broadcast is ending; all I'm hearing is dead air.",
"Now that's what I call good radio!",
"Tune in next time!",
"Goodnight, Toon. Goodnight."],
 'msp': ["Who'ff ready for ffome cartoon violenffe?!",
"Come on, babe, FFHOW UFF THOFFE NUMBERFF!",
"Oooo-hooo-hooo, ratingff are ffkyrocketing!",
"WHAT A TWIFFT, BUTTERCUP BLUE!",
"Give a big one for the headline, top banana!",
...
"You know, I've alwayff got an affe up my ffleeve! Ffee?"],
 ...
 'bg': ["Your version of 'golf' disgusts me.",
         "Should've targeted me first.",
         "Next time, ask your friends 'fore' help."],
 'laa': ["Finally SOMETHING goes in my favor.",
         "Finally SOMETHING goes in my favor."],
 'lit': ["You call yourself a member of the Resistance? Pathetic.",
...
SuitBrushOffs = {'f': ["I'm late for a meeting."],
 'p': ['Push off.'],
 'mm': ['Yes Man says NO.'],
 'dot': ["I'm busy hunting for other Toons."],
 'sc': ["My time is too short for you."],
 'pp': ["You're not even worth a pinch of my time."],
'ds': ["Don't force me to fight you."],
 'bc': ["I'm on a tight schedule."],
 'ssr': ["Sorry, I'm on commercial break."],
 'nd': ["I do not fancy yer time right now."],
 'cc': ["I'm giving you the cold shoulder."],
 'mld': ['Just keep swimming, toon.'],
                 'dfh': ['Just keep swimming, toon.'],
 'txm': ["I'm right in the middle of something."],
