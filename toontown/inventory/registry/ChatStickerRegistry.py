...
# TODO: DiceStickerSequence pulls in toontown.utils.bmp.BMPToon -> toontown.battle.BattleAvatar,
# which cascades into Clash's battle/quest/modifiers/groups graph. Deferred until those are ported.
...
ChatStickerRegistry: Dict[IntEnum, ChatStickerDefinition] = {
    ...
    ChatStickersItemType.DiceRoll: DiceRollStickerItemDefinition(
        ...
        # TODO: restore customSequence=DiceStickerSequence once battle/quest deps are ported.
        # Falls back to DefaultStickerSequence for now.
