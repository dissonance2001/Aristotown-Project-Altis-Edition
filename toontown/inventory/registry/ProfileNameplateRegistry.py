...
class ProfileNameplateDefinition(ItemDefinition):
    ...
    def makeItemModel(self, *extraArgs, item: Optional[InventoryItem] = None) -> NodePath:
        ...
        found = self.model.find(self.getModelPath())
        if found.isEmpty():
            # NOTE: asset-content gap, not a code bug -- see ProfileBackgroundRegistry.
            return nameplate
        nameplate = found.copyTo(nameplate)
...
ProfileNameplateRegistry: Dict[IntEnum, ProfileNameplateDefinition] = {
    ...
    NameplateItemType.Event_Witch: ProfileNameplateDefinition(
        name='Halloween Night',
        description='Todo',
        rarity=Rarity.Event,
        modelPath='**/event_halloween_witch',
    ),
    NameplateItemType.Event_HighRoller: ProfileNameplateDefinition(
        name='High Roller',
        description='A special event profile nameplate.',
        rarity=Rarity.Event,
        modelPath='**/event_highroller',
    ),
    ...
    ### Makeship ###
    NameplateItemType.Makeship_DuckShufflerGreen: ProfileNameplateDefinition(
        name='Duck Shuffler Green',
        description='A special Makeship profile nameplate.',
        modelPath='**/makeship_duckshuffler_green',
    ),
    NameplateItemType.Makeship_DuckShufflerRed: ProfileNameplateDefinition(
        name='Duck Shuffler Red',
        description='A special Makeship profile nameplate.',
        modelPath='**/makeship_duckshuffler_red',
    ),
    NameplateItemType.Makeship_FirePace: ProfileNameplateDefinition(
        name='Firestarter & Pacesetter',
        description='A special Makeship profile nameplate.',
        modelPath='**/makeship_firepace',
    ),
}
