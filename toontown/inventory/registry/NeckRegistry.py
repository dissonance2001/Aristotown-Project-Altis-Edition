...
class NeckItemDefinition(AccessoryDefinition):
    ...
    def __init__(self,
                 ...
                 accFilePath=('neck', 'neck'),  # cosmetics/XXX/maps/
...
NeckRegistry: Dict[IntEnum, NeckItemDefinition] = {
    NeckItemType.Scarf_NYE_2019: NeckItemDefinition(
        name="2019 Scarf",
        description='Todo!',
        modelName='scarf_nye',
    ...
    NeckItemType.Scarf_Aviator: NeckItemDefinition(
        name="Aviator Scarf",
    ...
    NeckItemType.Bowtie_Pinwheel: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_White: NeckItemDefinition(
        name="Sailor Collar",
        description='Todo!',
    ...
    NeckItemType.Collar_Sailor_Blue: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Cyan: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Green: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Orange: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Pink: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Purple: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Red: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Black: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Yellow: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Bow_White: NeckItemDefinition(
        name="Sailor Bow",
        description='Todo!',
    ...
    NeckItemType.Collar_Sailor_Bow_Blue: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Bow_Cyan: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Bow_Green: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Bow_Orange: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Bow_Pink: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Bow_Purple: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Bow_Red: NeckItemDefinition(
        name="Red Sailor Bow",
        description='Todo!',
        modelName='collar_sailor_bow',
    ...
    NeckItemType.Collar_Sailor_Bow_Black: NeckItemDefinition(
    ...
    NeckItemType.Collar_Sailor_Bow_Yellow: NeckItemDefinition(
    ...
    NeckItemType.Scarf_Retro_Black: NeckItemDefinition(
    ...
    NeckItemType.Scarf_NYE_2020: NeckItemDefinition(
        name="2020 Scarf",
        description='Todo!',
        modelName='scarf_nye',
    ...
    NeckItemType.Bowtie_Clown: NeckItemDefinition(
        name="Clown Bowtie",
        description='Todo!',
    ...
    NeckItemType.Scarf_NYE_2021: NeckItemDefinition(
        name="2021 Scarf",
        description='Todo!',
        modelName='scarf_nye',
    ...
    NeckItemType.Scarf_NYE_2022: NeckItemDefinition(
        name="2022 Scarf",
        description='Todo!',
        modelName='scarf_nye',
    ...
    NeckItemType.Bowtie_Ribbon_Pink: NeckItemDefinition(
        name="Ribbon Bowtie",
        description='Todo!',
    ...
    NeckItemType.Bowtie_Ribbon_Redpolka: NeckItemDefinition(
    ...
    NeckItemType.Bowtie_Ribbon_Purple: NeckItemDefinition(
        name="Purple Bowtie",
        description='Todo!',
        modelName='bowtie_classic',
    ...
    NeckItemType.Bowtie_Ribbon_Yellow: NeckItemDefinition(
        name="Yellow Bowtie",
        description='Todo!',
        modelName='bowtie_classic',
    ...
    NeckItemType.Bowtie_Ribbon_Bluechecker: NeckItemDefinition(
    ...
    NeckItemType.Bowtie_Ribbon_Red: NeckItemDefinition(
        name="Red Bowtie",
        description='Todo!',
        modelName='bowtie_classic',
        textureName='bow_classic_polka_lg_red',
    ...
    NeckItemType.Bowtie_Ribbon_Rainbow: NeckItemDefinition(
        name="Rainbow Bowtie",
        description='Todo!',
        modelName='bowtie_classic',
    ...
    NeckItemType.Bowtie_Ribbon_Pinkdots: NeckItemDefinition(
    ...
    NeckItemType.Bowtie_Ribbon_Greenchecker: NeckItemDefinition(
    ...
    NeckItemType.Bowtie_Ribbon_Blue: NeckItemDefinition(
        name="Blue Bowtie",
        description='Todo!',
        modelName='bowtie_classic',
    ...
    NeckItemType.Bowtie_Ribbon_Candycorn: NeckItemDefinition(
    ...
    NeckItemType.Bowtie_Ribbon_Black: NeckItemDefinition(
        name="Black Bowtie",
        description='Todo!',
        modelName='bowtie_classic',
    ...
    NeckItemType.Necklace_Brovinci: NeckItemDefinition(
        name="Bro's Necklace",
        description='Todo!',
    ...
    NeckItemType.Bowtie_Fancy_Black: NeckItemDefinition(
        name="Black Bowtie",
    ...
    NeckItemType.Bowtie_Fancy_Blackwhite: NeckItemDefinition(
    ...
    NeckItemType.Bowtie_Fancy_Blue: NeckItemDefinition(
        name="Blue Bowtie",
    ...
    NeckItemType.Bowtie_Fancy_Gray: NeckItemDefinition(
        name="Gray Bowtie",
    ...
    NeckItemType.Bowtie_Fancy_Green: NeckItemDefinition(
        name="Green Bowtie",
    ...
    NeckItemType.Bowtie_Fancy_Orange: NeckItemDefinition(
        name="Orange Bowtie",
    ...
    NeckItemType.Bowtie_Fancy_Pink: NeckItemDefinition(
        name="Pink Bowtie",
    ...
    NeckItemType.Bowtie_Fancy_Pinkblack: NeckItemDefinition(
        name="Radical Bowtie",
    ...
    NeckItemType.Bowtie_Fancy_Polkadot: NeckItemDefinition(
    ...
    NeckItemType.Bowtie_Fancy_Purple: NeckItemDefinition(
        name="Grape Bowtie",
    ...
    NeckItemType.Bowtie_Fancy_Purpleorange: NeckItemDefinition(
        name="PBJ Bowtie",
    ...
    NeckItemType.Bowtie_Fancy_Red: NeckItemDefinition(
        name="Red Bowtie",
    ...
    NeckItemType.Bowtie_Fancy_Yellow: NeckItemDefinition(
        name="Yellow Bowtie",
    ...
    NeckItemType.Bowtie_Fancy_Yellowblack: NeckItemDefinition(
    ...
    NeckItemType.Scarf_Chef_Red: NeckItemDefinition(
        name="Chef's Scarf",
        description='Todo!',
    ...
    NeckItemType.Scarf_NYE_2023: NeckItemDefinition(
        name='2023 Scarf',
        description='Todo!',
        modelName='scarf_nye',
    ...
    NeckItemType.Bowtie_Pride_Ace: NeckItemDefinition(
        name='Ace Pride Bowtie',
        description='Todo!',
        modelName='bowtie_fancy',
        textureName='bowtie_fancy_pride_ace',
    ),
    NeckItemType.Bowtie_Pride_Aro: NeckItemDefinition(
        name='Aromantic Pride Bowtie',
        description='Todo!',
        modelName='bowtie_fancy',
        textureName='bowtie_fancy_pride_aro',
    ),
    NeckItemType.Bowtie_Pride_Bi: NeckItemDefinition(
        name='Bi Pride Bowtie',
        description='Todo!',
        modelName='bowtie_fancy',
        textureName='bowtie_fancy_pride_bi',
    ),
    NeckItemType.Bowtie_Pride_Gay: NeckItemDefinition(
        name='Gay Pride Bowtie',
        description='Todo!',
        modelName='bowtie_fancy',
        textureName='bowtie_fancy_pride_gay',
    ),
    NeckItemType.Bowtie_Pride_Fluid: NeckItemDefinition(
        name='Genderfluid Pride Bowtie',
        description='Todo!',
        modelName='bowtie_fancy',
        textureName='bowtie_fancy_pride_gfld',
    ),
    NeckItemType.Bowtie_Pride_Lesbian: NeckItemDefinition(
        name='Lesbian Pride Bowtie',
        description='Todo!',
        modelName='bowtie_fancy',
        textureName='bowtie_fancy_pride_lsbn',
    ),
    NeckItemType.Bowtie_Pride_Lgbt: NeckItemDefinition(
        name='Pride Bowtie',
        description='Todo!',
        modelName='bowtie_fancy',
        textureName='bowtie_fancy_pride_lgbt',
    ),
    NeckItemType.Bowtie_Pride_Nb: NeckItemDefinition(
        name='Non-Binary Pride Bowtie',
        description='Todo!',
        modelName='bowtie_fancy',
        textureName='bowtie_fancy_pride_nb',
    ),
    NeckItemType.Bowtie_Pride_Pan: NeckItemDefinition(
        name='Pan Pride Bowtie',
        description='Todo!',
        modelName='bowtie_fancy',
        textureName='bowtie_fancy_pride_pan',
    ),
    NeckItemType.Bowtie_Pride_Trans: NeckItemDefinition(
        name='Trans Pride Bowtie',
        description='Todo!',
        modelName='bowtie_fancy',
        textureName='bowtie_fancy_pride_trans',
    ),
    NeckItemType.Bowtie_Elf: NeckItemDefinition(
        name = 'Elf Bowtie Backpack',
        description = 'Todo!',
        modelName = 'bowtie_elf',
    ),
    NeckItemType.Scarf_NYE_2024: NeckItemDefinition(
        name='2024 Scarf',
        description='Todo!',
        modelName='scarf_nye',
        textureName='scarf_nye_24',
    ),
}
