...
class BackpackItemDefinition(AccessoryDefinition):
    ...
    def __init__(self,
                 ...
                 accFilePath=('backpack', 'backpack'),  # cosmetics/XXX/maps/
...
BackpackRegistry: Dict[IntEnum, BackpackItemDefinition] = {
    ...
    BackpackItemType.Backpack_Wings_Bat_Classic: BackpackItemDefinition(
        name="Bat Wings",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Wings_Bee_Classic: BackpackItemDefinition(
        name="Bee Wings",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Wings_Dragonfly_Classic: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_ScubaTank_Classic: BackpackItemDefinition(
        name="Scuba Tank",
        description='Todo!',
    ...
    BackpackItemType.Backpack_SharkFin_Classic: BackpackItemDefinition(
        name="Shark Fin",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Wings_Angel_Classic_White: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Wings_Angel_Classic_Rainbow: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Toys_Classic: BackpackItemDefinition(
        name="Toys Backpack",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Wings_Butterfly_Classic: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Wings_Pixie_Classic: BackpackItemDefinition(
        name="Pixie Wings",
        description='Todo!',
        modelName='wings_butterfly_classic',
    ...
    BackpackItemType.Backpack_Wings_Dragon_Classic: BackpackItemDefinition(
        name="Dragon Wings",
        description='Todo!',
        modelName='wings_dragonfly_classic',
        textureName=None,
    ...
    BackpackItemType.Backpack_JetPack_Classic: BackpackItemDefinition(
        name="Jet Pack",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Bug_Classic: BackpackItemDefinition(
        name="Bug Backpack",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Stuffed_Bear_Classic: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Wings_Bird_Classic: BackpackItemDefinition(
        name="Bird Wings",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Stuffed_Cat_Classic: BackpackItemDefinition(
        name="Plush Cat Pack",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Stuffed_Dog_Classic: BackpackItemDefinition(
        name="Plush Dog Pack",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Wings_Airplane_Classic: BackpackItemDefinition(
        name="Airplane Wings",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Cape_Classic_Red: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Cape_Classic_Black: BackpackItemDefinition(
        name="Vampire Cape",
        description='Todo!',
        modelName='cape_classic',
    ...
    BackpackItemType.Backpack_Tail_Toonosaur_Classic: BackpackItemDefinition(
        name="Toonosaur Tail",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Jamboree: BackpackItemDefinition(
        name="Jamboree Pack",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Plushie_Flunky_Classic: BackpackItemDefinition(
        name="Cog Pack",
        description='Todo!',
    ...
    BackpackItemType.Backpack_WitchBroom: BackpackItemDefinition(
        name="Witches Broom",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Cape_Reaper: BackpackItemDefinition(
        name="Reaper Cape",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Cape_Dracula: BackpackItemDefinition(
        name="Dracula Cape",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Bow_Ragdoll_White: BackpackItemDefinition(
        name="Humble Ragdoll",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Bow_Ragdoll_Red: BackpackItemDefinition(
        name="Regal Ragdoll",
        description='Todo!',
        modelName='bow_ragdoll',
    ...
    BackpackItemType.Backpack_Bow_Ragdoll_Yellow: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Wings_HangGlider: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Alien: BackpackItemDefinition(
        name="Alien Backpack",
        description='Todo!',
        modelName='alien',
        textureName=None,
    ...
    BackpackItemType.Backpack_Wings_Angel_Divine_White: BackpackItemDefinition(
        name="Angel Wings",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Wings_Angel_Divine_Blue: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Wings_Angel_Divine_Green: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Wings_Angel_Divine_Orange: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Wings_Angel_Divine_Purple: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Wings_Angel_Divine_Red: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Wings_Angel_Divine_Yellow: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Backstabber: BackpackItemDefinition(
        name="The Backstab",
        description='Todo!',
        modelName='backstab',
        textureName=None,
    ...
    BackpackItemType.Backpack_Gavel: BackpackItemDefinition(
        name="Gavel Backpack",
        description='Todo!',
        modelName='gavel',
        textureName = None,
    ...
    BackpackItemType.Backpack_Lawbook: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Gag_TNT: BackpackItemDefinition(
        name="TNT Backpack",
    ...
    BackpackItemType.Backpack_Bow_Ragdoll_Orange: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Gag_Seltzer: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Gag_Magnet_Red: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Gag_JoyBuzzer: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Plushie_Chairman: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Stuffed_Bunny: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Cape_HwTown: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Plushie_Sads: BackpackItemDefinition(
        name="Sads Plushpack",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Newstoon_Suitcase: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Newstoon_Camera: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Cape_Pride_Lgbt: BackpackItemDefinition(
        name="Pride Cape",
        description='Todo!',
        modelName='cape_classic',
    ...
    BackpackItemType.Backpack_Cape_Pride_Trans: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Cape_Pride_Lesbian: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Cape_Pride_Pan: BackpackItemDefinition(
        name="Pan Pride Cape",
        description='Todo!',
        modelName='cape_classic',
    ...
    BackpackItemType.Backpack_Cape_Pride_Bi: BackpackItemDefinition(
        name="Bi Pride Cape",
        description='Todo!',
        modelName='cape_classic',
    ...
    BackpackItemType.Backpack_Cape_Pride_Nb: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Cape_Pride_Ace: BackpackItemDefinition(
        name="Ace Pride Cape",
        description='Todo!',
        modelName='cape_classic',
    ...
    BackpackItemType.Backpack_Cape_Pride_Fluid: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Cape_Pride_Aro: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Cape_Pride_Gay: BackpackItemDefinition(
        name="Gay Pride Cape",
        description='Todo!',
        modelName='cape_classic',
    ...
    BackpackItemType.Backpack_Stuffed_Doodle: BackpackItemDefinition(
        name="Doodle Pack",
        description='Todo!',
    ...
    BackpackItemType.Backpack_MoneyBag: BackpackItemDefinition(
        name="Money Bag",
        description='Todo!',
        modelName='bag_money',
        textureName=None,
    ...
    BackpackItemType.Backpack_PitchFork: BackpackItemDefinition(
        name="Pitchfork",
        description='Todo!',
        modelName='pitchfork',
        textureName=None,
    ...
    BackpackItemType.Backpack_Wings_WingSuit: BackpackItemDefinition(
        name="Wingsuit Wings",
    ...
    BackpackItemType.Backpack_Pillow: BackpackItemDefinition(
    ...
    BackpackItemType.Backpack_Saxophone: BackpackItemDefinition(
        name="Saxophone",
        description='Todo!',
        modelName='saxophone',
        textureName=None,
    ...
    BackpackItemType.Backpack_Firestoker: BackpackItemDefinition(
        name="Firestoker",
        description='Todo!',
    ...
    BackpackItemType.Backpack_Shield: BackpackItemDefinition(
        name="Shield",
        description='Todo!',
        modelName='shield',
        textureName=None,
    ...
    BackpackItemType.Backpack_FruitBasket: BackpackItemDefinition(
        name="Fruit Basket",
    ...
    BackpackItemType.Backpack_RetroBag: BackpackItemDefinition(
        name="Retro Backpack",
    ...
    BackpackItemType.Backpack_BreadBag: BackpackItemDefinition(
        name="Breadbag",
        description='Todo!',
        modelName='bag_bread',
        textureName=None,
    ...
    BackpackItemType.Backpack_Paddle: BackpackItemDefinition(
        name="Pizza Paddle",
        description='Todo!',
        modelName='paddle',
        textureName=None,
    ...
    BackpackItemType.Backpack_Guitar_Pacesetter: BackpackItemDefinition(
        name='The Shredder',
        description='Todo!',
        modelName='guitar_1',
    ),
    ...
    BackpackItemType.Backpack_Cybertoon: BackpackItemDefinition(
        name='Cybertoon Backpack',
        description='Todo!',
        modelName='cybertoon',
    ),
    BackpackItemType.Backpack_Pirate_Ghost: BackpackItemDefinition(
        name='Pirate Ghost Backpack',
        description='Todo!',
