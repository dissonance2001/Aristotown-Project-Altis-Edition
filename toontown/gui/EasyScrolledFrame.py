...
from panda3d.core import MouseButton, PGButton
DGG.WHEEL_UP = PGButton.getPressPrefix() + MouseButton.wheel_up().getName() + '-'
DGG.WHEEL_DOWN = PGButton.getPressPrefix() + MouseButton.wheel_down().getName() + '-'
...
class EasyScrolledFrame(DirectScrolledFrameNoHorizontal):
    ...
    def __init__(self, parent, **kw):
        ...
        optiondefs = kwargsToOptionDefs(
            ...
            heightDownPad=[None, self.updateItemPositions],  # Allows you to define some extra padding at the
                                                             # very bottom of the scrolled frame
    ...
    def manageCanvasSize(self, newHeight: float):
        ...
        if self['heightDownPad']:
            newHeight += self['heightDownPad']
