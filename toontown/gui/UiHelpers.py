...
def _chunks(l: list, n):
    """Yield successive n-sized chunks from l. (Inlined from Clash's PythonUtil --
    Altis's toonbase module has no equivalent, and this is the only function used.)"""
...
def fillGridWithElements(initialGuiList: list, horizontalCount: int, verticalCount: int,
    ...
    guiMatrix = list(_chunks(initialGuiList, chunkSize))
