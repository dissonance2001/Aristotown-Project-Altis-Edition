...
class ToontownLoadingScreen:
    ...
    def begin(self, range, label, gui, tipCategory, zoneId):
        self.zone2background = {
            ToontownGlobals.ToontownCentral: 'ttc.png',
            ToontownGlobals.LoopyLane: 'ttc.png',
            ToontownGlobals.WackyWay: 'ttc.png',
            ToontownGlobals.PunchlinePlace: 'ttc.png',
            ToontownGlobals.SillyStreet: 'ttc.png',
            ToontownGlobals.DonaldsDock: 'dd.png',
            ToontownGlobals.AnchorAvenue: 'dd.png',
            ToontownGlobals.BuccaneerBoulevard: 'dd.png',
            ToontownGlobals.SeaweedStreet: 'dd.png',
            ToontownGlobals.LighthouseLane: 'dd.png',
            ToontownGlobals.DaisyGardens: 'dg.png',
            ToontownGlobals.TulipTerrace: 'dg.png',
            ToontownGlobals.PetuniaPlace: 'dg.png',
            ToontownGlobals.DaisyDrive: 'dg.png',
            ToontownGlobals.MinniesMelodyland: 'mml.png',
            ToontownGlobals.AltoAvenue: 'mml.png',
            ToontownGlobals.SopranoStreet: 'mml.png',
            ToontownGlobals.BuccaneerBoulevard: 'mml.png',
            ToontownGlobals.TenorTerrace: 'mml.png',
            ToontownGlobals.TheBrrrgh: 'tb.png',
            ToontownGlobals.PolarPlace: 'tb.png',
            ToontownGlobals.SleetStreet: 'tb.png',
            ToontownGlobals.WalrusWay: 'tb.png',
            ToontownGlobals.ArcticAvenue: 'tb.png',
            ToontownGlobals.YeOlde: 'yott.png',
            ToontownGlobals.NobleNook: 'yott.png',
            ToontownGlobals.WizardWay: 'yott.png',
            ToontownGlobals.KnightKnoll: 'yott.png',
            ToontownGlobals.DonaldsDreamland: 'ddl.png',
            ToontownGlobals.PajamaPlace: 'ddl.png',
            ToontownGlobals.LullabyLane: 'ddl.png',
            ToontownGlobals.TwilightTerrace: 'ddl.png',
            ToontownGlobals.OutdoorZone: 'aa.png',
            ToontownGlobals.GoofySpeedway: 'gs.png',
            ToontownGlobals.SellbotHQ: 'sbhq.png',
            ToontownGlobals.SellbotFactoryExt: 'sbhqext.png',
            ToontownGlobals.LawbotHQ: 'lbhq.png',
            ToontownGlobals.CashbotHQ: 'cbhq.png',
            ToontownGlobals.BossbotHQ: 'bbhq.png'
            }
        self.zone2fontcolor = {
            ...
            ToontownGlobals.BuccaneerBoulevard : VBase4(ToontownGlobals.DDCOLOR),
            ...
            ToontownGlobals.AnchorAvenue : VBase4(ToontownGlobals.DDCOLOR),
            ToontownGlobals.DaisyGardens : VBase4(ToontownGlobals.DGCOLOR),
            ToontownGlobals.PetuniaPlace : VBase4(ToontownGlobals.DGCOLOR),
            ToontownGlobals.DaisyDrive : VBase4(ToontownGlobals.DGCOLOR),
            ToontownGlobals.TulipTerrace : VBase4(ToontownGlobals.DGCOLOR),
            ToontownGlobals.SunflowerStreet : VBase4(ToontownGlobals.DGCOLOR),
