...
class Ambience(object):
    ...
    """
    def __init__(self, title, fileLocation, ambienceNames=None, volume=1.0,
                 durationBetween=None, suffix='.ogg'):
        self.title = title
    ...
    def _getTaskName(self):
        ...
        return 'amb{0}'.format(self.title)

    def _getFileName(self, ambienceName=''):
...
class FieldAmbience(Ambience):
    ...
    def __init__(self, fadeInTime=0.0, fadeOutTime=0.0, *args, **kwargs):
        super(FieldAmbience, self).__init__(*args, **kwargs)
