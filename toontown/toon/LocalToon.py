...
from toontown.shtiker import ToonProfilePage
...
class LocalToon(DistributedToon.DistributedToon, LocalAvatar.LocalAvatar):
    ...
    def cleanupToonOverlapCollisions(self):
        ...
        if hasattr(self, 'toonOverlapFadeTracks'):
            for toonId, track in list(self.toonOverlapFadeTracks.items()):
                track.pause()
    ...
    def initInterface(self):
        ...
        self.profilePage = ToonProfilePage.ToonProfilePage()
        self.profilePage.load()
        self.book.addPage(self.profilePage, pageName=TTLocalizer.ToonProfilePageTitle)
