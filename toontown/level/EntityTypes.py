...
from toontown.level.EntityTypeDesc import EntityTypeDesc
...
class LogicGate(Entity):
    ...
    attribs = (
        ...
        ('isInput1', 0, 'bool'),
        ('isInput2', 0, 'bool'),
        ('logicType', 'or', 'choice', {'choiceSet': ['or',
                                                     'and',
                                                     'xor',
                                                     'nand',
                                                     'nor',
...
class Model(Nodepath):
    type = 'model'
    attribs = (
        ('loadType', 'loadModel', 'choice', {'choiceSet': ['loadModel']}),
...
class Chair(Nodepath):
    type = 'chair'
    attribs = (
        ('radius', 4, 'int'),
        ('hopOnPos', Point3(-0.1, -4.75, 2.15), 'pos'),
        ('hopOffPos', Point3(0, -5, 0.4), 'pos'),
        ('chairType', ChairTypeEnum.COUCH.value, 'int'),
    )
