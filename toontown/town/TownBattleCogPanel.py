...
class TownBattleCogPanel(DirectFrame):
    ...
    def generateSuitHead(self, name):
        ...
        if name == 'dfh':
            ...
            self.suitHead.setPosHprScale(-0.27, 0.5, 0.11, -180, 0, 0, .10, .10, .10)
        elif name == 'scg':
            ...
            self.suitHead.setPosHprScale(-0.27, 0.5, 0.12, -180, 0, 0, .1, .1, .1)
        elif name == 'ls' or name == 'mh' or name == 'inw':
            self.suitHead.setPosHprScale(-0.27, 0.5, 0.11, -180, 0, 0, .085, .085, .085)
        elif name == 'm':
            self.suitHead.setPosHprScale(-0.27, 0.5, 0.10, -180, 0, 0, .085, .085, .085)
        elif name == 'sb':
        ...
        elif name == 'laa' or name == 'csh' or name == 'gb' or name == 'lbs' or name == 'ddv' or name == 'sya' or name == 'mdr' or name == 'fas' or name == 'gkp':
        ...
        elif name == 'jur' or name == 'ant' or name == 'fb':
