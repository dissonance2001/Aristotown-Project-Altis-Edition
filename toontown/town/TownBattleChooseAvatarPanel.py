...
class TownBattleChooseAvatarPanel(StateData.StateData):
    ...
    def __placeButtons(self, numAvatars, invalidTargets, localNum):
        ...
        if numAvatars == 1:
            ...
            self.avatarButtons[random.choice((1, 2))].setX(0.75)
            self.avatarButtons[random.choice((0, 2))].setX(0.0)
            self.avatarButtons[random.choice((0, 1))].setX(-0.75)
            ...
            self.avatarButtons[random.choice((1, 2, 3))].setX(1.15)
            self.avatarButtons[random.choice((0, 2, 3))].setX(0.4)
            self.avatarButtons[random.choice((0, 1, 3))].setX(-0.4)
            self.avatarButtons[random.choice((0, 1, 2))].setX(-1.15)
            ...
            self.avatarButtons[random.choice((1, 2, 3, 4))].setX(1.5)
            self.avatarButtons[random.choice((0, 2, 3, 4))].setX(0.75)
            self.avatarButtons[random.choice((0, 1, 3, 4))].setX(0.0)
            self.avatarButtons[random.choice((0, 1, 2, 4))].setX(-0.75)
            self.avatarButtons[random.choice((0, 1, 2, 3))].setX(-1.5)
            ...
            self.avatarButtons[random.choice((1, 2, 3, 4, 5))].setX(1.9)
            self.avatarButtons[random.choice((0, 2, 3, 4, 5))].setX(1.15)
            self.avatarButtons[random.choice((0, 1, 3, 4, 5))].setX(0.4)
            self.avatarButtons[random.choice((0, 1, 2, 4, 5))].setX(-0.4)
            self.avatarButtons[random.choice((0, 1, 2, 3, 5))].setX(-1.15)
            self.avatarButtons[random.choice((0, 1, 2, 3, 4))].setX(-1.9)
