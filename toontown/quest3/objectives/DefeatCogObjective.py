...
from toontown.clashbattle.battle.SuitBattleGlobals import COG_MINIBOSSES
...
from toontown.clashsuit.suit import SuitDNA, SuitHoodGlobals
...
class DefeatCogObjective(QuestObjective):
    ...
    def generateFromDifficulty(cls, rng, difficulty: float, questSource: QuestSource, **extraArgs):
        ...
        for modifier in modifiers:
            if modifier == 'cogType':
                suitDict = {ToontownCentral:   (("bgh", "f", "bf", "sc", "cc"), ("pph", "p", "b", "pf", "pp", "tm"), ("ins", "ym", "dt", "nn", "tw", "nd")),
                            DonaldsDock:       (("pph", "p", "b", "pf", "pp", "tm"), ("ins", "ym", "dt", "nn", "tw", "nd"), ("cbr", "mm", "ac", "cv", "bc", "gh")),
                            YeOlde:      (("ins", "ym", "dt", "nn", "tw", "nd"), ("cbr", "mm", "ac", "cv", "bc", "gh"), ("dl", "ds", "bs", "ad", "nc", "ms")),
                            DaisyGardens:      (("cbr", "mm", "ac", "cv", "bc", "gh"), ("dl", "ds", "bs", "ad", "nc", "ms"), ("shw", "hh", "sd", "sh", "mb", "tf")),
                            MinniesMelodyland: (("dl", "ds", "bs", "ad", "nc", "ms"), ("shw", "hh", "sd", "sh", "mb", "tf"), ("mg", "cr", "le", "br", "ls", "mi")),
                            -1:                (("shw", "hh", "sd", "sh", "mb", "tf"), ("mg", "cr", "le", "br", "ls", "mi"), ("hho", "tbc", "bw", "rb", "mh")),
                            }
                ...
                cogTracks = ['s', 'm', 'l', 'c', 'g']
                # We do not want any defeat X level X+ executive Boardbot tasks for clubs
                if questSource == QuestSource.ClubQuest and 'executive' in modifiers and 'cogLevelMin' in modifiers:
                    cogTracks.remove('g')
                ...
                if cogTrack == 'g':
                    ...
                    # for clubs, further scale it down by 50%
                    cogCount *= 0.7
            ...
            if rng.random() < 0.35 and zoneId in (DaisyGardens, MinniesMelodyland, TheBrrrgh, OutdoorZone, DonaldsDreamland):
                ...
                if cogTrack:
                    if cogTrack == 'g':
                        ...
                        # This is to undo a previous operation that decreased boardbot tasks by 30% (+50% for clubs)
                        if questSource == QuestSource.ClubQuest:
                            cogCount /= 0.5
                        cogCount /= 0.7
