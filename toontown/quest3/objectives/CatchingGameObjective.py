...
class CatchingGameObjective(QuestObjective):
    ...
    def getDifficultyRange(questerType: QuesterType, questSource: QuestSource, **extraArgs):
        ...
        if questSource == QuestSource.KudosQuest:
            ...
            if zoneId not in (ToontownGlobals.ToontownCentral, ToontownGlobals.DonaldsDock, ToontownGlobals.YeOlde):
                return None
            return None, None
    ...
    def getObjectiveGoal(self) -> str:
        return OBJ_Catch % FRUIT_TYPES[self.zoneId]['fruit'].capitalize() + text.plural(self.fruitCount)
