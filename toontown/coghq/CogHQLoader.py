...
class CogHQLoader(StateData.StateData):
    ...
    def __init__(self, hood, parentFSMState, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('CogHQLoader', [State.State('start', None, None, ['quietZone', 'cogHQExterior', 'cogHQLobby', 'cogHQBossBattle']),
    ...
    def load(self, zoneId):
        ...
        self.lobbyMusic = base.loader.loadMusic(self.lobbyMusicFile)
