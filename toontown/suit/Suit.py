...
class Suit(Avatar.Avatar):
    ...
    def generateSuit(self):
        ...
        if dna.name == 'f':
            ...
            self.handColor = VBase4(0.922, 0.757, 0.663, 1)
            self.generateFemaleBody()
            ...
            self.scale = 5.0 / bSize
            self.handColor = VBase4(0.725, 0.784, 0.757, 1)
            self.generateBody()
            ...
            self.scale = 5.0 / bSize
            self.handColor = VBase4(0.929, 0.816, 0.753, 1)
            self.generateBody()
            ...
            self.scale = 5.0 / aSize
            self.handColor = VBase4(0.682, 0.678, 0.675, 1)
            self.generateBody()
            self.generateHead2('skeleskull_A')
    ...
    def makeExecutive(self, modelRoot=None):
        ...
        if self.isSkeleton:
            ...
            texture = loader.loadTexture('phase_5/maps/ttcc_ene_skelecog_%s_exe.png' %
                                         self.style.dept)
            modelRoot.find('**/hands').setColor(0.733, 0.302, 0.769, 1)
            for headPart in self.headParts:
                headPart.setTexture(texture, 1)
    ...
    def makeGovernaught(self, modelRoot=None):
        ...
        if self.isSkeleton:
            ...
            texture = loader.loadTexture('phase_5/maps/ttcc_ene_skelecog_%s_gov.png' %
                                         self.style.dept)
            modelRoot.find('**/hands').setColor(1, 0.812, 0.204, 1)
            for headPart in self.headParts:
                headPart.setTexture(texture, 1)
        elif self.style.name == 'tld':
            self.setSuitClothes()
    ...
    def getDialogueArray(self):
        ...
        if self.style.name == 'bdb' and not self.isSkeleton:
            loadDialog(1)
            return FemaleDialogArray
        if self.style.name == 'cr' and self.isSkeleton:
            loadDialog(1)
            return SkelecogDialogFemaleArray
        if self.style.name == 'cr' and not self.isSkeleton:
            loadDialog(1)
            return FemaleDialogArray
