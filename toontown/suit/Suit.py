...
class Suit(Avatar.Avatar):
    ...
    def generateBodyHybrid(self):
        ...
        if base.config.GetBool('want-new-cogs', 0):
            if cogExists(filePrefix + 'zero.bam'):
                self.loadModel('phase_3.5' + filePrefix + 'zero')
                self.loadModel('phase_5/models/char/cog' + self.style.body.upper() + '_robot-zero', 'skelehands')
            else:
                self.loadModel('phase_3.5' + filePrefix + 'mod')
                self.loadModel('phase_5/models/char/cog' + self.style.body.upper() + '_robot-zero', 'skelehands')
        else:
    ...
    def generateSkeletonBody(self):
        ...
        if base.config.GetBool('want-new-cogs', 0):
            if cogExists(filePrefix + 'zero.bam'):
                self.loadModel('phase_5/models/char/cog' + self.style.body.upper() + '_robot-zero')
            else:
                self.loadModel('phase_5/models/char/cog' + self.style.body.upper() + '_robot-zero')
        else:
            self.loadModel('phase_5/models/char/cog' + self.style.body.upper() + '_robot-zero')
            ...
            if headType == 'skelecog' or headType == 'overwhelmingauthorizer' or headType == 'executioner':
                if headType == 'overwhelmingauthorizer':
                    ...
                    headModel = Actor.Actor(
                        'phase_14/models/char/cog' + self.style.body.upper() + '_robot_head-zero')
                self.generateHeadAnims(
                    'phase_14/models/char/cog' + self.style.body.upper() + '_robot_head-',
            ...
            if headType == 'skelecog':
                if base.config.GetBool('want-clash-assets', False):
                    headModel = loader.loadModel(
                        'phase_14/models/char/cog' + self.style.body.upper() + '_robot_head-zero')
                    headReferences = headModel.findAllMatches('**/skeleskull_' + self.style.body.upper())
                else:
                    headModel = loader.loadModel(
                        'phase_5/models/char/cog' + self.style.body.upper() + '_robot-head')
                    headReferences = headModel.findAllMatches('**/suit' + self.style.body.upper())
            else:
                if pathOverride:
        ...
        if animated:
            if headType == 'skullA' or headType == 'skullB' or headType == 'skullC':
                if headType == 'skullC' or headType == 'skullA' or headType == 'skullB':
                    ...
                    headModel = Actor.Actor(
                        'phase_14/models/char/' + self.style.body.upper() + '-zero')
                self.generateHeadAnims(
                    'phase_14/models/char/ttcc_ene_skull' + self.style.body.upper() + '-',
                    headModel, additionalAnims)
                self.headParts.append(headModel)
                if headTexture:
                    try:
            ...
            if headType == 'skelecog':
                if base.config.GetBool('want-clash-assets', True):
                    headModel = loader.loadModel(
                        'phase_14/models/char/' + self.style.body.upper() + '_robot_head-zero')
                    headReferences = headModel.findAllMatches('**/skeleskull_' + self.style.body.upper())
                else:
                    headModel = loader.loadModel(
                        'phase_5/models/char/cog' + self.style.body.upper() + '_robot-head')
    ...
    def getZapActor(self):
        ...
        model = 'phase_5/models/char/cog%s_robot-zero' % self.style.body.upper()
        anims = self.generateAnimDict()
