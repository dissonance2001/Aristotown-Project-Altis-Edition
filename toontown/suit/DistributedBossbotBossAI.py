...
class DistributedBossbotBossAI(DistributedMinibossAI.DistributedMinibossAI, FSM.FSM):
    ...
    def __genSuitObjectBoss(self, suitZone, suitType, bldgTrack, suitLevel, revives = 0):
