...
suitProperties = {
      ...
      'trb': (7.0 / aSize, VBase4(0.75, 0.95, 0.75, 1.0), ['bigcheese'], '', 9.34),
      ...
      'brv': (7.0 / aSize, SuitDNA.legalPolyColor, ['bigwig'], '', 8.69),
      ...
      'gm': (7.0 / aSize, SuitDNA.moneyPolyColor, ['yesman'], 'robber-baron.jpg', 8.95),
      ...
      'ka': (7.0 / aSize, SuitDNA.salesPolyColor, ['yesman', 'shades'], '', 8.95),
      ...
      'bdb': (7.0 / aSize, SuitDNA.boardPolyColor, ['headhoncho'], 'head-honcho.jpg', 8.23),
}