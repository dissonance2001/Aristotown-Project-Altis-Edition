...
class DistributedSuitBase(DistributedAvatar.DistributedAvatar, Suit.Suit, SuitBase.SuitBase):
    ...
    def resetNameForManager(self):
        nameWLevel = TTLocalizer.SuitBaseNameWithLevel % {'name': self.name,
         'dept': self.getStyleDept(),
         'level': str(self.getActualLevel()) + '.mgr'}
        self.setDisplayName(nameWLevel)

    def resetNameForExecutive(self):
        nameWLevel = TTLocalizer.SuitBaseNameWithLevel % {'name': self.name,
         'dept': self.getStyleDept(),
         'level': str(self.getActualLevel()) + '.exe'}
        self.setDisplayName(nameWLevel)

    def resetNameForGovernaught(self):
        nameWLevel = TTLocalizer.SuitBaseNameWithLevel % {'name': self.name,
         'dept': self.getStyleDept(),
         'level': str(self.getActualLevel()) + '.gov'}
        self.setDisplayName(nameWLevel)
