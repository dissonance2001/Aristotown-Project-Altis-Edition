...
class BossCog(Avatar.Avatar):
    ...
    def generateBossCog(self):
        self.throwSfx = base.loader.loadSfx('phase_9/audio/sfx/CHQ_VP_frisbee_gears.ogg')
        self.swingSfx = base.loader.loadSfx ('phase_9/audio/sfx/CHQ_VP_swipe.ogg')
        self.spinSfx = base.loader.loadSfx('phase_9/audio/sfx/CHQ_VP_spin.ogg')
        self.rainGearsSfx = base.loader.loadSfx('phase_9/audio/sfx/CHQ_VP_raining_gears.ogg')
        self.swishSfx = base.loader.loadSfx('phase_9/audio/sfx/CHQ_VP_swish.ogg')
        self.boomSfx = base.loader.loadSfx('phase_9/audio/sfx/CHQ_VP_boom.ogg')
        self.deathSfx = base.loader.loadSfx('phase_9/audio/sfx/CHQ_VP_big_death.ogg')
        self.treadsSfx = base.loader.loadSfx('phase_9/audio/sfx/CHQ_VP_tractor_treads.ogg')
        self.headshakeSfx = base.loader.loadSfx('phase_9/audio/sfx/CHQ_VP_headshake.ogg')
        self.upSfx = base.loader.loadSfx('phase_9/audio/sfx/CHQ_VP_raise_up.ogg')
        self.downSfx = base.loader.loadSfx('phase_9/audio/sfx/CHQ_VP_collapse.ogg')
        self.reelSfx = base.loader.loadSfx('phase_9/audio/sfx/CHQ_VP_reeling_backwards.ogg')
        self.birdsSfx = base.loader.loadSfx('phase_4/audio/sfx/SZ_TC_bird1.ogg')
        self.dizzyAlert = base.loader.loadSfx('phase_5/audio/sfx/AA_sound_aoogah.ogg')
        if self.style.dept == 'c':
            self.grunt = base.loader.loadSfx('phase_9/audio/sfx/Boss_c_COG_VO_grunt.ogg')
            self.murmur = base.loader.loadSfx('phase_9/audio/sfx/Boss_c_COG_VO_murmur.ogg')
            self.statement = base.loader.loadSfx('phase_9/audio/sfx/Boss_c_COG_VO_statement.ogg')
            self.question = base.loader.loadSfx('phase_9/audio/sfx/Boss_c_COG_VO_question.ogg')
        elif self.style.dept == 'l':
            self.grunt = base.loader.loadSfx('phase_9/audio/sfx/Boss_l_COG_VO_grunt.ogg')
            self.murmur = base.loader.loadSfx('phase_9/audio/sfx/Boss_l_COG_VO_murmur.ogg')
            self.statement = base.loader.loadSfx('phase_9/audio/sfx/Boss_l_COG_VO_statement.ogg')
            self.question = base.loader.loadSfx('phase_9/audio/sfx/Boss_l_COG_VO_question.ogg')
        elif self.style.dept == 'g':
            self.grunt = base.loader.loadSfx('phase_3.5/audio/dial/ttcc_ene_chairman_grunt.ogg')
            self.murmur = base.loader.loadSfx('phase_3.5/audio/dial/ttcc_ene_chairman_murmur.ogg')
            self.statement = base.loader.loadSfx('phase_3.5/audio/dial/ttcc_ene_chairman_statement.ogg')
            self.question = base.loader.loadSfx('phase_3.5/audio/dial/ttcc_ene_chairman_question.ogg')
        else:
            self.grunt = base.loader.loadSfx('phase_9/audio/sfx/Boss_COG_VO_grunt.ogg')
            self.murmur = base.loader.loadSfx('phase_9/audio/sfx/Boss_COG_VO_murmur.ogg')
            self.statement = base.loader.loadSfx('phase_9/audio/sfx/Boss_COG_VO_statement.ogg')
            self.question = base.loader.loadSfx('phase_9/audio/sfx/Boss_COG_VO_question.ogg')
