...
class DropdownVisualEffects(CSPanelAdjusterBase, DirectScrollableOptionMenu):
    """
    A dropdown panel for visual effects.
    Enum: dropdown_visual_effects
    """
    ...
    def __init__(self, parent, subevent, kwarg, cutsceneDict, **kw):
        ...
        self.items = cutsceneDict['visualEffects'][:]
        ...
        self.defineoptions(kw, optiondefs)
        DirectScrollableOptionMenu.__init__(self, parent, **kw)
        self.initialiseoptions(DropdownVisualEffects)

        self.textLabel = DirectFrame(
            parent=self, text='Visual Effects', text_scale=1.1,
            text_pos=(-2.5, -0.01), frameColor=(0, 0, 0, 0),
        )
