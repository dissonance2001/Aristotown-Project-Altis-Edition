...
class CutsceneLoader:
    ...
    def createLoader(cls, key, editor: bool = False, affectsCamera: bool = True, maxPlayers: int = 4, **kwargs) -> 'CutsceneLoader':
        ...
        # Inject affectsCamera into the kwargs for use in cutscene setup funcs
        kwargs['affectsCamera'] = affectsCamera
    ...
    def addVisualEffectsToCutscene(self, effectEnumList: list):
        """Adds a list of visual effects to the cutscene dict."""
        self.cutsceneDict['visualEffects'] = effectEnumList
    ...
    def addStuffToCutscene(self, *stuff,
        ...
        if visualEffects:
            self.addVisualEffectsToCutscene(visualEffects)
        if sounds:
