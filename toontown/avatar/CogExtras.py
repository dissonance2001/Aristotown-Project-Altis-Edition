...
class CogExtras:
    ...
    def flyIn(self, suit, duration):
        ...
        spin = ActorInterval(self.propeller, 'chan', startTime=0, endTime=.3)
    ...
    def cogTalk(self, text, suit, height, size=.3, duration=3, noise=None, cog=True, boss=False, x=0, y=0, Bin=True, smallCaps=False):
        ...
        Sequence(bubble.scaleInterval(.35, (size+.1)), bubble.scaleInterval(.1, (size)), Parallel(sfx, Wait(duration)), Func(bubble.removeNode)).start(playRate=playRate)
