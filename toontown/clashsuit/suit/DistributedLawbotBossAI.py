...
class DistributedLawbotBossAI(DistributedBossCogAI.DistributedBossCogAI, FSM.FSM):
    ...
    def handleBattleADone(self, zoneId, toonIds):
        ...
        DistributedBossCogAI.DistributedBossCogAI.handleBattleADone(self, zoneId, toonIds)
    ...
    def handleBattleBDone(self, zoneId, toonIds):
        ...
        DistributedBossCogAI.DistributedBossCogAI.handleBattleBDone(self, zoneId, toonIds)
    ...
    def makeLawyer(self, painting, virtual=False, elite=False):
        ...
        spotlight = None
        suit = DistributedLawbotBossSuitAI.DistributedLawbotBossSuitAI(self, self.air, None, painting)
    ...
    def cannon_destroyedSuit(self, suit: DistributedLawbotBossSuitAI.DistributedLawbotBossSuitAI, avId: int) -> None:
        if suit.isElite:
    ...
    def getDamageMultiplier(self):
        mult = DistributedBossCogAI.DistributedBossCogAI.getDamageMultiplier(self)
