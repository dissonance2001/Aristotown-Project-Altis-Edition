...
class DistributedSuit(DistributedSuitBase, FSM, DelayDeletable):
    """
    ...
    def denyBattle(self):
        DistributedSuitBase.denyBattle(self)
    ...
    def enterBattle(self):
        DistributedSuitBase.enterBattle(self)
        self.resumePath(0)
    ...
    def enterWaitForBattle(self):
        DistributedSuitBase.enterWaitForBattle(self)
        self.resumePath(0)
