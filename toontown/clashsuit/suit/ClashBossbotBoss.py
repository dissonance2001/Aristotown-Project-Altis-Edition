...
from toontown.clashsuit.suit.ClashBossCog import ClashBossCog
...
class ClashBossbotBoss(ClashBossCog, FSM.FSM):
    BallLaunchOffset = Point3(10.5, 8.5, -5)

    def __init__(self, cr):
        ClashBossCog.__init__(self, cr)
        FSM.FSM.__init__(self, 'ClashBossbotBoss')
        self.bossDamage = 0
    ...
    def announceGenerate(self):
        ...
        global OneBossCog
        ClashBossCog.announceGenerate(self)
    ...
    def loadEnvironment(self):
        ...
        ClashBossCog.loadEnvironment(self)
    ...
    def unloadEnvironment(self):
        ...
        del self.geom
        ClashBossCog.unloadEnvironment(self)
    ...
    def enterElevator(self):
        ...
        ClashBossCog.enterElevator(self)
        self.resistanceToon.removeActive()
    ...
    def enterIntroduction(self):
        if not self.resistanceToonOnstage:
            self.__showResistanceToon(True)
        ClashBossCog.enterIntroduction(self)
    ...
    def exitIntroduction(self):
        ...
        ClashBossCog.exitIntroduction(self)
    ...
    def enterBattleOne(self):
        ...
        ClashBossCog.enterBattleOne(self)

    def enterFrolic(self):
        self.setPosHpr(*BossCogGlobals.BossbotBossBattleOnePosHpr)
        ClashBossCog.enterFrolic(self)
        self.show()
        ...
        if av:
            if hasattr(av, 'suit'):
                ...
                if av.isLocal():
                    ...
                    TTEmote.globalEmote.disableBody(base.localAvatar, 'ClashBossbotBoss.putFoodOnToon')
    ...
    def removeFoodFromToon(self, avId):
        ...
        if av:
            ...
            if av.isLocal() and self.battleTwoEmoteDisableBody:
                self.battleTwoEmoteDisableBody = False
                TTEmote.globalEmote.releaseBody(base.localAvatar, 'ClashBossbotBoss.removeFoodFromToon')
    ...
    def detachFoodFromToon(self, avId):
        ...
        if av:
            ...
            if av.isLocal() and self.battleTwoEmoteDisableBody:
                self.battleTwoEmoteDisableBody = False
                TTEmote.globalEmote.releaseBody(base.localAvatar, 'ClashBossbotBoss.detachFoodFromToon')
            cogFood = av.find('**/cogFood')
            if not cogFood.isEmpty():
                # retval = cogFood
    ...
    def claimOneChair(self, suit: ClashSuitBase):
        if self.notDeadList:
    ...
    def enterBattleFour(self):
        ...
        self.departmentExpBar.reparentTo(base.a2dBottomLeft)
        self.departmentExpBar.start()
        ClashBossCog.enterBattleFour(self)
        self.releaseToons(finalBattle=1)
        for toonId in self.involvedToons:
            toon = self.cr.doId2do.get(toonId)
            if toon:
    ...
    def exitBattleFour(self):
        ClashBossCog.exitBattleFour(self)
    ...
    def toonDied(self, avId):
        ClashBossCog.toonDied(self, avId)
