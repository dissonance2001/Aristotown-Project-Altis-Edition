...
class ClashSuitAI(ClashSuitBaseAI.ClashSuitBaseAI):
    ...
    def __init__(self, air, suitPlanner):
        ...
        # the track of the suit when it comes out a certain type of a building
        self.bldgTrack = None
        ...
        # Starting point (set by Suit planner)
    ...
    def pointInMyPath(self, point, elapsedTime):
        ...
        if not self.sp:
            pass
        return self.legList.isPointInRange(point, elapsed - SuitHoodGlobals.PATH_COLLISION_BUFFER, elapsed + SuitHoodGlobals.PATH_COLLISION_BUFFER)
    ...
    def flyAwayNow(self, forceRemove=False):
        """
        flyAwayNow(self)
    ...
    def d_setSPDoId(self, doId):
        ...
        set/get the suit planner doId for this suit, needed for
    ...
    def interruptMove(self):
        # is this unused? - Eliz 1/14/2021
        # so sad that steve jobs died of ligma - Main 9/8/2021
