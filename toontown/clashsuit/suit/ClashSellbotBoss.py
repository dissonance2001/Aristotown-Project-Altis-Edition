...
from toontown.clashsuit.suit import (ClashBossCog, SuitDNA,
                           SuitHealthMeter)
...
# This pointer keeps track of the one ClashSellbotBoss that should appear within avatar's current visibility zones
# If there is more than one ClashSellbotBoss visible to a client at any given time, something is wrong.
OneBossCog = None
...
class ClashSellbotBoss(ClashBossCog.ClashBossCog, FSM):
    ...
    def __init__(self, cr):
        ...
        FSM.__init__(self, 'ClashSellbotBoss')
    ...
    def makeEndOfBattleMovie(self, hasLocalToon):
        ...
        This one is called from ClashBattleFinal.
        """
    ...
    def exitElevator(self):
        ClashBossCog.ClashBossCog.exitElevator(self)
        self.cagedToon.addActive()
    ...
    def enterBattleTwo(self):
        ...
        ClashBossCog.ClashBossCog.enterBattleTwo(self)
    ...
    def exitBattleTwo(self):
        ...
        self.clearInterval(intervalName)
        ClashBossCog.ClashBossCog.exitBattleTwo(self)
        # self.cleanupBattles()
    ...
    def enterBattleThree(self):
        ...
        ClashBossCog.ClashBossCog.enterBattleThree(self)
        self.clearChat()
        self.cagedToon.clearChat()
        self.reparentTo(render)
        self.rampA.request('Retract')
    ...
    def exitBattleThree(self):
        ClashBossCog.ClashBossCog.exitBattleThree(self)
        bossDoneEventName = self.uniqueName('DestroyedBoss')
