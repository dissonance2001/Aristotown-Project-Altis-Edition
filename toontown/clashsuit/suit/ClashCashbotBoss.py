...
from toontown.clashsuit.suit import ClashCashbotBossGoon
...
class ClashCashbotBoss(ClashBossCog.ClashBossCog, FSM.FSM):
    numFakeGoons = 3

    def __init__(self, cr):
        ClashBossCog.ClashBossCog.__init__(self, cr)
        FSM.FSM.__init__(self, 'ClashCashbotBoss')
    ...
    def __makeResistanceToon(self):
        ...
        for i in range(self.numFakeGoons):
            goon = ClashCashbotBossGoon.ClashCashbotBossGoon(base.cr)
            goon.doId = -1 - i
