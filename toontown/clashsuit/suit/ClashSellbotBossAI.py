...
from toontown.clashsuit.suit import ClashBossCogAI, ClashSuitAI, SuitDNA
...
class ClashSellbotBossAI(ClashBossCogAI.ClashBossCogAI, FSM.FSM):
    ...
    def __init__(self, air):
        ...
        FSM.FSM.__init__(self, 'ClashSellbotBossAI')
        self.doobers = []
    ...
    def enterFrolic(self):
        ClashBossCogAI.ClashBossCogAI.enterFrolic(self)
        self.b_setBossDamage(0, 0, 0)
    ...
    def __makeDoobers(self):
        self.__resetDoobers()
        for i in range(8):
            suit = ClashSuitAI.ClashSuitAI(self.air, None)
