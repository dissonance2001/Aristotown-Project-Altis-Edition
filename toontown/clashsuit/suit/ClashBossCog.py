...
from toontown.clashbattle.battle import BattleExperience
from toontown.clashbattle.battle import BattleBase
from toontown.clashsuit.suit import BossCog
from toontown.clashsuit.suit import BossHealthBar
...
class ClashBossCog(DistributedAvatar.DistributedAvatar, BossCog.BossCog):
    ...
    def exitIntroduction(self):
        self.notify.debug('ClashBossCog.exitIntroduction:')
        intervalName = 'IntroductionMovie'
        self.clearInterval(intervalName)
        self.unstickToons()
        self.releaseToons()
