...
class ClashFactorySuit(ClashSuitBase, FSM, DelayDeletable):
    ...
    def doReparent(self):
        ...
        if not hasattr(self, 'factory'):
            self.notify.warning('no factory, get Redmond to look at ClashFactorySuit.announceGenerate()')
    ...
    def initializeBodyCollisions(self, collIdStr):
        ClashSuitBase.initializeBodyCollisions(self, collIdStr)
    ...
    def enableBattleDetect(self, name, handler):
        ClashSuitBase.enableBattleDetect(self, name, handler)

    def disableBattleDetect(self):
        ClashSuitBase.disableBattleDetect(self)
