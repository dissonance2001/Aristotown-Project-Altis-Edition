...
from toontown.clashsuit.suit.ClashBossCogAI import ClashBossCogAI
...
class ClashBossbotBossAI(ClashBossCogAI, FSM):
    maxToonLevels = 77
    ...
    def __init__(self, air):
        ...
        FSM.__init__(self, 'ClashBossbotBossAI')
    ...
    def announceGenerate(self):
        ...
        ClashBossCogAI.announceGenerate(self)
    ...
    def exitIntroduction(self):
        ...
        ClashBossCogAI.exitIntroduction(self)
    ...
    def invokeSuitPlanner(self, buildingCode, skelecog):
        suits = ClashBossCogAI.invokeSuitPlanner(self, buildingCode, skelecog)
    ...
    def makeBattle(self, bossCogPosHpr, battlePosHpr, roundCallback, finishCallback, battleNumber, battleSide):
        if battleNumber == 1:
            battle = ClashBattleWaitersAI.ClashBattleWaitersAI(self.air, self, roundCallback, finishCallback, battleSide)
        else:
            battle = ClashBattleDinersAI.ClashBattleDinersAI(self.air, self, roundCallback, finishCallback, battleSide)
    ...
    def genSuitObject(self, suitZone, suitType, bldgTrack, suitLevel, revives = 0, executive = 0):
        newSuit = ClashSuitAI(simbase.air, None)
    ...
    def b_setAttackCode(self, attackCode, avId=0):
        ...
        ClashBossCogAI.b_setAttackCode(self, attackCode, avId)
