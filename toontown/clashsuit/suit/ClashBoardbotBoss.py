...
class ClashBoardbotBoss(ClashBossCog.ClashBossCog, FSM.FSM):
    ...
    def __init__(self, cr):
        ...
        FSM.FSM.__init__(self, 'ClashBoardbotBoss')
        self.lawyers = []
    ...
    def setAttackCode(self, attackCode, avId = 0):
        ClashBossCog.ClashBossCog.setAttackCode(self, attackCode, avId)
