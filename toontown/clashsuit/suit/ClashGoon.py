...
class ClashGoon(DistributedCrushableEntity.DistributedCrushableEntity, Goon.Goon, FSM.FSM):
    ...
    def __init__(self, cr):
        ...
        FSM.FSM.__init__(self, 'ClashGoon')
        self.setCacheable(0)
        self.rayNode = None
    ...
    def disable(self):
        ...
        """
        self.notify.debug('ClashGoon %d: disabling' % self.getDoId())
        self.ignoreAll()
        self.stopToonDetect()
    ...
    def delete(self):
        try:
            ...
            self.notify.debug('ClashGoon %d: deleting' % self.getDoId())
    ...
    def enterStunned(self, ts = 0):
        ...
        self.animTrack = Parallel(
            ...
            Func(base.playSfx, self.collapseSound, node=self)
        )
