...
taskZoneId2pathId = {ToontownGlobals.SellbotFactoryInt: 'sellbotFactory',
 ToontownGlobals.SellbotFindForemanInt: 'sellbotFactory',
 ToontownGlobals.SellbotOcFindForemanInt: 'sellbotFactory',
 ToontownGlobals.SellbotOcFindFamilyInt: 'sellbotFactory',
 ToontownGlobals.SellbotFactorySideInt: 'sellbotFactory',
 ...
 ToontownGlobals.LawbotStageIntA: 'sellbotFactory',
 ToontownGlobals.LawbotStageIntB: 'sellbotFactory',
 ToontownGlobals.LawbotStageIntC: 'sellbotFactory'}
Paths = {'sellbotFactory': {0: [Vec3(10.0, 0.0, 0.0),
                    ...
                    42: [Vec3(6.0, -6.0, 0.0),
                         ...
                         Vec3(-6.0, -6.0, 0.0)],
                    # FTF Goons
                    102: [Vec3(-5.77, 10.0, 0.0),
                          Vec3(5.77, 10.0, 0.0),
                          Vec3(-5.77, -10.0, 0.0),
                          Vec3(5.77, -10.0, 0.0)],
                    103: [Vec3(-10, 0, 0), Vec3(10, 0, 0)]
                    },
