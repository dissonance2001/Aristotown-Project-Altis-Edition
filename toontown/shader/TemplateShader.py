...
This is a template shader class to base any new custom shaders off of.
It would be a child of ToontownShaderManager and registered with base.shader

Keep in mind for any shader inputs that are needed by the frag shader.
"""
...
class TemplateShader:
    def __init__(self, manager=None, manager2d=None):
        ...
        # self.sg = ShaderGlobals # Use only if you need ShaderGlobals
