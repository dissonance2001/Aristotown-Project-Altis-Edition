...
class PurchaseBase(StateData.StateData):
    ...
    def load(self, purchaseModels = None):
        ...
        self.pointDisplay = DirectLabel(parent=self.frame, relief=None, pos=(-1.03, 0.0, 0.1), scale=(0.8), text=str(self.toon.getMoney()), text_scale=0.2, text_fg=(0.95, 0.95, 0, 1), text_shadow=(0, 0, 0, 1), text_pos=(0, -0.1, 0), image=self.jarImage, text_font=ToontownGlobals.getSignFont())
