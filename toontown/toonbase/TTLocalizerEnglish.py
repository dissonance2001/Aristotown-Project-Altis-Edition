...
GlobalStreetNames = {15000: ('to', 'on', 'Tutorial Terrace'),
 ...
 7100: ('to the', 'in the', 'Knight Knoll'),
 7200: ('to the', 'in the', 'Noble Nook'),
 7300: ('to the', 'in the', 'Wizard Way'),
...
SuitBaseNameWithLevelHP = '%(name)s\n%(dept)s\nLevel %(level)s\n%(currHP)s / %(maxHP)s HP'
SkeleRevivePostFix = ' v%s.0'
ExecutivePostFix = '.exe'
ManagerPostFix = '.mgr'
GovernaughtPostFix = '.adv'
...
SuitFaceoffDefaultTaunts = ['ERROR 404: NO FACEOFF TAUNT FOUND.']
SuitFireManager = (
...
'stg': ["They call me Stooge - but I'm real huge.",
...
'enf': ["Oh you actually made it this far? That's adorable.",
           "I'd applaud your effort... if it amounted to anything.",
        "You're out of your depth, and it shows.",
        "Try to keep up. I know it's difficult for you."],
...
'blh': ["I could defeat you with half my effort, and still impress myself.",
        "You're not competition, you're a presentation opportunity.",
        "I've already won. This is just the demonstration phase.",
        "I'd explain my strategy, but it'd go over your head.",
        "I didn't climb to the top just to be challenged by someone like you!",
        "This won't take long, excellence rarely does."],
...
'mldr': ["I think it's my turn to stomp you.",
         "Does something smell a little moldy to you? No, it's just me!"],
...
'bsht': ["Shoot for the moon, and you might get to my level.",
        "This is going to leave a mark.",
        "I'll leave a crater where you stand.",
        "Houston, you have a problem.",
        "One small step for me, one giant leap for Cogs Inc."],
'cr': ["RAID!",
...
'txl': ["Prepare for a Nuclear meltdown.",
        ...
        "Steer Nu-clear!",
        "I don't even need half of my life to defeat you."],
...
'fbed': ["Can't you Toons ever give it a rest?",
...
'chainsaw2': ["ENTERING EMPLOYEE TERMINATION MODE.",
            "If you worked for this company, you'd be out in a cannon.",
            "I'm kind of busy right now, can you go away?",
            "You don't want to see what happens when I get angry."],
'choreo': ["Everyone in formation!",
            "This performance demands precision!",
            "Let's see if you can keep time.",
            "Out of step already?"],
...
'bkeeper': ['Your existence has been reviewed... and denied.',
            ...
            "By order of the board, this confrontation is mandatory."],
...
'ambass': ["I don't raise my voice, I raise the stakes.",
        "You're already outmatched.",
           "Stand straight, you're in my presence!",
...
'pf': ["Clearly, you've been outmatched.",
        "I'll gladly fight over petty differences.",
        "You need glasses if you think you can beat me.",
...
'cv': ["You're outta line!",
        ...
        "Watch out Toon, I have a lot of tricks under my belt.",
        "You're treading on thin ice, Toon,"],
...
'ad': ["I'm quite versed in paw and order.",
        "I'm not afraid of mew.",
...
'sh': ["Perhaps I could let you in on a little secret...",
...
'br': ["You and I are polar opposites, Toon.",
        "You'll find my methods quite aggressive.",
...
'whistleb': ["I'm the Whistleblower."],
'clerk': ["I'm the Head Attorney."],
'arbit': ["I'm the Arbitrator."],
'judy': ["Schedule an appointment for some other time.",
        ...
        "Sorry, Toon, I can't talk right now.",
        "Please, Toon. I'm rather busy at the moment."],
'mouthp': ["Come to chat?",
...
'erclaim': ["Gah! I was just out getting 'chup'!",
            "How did you find me?",
            "Next time I will send that lazy Skelecog for the errands!"],
'redd': ["I'm Redd 'Heir' Wing."],
'wsi': ["I'm The Witness Stand-In."],
'sgoat': ["Goat ready for a fight!",
            "You won't like me maa-d!",
            "I'll take you all on!",
            "How baa-d can I be?"],
'caseman': ["Mmph.",
            "Hmmph."],
'stenog': ["Not a single word goes amiss.",
            "Want me to run that by you again?"],
'lgator': ["Your strategies will go up in smoke, Toon.",
...
'sc': ["I will make short work of you.",
        ...
        "Well, aren't you a little short on your charges?"],
...
'shy': ["Company assets are under protection.",
		"These funds aren't for Toon hands.",
		"Your withdrawal request is denied.",
		"Your intrusion has been logged.",
		"Nothing gets past my seal.",
		"Try all you want, I don't open.",
...
'fct': ["Money is the art of purrfection.",
		"Oh sweet, you're the purrfect meal.",
		"I'm so furtunate to have all the money in the world.",
		"You will never furget me.",
		"I'm a real purrsonality.",
		"Do I look pawfully familiar? Good.",
		"You're infurior to me, Toon.",
		"You can't pawse the game on me.",
		"It ain't easy being purrfect.",
		"Careful, I have nine lives.",
		"I am pawsitive that I will win."],
...
'ovt': ["I'm the Supervisor... I think."],
...
'gld': ["YOU'LL NEVER TAKE MY NEST EGG!!!!",
...
'supervis': ["I'm the Mint Supervisor."],
'duckshfl': ["Deal me IN!",
            "Watch it, the cardth are THTACKED againtht ya!",
            "Taking a chanthe are we??",
            "All betth are OFF!"],
'treek': ["CHOP, CHOP, CHOP! Let's Hurreh this up!",
            "AH-HAH-HEH! I'll chop you down!",
            "Yah oveh-grown, Toon!",
            "Gegh! Let's cut to the chase!"],
'payman': ["Let's get everyone on the payroll.",
             "Your wages are already allocated.",
             "Time to process your earnings.",
             "You're all set for compensation!"],
'bookkeep': ["Hold still, I need to log this properly.",
            "I've logged every mistake you've made.",
            "Nothing escapes documentation.",
            "Your losses are already on file."],
'hustle': ["Hey hey, let's make this quick, yeah?",
              "Blink and you'll miss it, that's how I work!",
              "You're already losing, you just don't know it yet.",
              "C'mon, let's play a little game!"],
'liquidr': ["I can already see what you're worth!",
                 "Don't worry; I'll make good use of you!",
                 "You're wasting assets, I won't.",
                 "Let's strip this down to it's value."],
'treasure': ["Take your time. The interest won't!",
               "I've seen accounts like yours before, they never recover.",
               "Go on, spend what little you have left!",
               "Oh dear, you're already in the red."],
'pcrat': ["I'M the one who's gonna put ya away for good!",
            "Perhaps that's 'persuasion' enough for ya!",
            "Consider this ya share for the operation.",
            "Get outta my orbit, Toon!"],
'hroller': ["Come on, babe, FFHOW UFF THOFFE NUMBERFF!",
            "Give a big one for the headline, top banana!",
            "Hope you folkff at home are ready for a real ffhowfftopper!",
...
'erfit': ["Try and keep up, Toon.",
          "Look at these gains!",
          "Are you looking for a gym membership?"],
'hrollers': ["Come on, babe, FFHOW UFF THOFFE NUMBERFF!",
            "Give a big one for the headline, top banana!",
            "Hope you folkff at home are ready for a real ffhowfftopper!",
            "Pain iff ffhared equally between all participantff.",
            "Oooo-hooo-hooo, ratingff are ffkyrocketing!",
            ...
            "Who'ff ready for ffome cartoon violenffe?!",
            "You know, I've alwayff got an affe up my ffleeve! Ffee?"],
'hroller2': ["Come on, babe, FFHOW UFF THOFFE NUMBERFF!",
            "Give a big one for the headline, top banana!",
            "Hope you folkff at home are ready for a real ffhowfftopper!",
            "Pain iff ffhared equally between all participantff.",
            "Oooo-hooo-hooo, ratingff are ffkyrocketing!",
...
'dc': ["I don't take no for an answer, I just raise the price.",
		"Every hit I land? That's just me closing the deal.",
		"You're already losing, I'm just maximizing profits.",
		"You didn't ask for extras, but you're getting them anyway.",
		"Trust me, Toon. This deal only gets worse from here."],
...
'fcs': ["In a matter of minutes, I think you'll be sent back to the playground.",
		"Things are going to look rather stormy for you.",
		"You better be prepared, because I am the storm.",
		"I think you're not going to disrupt the sales.",
		"Oh, it isn't looking so sunny for you today.",
		"You're going to end in a drizzling defeat.",
		"Today's forecast isn't looking so kind for you.",
		"This snowstorm won't be quite the playful one.",
		"Rising sales? Check! Rising Toons? Nope."],
...
'asm': ["You've been identified as inefficient. I'm here to correct that.",
        "Every move you make has already been accounted for.",
        "Your defeat is already in production.",
        "You're just another step in the process."],
'cnd': ["Thank you all for attending my campaign rally.",
        "Your support means everything, especially when it's forced.",
        "Let's make this battle profitable again.",
...
'tf': ["It's time to face-off!",
        ...
        "My eyes are on you."],
'ppl': ["Sorry we have to fight, my boss is making me.",
        "I regret to inform you that your stay here is no longer tolerated.",
        "Anything my bosses say goes, and they want you gone.",
...
'ksp': ["Pucker up, Toon.",
        ...
        "Is this a good shade on me?",
        "This will leave a mark.",
        "My superiors will love this.",
        "Nobody can gloss over my talents.",
...
'mh2': ["Are you ready for my take?",
        ...
        "There's no business like Hollywood!",
        "I hope you don't forget your lines."],
'prethink': ["It's only natural I thought to prepare for this scenario!",
            "I'm always one step ahead!",
            "Such a simple-minded strategy won't work on me!",
            "I'll show you what intelligence is truly capable of!"],
'mslacker': ["My dad says that the union forces us to take breaks.",
            "My show is on in a few minutes.",
            "You're just trying to mooch off of my cable package.",
            "I'm assuming you've met my dad."],
'cinema': ["Smile, Toons, you're about to be famous!",
            "This shot's going to make headlines!",
            "I capture every embarrassing moment.",
            "Try not to blink."],
'radiog': ["This frequency is now under my control.",
            "Let's see how well you handle live broadcast pressure.",
            "No static can hide you from my signal.",
           "There's no off switch on my station.",
            "You're live on the air! Don't embarrass yourselves!"],
'racket': ["Relax Toons. This is just a hostile takeover.",
           "Every fight's a transaction. You're about to lose value.",
           "I run this market, you're just another commodity.",
           "I don't need to cheat, the system's rigged already.",],
'ubuster': ["Looks like we've got a congestion problem.",
            "I'm here to keep things moving. You're slowing everything down.",
            "Let's see if you can survive rush hour.",
            "This road wasn't built for Toon traffic.",
            "Nobody gets through this route without my approval!"],
'safesupervis': ["Pressure builds long before you notice it.",
                 "Resistance only increases the strain.",
                 "Everything breaks eventually. Let's test your limit.",
                "You've already stepped into the compression zone."],
'psetter': ["You gotta do more than hustle to match my speed!",
            "20 meters ain't nothing!",
            "Bite the dust, buddy!",
            "Ka-pow."],
    # Boardbots
'bgh': ["You won't be worth much once we're done here.",
...
'pph': ["You'll crumple under the pressure.",
...
'ins': ["Can't you see there's important intel I have to collect?!",
...
'cbr': ["It's about time I cut your cord.",
...
'txm': ["Prepare for a Nuclear meltdown.",
        ...
        "Steer Nu-clear!",
        "I don't even need half of my life to defeat you."],
'dl': ["The secret to my success? That's under lock and key.",
...
'ang': ["Good news! I'm investing in your downfall.",
        "Let's discuss your future. It's very short.",
        "I only fund winning ventures, you are not one of them.",
        "Trust me, this is a growth opportunity.",
        "I'll guide you through your liquidation.",
        "You're about to experience rapid depreciation.",
        "You look underfunded."],
'shw': ["These waters are not for you.",
...
'bfh2': ["Any fin is possible if I don't trout myself.",
        "You're just fishing for trouble.",
        "You will find me swimming in cash.",
        "I won't feel gillty after defeating you.",
        "I'm bigger than any fish you will ever catch.",
        "Something's rather fishy in here. No, it's just me!",
        "I'm a Big Fish in a little pond, Toon."],
'mg': ["From heron, you will respect my authority.",
...
'chw': ["Let's make this quick. I am late for the board meeting.",
...
'hho': ["Don't underestimate me. I graduated head of my class.",
        ...
        "You're my ticket to getting ahead of this company."],
'chairp': ["I'm the Ground Floor Investor."],
'bdirector': ["I'm the Board Director."],
'ddiver': ["I'm not so shore you know what you're getting into.",
            "Let's dive right into this, shall we?",
            "You're getting into deep waters, Toon.",
            "This battle will throw you off the deep end."],
'gatekeep': ["I shall putteth this area on lockethdown.",
...
'dola': ["I'll break the very ground ya stand on!",
        "Ya plans are goin' down the drain!",
        "Who could'a seen such a development!",
        "Your hopes are diluted, Toon."],
'dold': ["There ain't room in this town for tha both o' us.",
            "Yippee-ki-yah-yippee-ki-yo!",
            "Ink says yer wanted.",
            "Yer farm looks drained."],
'liquid': ["You're trespassing on premium territory.",
            "Consider this a mandatory surcharge.",
            "Your resistance accrues interest.",
            "No entry without tribute."],
'rkeeper': ["Your resistance has been categorized as futile.",
            "You will be archived accordingly.",
             "Every error you make will be preserved.",
             "Do try to struggle, it improves the transcript."],
'cbutcher': ["Your resistance has been categorized as futile.",
            "You will be archived accordingly.",
             "Every error you make will be preserved.",
             "Do try to struggle, it improves the transcript."],
'cdirector': ["This encounter has already been resolved. You're just late.",
              "We're operating within acceptable projections.",
              "Your survival probability is negligible.",
            "You've entered a scenario where you do not win."],
'fmaker': ["This will make a great scene.",
            "Every story needs a tragic ending.",
            "You'll be remembered... briefly.",
            "Try to act surprised."],
'dking': ["Welcome to my market. You're already overvalued.",
          "Let's see how long your assets last.",
          "I reward performance. You don't look promising.",
          "Every move you make affects my bottom line."],
'ottoman': ["I'm the Ottoman."],
'crystal': ["I'm Crystalline."],
'chairman': ["I'm the Chairman."],
    # Techbots
'skd': ["I'm going to steal your script!",
		"I'm capable of distributing a Denial-Of-Service.",
		"When I'm done with you, you will need a new set of code.",
		"Are you secure?",
		"It would be a shame if a Trojan Horse snuck in.",
		"I'm about to replace all occurrences of Toons with COGs.",
		"They say I am the next Industry Titan!",
		"My attack will be multithreaded.",
		"My software is one of a kind.",
		"As we speak, I'm spoofing your scripts."],
'cmk': ["No one can keep up with my algorithm.",
		"I'll be making this a quick one.",
		"My code tends to drive Toons bananas.",
		"I have heard my code is intimidating.",
		"I'm going to perform a routine task.",
		"I'll show you who the top banana is.",
		"I'm gonna go ape on you!",
		"I'll throw a monkey wrench into things.",
		"No more monkey business.",
		"I'm gonna make a monkey out of you."],
'dhr': ["According to my data, this will be easy.",
		"Another Toon to add to my collection!",
		"Step aside, you are blocking my data.",
		"Careful, I know all of your tendencies.",
		"My approach to this battle is data driven.",
		"I am going to take a byte out of you.",
		"Your data is worth far more than you, Toon.",
		"You think you can keep your information from me?"],
'vpr': ["This is all part of my code.",
		"I'm sure this will work.",
		"Deep magic begins here...",
		"I'll teach you how this code works.",
		"Wanna know how this code works?",
		"I'll teach you, Toon!",
		"It's just like magic.",
		"Your knowledge doesn't go beyond this."],
'brn': ["I am the brains of this operation.",
		"I am always one step ahead.",
		"Who needs brawn when you have BRAIN.",
		"Think fast, Toon.",
		"Out of the way Toon, you are no match for my intelligence.",
		"Checkmate.",
		"I can predict your every move.",
		"My next move will boggle your mind.",
		"Are you challenging my intellect?",
		"I don't Think so.",
		"You're getting on my nerves.",
		"You Toons give me a headache."],
'sdb': ["I know something will work for you.",
		"Let me remove your bugs.",
		"Are you buggy? Let me help.",
		"I'm being paid to fix your ways.",
		"I'll have to take you apart.",
		"Good, I was bored anyways.",
		"You need some urgent care.",
		"You're not going to like my debug procedure."],
'key': ["Your opinions don't matter to me.",
		"I'll tell you who runs this town.",
		"Let's discuss a stand-off.",
		"Where're you headed, warrior?",
		"Don't even think about it, warrior.",
		"Tell them I'm coming.",
		"Get ready for this flame war.",
		"Civil discussions? What are those?"],
'kbc': ["Get ready for this flame war."],
'blk': ["Toons like you have no chance against my security precautions.",
...
'sfs': ["Are you ape enough?",
        'My software will withdraw your attacks.',
        "Toons are no trouble against my software."],
'pyc': ["You are looking particularly lovely today!",
		"Software is my nature.",
		"Let me find a solution to this problem.",
		"Don't snake off on me, Toon!",
		"What happens next will charm you.",
		"Sss! Be quiet, Toon!",
		"Toons are no trouble against my software.",
		"My software will withdraw your attacks."],
'inw': ["This will be easy - I know my way around things.",
...
'itn': ["I am a Titan in this department.",
		"This industry isn't for you, Toon.",
		"You're up against Big Tech.",
		"Your code is not up to industry standards.",
		"This will be the last time you halt development.",
		"There's been a change in Tech.",
		"This world is only big enough for me.",
		"Marble in my glory.",
		"I'm as sturdy as stone."],
'rus': ["Time to plant you in the ground.",
		"I'm going to take away your privileges!",
		"You're the root of the problem.",
		"Prepare to be rooted out!",
		"I'm the root of your problem.",
		"Show me your roots!",
		"I have full control over your account."],
'ant': ["I'm the Antivirus."],
'sya': ["I'm the Senior Developer."],
'djockey': ["My initiative may surprise you.",
            "I'm calling in backup!",
            "Let's get things started, shall we?"],
'ptjockey': ["My initiative may surprise you.",
            "I'm calling in backup!",
            "Let's get things started, shall we?"],
    # Pressbots
'ppb': ["I'll be delivering you a swift defeat.",
		...
		"This is no laughing matter.",
		"I'm going to give you the business."],
'shb': ["Shall I document this moment of sadness, toon?",
...
'gms': ["Time to investigate your weaknesses, Toon.",
...
'hck':["My report on you being a hack is nearly complete.",
...
'ath': ["My time in the shadows is over.",
...
'sbg': ["I take you with a grain of sand.",
...
'dcw': ["An apple a day won't keep me away.",
        "You're going to need a bigger boat.",
        "I don't need a stethoscope to hear your heart pounding.",
        "Step into my office.",
        "You're in deep waters now, Toon."],
'wnk': ["I am about to give you the worst knight of your life.",
...
'std': ["Mr. Hollywood is busy. You'll have to answer to me.",
...
'std2': ["Mr. Hollywood is busy. You'll have to answer to me.",
        "The director will surely notice this stunt.",
        "Let's get this over with, I've got a big scene to shoot.",
        "Beating you will get me a leading role.",
        "Time for an action shot!"],
'ghw': ["'I will lose.' Your words, not mine.",
...
'gzt': ["Oh deer. I hope you're not another Toon looking for a story.",
...
'nsh': ["You smell of nothing but bad news, Toon.",
...
'anc': ["Good news: I'll be defeating you. Bad news: you'll be defeated.",
...
'jls': ["I'm the Journalist."],
'pbl': ["I'm the Publisher."],
'videog': ["This production ends with you off-screen.",
            "I hope you like the spotlight. It's your last scene.",
            "Let's roll the footage of your downfall.",
            "The ratings love a good Toon defeat."],
'director': ["Quiet on set! The Toons are ruining my production!",
            "Everyone take your marks; especially you, Toons!",
            "You're about to be written out of the script.",
            "I run this set, not you!"],
...
SuitCheatNames = ('PowerhouseAbsorb', 'PowerhouseSoakImmune', 'PowerhouseGeneration', 'PowerhouseGeneration2', 'PowerhouseBurnDamage', 'PowerhouseLureImmune', 'PowerhouseSyphon', 'PowerhouseSyphonDesperation',
                  ...
                  'AmbassadorManagerialProtection', 'AmbassadorManagerialProtectionImmunity', 'SueDamage', 'WiretapperBusySignal',
...
'ForemanExplosion',
'ForemanCompensation',
'ForemanCompensation2',
'ForemanCompensation3',
'ForemanCompensation4',
'ForemanCompensation5',
                  'DividendAccountRollover',
                 'DividendAccountRollover2',
                                             'DividendAccountRollover3',
'DividendAccountRollover4',
'DividendAccountRollover5',
'DividendLiquidationEvent',
'DividendLiquidationEventDamage',
'DividendTotalMarketMeltdown',
'DividendTotalMarketMeltdown2',
'DividendPeckingOrder',
'DividendPeckingOrderZapped',
'DividendZapRetaliation',
'OttomanRevisedDraft',
'OttomanRedPenReview',
'OttomanFootnoteOverload',
'OttomanPerformanceReview',
'OttomanPerformanceReviewRevert',
'CrystalShatteringClarity',
'CrystalRefractDamage',
'CrystalRefractDamageRetaliation',
'CrystalFracturedLimitsOffensive',
'CrystalFracturedLimitsDefensive',
'CrystalFracturedLimitsRetaliation',
'CrystalPrismaticDistortion',
'ChairmanTrapRetaliation',
'ChairmanLureRetaliation',
'ChairmanThrowRetaliation',
'ChairmanSquirtRetaliation',
'ChairmanZapRetaliation',
'ChairmanSoundRetaliation',
'ChairmanDropRetaliation',
'ChairmanCage',
'ChairmanPhase2',
'ChairmanOvertime',
'ChairmanOvertime2',
...
'ChairmanOvertime4',
'ChairmanOvertime5',
'ChairmanHostileLiquidation',
'ChairmanHostileLiquidation2',
'ChairmanHostileLiquidation3',
'ChairmanHostileLiquidation4',
'ChairmanHostileLiquidation5',
...
'ChairmanSnipe',
                  ...
                  'HustlerExclusiveOffer',
                  'HustlerExclusiveOfferRetaliation',
                  'HustlerHalfWindsor',
...
'RecordkeeperRedlinedClauseMissedPayment',
                  ...
                  'RecordkeeperPaperTrail',
                  'RecordkeeperRevisedFiling',
                  'RecordkeeperRedlinedClause',
                  'RecordkeeperAuditCycle',
                  'RecordkeeperPhantomEntryDamage',
                  'RecordkeeperPhantomEntrySpawn',
                  'RecordkeeperPhantomEntrySacrifice',
                  'ButcherOverride',
                  'ButcherOverrideRemoval',
                  'ButcherRevvingUp',
                  ...
                  'ContingencyFailsafeProtocol',
                  'ContingencyRiskThresholdBreach75',
                  'ContingencyRiskThresholdBreach50',
                  'ContingencyRiskThresholdBreach25',
                  'ContingencyContingencyClause',
                  'ContingencyContingencyClauseRetaliation',
...
'AttorneyObjectionOverruled',
'AttorneyOverseerHeal',
'AttorneyChrono',
'AttorneyInkDrain',
'AttorneyDrainingPower',
'AttorneyRushJob',
'AttorneyRemand',
'AttorneyHurrySickness',
                  'WhistleCompensation',
'AttorneyOverseer',
...
'PresidentSnap',
'PresidentSyphon',
'PresidentBayouBellow',
'PresidentSnipe',
'PresidentDeepFreeze',
'PresidentFrozenDeath',
'PresidentPuzzling',
'PresidentDriver',
'PresidentMulligan',
'PresidentHighStakes',
                  'PowerhouseGroundbreaker',
                  'PowerhouseGroundbreakerRevert',
                  'ArbitratorPaperFiling',
                                           'ArbitratorWhirlwind',
'HighRollerGameTimeCog5',
'AmbassadorHeadRoller2',
 'AmbassadorHeadRoller3',
 'AmbassadorHeadRoller4',
 'AmbassadorHeadRoller5',
'AmbassadorAdvancement',
'AmbassadorAdvancement2',
 'ErclaimLaffSteal',
'ErclaimSacrifice',
 'ErclaimSacrifice2',
'ErclaimSacrifice3',
...
'ErfitGainsFromTheScrap2',
'ErfitGainsFromTheScrap3',
'ErfitGainsFromTheScrap4',
'ErfitGainsFromTheScrap5',
'ErfitPersonalTrainer',
'ErfitPhase2',
'AmbassadorAdvancement3',
'AmbassadorAdvancement4',
'AmbassadorAdvancement5',
'HighRollerGameTimeCog6',
'HighRollerGameTimeCog7',
'HighRollerGameTimeCog8',
'HighRollerGameTimeCog9',
'HighRollerGameTimeCog10',
'HighRollerPuzzle',
'HighRollerPuzzleBan',
'HighRollerGameOver',
'HighRollerGameOver2',
...
'UnionBusterUnionWages3',
'UnionBusterUnionWages4',
'UnionBusterUnionWages5',
'UnionBusterBreachOfContract',
'UnionBusterBreachOfContract2',
'UnionBusterBreachOfContract3',
'UnionBusterBreachOfContract4',
'UnionBusterNoStrikeClause',
'UnionBusterContractEnforcement',
'UnionBusterContractEnforcement2',
'RacketeerProfiteering',
'RacketeerProfiteering2',
'RacketeerProfiteering3',
'RacketeerProfiteering4',
'RacketeerProfiteering5',
'RacketeerExtortion',
'RacketeerExtortion2',
...
'SafetyOverpressured5',
                  ...
                  'RacketeerOverextendedLeverage2',
'RadiographerOvermodulated',
'RadiographerOvermodulated2',
'RadiographerOvermodulated3',
'RadiographerOvermodulated4',
'RadiographerOvermodulated5',
                  'DerrickManRefinement',
                  'DOLAInkDrain',
                  'DOPRAmbushMarketing',
'ReddAutoRepair',
'MintScheming',
'ReddLiquidationSale',
'ReddPeckingOrder',
'VideographerRisingStars',
 'VideographerRisingStars2',
 'VideographerDeath',
 'VideographerRisingStarsSacrifice',
 ...
 'DirectorCut',
                  'ArbitratorThrowBook',
                  'ArbitratorThrowBook2',
                  'ArbitratorThrowBook3',
                  'ArbitratorThrowBook4',
...
'PayrollPerformanceBonus',
                  ...
                  'DisableLevel68',
                  'DisableLevel78',
                   'AttorneyShakedownCooldown',
 'AttorneyShakedownVulnerable',
                  'DisableToonupTrap',
                  'DisableToonupLure',
                  'ErfitWringOut',
                  'DisableToonupThrow',
                  ...
                  'CaseManagerLegalBindings', 'CaseManagerLegalBindings2', 'CaseManagerInsurancePlan', 'CaseManagerInsurancePlan2', 'CaseManagerLegallyBound', 'ScapegoatGavel', 'ScapegoatShieldsUp', 'ScapegoatEnraged', 'ScapegoatBarnyardBash',
                  ...
                  'WSIJuryNotice', 'WSICeaseAndDesist', 'BanToonupTrap', 'BanToonupLure', 'BanToonupThrow', 'BanToonupSquirt', 'BanToonupZap', 'BanToonupSound', 'BanToonupDrop', 'BanTrapLure', 'BanTrapThrow',
                  'BanTrapSquirt', 'BanTrapZap', 'BanTrapSound', 'BanTrapDrop', 'BanLureThrow', 'BanLureSquirt', 'BanLureZap', 'BanLureSound', 'BanLureDrop',
...
'ReddAutoRepair': "Redd 'Heir' Wing heals all cogs for 35% of their max HP!",
'ReddLiquidationSale': "Redd 'Heir' Wing deals more damage when soaked!",
'ReddPeckingOrder': "Redd 'Heir' Wing applies a damage vulnerability to a Toon!",
    # Witness Stand-In Cheats
'WSIJuryNotice': "The Witness Stand-In calls cogs to his side!",
'WSICeaseAndDesist': "All negative effects are removed from the cogs and will attack first next round!",
    # Arbitrator Cheats
'ArbitratorObjection': "The Scapegoat retaliates when cogs are destroyed!",
'ArbitratorPaperFiling': "The Case Manager places a Toon on cooldown for 2 rounds!",
'ArbitratorWhirlwind': "The Stenographer sends a Toon through a storm of paperwork!",
...
'LitigatorSnap': "The Litigator retaliates against the most dangerous Toon!",
'LitigatorBayouBash': "The Litigator absolutely swamps you with cogs!",
'LitigatorBayouBellow': "The Litigator removes all negative effects from the cogs!",
    # Stenographer Cheats
...
'StenographerSanction': "The Stenographer retaliates against the least dangerous toon!",
    # Case Manager Cheats
'CaseManagerLegalBindings': "The Case Manager legally binds a toon to take damage every round!",
'CaseManagerLegalBindings2': "The Case Manager applies a damage boost to the cogs!",
'CaseManagerInsurancePlan':  "The Case Manager ensures that cogs are healed every round!",
'CaseManagerInsurancePlan2':  "The Case Manager ensures that cogs are healed every round!",
'CaseManagerLegallyBound': "This toon is legally bound to take 20 damage every round!",
    # Scapegoat Cheats
'ScapegoatGavel': "The Scapegoat removes a Toon from battle!",
'ScapegoatShieldsUp': "The Scapegoat's temperature has cooled and is now protecting cogs again!",
...
'PowerhouseAbsorb': "The Ambassador is now absorbing damage taken from the other cogs!",
...
'PowerhouseSnipeSoaked': "The Powerhouse shocks Toons at random!",
'PowerhouseSnipeBookkept': "The Powerhouse retaliates against toons who didn't follow the Bookkeeper's instructions!",
'PowerhouseSnipeMulligan': "The Powerhouse retaliates against toons who took damage from Fore!",
'PowerhouseSnipeCollectCall': "The Powerhouse becomes stronger when soaked!",
'PowerhouseGeneration': "The Powerhouse becomes stronger when zapped!",
...
'BookkeeperExplodingDocument': "All cogs are now shielded from combo and knockback damage!",
...
'WiretapperWiretapped': "The Wiretapper scrambles your damage!",
...
'AmbassadorHeadRoller3': "The Ambassador becomes stronger for every cog he sacrifices!",
'AmbassadorHeadRoller4': "The Ambassador becomes stronger for every cog he sacrifices!",
'AmbassadorHeadRoller5': "The Ambassador becomes stronger for every cog he sacrifices!",
...
'AmbassadorRefinement': "The Ambassador drowns cogs in oil to make them stronger!",
'AmbassadorRefinementManager': "The Ambassador heals all manager cogs!",
'AmbassadorGhostMentality': "The Ambassador virtualizes all cogs and supplies a damage boost!",
...
'SafetyViolation': "The Pressurizer retaliates against Toons who chose banned gags!",
'SafetyPromotion': "The Pressurizer promotes a random cog to absorb damage!",
'SafetyPromotion2': "The Pressurizer promotes a random cog to absorb damage!",
'SafetyPromotion3': "The Pressurizer promotes a random cog to absorb damage!",
'SafetyPromotion4': "The Pressurizer promotes a random cog to absorb damage!",
'SafetyPromotion5': "The Pressurizer promotes a random cog to absorb damage!",
'SafetyOverpressured': "The Pressurizer pushes a cog beyonds it's limits!",
'SafetyOverpressured2': "The Pressurizer pushes a cog beyonds it's limits!",
'SafetyOverpressured3': "The Pressurizer pushes a cog beyonds it's limits!",
'SafetyOverpressured4': "The Pressurizer pushes a cog beyonds it's limits!",
'SafetyOverpressured5': "The Pressurizer pushes a cog beyonds it's limits!",
'SafetyOverpressureDeath': "The Pressurizer takes damage when overpressured cogs are destroyed!",
        # Hustler Cheats
...
'HustlerCustomerRetention': "The Hustler heals all damaged cogs!",
...
'HustlerExclusiveOfferRetaliation': "The Hustler punishes the Toon who did not follow his instructions!",
'HustlerHalfWindsor': "The Hustler attacks again when hit!",
   # Traffic Manager Cheats
'TrafficDetour': "The Traffic Manager reroutes a Toon's gag choices!",
'TrafficCongestionPricing': "The Traffic Manager disables a random gag level every round!",
'TrafficRedLight': "The Traffic Manager cannot be targeted this round!",
'TrafficRedLightRetaliation': "The Traffic Manager retaliates against Toons who targeted him!",
'TrafficGreenLight': "The Traffic Manager must be targeted this round!",
'TrafficGreenLightRetaliation': "The Traffic Manager retaliates against Toons who did not target him!",
'TrafficYield': "The Traffic Manager retaliates against the least dangerous Toon!",
    # Union Buster Cheats
'UnionBusterUnionDues': "The Union Buster overworks all Toons when the battle is full!",
'UnionBusterUnionCalculator': "The Union Buster increases the amount of overtime hours when cogs are sacrificed!",
'UnionBusterUnionBust': "The Union Buster sacrifices unionized cogs for his own benefit!",
'UnionBusterUnionBuster': "The Union Buster forces Toons to take damage every round!",
'UnionBusterUnionBusterDamage': "Employed toons are forced to take damage every round!",
'UnionBusterNoStrikeClause': "The Union Buster removes the Toon's ability to dodge all incoming cog attacks!",
'UnionBusterUnionWages': "The Union Buster becomes stronger for every cog that is sacrificed!",
'UnionBusterUnionWages2': "The Union Buster becomes stronger for every cog that is sacrificed!",
'UnionBusterUnionWages3': "The Union Buster becomes stronger for every cog that is sacrificed!",
'UnionBusterUnionWages4': "The Union Buster becomes stronger for every cog that is sacrificed!",
'UnionBusterUnionWages5': "The Union Buster becomes stronger for every cog that is sacrificed!",
'UnionBusterBreachOfContract': "The Traffic Manager applies a damage debuff to the least dangerous Toon!",
'UnionBusterBreachOfContract2': "The Traffic Manager retaliates against Toons with existing vulnerabilities!",
'UnionBusterBreachOfContract3': "The Traffic Manager retaliates against bombed Toons!",
'UnionBusterBreachOfContract4': "The Traffic Manager retaliates against Toons who chose banned gags!",
'UnionBusterContractEnforcement': "The Traffic Manager heals cogs at random!",
'UnionBusterContractEnforcement2': "The Traffic Manager heals cogs at random!",
    # Racketeer Cheats
...
'RacketeerProfiteering': "The Racketeer steals resources from a nearby cog!",
'RacketeerProfiteering2': "The Racketeer steals resources from a nearby cog!",
'RacketeerProfiteering3': "The Racketeer steals resources from a nearby cog!",
'RacketeerProfiteering4': "The Racketeer steals resources from a nearby cog!",
'RacketeerProfiteering5': "The Racketeer steals resources from a nearby cog!",
'RacketeerExtortion': "The Racketeer steals resources from the Toons!",
'RacketeerExtortion2': "The Racketeer collects his dues when the Racket is full!",
'RacketeerCompensation': "The Racketeer strengthens damaged cogs!",
'RacketeerHustling': "The Racketeer requires Toons to use specific gag tracks!",
'RacketeerRacketeering': "The Racketeer bans your last chosen gag tracks!",
'RacketeerPeckingOrderRetaliation': "The Racketeer retaliates against Toons who used banned gags!",
'RacketeerPeckingOrderRetaliationSoak': "The Pressurizer removes your defense!",
    # Radiographer Cheats
...
'RadiographerHotTakeRetaliation': "The Pressurizer uses resources from the ashes to create an evil Toon!",
...
'RadiographerOvermodulated3': "The Radiographer unlures a cog and gives them an extra attack!",
...
'DerrickManRefinement': "The Derrick Man heals all cogs for 40% of their max HP!",
    # DOLA Cheats
'DOLAInkDrain': "All gags are 25% less effective for 2 rounds!",
    # DOPR Cheats
'DOPRAmbushMarketing': "The D.O.P.R. gains another attack every turn they are not hit!",
...
# 'DividendAccountRollover3': "The Dividend King becomes stronger for every cog\nthat is defeated!",
# 'DividendAccountRollover4': "The Dividend King becomes stronger for every cog\nthat is defeated!",
# 'DividendAccountRollover5': "The Dividend King becomes stronger for every cog\nthat is defeated!",
...
# 'DividendTotalMarketMeltdown': "The market is crashing at a rapid pace!",
# 'DividendPeckingOrder': "The Dividend King inflicts a damage vulnerability\nupon a Toon!",
# 'DividendPeckingOrderZapped': "The Dividend King retaliates against Toons who\nzapped him!",
    # Ottoman Cheats
'OttomanRevisedDraft': "The Ottoman disables random gag levels every turn!",
'OttomanRedPenReview': "The Ottoman retaliates against the least dangerous toon!",
'OttomanFootnoteOverload': "The Ottoman retaliates when attacked multiple times!",
'OttomanPerformanceReview': "The Ottoman is writing a review for his colleagues!",
'OttomanPerformanceReviewRevert': "The Ottoman completes his review!",
    # Crystalline Cheats
'CrystalShatteringClarity': "Crystalline confuses the most dangerous Toon and strengthens all damaged cogs!",
'CrystalRefractDamage': "Crystalline is redirecting damage dealt towards her allies!",
'CrystalRefractDamageRetaliation': "Crystalline retaliates when she absorbs damage!",
'CrystalFracturedLimitsOffensive': "Offensive gags are now off-limits!",
'CrystalFracturedLimitsDefensive': "Defensive gags are now off-limits!",
'CrystalFracturedLimitsRetaliation': "Crystalline retaliates against Toons who chose banned gags!",
'CrystalPrismaticDistortion': "Crystalline randomizes the Toons damage output!",
    # Chairman Cheats
'ChairmanTrapRetaliation': "The Chairman retaliates against toons who used Trap against him!",
'ChairmanLureRetaliation': "The Chairman retaliates against toons who used Lure against him!",
'ChairmanThrowRetaliation': "The Chairman retaliates against toons who used Throw against him!",
'ChairmanSquirtRetaliation': "The Chairman retaliates against toons who used Squirt against him!",
'ChairmanZapRetaliation': "The Chairman retaliates against toons who used Zap against him!",
'ChairmanSoundRetaliation': "The Chairman retaliates against toons who used Sound against him!",
'ChairmanDropRetaliation': "The Chairman retaliates against toons who used Drop against him!",
'ChairmanCage': "The Chairman locks a Toon up for 1 turn!",
'ChairmanPhase2': "The Chairman is now enraged!",
'ChairmanOvertime': "The Chairman gives a cog an extra attack!",
'ChairmanOvertime2': "The Chairman gives a cog an extra attack!",
'ChairmanOvertime3': "The Chairman gives a cog an extra attack!",
'ChairmanOvertime4': "The Chairman gives a cog an extra attack!",
'ChairmanOvertime5': "The Chairman gives a cog an extra attack!",
'ChairmanHostileLiquidation': "The Chairman sacrifices a cog!",
'ChairmanHostileLiquidation2': "The Chairman sacrifices a cog!",
'ChairmanHostileLiquidation3': "The Chairman sacrifices a cog!",
'ChairmanHostileLiquidation4': "The Chairman sacrifices a cog!",
'ChairmanHostileLiquidation5': "The Chairman sacrifices a cog!",
'ChairmanSnipe': "The Chairman gains another attack when under half health!",
    # Liquidator Cheats
 'LiquidatorOilRain': "The weather is changing!",
 'LiquidatorTornado': "The storm is picking up!",
 'LiquidatorOilRainDamage': "",
 'LiquidatorFreezingRain': "The weather is changing!",
 'LiquidatorHeavyRain': "The weather is changing!",
 'LiquidatorHeavyRainDamage': "",
 'LiquidatorStormCell': "The weather is changing!",
 'LiquidatorStormCellDamage': "",
 'LiquidatorInversion': "The weather is changing!",
 'LiquidatorMonsoon': "The weather is changing!",
    # Tollmaster Cheats
 'TollmasterMandatoryToll': "The Tollmaster increases the Toll cost for Toons that attacked him!",
 ...
 'TollmasterBalanceTheLedger': "The Tollmaster destroys damaged cogs and distributes their resources to all manager cogs!",
 ...
 'RecordkeeperRedlinedClauseMissedPayment': "An audit is about to commence!",
 'RecordkeeperMinutesTaken': "The Recordkeeper adds records to the bookshelf when unlured!",
 'RecordkeeperMinutesTakenContingency': "The Recordkeeper inflates the number of records when banned gags are used!",
 'RecordkeeperMinutesTakenDamage': "The records are piling up!",
 ...
 'RecordkeeperRedlinedClause': "The Recordkeeper places a Toon on cooldown!",
 ...
 'ButcherRevvingUp': "The Corporate Butcherer gains RPM when attacked!",
 'ButcherRevvingUpWhipsaw': "The Corporate Butcherer gains RPM when attacked! (Whipsaw: +4,000 RPM)",
 'ButcherKickback': "The Corporate Butcherer is now vulnerable for 2 turns!",
 'ButcherMarkedWood': "The Corporate Butcherer marks the most dangerous toon for termination!",
 'ButcherOffboarding': "The Corporate Butcherer fires a cog at a Toon!",
 'ButcherOffboarding2': "The Corporate Butcherer fires a cog at a Toon!",
 'ButcherOffboarding3': "The Corporate Butcherer fires a cog at a Toon!",
 'ButcherOffboarding4': "The Corporate Butcherer fires a cog at a Toon!",
 'ButcherOffboarding5': "The Corporate Butcherer fires a cog at a Toon!",
 'ButcherAggrandize': "The Corporate Butcherer promotes a cog to absorb damage!",
 'ButcherAggrandize2': "The Corporate Butcherer promotes a cog to absorb damage!",
 'ButcherAggrandize3': "The Corporate Butcherer promotes a cog to absorb damage!",
 'ButcherAggrandize4': "The Corporate Butcherer promotes a cog to absorb damage!",
 'ButcherAggrandize5': "The Corporate Butcherer promotes a cog to absorb damage!",
 'ButcherSparkPlug': "The Corporate Butcherer inflicts damage over time to a Toon!",
 'ButcherSparkPlugDamage': "",
 ...
 'ContingencyContingencyClauseRetaliation': "The Contingency Director punishes Toons for using banned gags!",
 'ContingencyRedundantAuthority': "The Contingency Director uses her own resources to heal his allies!",
 'ContingencyOperationalFreeze': "The Contingency Director will now start randomizing your gag damage!",
 'ContingencyForecastCollapse': "The Contingency Director buffs his partner when under 4000 HP!",
 'ContingencyRiskThresholdBreach': "The Contingency Director gains a new ability when a new HP threshold has been passed!",
 'SafetyHighPressure': "The Contingency Director unleashes a devastating attack!",
    # Dividend King Cheats
 'DividendLiquidationEvent': "The Dividend King liquidates Toons at random!",
 'DividendLiquidationEventDamage': "Drowned Toons take extra damage every turn!",
 'DividendTotalMarketMeltdown': "The market is taking a huge hit!",
 ...
 'TollmasterResonanceTax3': "The Dividend King becomes stronger for every cog defeated!",
 'TollmasterResonanceTax4': "The Dividend King becomes stronger for every cog defeated!",
 'TollmasterResonanceTax5': "The Dividend King becomes stronger for every cog defeated!",
    # Count Erclaim Cheats
'ErclaimLaffSteal': "The Count syphons your laff with each attack!",
'ErclaimSacrifice': "The Count sacrifices other cogs to become stronger!",
'ErclaimSacrifice2': "Count Erclaim sacrifices other cogs to become stronger!",
'ErclaimSacrifice3': "Count Erclaim sacrifices other cogs to become stronger!",
'ErclaimSacrifice4': "Count Erclaim sacrifices other cogs to become stronger!",
'ErclaimSacrifice5': "Count Erclaim sacrifices other cogs to become stronger!",
'ErclaimRiseFromTheScrap': "The Count resurrects and refines destroyed cogs!",
'ErclaimScopeCreep': "The Count gets tankier!",
'ErclaimHemmorage': "The Count marks a Toon to take extra damage this turn!", 
'ErclaimHemmorageHealing': "", 
'ErclaimPhase2': "nothing",
    # Count Erfit Cheats
'ErfitHydrationCheck': "Erfit hydrates a random Toon!",
'ErfitHydrationCheckRevert': "Hydrated toons take damage upon re-entry!",
'ErfitWringOut': "Erfit wrings the sweat out of this toon!",
'ErfitProToonShake': "Erfit heals the healthiest cog with every attack!",
'ErfitGainsFromTheScrap': "Erfit deletes the weakest cog for not being fit enough!",
'ErfitGainsFromTheScrap2': "Count Erfit deletes a random cog for not being fit enough!",
'ErfitGainsFromTheScrap3': "Count Erfit deletes a random cog for not being fit enough!",
'ErfitGainsFromTheScrap4': "Count Erfit deletes a random cog for not being fit enough!",
'ErfitGainsFromTheScrap5': "Count Erfit deletes a random cog for not being fit enough!",
'ErfitPersonalTrainer': "Erfit revives cogs with his own HP!",
'ErfitPhase2': "nothing",
    # High Roller Phase 1 Cheats
'HighRollerNoAttack': "nothing",
'HighRollerWheelSpin': "The High Roller starts a new minigame!",
'HighRollerPuzzle': "The High Roller requires certain gag track usage!",
'HighRollerPuzzleBan': "The High Roller bans gags at random!",
'HighRollerGameOver': "The High Roller punishes the toons who lost the game!",
'HighRollerGameOver2': "The High Roller punishes the toons who lost the game!",
'HighRollerCommercialBreak': "The High Roller removes all contestants!",
'HighRollerGameTimeSpawn': "The High Roller fills the battle with new contestants!",
'HighRollerGameTimeCog': "The High Roller asks a contestant to answer a trivia question!",
'HighRollerGameTimeCog2': "The High Roller asks a contestant to answer a trivia question!",
'HighRollerGameTimeCog3': "The High Roller asks a contestant to answer a trivia question!",
'HighRollerGameTimeCog4': "The High Roller asks a contestant to answer a trivia question!",
'HighRollerGameTimeCog5': "The High Roller asks a contestant to answer a trivia question!",
'HighRollerGameTimeCog6': "The High Roller asks a contestant to answer a trivia question!",
'HighRollerGameTimeCog7': "The High Roller asks a contestant to answer a trivia question!",
'HighRollerGameTimeCog8': "The High Roller asks a contestant to answer a trivia question!",
'HighRollerGameTimeCog9': "The High Roller asks a contestant to answer a trivia question!",
'HighRollerGameTimeCog10': "The High Roller asks a contestant to answer a trivia question!",
...
'HighRollerDiceRouletteCogs': "The dice will randomly decide who gets damaged!",
'HighRollerDiceRouletteToons': "The dice will randomly decide who gets damaged!",
'HighRollerDiceRouletteEveryone': "The dice will randomly decide who gets damaged!",
'HighRollerDiceRouletteNobody': "The dice will randomly decide who gets damaged!",
'HighRollerTrickOfTheLight': "The High Roller uses the power of refraction to clone himself!",
...
'HighRollerRaisingTheAnte': "The High Roller gives all Toons a massive damage boost!",
    # High Roller Silhouette Cheats
'HighRollerDonation': "The White Silhouette donates part of their health to The High Roller!",
'HighRollerSyphon': "The Magenta Silhouette syphons health from the Toons!",
'HighRollerBar': "The Red Silhouette retaliates when left unlured!",
'HighRollerBar2': "The Red Silhouette retaliates when a trap is placed!",
'HighRollerLureResistance': "The Green Silhouette grants lure immunity to Silhouettes at random!",
'HighRollerLureResistance2': "The Green Silhouette grants lure immunity to Silhouettes at random!",
'HighRollerSingingBlues': "The Blue Silhouette applies the winded effect to all Toons!",
'HighRollerDamageReduction': "The Gold Silhouette switches the gag order!",
'HighRollerSplashback': "The Pink Silhouette retaliates against Toons who used squirt!",
'HighRollerCheerRetaliation': "The Purple Silhouette retaliates against Toons with cheer!",
 ...
 'VideographerElectricShock': "The Videographer overcharges a cog!",
 'VideographerElectricShock2': "The Videographer overcharges a cog!",
 'VideographerElectricShock3': "The Videographer overcharges a cog!",
 'VideographerElectricShock4': "The Videographer overcharges a cog!",
 ...
 'ForemanContributing': "The Factory Foreman donates part of his health to an ally!",
 'ForemanUnionized': "The Factory Foreman buffs his allies and shields himself!",
 'ForemanBurning': "The Factory Foreman burns 2 Toons at random!",
 'ForemanBurningDamage': "Smoked Toons take damage every round!",
 'ForemanSleepyOvercharge': "",
 'ForemanExplosion': "",
 'ForemanCompensation': "The Factory Foreman will get stronger with each cog defeated!",
 'ForemanCompensation2': "The Factory Foreman will get stronger with each cog defeated!",
 'ForemanCompensation3': "The Factory Foreman will get stronger with each cog defeated!",
 'ForemanCompensation4': "The Factory Foreman will get stronger with each cog defeated!",
 'ForemanCompensation5': "The Factory Foreman will get stronger with each cog defeated!",
    # Mint Supervisor Cheats
 'MintScheming': "The Mint Supervisor gains an extra attack when not hit!",
 'MintUsury': "The Mint Supervisor steals health from a nearby cog!",
 'MintLureResistance': "The Mint Supervisor makes cogs immune to lure at random!",
 'MintLureResistance2': "The Mint Supervisor makes cogs immune to lure at random!",
 'MintLedger': "The Mint Supervisor retaliates when sound is used!",
 'MintAudit': "The Mint Supervisor disables your last chosen gag tracks!",
 'MintLifeInsurance': "If other cogs are alive, The Mint Supervisor will heal and get a damage boost!",
 'MintPolicyTerminated': "",
 'MintFraudulentDamage': "",
 'MintAbacusAbove15': "The Mint Supervisor requires certain gag level usage!",
 'MintAbacusBelow15': "The Mint Supervisor requires certain gag level usage!",
 'MintCompoundingInterest': "The Interest Fees are racking up!",
 'MintAccountant1': "The Mint Supervisor requires a certain number of targets!",
 'MintAccountant2': "The Mint Supervisor requires a certain number of targets!",
 'MintAccountant3': "The Mint Supervisor requires a certain number of targets!",
 'MintAccountant4': "The Mint Supervisor requires a certain number of targets!",
 'MintAccountant5': "The Mint Supervisor requires a certain number of targets!",
 'MintApprove': "",
 'MintDisapprove': "",
 'MintSynergy': "The Mint Supervisor punishes the Toons for not following his calculations!",
 'MintMovingGoalposts': "The Mint Supervisor randomizes the gag order!",
 'MintHurrySickness': "The Mint Supervisor punishes Toons that chose banned gags!",
    # Head Attorney Cheats
 'AttorneyDizzy': "The Head Attorney sends a Toon through a whirlwind of paperwork!",
 'AttorneyRemand': "The Head Attorney changes his position!",
 'AttorneyObjection': "The Head Attorney objects to your combo damage!",
 'AttorneyObjectionSustained': "Sorry guys, he has a point!",
 'AttorneyObjectionOverruled': "The Head Attorney has no evidence to support his claim!",
 'AttorneyOverseerHeal': "",
 'AttorneyChrono': "",
 'AttorneyOverseer': "",
 'AttorneyShakedownCooldown': "The Head Attorney places a Toon on a reward cooldown!",
 'AttorneyShakedownVulnerable': "The Head Attorney applies a damage vulnerability!",
 'AttorneyInkDrain': "All gags will be 10% less effective for 1 round!",
 'AttorneyDrainingPower': "The Head Attorney steals resources from drained Toons!",
 'AttorneyRushJob': "The Head Attorney requires certain gag usage!",
 'AttorneyHurrySickness': "The Head Attorney punishes the Toons for not following his orders!",
 'WhistleCompensation': "The Whistleblower supplies a damage boost to all damaged cogs!",
    # Club President Cheats
 'PresidentMandatoryFiling': "Toon's defense is stripped at random!",
 'PresidentLiability': "The Club President marks a Toon to take extra damage!",
 'PresidentLiability2': "The Club President retaliates against marked Toons!",
 'PresidentSensational': "The Club President asks a fellow cog to show off!",
 'PresidentTargetCheck': "",
 'PresidentExtraTip': "The Club President unlures and heals a cog!",
 'PresidentExtraTip2': "The Club President unlures and heals a cog!",
 'PresidentExtraTip3': "The Club President unlures and heals a cog!",
 'PresidentExtraTip4': "The Club President unlures and heals a cog!",
 'PresidentExtraTip5': "The Club President unlures and heals a cog!",
 'PresidentExtraTip6': "The Club President unlures and heals a cog!",
 'PresidentSnap': "The Club President places a damage vulnerability on a random Toon!",
 'PresidentSyphon': "The Club President syphons health from the Toons!",
 'PresidentBayouBellow': "The Club President removes all negative effects from the cogs!",
 'PresidentSnipe': "The Club President retaliates against Toons at random!",
 'PresidentDeepFreeze': "The Club President slows the Toons down!",
 'PresidentFrozenDeath': "Frozen cogs shatter when defeated!",
 'PresidentPuzzling': "The Club President puzzles a Toon!",
 'PresidentDriver': "The Club President applies a damage debuff to 2 Toons at random!",
 'PresidentMulligan': "The Club President takes another shot!",
 'PresidentHighStakes': "The Club President randomizes the Toons damage power!",
...
'Desperation': "!",
'Desperation2': "!",
'GovernaughtDeath': "Toons gain a damage boost when they defeat Governaught cogs!",
    # Sue Damage Movie
...
'BanLevel6': "Level 6 gags are now off-limits!",
'BanLevel7': "Level 7 gags are now off-limits!",
'BanLevel8': "Level 8 gags are now off-limits!",
    # Double Level Bans
'BanLevel45': "Level 4 and 5 gags are now off-limits!",
'BanLevel46': "Level 4 and 6 gags are now off-limits!",
'BanLevel47': "Level 4 and 7 gags are now off-limits!",
'BanLevel48': "Level 4 and 8 gags are now off-limits!",
'BanLevel56': "Level 5 and 6 gags are now off-limits!",
'BanLevel57': "Level 5 and 7 gags are now off-limits!",
'BanLevel58': "Level 5 and 8 gags are now off-limits!",
'BanLevel67': "Level 6 and 7 gags are now off-limits!",
'BanLevel68': "Level 6 and 8 gags are now off-limits!",
'BanLevel78': "Level 7 and 8 gags are now off-limits!",
    # Single Track Bans
'BanToonup': "Toon-Up gags are now off-limits!",
'BanTrap': "Trap gags are now off-limits!",
'BanLure' : "Lure gags are now off-limits!",
'BanThrow': "Throw gags are now off-limits!",
'BanSquirt': "Squirt gags are now off-limits!",
'BanZap': "Zap gags are now off-limits!",
'BanSound': "Sound gags are now off-limits!",
'BanDrop': "Drop gags are now off-limits!",
        # Double Track Bans
'BanToonupTrap': "Toon-Up and Trap gags are now off-limits!",
'BanToonupLure': "Toon-Up and Lure gags are now off-limits!",
'BanToonupThrow': "Toon-Up and Throw gags are now off-limits!",
'BanToonupSquirt': "Toon-Up and Squirt gags are now off-limits!",
'BanToonupZap': "Toon-Up and Zap gags are now off-limits!",
'BanToonupSound': "Toon-Up and Sound gags are now off-limits!",
'BanToonupDrop': "Toon-Up and Drop gags are now off-limits!",
'BanTrapLure': "Trap and Lure gags are now off-limits!",
'BanTrapThrow': "Trap and Throw gags are now off-limits!",
'BanTrapSquirt': "Trap and Squirt gags are now off-limits!",
'BanTrapZap': "Trap and Zap gags are now off-limits!",
'BanTrapSound': "Trap and Sound gags are now off-limits!",
'BanTrapDrop': "Trap and Drop gags are now off-limits!",
'BanLureThrow': "Lure and Throw gags are now off-limits!",
'BanLureSquirt': "Lure and Squirt gags are now off-limits!",
'BanLureZap': "Lure and Zap gags are now off-limits!",
'BanLureSound': "Lure and Sound gags are now off-limits!",
'BanLureDrop': "Lure and Drop gags are now off-limits!",
'BanThrowSquirt': "Throw and Squirt gags are now off-limits!",
'BanThrowZap': "Throw and Zap gags are now off-limits!",
'BanThrowSound': "Throw and Sound gags are now off-limits!",
'BanThrowDrop': "Throw and Drop gags are now off-limits!",
'BanSquirtZap': "Squirt and Zap gags are now off-limits!",
'BanSquirtSound': "Squirt and Sound gags are now off-limits!",
'BanSquirtDrop': "Squirt and Drop gags are now off-limits!",
'BanZapSound': "Zap and Sound gags are now off-limits!",
'BanZapDrop': "Zap and Drop gags are now off-limits!",
'BanSoundDrop': "Sound and Drop gags are now off-limits!",
    # Universal Ban Disabled Levels
    'DisableLevel45': "Level 4 and 5 gags are now disabled!",
    'DisableLevel46': "Level 4 and 6 gags are now disabled!",
    'DisableLevel47': "Level 4 and 7 gags are now disabled!",
    'DisableLevel48': "Level 4 and 8 gags are now disabled!",
    'DisableLevel56': "Level 5 and 6 gags are now disabled!",
    'DisableLevel57': "Level 5 and 7 gags are now disabled!",
    'DisableLevel58': "Level 5 and 8 gags are now disabled!",
    'DisableLevel67': "Level 6 and 7 gags are now disabled!",
    'DisableLevel68': "Level 6 and 8 gags are now disabled!",
    'DisableLevel78': "Level 7 and 8 gags are now disabled!",
    # Universal Ban Disabled Tracks
    'DisableToonupTrap': "Toon-Up and Trap gags are now disabled!",
    'DisableToonupLure': "Toon-Up and Lure gags are now disabled!",
    'DisableToonupThrow': "Toon-Up and Throw gags are now disabled!",
    'DisableToonupSquirt': "Toon-Up and Squirt gags are now disabled!",
    'DisableToonupZap': "Toon-Up and Zap gags are now disabled!",
    'DisableToonupSound': "Toon-Up and Sound gags are now disabled!",
    'DisableToonupDrop': "Toon-Up and Drop gags are now disabled!",
    'DisableTrapLure': "Trap and Lure gags are now disabled!",
    'DisableTrapThrow': "Trap and Throw gags are now disabled!",
    'DisableTrapSquirt': "Trap and Squirt gags are now disabled!",
    'DisableTrapZap': "Trap and Zap gags are now disabled!",
    'DisableTrapSound': "Trap and Sound gags are now disabled!",
    'DisableTrapDrop': "Trap and Drop gags are now disabled!",
    'DisableLureThrow': "Lure and Throw gags are now disabled!",
    'DisableLureSquirt': "Lure and Squirt gags are now disabled!",
    'DisableLureZap': "Lure and Zap gags are now disabled!",
    'DisableLureSound': "Lure and Sound gags are now disabled!",
    'DisableLureDrop': "Lure and Drop gags are now disabled!",
    'DisableThrowSquirt': "Throw and Squirt gags are now disabled!",
    'DisableThrowZap': "Throw and Zap gags are now disabled!",
    'DisableThrowSound': "Throw and Sound gags are now disabled!",
    'DisableThrowDrop': "Throw and Drop gags are now disabled!",
    'DisableSquirtZap': "Squirt and Zap gags are now disabled!",
    'DisableSquirtSound': "Squirt and Sound gags are now disabled!",
    'DisableSquirtDrop': "Squirt and Drop gags are now disabled!",
    'DisableZapSound': "Zap and Sound gags are now disabled!",
    'DisableZapDrop': "Zap and Drop gags are now disabled!",
    'DisableSoundDrop': "Sound and Drop gags are now disabled!",
}
SuitAttackNames = {
    'AcidRain': "Acid Rain!",
    ...
    'ArbitratorThrowBook3': "Throw Book!",
    'ArbitratorThrowBook4': "Throw Book!",
    ...
    'CaseManagerLegalBindings2': "Insurance Plan!",
    'CaseManagerInsurancePlan': "Insurance Plan!",
    'CaseManagerInsurancePlan2': "Insurance Plan!",
    ...
    'ScapegoatBarnyardBash': "Evidence Suppression!",
    'ScapegoatGavel': "Evidence Suppression!",
    ...
    'PowerhouseSyphonDesperation': "Asset Extraction!", # NOW DIVIDEND KINGS
    'PowerhouseSnipeVulnerable': "Power Surge!",
    'PowerhouseSnipeGagBan': "Power Surge!",
    'PowerhouseSnipeSoaked': "Power Surge!",
    'PowerhouseSnipeBookkept': "Power Surge!",
    'PowerhouseSnipeMulligan': "Power Surge!",
    'PowerhouseSnipeCollectCall': "Power Generation!",
    'PowerhouseGeneration': "Power Generation!",
    'PowerhouseGeneration2': "Power Generation!",
    'PowerhouseBurnDamage': "Short Circuit!",
    # Bookkeeper Cheats
    'BookkeeperPaperCutSoaked': "Liability Flag!",
    ...
    # Wiretapper Cheats
    'WiretapperCollectCall': "Collect Call!",
    'WiretapperCollectCall2': "Collect Call Dues!",
    'WiretapperCollectCallDamage': "Collect Call Dues!",
    'WiretapperWiretapped': "Wiretapped!",
    'WiretapperVoicemail': "Voicemail!",
    'WiretapperBrokenConnection': "Broken Connection!",
    ...
    'AmbassadorRefinement': "Prestige Polishing!",
    'AmbassadorRefinementManager': "Prestige Polishing!",
    ...
    'SafetySoakRetaliation': "Combustion Chamber!",
    'SafetyHeatWaveCalculation': "Temperature Rising!",
    'SafetyViolation': "Combustion Chamber!",
    ...
    'SafetyOverpressured': "Overpressured!",
    'SafetyOverpressured2': "Overpressured!",
    'SafetyOverpressured3': "Overpressured!",
    'SafetyOverpressured4': "Overpressured!",
    'SafetyOverpressured5': "Overpressured!",
    'SafetyOverpressureDeath': "Overpressured!",
            # Hustler Cheats
'HustlerLimitedTimeOfferApprove': "Limited Time Offer!",
'HustlerLimitedTimeOfferDenied': "Limited Time Offer!",
'HustlerSalesPitch': "Sales Pitch!",
'HustlerCustomerRetention': "Customer Retention!",
'HustlerClosingTime': "Closing Time!",
'HustlerBaitAndSwitch': "Bait And Switch!",
'HustlerExclusiveOffer': "Exclusive Offer!",
'HustlerExclusiveOfferRetaliation': "Exclusive Offer!",
'HustlerHalfWindsor': "Buyer's Remorse!",
       # Traffic Manager Cheats
'TrafficDetour': "Detour!",
'TrafficCongestionPricing': "Roadblock!",
'TrafficRedLight': "Red Light!",
'TrafficRedLightRetaliation': "Red Light!",
'TrafficGreenLight': "Green Light!",
'TrafficGreenLightRetaliation': "Green Light!",
'TrafficYield': "Yield!",
    # Union Buster Cheats
    'UnionBusterUnionDues': "Mandatory Overtime!",
    'UnionBusterUnionCalculator': "Calculating Overtime!",
    'UnionBusterUnionBust': "Union Bust!",
    'UnionBusterNoStrikeClause': "No-Strike Clause!",
    'UnionBusterUnionBuster': "At-Will Employment!",
    'UnionBusterUnionBusterDamage': "At-Will Employment!",
    'UnionBusterUnionWages': "Union Wages!",
    'UnionBusterUnionWages2': "Union Wages!",
    'UnionBusterUnionWages3': "Union Wages!",
    'UnionBusterUnionWages4': "Union Wages!",
    'UnionBusterUnionWages5': "Union Wages!",
    'UnionBusterBreachOfContract': "Yield!",
    'UnionBusterBreachOfContract2': "Yield!",
    'UnionBusterBreachOfContract3': "Yield!",
    'UnionBusterBreachOfContract4': "Yield!",
    'UnionBusterContractEnforcement': "Traffic Control!",
    'UnionBusterContractEnforcement2': "Traffic Control!",
    # Racketeer Cheats
    'RacketeerOverextendedLeverage': "Protection Racket!",
    'RacketeerOverextendedLeverage2': "Overinflated Racket!",
    'RacketeerProfiteering': "Profiteering!",
    'RacketeerProfiteering2': "Profiteering!",
    'RacketeerProfiteering3': "Profiteering!",
    'RacketeerProfiteering4': "Profiteering!",
    'RacketeerProfiteering5': "Profiteering!",
    'RacketeerExtortion': "Extortion!",
    'RacketeerExtortion2': "Protection Payout!",
    'RacketeerCompensation': "Compensation!",
    'RacketeerHustling': "Hustling!",
    'RacketeerRacketeering': "Racketeering!",
    'RacketeerPeckingOrderRetaliation': "Corporate Dominion!",
    'RacketeerPeckingOrderRetaliationSoak': "Combustion Chamber!",
    # Radiographer Cheats
    'RadiographerRadioInfrequency': "Radio Infrequency!",
    'RadiographerHotTake': "Hot Seat!",
    'RadiographerHotTakeRetaliation': "Rise From The Ashes!",
    'RadiographerHotTakeDamage': "Hot Seat!",
    'RadiographerOvermodulated': "Overmodulated!",
    'RadiographerOvermodulated2': "Overmodulated!",
    ...
    # Derrick Man Cheats
    'DerrickManRefinement': "Refinement!",
    # DOLA Cheats
    'DOLAInkDrain': "Ink Drain!",
    # DOPR Cheats
    'DOPRAmbushMarketing': "Ambush Marketing!",
    # # Dividend King Cheats
    # 'DividendAccountRollover': "Account Rollover!",
    # 'DividendAccountRollover2': "Account Rollover!",
    # 'DividendAccountRollover3': "Account Rollover!",
    # 'DividendAccountRollover4': "Account Rollover!",
    # 'DividendAccountRollover5': "Account Rollover!",
    # 'DividendLiquidationEvent': "Liquidation Event!",
    # 'DividendLiquidationEventDamage': "Liquidation Event!",
    # 'DividendTotalMarketMeltdown': "Total Market Meltdown!",
    # 'DividendPeckingOrder': "Pecking Order!",
    # 'DividendPeckingOrderZapped': "Pecking Order!",
    # Ottoman Cheats
    'OttomanRevisedDraft': "Revised Draft!",
    'OttomanRedPenReview': "Red Pen Review!",
    'OttomanFootnoteOverload': "Footnote Overload!",
    'OttomanPerformanceReview': "Performance Review!",
    'OttomanPerformanceReviewRevert': "Performance Review!",
    # Crystalline Cheats
    'CrystalShatteringClarity': "Shattering Clarity!",
    'CrystalRefractDamage': "Refracting Damage!",
    'CrystalRefractDamageRetaliation': "Refracted Damage!",
    'CrystalFracturedLimitsOffensive': "Fractured Limits!",
    'CrystalFracturedLimitsDefensive': "Fractured Limits!",
    'CrystalFracturedLimitsRetaliation': "Fractured Limits!",
    'CrystalPrismaticDistortion': "Prismatic Distortion!",
    # Chairman Cheats
    'ChairmanTrapRetaliation': "Hazard Compliance Violation!",
    'ChairmanLureRetaliation': "Deception Audit!",
    'ChairmanThrowRetaliation': "Impact Mitigation Act!",
    'ChairmanSquirtRetaliation': "Spill Containment Policy!",
    'ChairmanZapRetaliation': "Blue Chip Bet!",
    'ChairmanSoundRetaliation': "Noise Complaint!",
    'ChairmanDropRetaliation': "Gravity Budget Freeze!",
    'ChairmanCage': "Hostile Detention!",
    'ChairmanPhase2': "Chairman's Order!",
    'ChairmanOvertime': "Mandatory Overtime!",
    'ChairmanOvertime2': "Mandatory Overtime!",
    'ChairmanOvertime3': "Mandatory Overtime!",
    'ChairmanOvertime4': "Mandatory Overtime!",
    'ChairmanOvertime5': "Mandatory Overtime!",
    'ChairmanHostileLiquidation': "Hostile Liquidation!",
    'ChairmanHostileLiquidation2': "Hostile Liquidation!",
    'ChairmanHostileLiquidation3': "Hostile Liquidation!",
    'ChairmanHostileLiquidation4': "Hostile Liquidation!",
    'ChairmanHostileLiquidation5': "Hostile Liquidation!",
    'ChairmanSnipe': "Snipe!",
    # Liquidator Cheats
    'LiquidatorTornado': "Tornado!",
    'LiquidatorOilRain': "Oil Rain!",
    'LiquidatorOilRainDamage': "Oil Rain!",
    'LiquidatorFreezingRain': "Freezing Rain!",
    'LiquidatorHeavyRain': "Heavy Rain!",
    'LiquidatorHeavyRainDamage': "",
    'LiquidatorStormCell': "Storm Cell!",
    'LiquidatorStormCellDamage': "",
    'LiquidatorInversion': "Inversion!",
    'LiquidatorMonsoon': "Monsoon!",
    # Tollmaster Cheats
    'TollmasterMandatoryToll': "Mandatory Toll!",
    'TollmasterMandatoryTollFinal': "Mandatory Toll!",
    'TollmasterMissedPayment': "Toll of Entry!",
    'TollmasterRushHour': "Rush Hour!",
    'TollmasterLedgerOfSound': "Ledger Of Sound!",
    'TollmasterBalanceTheLedger': "Balance The Ledger!",
    'TollmasterBalanceTheLedger2': "Balance The Ledger!",
    'TollmasterBalanceTheLedger3': "Balance The Ledger!",
    'TollmasterBalanceTheLedger4': "Balance The Ledger!",
    'TollmasterBalanceTheLedger5': "Balance The Ledger!",
    # Dividend King Cheats
    'DividendPeckingOrder': "High Voltage!", # NOW POWERHOUSES
    'DividendPeckingOrderZapped': "Capital Confiscation!",
    'DividendLiquidationEvent': "Liquidation Event!",
    'DividendLiquidationEventDamage': "Liquidation Event!",
    'DividendTotalMarketMeltdown': "Total Market Meltdown!",
    'DividendTotalMarketMeltdown2': "Total Market Meltdown!",
    'DividendZapRetaliation': "Blue Chip Bet!",
    'TollmasterResonanceTax': "Account Rollover!",
    'TollmasterResonanceTax2': "Account Rollover!",
    'TollmasterResonanceTax3': "Account Rollover!",
    'TollmasterResonanceTax4': "Account Rollover!",
    'TollmasterResonanceTax5': "Account Rollover!",
    # Recordkeeper Cheats
    'RecordkeeperRedlinedClauseMissedPayment': "Permanent Record!",
    'RecordkeeperRevisedFilingLiquidation': "Revised Filing!",
    'RecordkeeperMinutesTaken': "Permanent Record!",
    'RecordkeeperMinutesTakenContingency': "Permanent Record!",
    'RecordkeeperMinutesTakenDamage': "Permanent Record!",
    'RecordkeeperPaperTrail': "Phantom Entry!",
    'RecordkeeperRevisedFiling': "Revised Filing!",
    'RecordkeeperRedlinedClause': "Redlined Clause!",
    'RecordkeeperAuditCycle': "Audit Cycle!",
    'RecordkeeperPhantomEntryDamage': "Phantom Entry!",
    'RecordkeeperPhantomEntrySpawn': "Phantom Entry!",
    'RecordkeeperPhantomEntrySacrifice': "Phantom Entry!",
    # Corporate Butcherer Cheats
    'ButcherOverride': "Personality Override!",
    'ButcherOverrideRemoval': "Personality Override!",
    'ButcherRevvingUp': "Revving Up!",
    'ButcherRevvingUpWhipsaw': "Revving Up!",
    'ButcherKickback': "Kickback!",
    'ButcherMarkedWood': "Marked Wood!",
    'ButcherOffboarding': "Offboarding!",
    'ButcherOffboarding2': "Offboarding!",
    'ButcherOffboarding3': "Offboarding!",
    'ButcherOffboarding4': "Offboarding!",
    'ButcherOffboarding5': "Offboarding!",
    'ButcherAggrandize': "Aggrandize!",
    'ButcherAggrandize2': "Aggrandize!",
    'ButcherAggrandize3': "Aggrandize!",
    'ButcherAggrandize4': "Aggrandize!",
    'ButcherAggrandize5': "Aggrandize!",
    'ButcherSparkPlug': "Spark Plug!",
    'ButcherSparkPlugDamage': "",
    'ButcherScabbard': "Scabbard!",
    'ButcherLayoffs': "Layoffs!",
    # Contingency Director Cheats
    'ContingencySelfRepair': "Contingency Reserve!",
    'ContingencyMarkLiquidated': "Targeted Audit!",
    'ContingencyMarkRevisedFiling': "Oversight Directive!",
    ...
    'ContingencyRiskThresholdBreach25': "Targeted Neutralization!",
    'ContingencyContingencyClause': "Contingency Clause!",
    'ContingencyContingencyClauseRetaliation': "Contingency Clause!",
    'ContingencyRedundantAuthority': "Redundant Authority!",
    'ContingencyOperationalFreeze': "Contingency Plan!",
    ...
    # Factory Foreman Cheats
    'ForemanPolish': "Prestige Polishing!",
    'ForemanExtortion': "Extortion!",
    'ForemanSnipe': "Snipe!",
    'ForemanRedTape': "Red Tape!",
    'ForemanContractor': "",
    'ForemanContributing': "Tribute!",
    'ForemanUnionized': "Unionization!",
    'ForemanBurning': "Smoked!",
    'ForemanBurningDamage': "Smoked!",
    'ForemanSleepyOvercharge': "",
    'ForemanExplosion': "",
    'ForemanCompensation': "Worker's Compensation!",
    'ForemanCompensation2': "Worker's Compensation!",
    'ForemanCompensation3': "Worker's Compensation!",
    'ForemanCompensation4': "Worker's Compensation!",
    'ForemanCompensation5': "Worker's Compensation!",
        # Mint Supervisor Cheats
    'MintUsury': "Usury!",
    'MintLureResistance': "Immovability!",
    'MintLureResistance2': "Immovability!",
    'MintLedger': "Ledger Of Sound!",
    'MintAudit': "Audit Cycle!",
    'MintLifeInsurance': "Life Insurance!",
    'MintPolicyTerminated': "",
    'MintFraudulentDamage': "",
    'MintAbacusAbove15': "Abacus Requirement!",
    'MintAbacusBelow15': "Abacus Requirement!",
    'MintCompoundingInterest': "Compounding Interest!",
    'MintAccountant1': "Accountant Requirement!",
    'MintAccountant2': "Accountant Requirement!",
    'MintAccountant3': "Accountant Requirement!",
    'MintAccountant4': "Accountant Requirement!",
    'MintAccountant5': "Accountant Requirement!",
    'MintApprove': "",
    'MintDisapprove': "",
    'MintSynergy': "Synergy!",
    'MintMovingGoalposts': "Content Sync!",
    'MintHurrySickness': "Hurry Sickness!",
    'MintScheming': "Ambush Marketing!",
        # Head Attorney Cheats
    'AttorneyDizzy': "Whirlwind!",
    'AttorneyRemand': "Remand!",
    'AttorneyObjection': "Objection!",
    'AttorneyObjectionSustained': "Sustained!",
    'AttorneyObjectionOverruled': "Overruled!",
    'AttorneyOverseerHeal': "",
    'AttorneyChrono': "",
    'AttorneyOverseer': "",
    'AttorneyShakedownCooldown': "Shakedown!",
    'AttorneyShakedownVulnerable': "Shakedown!",
    'AttorneyInkDrain': "Ink Drain!",
    'AttorneyDrainingPower': "Draining Power!",
    'AttorneyRushJob': "Rush Job!",
    'AttorneyHurrySickness': "Hurry Sickness!",
    'WhistleCompensation': "Compensation!",
        # Club President Cheats
    'PresidentMandatoryFiling': "Mandatory Filing!",
    'PresidentLiability': "Liability Flag!",
    'PresidentLiability2': "Liability Flag!",
    'PresidentSensational': "Guest Verse!",
    'PresidentTargetCheck': "",
    'PresidentExtraTip': "Extra Tip!",
    'PresidentExtraTip2': "Extra Tip!",
    'PresidentExtraTip3': "Extra Tip!",
    'PresidentExtraTip4': "Extra Tip!",
    'PresidentExtraTip5': "Extra Tip!",
    'PresidentExtraTip6': "Extra Tip!",
    'PresidentSnap': "Snap!",
    'PresidentSyphon': "Syphon!",
    'PresidentBayouBellow': "Bayou Bellow!",
    'PresidentSnipe': "Snipe!",
    'PresidentDeepFreeze': "Deep Freeze!",
    'PresidentFrozenDeath': "Shatter!",
    'PresidentPuzzling': "Puzzle!",
    'PresidentDriver': "Driver!",
    'PresidentMulligan': "Mulligan!",
    'PresidentHighStakes': "Raising The Stakes!",
    # Count Erclaim Cheats
    'ErclaimLaffSteal': "Laff Steal!",
    'ErclaimSacrifice': "Sacrifice!",
    'ErclaimSacrifice2': "Sacrifice!",
    'ErclaimSacrifice3': "Sacrifice!",
    'ErclaimSacrifice4': "Sacrifice!",
    'ErclaimSacrifice5': "Sacrifice!",
    'ErclaimRiseFromTheScrap': "Rise From The Scrap!",
    'ErclaimScopeCreep': "Scope Creep!",
    'ErclaimHemmorage': "Hemmorage!", 
    'ErclaimHemmorageHealing': "", 
    'ErclaimPhase2': "nothing",
        # Count Erfit Cheats
    'ErfitHydrationCheck': "Hydration Check!",
    'ErfitHydrationCheckRevert': "Hydration Check!",
    'ErfitWringOut': "Wring Out!",
    'ErfitProToonShake': "Pro-Toon Shake!",
    'ErfitGainsFromTheScrap': "Gains From The Scrap!",
    'ErfitGainsFromTheScrap2': "Gains From The Scrap!",
    'ErfitGainsFromTheScrap3': "Gains From The Scrap!",
    'ErfitGainsFromTheScrap4': "Gains From The Scrap!",
    'ErfitGainsFromTheScrap5': "Gains From The Scrap!",
    'ErfitPersonalTrainer': "Personal Trainer!",
    'ErfitPhase2': "nothing",
    # High Roller Phase 1
    'HighRollerNoAttack': "No Attack",
    'HighRollerWheelSpin': "Game Time!",
    'HighRollerPuzzle': "Puzzle!",
    'HighRollerPuzzleBan': "Shuffle!",
    'HighRollerGameOver': "Game Over!",
    'HighRollerGameOver2': "Game Over!",
    'HighRollerCommercialBreak': "Commercial Break!",
    'HighRollerGameTimeSpawn': "Show Time!",
    'HighRollerGameTimeCog': "Trivia!",
    'HighRollerGameTimeCog2': "Trivia!",
    'HighRollerGameTimeCog3': "Trivia!",
    'HighRollerGameTimeCog4': "Trivia!",
    'HighRollerGameTimeCog5': "Trivia!",
    'HighRollerGameTimeCog6': "Trivia!",
    'HighRollerGameTimeCog7': "Trivia!",
    'HighRollerGameTimeCog8': "Trivia!",
    'HighRollerGameTimeCog9': "Trivia!",
    'HighRollerGameTimeCog10': "Trivia!",
    'HighRollerBust': "Bust!",
    # High Roller Phase 2
    'HighRollerPhase3': "!",
    # High Roller Phase 3
    'HighRollerRolled': "Rolled!",
    'HighRollerFreeCruise': "Free Cruise!",
    'HighRollerConduction': "Con-duck-tion!",
    'HighRollerDiceRouletteCogs': "Dice Roulette!",
    'HighRollerDiceRouletteToons': "Dice Roulette!",
    'HighRollerDiceRouletteEveryone': "Dice Roulette!",
    'HighRollerDiceRouletteNobody': "Dice Roulette!",
    'HighRollerTrickOfTheLight': "Trick Of The Light!",
    'HighRollerAceInTheHole': "Ace In The Hole!",
    'HighRollerVulnerable': "!",
    'HighRollerRaisingTheAnte': "Raising The Ante!",
    # High Roller Silhouette Cheats
    'HighRollerDonation': "Trick Of The Light!",
    'HighRollerSyphon': "Trick Of The Light!",
    'HighRollerBar': "Bar!",
    'HighRollerBar2': "Bar!",
    'HighRollerLureResistance': "Greenlighter!",
    'HighRollerLureResistance2': "Greenlighter!",
    'HighRollerSingingBlues': "Singing Blues!",
    'HighRollerDamageReduction': "Deck Shuffle!",
    'HighRollerSplashback': "Splashback!",
    'HighRollerCheerRetaliation': "Snipe!",
    # Videographer Cheats
    'VideographerHardCut': "Hard Cut!",
    'VideographerRisingStars': "Rising Stars!",
    'VideographerRisingStars2': "Rising Stars!",
    'VideographerRisingStarsSacrifice': "Rising Stars!",
    'VideographerRisingStarsSilhouette': "Rising Stars!",
    'VideographerVideoStatic': "Video Static!",
    'VideographerElectricShock': "Over The Top!",
    'VideographerElectricShock2': "Over The Top!",
    'VideographerElectricShock3': "Over The Top!",
    'VideographerElectricShock4': "Over The Top!",
    'VideographerAttackRewind': "Cutting Room Floor!",
    'VideographerDirectorCuts': "Producer's Cut!",
    'VideographerDeath': "Intermission!",
    # Broadcaster Cheats
    'BroadcasterDonation': "Video Refresh!",
    'BroadcasterDonation2': "Video Refresh!",
    ...
    # Director Cheats
    'DirectorBudgetExpansion': "Budget Expansion!",
    'DirectorProductionBudget': "Production Budget!",
    'DirectorCut': "Cut!",
    'DirectorAction': "Action!",
    'DirectorActionRetaliation': "Bombshell!",
    'DirectorBackToOnes': "Back To Ones!",
    ...
    'BanLevel6': "Court Record!",
    'BanLevel7': "Court Record!",
    'BanLevel8': "Court Record!",
    # Universal Ban Double Levels
    'BanLevel45': "Court Record!",
    'BanLevel46': "Court Record!",
    'BanLevel47': "Court Record!",
    'BanLevel48': "Court Record!",
    'BanLevel56': "Court Record!",
    'BanLevel57': "Court Record!",
    'BanLevel58': "Court Record!",
    'BanLevel67': "Court Record!",
    'BanLevel68': "Court Record!",
    'BanLevel78': "Court Record!",
    # Universal Ban Single Tracks
    'BanToonup': "Court Record!",
    'BanTrap': "Court Record!",
    'BanLure': "Court Record!",
    'BanThrow': "Court Record!",
    'BanSquirt': "Court Record!",
    'BanZap': "Court Record!",
    'BanSound': "Court Record!",
    'BanDrop': "Court Record!",
    # Universal Ban Double Tracks
    'BanToonupTrap': "Court Record!",
    'BanToonupLure': "Court Record!",
    'BanToonupThrow': "Court Record!",
    'BanToonupSquirt': "Court Record!",
    'BanToonupZap': "Court Record!",
    'BanToonupSound': "Court Record!",
    'BanToonupDrop': "Court Record!",
    'BanTrapLure': "Court Record!",
    'BanTrapThrow': "Court Record!",
    'BanTrapSquirt': "Court Record!",
    'BanTrapZap': "Court Record!",
    'BanTrapSound': "Court Record!",
    'BanTrapDrop': "Court Record!",
    'BanLureThrow': "Court Record!",
    'BanLureSquirt': "Court Record!",
    'BanLureZap': "Court Record!",
    'BanLureSound': "Court Record!",
    'BanLureDrop': "Court Record!",
    'BanThrowSquirt': "Court Record!",
    'BanThrowZap': "Court Record!",
    'BanThrowSound': "Court Record!",
    'BanThrowDrop': "Court Record!",
    'BanSquirtZap': "Court Record!",
    'BanSquirtSound': "Court Record!",
    'BanSquirtDrop': "Court Record!",
    'BanZapSound': "Court Record!",
    'BanZapDrop': "Court Record!",
    'BanSoundDrop': "Court Record!",
    # Universal Ban Disabled Levels
    'DisableLevel45': "Court Mandate!",
    'DisableLevel46': "Court Mandate!",
    'DisableLevel47': "Court Mandate!",
    'DisableLevel48': "Court Mandate!",
    'DisableLevel56': "Court Mandate!",
    'DisableLevel57': "Court Mandate!",
    'DisableLevel58': "Court Mandate!",
    'DisableLevel67': "Court Mandate!",
    'DisableLevel68': "Court Mandate!",
    'DisableLevel78': "Court Mandate!",
    # Universal Ban Disabled Tracks
    'DisableToonupTrap': "Court Mandate!",
    'DisableToonupLure': "Court Mandate!",
    'DisableToonupThrow': "Court Mandate!",
    'DisableToonupSquirt': "Court Mandate!",
    'DisableToonupZap': "Court Mandate!",
    'DisableToonupSound': "Court Mandate!",
    'DisableToonupDrop': "Court Mandate!",
    'DisableTrapLure': "Court Mandate!",
    'DisableTrapThrow': "Court Mandate!",
    'DisableTrapSquirt': "Court Mandate!",
    'DisableTrapZap': "Court Mandate!",
    'DisableTrapSound': "Court Mandate!",
    'DisableTrapDrop': "Court Mandate!",
    'DisableLureThrow': "Court Mandate!",
    'DisableLureSquirt': "Court Mandate!",
    'DisableLureZap': "Court Mandate!",
    'DisableLureSound': "Court Mandate!",
    'DisableLureDrop': "Court Mandate!",
    'DisableThrowSquirt': "Court Mandate!",
    'DisableThrowZap': "Court Mandate!",
    'DisableThrowSound': "Court Mandate!",
    'DisableThrowDrop': "Court Mandate!",
    'DisableSquirtZap': "Court Mandate!",
    'DisableSquirtSound': "Court Mandate!",
    'DisableSquirtDrop': "Court Mandate!",
    'DisableZapSound': "Court Mandate!",
    'DisableZapDrop': "Court Mandate!",
    'DisableSoundDrop': "Court Mandate!",
                   }
SuitAttackTaunts = {
    'AcidRain': ["It's sulfur you.",
                'A little CO2 never hurt anyone, right?',
                'Environment, shmenvironment.',
                "Today's forecast: Rainy with a chance of dissolution.",
                'pHew, that was close.'],
'Beguile': {
         'hustle': ["You look like someone who appreciates a good opportunity.",
               "Why don't you let me handle the details?",
               "I'm sure we can come to an arrangement.",
               "I can already tell you're interested.",
               "I'm offering you a once-in-a-lifetime opportunity!",
               "The smart Toons are already on board.",
               "You wouldn't want to miss out, would you?"],
    'videog': ["You're falling for my best angle.",
               "Trust me; I always make the talent look good.",
               "One smile and you're under contract.",
               "Charmed, I'm sure, but only by myself.",
               "Don't worry, I'll make you famous... in the fine print.",
               "Starstruck already? I haven't even started filming.",
               'I spin the story, you play the fool.'],
    'radiog': ["Look into my words, not my hands...",
             "Let me sweet-talk you into surrender.",
            "Why fight, when I can convince you instead?",
            "I promise, this is for your own good.",
             "One smooth line, and you'll forget your fight."],
    None: ["It's two for the price of one!",
...
'HostileTakeover': {
    'dking': ["Negotiations are over.",
              ...
              "You operate under MY brand now!",
              "You're not competitors, you're commodities.",
              "The market doesn't care, neither do I.",
              "If you can't profit, you're expendable."],
    'ubuster': ["This acquisition won't be friendly!",
                 "I gave you a chance to sell!",
                 "Negotiations have failed.",
                "See? Resistance just lowers your valuation.",
                 "You should've accepted my offer."],
    'cbutcher': ["This operation is mine now, whether you like it or not!",
                 "No vote. No appeal. I own you!",
                 "We're restructuring, and you're the first cut!",
                 "You should've fought harder for your division!"],
    None: ["I think I'll just take what I want.",
                    "Don't underestimate my value!",
                    "You shouldn't take my word at face value.",
                    'I like to take without asking.',
                    "You're in hostile territory now.",
                    'Consider this a seizure of assets.']},
'Quash': ["There'll be no record of this happening.",
            "I'll strike you from the record.",
            'Evidence is everything in a court of law.',
            "Where's that evidence you had before?",
            "Stop, you've violated the law!",
            'What proof could you possibly have?',
            'Objection denied.'],
 'Audit': {
     'bookkeep': ["Let's take a closer look... I'm seeing quite a few inconsistencies.",
...
'Aftershock': ["Best plant yerself on that ground you stand on.",
                ...
                "Yippee-ki-yah-yippee-ki-yo!"],
'DataCorruption': ["This data seems a little bit corrupted.",
                   "You should've installed a firewall.",
                   "My software doesn't like you.",
                   "You're more corrupted than Frump!",
                   'Compatibility seems to be normal.'],
'DiskScratch': ["Your favorite movie? Too bad.",
                "It's better to stay on the cutting edge."],
'CloudStorage':
   {
    'liquid': ["They said move everything to the cloud... again.",
                "Nothing's really gone, it's just... archived.",
                "Latency's a feature, not a bug.",
                "This company hoards everything.",
                "They trust the cloud more than people."],
       None: ["Pied Piper's gonna hide behind this one.",
                "I forecast rain.",
                "You're being compressed.",
                'Sure seems cloudy today.']},
'Disassemble': ["Better hope I put you back together!",
                "Children's play.",
                "Take a look at my skills!",
                "You aren't a Toonbot? Let's fix that.",
                "You're being disassembled."],
'VoodooMagic': ['Let me check your valuables.',
                                   ...
                                   'Give me that!'],
'Bash': ["No match for you.",
            "Make me a sandwich, or else!",
           "There is no place like home."],
'ElectrostaticEnergy': ["Electricity is dangerous.",
                        "Well, aren't you excited?",
                        "Surely you shouldn't be this happy to see me?"],
 'Bite': {
      'treasure': ["Another withdrawal from your account. Are you feeling it now?",
                "Your reserves are thinning, I can see it clearly!",
                "Each loss brings you closer to zero.",
                "You can't sustain this for long."],
     'racket': ["Consider this a mandatory deduction!",
               'Let me just sink my teeth into this deal, literally.',
                "Open your ledger; I'm about to leave a mark.",
               "I'll make this quick; just a little bite out of your assets.",
                "Looks like it's time to take a bigger cut.",
               "Don't worry, this'll only hurt your profits."],
     'sgoat': ["My bite's worse than my bleat!!!",
             'Learned this one from the best!!!',
             'Chomp, chomp, CHOMP!!!',
             'Back off! I bite!!!'],
        'erclaim':["Just one small bite, don't be afraid. You'll barely feel the fee I've made!",
        "A nip, a snack, a crimson delight. Now hold still... this won't take all night!",
        "Your neck looks nice beneath moonlight. Come closer now, it's Bitey Night!",
        "Ony tiny taste, one little chew. I promise, I'll leave most of you..."],
     None: ['Would you like a bite?',
            'Try a bite of this!',
 ...
 'BlackOrb': ['This ought to cool you off.',
                 ...
                 "The drink's on you."],
  'BounceCheck': {
        'erfit':["Check out these sick biceps, let's move on to our triceps!",
                "Now you might be a hater, but your muscles will thank me later.",
                "Up, down, up, down, don't you dare frown!",
                "Your muscles may be tender, but good physique will render."],
        ...
        'bookkeep': ["Submitting transaction... declined. Not enough to cover it!",
                ...
                "You attempted a payment with nothing behind it!",],
      'dking': ["You trust paperwork, don't you?",
                "You should've read the fine print.",
                "Hope is not legal tender.",
                "Always check the signature.",
                "Did you really not verify?"],
      'racket': ["Rubber's good for one thing: hittin' back!",
               "Careful, this one bounces hard.",
               "Looks like your account's overdrawn... in pain!",
               "Keep trustin' me, I'll keep cashin' outta you!"],
      None: ["Ah, too bad, you're funless.",
 ...
 'BrainStorm': {
         'erclaim':["I'll fog your brain with eerie rhyme. You'll lose your thoughts in half the time!",
                "Your clever plans have gone astray. My spooky words have swept away!",
                "Your head will spin, your thoughts will flee. A brainstorm brewed especially!"],
     'liquid': ["Let's ideate termination pathways!",
                "Ugh... another meeting. Fine. Let it rain.",
                "Storm's rolling in... Don't ask me to smile about it.",
                "They want results; this is what results look like.",
                 "If I have to be here, you're standing in the downpour."],
    'racket': ["That storm just wiped your balance clean!",
                "Frazzled and fried, just how I like ya.",
                "Can ya even think straight now?",
                "Lightning-fast scams comin' through!",
                "Time to cloud your judgment!"],
    'dola': ["Back home, we'd call this one a lightning attack.",
                "Hope you packed ya umbrella.",
                "How 'bout just a few rain DROPS?",
                "Mah knees a-shakin, must mean rain."],
     'rainmake': ["I'm smart to how you've treated me... and him!",
                    "Rain, rain, go away!",
                    "You've caught me in a stormy mood, Toon.",
                    "Why can't we just get along?",
                    "I try to keep a sunny mindset, but you make it impossible!"],
    'dopa': ["Brace yourself for some electromagnetic interference!",
            "Defeating you will bring our ratings sky-high.",
            "I used to be quite the shock jock on radio.",
            "I'm going to put you out of transmission.",
            "Today's news will kick up quite the storm!"],
     'dopr': ["I love to be- to be a wet bla-a-a-anket.",
     ...
     'prethink': ['This is sure to puzzle you.',
                  'I can think of a thousand ways to beat you!',
                  'Maybe THIS concept will resonate with you.',
                  'The brilliance of my brain is unmatched by your simplicity.',
                  'My mind is too great for us to think alike.'],
     None: ["I'm going to take you by storm.",
            ...
            "I have a torrent of great ideas."]
 },
 'BuzzWord': {
        'hustle': ["We're leveraging synergistic growth opportunities!",
                 "Let's circle back on that later.",
                 "I'm maximizing value for all stakeholders!",
                 "This is a paradigm-shifting solution!",
                 "You're not supposed to understand the terminology."],
     'radiog': ["You can't resist the power of trending terms!",
                 "Get ready for the next big thing!",
                 "I'm leveraging scalable solutions to crush you!",
                 "My words sting harder than your gags!",
                 "Consider yourself streamlined.",
                 "You've just been rebranded into oblivion!"],
     'wtapper': ["Buzzing words, buzzing pain!",
                 "Caught in the buzz, Toon?",
                "That's what I call a powerful pitch.",
                "Ha! Trendy and deadly.",
                "Corporate lingo stings, doesn't it?"],
     'stenog': ['Have you heard the buzz? No? That stings!',
             'Word on the street is that you Toons are in for a sting!',
             'Not a single word goes amiss.',
             'Pardon me! I just must tell you the latest news!'],
     'prethink': ['My lexicon is what makes me superior to you.',
                  "You can't even begin to understand my intellectuality.",
                  'You lack articulation in your delivery, unlike me!',
                  "Despite your quips, I DO know what I'm talking about!",
                  'Tell me, do you comprehend this strategy?'],
     None: ['Pardon me if I drone on.',
 ...
 'Calculate': {
      'liquidr': ["Evaluating your worth... yes, this confirms everything I expected.",
                  "I've run the numbers. You don't measure up.",
                "All factors considered, your outcome was already decided.",
                   "The calculation is complete... and it doesn't favor you!",],
      'bookkeep': ["Running the numbers... yes, this outcome checks out.",
                "All variables accounted for. This was inevitable.",
                "You're operating on guesswork. I'm not.",
                "The result was decided before you even acted.",],
     'rkeeper': ["Let's see how the numbers line up.",
                 "Calculations in progress... don't move.",
                 "Time to total your contributions... and failures.",
                 "Precision matters, try not to interfere.",
                 "Your errors have been quantified."],
     None: ['These numbers do add up!',
               ...
               Cogs + ': 1 Toons: 0']},
 'DoubleCross': ["Let this cross your face.",
                    'Allow me to cross along.',
                    "You're about to be double-crossed.",
                    'This attack is double the trouble!',
                    "You've been BETRAYED.",
                    'Time to change your plans.',
                    'Ever been duped?',
                    'Our promise is over.',
                    "Who holds this obligation? Not me!"],
 'Forecast': ["Today's forecast will have a chance of rain.",
                 "Today's forecast will be cloudy with a chance of golf balls.",
                 "Today's forecast will have a chance of Toons going sad!",
                 "Today's forecast will have an 100% chance of rising sales.",
                 "Today's forecast is looking rather stormy.",
                 "Today's forecast will have a hurricane coming your way.",
                 "Today's forecast will have a tornado coming your way.",
                 "Today's forecast will have a drizzle of defeat.",
                 "Today's forecast makes it clear that Toons will go sad.",
                 "Watch out, today's forecast includes a BIG PURPLE TSUNAMI!",
                 "Today's forecast will have a chance of snow."],
 'GoldDust': ['This gold is very hard to find.',
                 'Ready for a dust storm?',
                 'Things are about to get real dusty.',
                 'The gold is rather flakey.',
                 'I always take the gold dust with me.',
                 'Remember to season your food with gold dust.',
                 'Do you like the gold bits?',
                 'You know, a lot of people like this gold.',
                 "You'll find this very valuable."],
 'GoldRush': ['Can you feel the rush now?',
                 'Welcome to the gold rush.',
                 'The gold rush starts now.',
                 'Are you ready for the gold rush?',
                 'Get your pickaxe ready, we are rushing to California.',
                 "You've never seen this much gold in your life.",
                 "Come quickly! The gold ain't going to last for long.",
                 'Got gold?',
                 "If you got the gold, I'm coming!"],
 'MysteriousDisappearance': ['No one will ever see you again...',
                                "Now I see you, now I don't!",
                                'You are going away for a long time!',
                                'Your disappearance will be a real mystery.',
                                'Breaking news! You have mysteriously disappeared!',
                                'Your fate will remain a mystery.',
                                'Looks like you magicially disappeared!',
                                'Poof! You are suddenly gone.',
                                'Your presense is up!',
                                "They'll never know what happened."],
 'Canned':{
'cbutcher': ["You should've read the fine print!",
                 "This company doesn't carry dead weight.",
                 "Don't bother clearing your desk.",
                 "Your position has been eliminated, effective immediately!"],
     'safesupervis': ["Right back into the can where you belong!",
                "You're being compressed into something more manageable.",
                "Containment complete, barely any mess at all.",
                "Bagged or canned, the result's the same.",
                "Into the can with you!"],
    'ambass': ["No severance, no sympathy.",
                "Pack your things, permanently.",
                "Another Toon off the payroll.",
                "The course is no place for amateurs.",
                "Consider this your final notice."],
      'gatekeep': ["Thou doth not tasteth so valorous out of the can.",
      ...
      None: ['Do you like it out of the can?',
            '"Can" you handle this?',
...
'Reprogram': ['I need to code more of my voice lines.',
            "I'm reprogramming this software.",
            "Your software is not up to code Toon, allow me to fix that.",
            "You might want to delete your history after this one."],
'Overload': ["It's over for you.",
            "I'm reprogramming this software.",
            "Your software is not up to code Toon, allow me to fix that.",
            "You might want to delete your history after this one."],
'VersionControl': ['It seems to me like you need an update.',
            "It doesn't appear that you're using the most updated version of this software, allow me to fix that.",
            "Your software is not up to code, Toon, allow me to fix that.",
            "You might want to delete your history after this one."],
'BounceRate': ["At this rate, you'll be back to the playground in no time.",
            "You'll just become another statistic.",
            "Good luck bouncing back from this.",
               "Oh well, you're just another lost visitor."],
'Breakthrough': ["You're in way over your head!",
            "I've done it! I have made a life changing breakthrough!",
            "Eureka!",
            "Let's see if you can comprehend this.",
            "My ideas are far superior to yours."],
'Encrypt': ["You'll never see this data.",
            "Why don't you mind your own business, Toon.",
            "This information doesn't belong to you.",
            "We don't want any of this information leaked, do we?"],
'DataBreach': ["You aren't going to recover from this leak.",
            "All of your personal information is now mine!",
               "You can't hide your data from me!",
            "You're antivirus software can't save you this time.",
               "All of your data now belongs to us!",
               "Ah, so this is what you've been hiding!",
            "This information no longer belongs to you."],
'DenialOfService': ["Your server sends it's regards.",
                "ACCESS DENIED!",
                "I hope you don't mind - EXCESS TRAFFIC!",
                "The company has the right to refuse service to anyone, including you!",
                "We don't have to serve you here."],
'Inject': ["I think you should put on a bigger glove.",
                "This should clinch your downfall.",
                "I believe you're disqualified from this competition.",
                "You'll need to hit backspace after this.",
           "Don't bother reconnecting after this.",
           "Watch out for the uppercut!",
           "I bet you're impressed by my fast typing skills.",
                "How do I type this out for you... GAME OVER!"],
 'Chomp': {
          'treasure': ["A small deduction, but it will add up in time.",
                "Just a portion for now, I'll collect the rest later.",
                "Consider this the first payment toward your balance.",
                "No need to rush, I'll take this piece by piece!"],
     'dking': ["You look undervalued, I'll fix that.",
                "Let's carve out some profit.",
                "You're more profitable than you look!",
                "Growth requires consumption!",
               "This is what I call liquidity!"],
     'lgator': ["This'll leave a mark.",
             'Treading dangerous waters, are we?',
             "Stand back, I'm known to bite.",
             "Don't provoke the alligators if you don't want to get bitten."],
     None: ["Chomp, chomp, chomp!",
            ...
            "Some call me the chomp champ.",
            "I'll be chomping down on your silly antics.",
            "You've got me chomping at the bit!"]
 },
'ReArrange': ["I took some creative liberties with this one, babe.",
 ...
 'ClipOnTie': {
     'mslacker': ['I like these... No knots to tie.',
            'Look, no slip-stitch. Uh, whoops, wrong tie.',
            "There's peanut butter on the back, but you'll live.",
            "My dad's a stickler for the dress code. Not that I care.",
            "Don't love these colors..."],
     None: ['Better dress for our meeting.',
            ...
            "By the powers invested in me, I'll tie you up.",
...
'NickelAndDime': {
 ...
 'Crunch': {
             'bookkeep': ["There it is... everything balances perfectly!",
                ...
                "Finalized!",],
'rkeeper': ["Crunching numbers, your results are predictable!",
                 "I'll tally every mistake, efficiently.",
                 "Brace yourself, the sum isn't in your favor.",
                 "Time to see who adds up, and who doesn't.",
                 "Variables accounted for, you included."],
     None:["Looks like you're in a crunch.",
            "It's crunch time!",
            "I'll give you something to crunch on!",
            'Crunch on this!',
            'I pack quite a crunch.']},
 'Demotion': {
     'ambass': ["You've been reassessed.",
                 "Let's adjust your position.",
                 "You're no longer operating at that level!",
                 "Your performance is disappointing!"],
     None: ["You're moving down the corporate ladder.",
 ...
 'DoubleTalk': {
        'redd':["I never lied, you simply misunderstood the agreement.",
                "The truth is remarkable flexible with the right wording.",
                "Both outcomes benefit me. That's what I said.",
                "Contradictions are merely executive privileges."],
        'hustle': ["Trust me, Toon, this deal makes perfect sense!",
                 "I'm saying exactly what you want to hear.",
                 "The fine print isn't important.",
                 "You ask too many questions!",
                "It's not a scam if you believe me!"],
     'radiog': ["Talking out of both sides of my mouth is an art.",
                 "Don't listen too close, you'll get dizzy.",
                 "I guarantee results you'll never see!",
                 "I'll twist your head in knots with this spiel!",
                "Don't try to keep up, you'll just trip over my logic.",
                 "Words are cheap, but I make you pay double.",
                 "I win both sides of the argument."],
     'wtapper': ["I said it before, and I'll say it again!",
                 "Static and speech, doubled and deafening!",
                 "Two versions of the truth, both against you.",
                 "Overlapping terms, conflicting clauses, all binding!",
                "Both voices cut right through you.",
                 "Ha! Couldn't tell my words apart, could you?"],
     None: ["Your services are no longer required here.",
 ...
 'EvictionNotice': {
      'erclaim':["Out you go, don't stomp or shout. This castle says you're all checked out!",
                "I've stamped your file with great delight. Evicted by the Price of Night.",
                "Your welcome's worn astonishingly thin. Now kindly let the bats fly in!"],
'ovt': ["I'm out of place... I mean, you're out of place.",
    ...
    'arbit': ["I hereby serve you an official removal order.",
                "Consider yourself unhoused by hierarchy.",
                "The law's on my side of the fence!",
                "No one escapes corporate property law."],
    'bkeeper': ["This space is no longer yours.",
                "You're removed...",
                "Out... now.",
                "Relocated...",
                "Get out."],
     'dold': ["Best start beatin' the road.",
                "Cut a path, pardner.",
                "Off my land, pardner.",
     ...
     'dola': ["I'm gonna to send you packing.",
 ...
 'FallingKnife': {
     ...
     'cbutcher': ["That's gravity and management.",
                  "Should've watched the overhead!",
                  "Mistakes fall fast around here!"],
     'ubuster': ["Knives don't wait for you to move.",
                "Slice right through your defenses.",
                "Toons can't handle the crash.",
                "Management always knows where to cut.",
                "Knives keep falling, and you keep catching.",
                "How many cuts before you're finished?"],
     'ambass': ["Shall we cut negotiations short?",
                "The blade of business falls for you!",
                "Consider this a corporate cutback.",
                "Sliced right through your defenses.",
                "You're in free-fall, and I'm holding the blades.",
                "Death by a thousand corporate cuts."],
    'phouse': ["Welcome to the cutthroat world of business.",
             "In this office, survival means being sharper than the rest.",
             "You're about to feel the edge of management.",
               "That's what sharp leadership looks like.",
            "Knives don't wait for second chances.",
               "The market drops... and so does my blade."],
     None: ["Don't bring a Gag to a knife fight.",
                "Get to the point!",
...
'ShortSqueeze': {
         'erfit':["Need a towel? Just give me a howl.",
                "Those sweat stains, they are proof of your gains!",
                "Wipe off your sweat so it won't be a threat.",
                "Your sweat may be cooling, but don't let it start pooling!"],
       'hustle': ["Feel that? Space is closing in fast.",
                  "Time is money, and you're running out of both!",
                "Hope you've got an exit strategy!",
                "This deal just got a whole lot worse.",
                "You bought in at the wrong time, Toon!",
                   "The market's turning against you!",],
        'bookkeep': ["Your position is tightening; you're running out of space!",
                "Margins collapsing... you're overextended.",
                "Every move narrows your options further!",
                "You're boxed in. The numbers say so!",],
    'dking': ["That's forced appreciation!",
              "Pressure builds profits!",
              "This is how fortunes are made!",
              "Do you feel the pressure yet?"],
    'ambass': ["Time to tighten the margins.",
               "I'll extract every last cent.",
               "Consider this a small financial correction.",
               "The market bends to those who apply force.",
               "Let's see what falls out under pressure.",
               "You Toons leak profit like a broken faucet.",
               "I always get a return on my pressure.",
               "Your pockets are remarkably generous."],
    'racket': ["Should've cashed out earlier!",
               "Enjoy the crushing force of my portfolio!",
...
'BlueChip': {
         'racket': ["This investment's backed by influence.",
                "I've got interests in every corner of the market!",
                "My associates assure me this is a solid investment.",
                "Everybody pays into the system eventually.",
                "Some investments are too big to fail.",
                "Consider this a hostile acquisition.",
               "I've already cornered this opportunity."],
         'hustle': ["A deal this good practically sells itself!",
                "Past performance is no guarantee of future results!",
                "The market loves confidence, and I've got plenty.",
                "Just sign here and leave the worrying to me.",
                "Somebody's gonna profit from this, it might as well be me!",
               "You'd be crazy not to buy in now."],
    ...
    'ambass': ["You can't cash out of this blow.",
            ...
            "The market rewards me, not you.",
             "I only deal in first-class investments.",
             "This is what prestige feels like, crushing you."],
    'cdirector': ["Stable investments yield stable results.",
               "You mistake consistency for weakness!",
               "Solid foundations crush improvisation!",
               "Activating a stable asset, I prefer guarantees.",
               "You can't disrupt what's structurally sound!",
               "Watch closely, this is what competence looks like!"],
    None: ["I'm investing in your downfall.",
...
'Embezzle': {
           'liquidr': ["I'm taking this and reallocating it where it actually matters.",
                  "You've lost control of this asset, it belongs to me now.",
                "Consider this a forced transfer.",
                   "You had your chance with it, I'll make it worthwhile.",],
            'hustle': ["Don't worry, I'll put it to good use.",
                  "You weren't going to use it anyway.",
                "Call it a transfer, my kind!",
                   "Just moving this... over here.",],
    'dking': ["They'll cut me a deal in court!",
              "I'll just write this off as a business expense.",
              "My actions are always justified!",
              "Money changes hands quickly.",
              "It's not stealing if they never know!"],
    'racket': ["I'll reroute a few funds.",
               "Nobody checks the books.",
               "Just a quiet adjustment.",
               "Nobody will miss that.",
               "This comes from within."],
    None: ["Allow me to... partition some of your assets now.",
              'As they always say, property is theft.',
              "I'm just trying to reduce your tax liabilities.",
              "It'd be a shame if someone just... took your hard-earned Gags.",
              "Just another 'honest' day's work!",
              "Of course you can trust me, what could possibly go wrong?",
              'One for me, none for you.',
              "Steal from the rich, but don't give to the needy.",
              'The management is not responsible for lost items.',
              "Think of it as 'involuntary lending'.",
              "Think of it as 'prolonged borrowing'.",
               "You can safely deposit your money with me now.",
               "You'll never see it coming.",
               "You won't be needing this...",
               "Your fortunes are my fortunes now."]
    # None: ["I'll just write that off as a business expense.",
    #           'I solemnly swear that this is clean money.',
    #           "It's not stealing if they never know.",
    #           'This is for the good of the corporation!',
    #           'My actions are always justified.',
    #           "Don't worry, they'll cut me a deal in court.",
    #           'Money changes hands quickly.',
    #           'I could never cut my spending.',
    #           'Never put all your eggs in one basket!',
    #           'I could always use some more wealth.',
    #           "We've got to have money."]
                                            },
'FloodTheMarket': {
     'treasure':["Supply is rising, far beyond what you can handle!",
                "Let's overwhelm the system and watch it collapse under pressure.",
                "Too much at once, this will destablize everything!",
                "The market's flooded, try to stay afloat!"],
    'racket': ["When there's too much, value collapses.",
               "I'm about to drown you in product!",
               "Let's see how you handle this volume.",
               "Your resistance just depreciated.",
               "This is what happens when I set the terms.",
               "I own this market now!",
               "There's nowhere left to stand.",
               "You can't fight this much supply."
               ],
    'cdirector': ["We'll overwhelm them with volume!",
                  "This is what structured dominance looks like!",
                  "Let's overwhelm the competition!",
                  "Competition eliminated through excess.",
                  "You're about to experience surplus!",
                  "Your position is no longer viable."],
    'ambass': ["Flooding the market, and your chances!",
             "Here comes a wave of losses!",
            "No Toon survives a downturn this severe.",
             "Supply outweighs your demand.",
             "Too much of a bad thing..."],
    'phouse': ["Get ready Toons, I'm about to drown you in business.",
             "I'll crush you with a wave of supply and demand.",
            "In business, floods don't recede, they take everything!",
             "Here comes a tidal wave of corporate strategy!",
             "I'll drown you in excess until nothing's left."],
    None: ["I'll put out a Flood Watch.",
 ...
 'EvilEye': {
     'ubuster': ["You feel smaller already, don't you?",
                "This is the face of authority.",
                "Your defiance dies in my stare.",
                "Can't hold up under pressure, can you?",
                "Stare long enough, and you'll break.",
                "My gaze cuts deeper than a knife.",
                "The eyes of management see all."],
     'lgator': ['Look me in the eye.',
             "You will look at me when I'm talking to you.",
             "Don't assume that I'm not watching you, Toon.",
             "I've got my eye on you; you can't escape."],
    'wsi': ["You think I don't see what acts you do?",
            "I've seen your case files.",
            "Time for a cross-examination.",
            "I've seen your strategies.",
            "We'll never see eye to eye."],
     None: ["I'm giving you the evil eye.",
  ...
  'FiveOClockShadow': ['Let me throw some shade on you real quick.',
                      ...
                      'Clock out feeling sad.',
                      "It's time to say goodbye."],
 'Filibuster': {
     'stenog': ['This conversation will be prolonged! Now pay attention!',
             "I'm known to talk fast, but this might still take up your time.",
             "Don't fall asleep, now! I'll have to restart my entire tirade if you do!",
             'Sometimes I just like to go on and on and on and on!'],
     None: ["Shall I fill 'er up?",
 ...
 'FillWithLead': {
          'bookkeep': ['This entry requires... additional weight.',
             "Adjusting the ledger, adding mass to the deficit.",
             "Consider this a heavy adjustment.",
             'Applying pressure until the numbers align.'],
     None: ["I think you've had your fill of fun.",
                "You're in need of a shave.",
                "You'll be looking sharp with this on you.",
                "I hate to be blunt, but...",
                "I hope this leaves a mark on you."]},
 'FingerWag': {
              'director': ["That performance was unacceptable!",
                "I'm giving you one final note.",
                "Back to rehearsal!",
                "You've forgotten who's directing this scene.",
                "Consider yourselves officially reprimanded."],
     'cdirector': ["Consider this a formal notice.",
                   "You've breached operational standards!",
                   "Let's fix that inefficiency!",
                   "You operate without structure, how exhausting.",
                   "Chaos always folds.",
                   "Disorganization breeds failure!"],
     'videog': ["Cut! That was all wrong.",
                      "Do it again, but this time... better.",
                      "That's not in the script.",
                      "No, no no; amateurs like you ruin the shot.",
                      "Don't argue, just take the note.",
                "Even bad press wouldn't save you.",
                        "Unprofessional! Simply unprofessional!",
                      "That performance? Straight to the cutting room floor!"],
    'safesupervis': ["Mm-mm. You're making this too easy!",
                "Poor decisions create dangerous pressure points!",
                "Disobedience tends to end explosively.",
                "You should've listened before things escalated.",
                "I always wag my finger before I wag the axe."],
     ...
     'sgoat': ["Don't you dare make me come over there!!!",
             "I'll teach you to respect me!!!",
             "Hey! That's no way to treat a Suit like me!!!",
             "Don't talk baa-ck at me!!!"],
     None: ['I have told you a thousand times.',
            'Now see here Toon.',
            "Don't make me laugh.",
 ...
 'Fired': {
          'ambass': ["You've outlived your usefulness.",
                 "We're done here.",
                 "You were never a valuable asset.",
                 "Your position has officially been terminated!",
                 "This is where you're dismissed!"],
     'safesupervis': ["Careful, Toon, this workplace runs HOT!",
                 "You're about to melt under the pressure!",
                 "Combustion is just accelerated failure.",
                "Funny how quickly confidence burns away."],
     'ubuster': ["Management has no place for you!",
                 "No warning. Just termination.",
                 "Corporate policy says you're gone.",
                 "Burned out and tossed aside!",
                 "Management doesn't reconsider."],
    'phouse': ["I've cleared my schedule to clear you out.",
                    "Your position has been eliminated permanently.",
                    "Straight out the door, no appeals.",
                    "This is what peak efficiency looks like.",
                    "Mass layoffs are the fastest way to profit."],
     'gatekeep': ["Clearly, thou doth not owneth an air fryeth contraption.",
                    "I bethink I haveth a bit of flare about me.",
     ...
     'fires': ["I like to think I have a bit of a flare about me.",
     ...
     'lgator': ['Smell something burning?',
             "My coworkers always tell me I'm on fire. Heh.",
             "Ooh, you're on fire. Literally.",
             "What are you sweating for? Can't take the heat?"],
     None: ["Can you say ouch?",
 ...
 'FountainPen': {
'rkeeper': ["Time to put it in writing, permanently!",
                 "Every detail must be precise.",
                 "I don't make mistakes, only corrections.",
                 "Prepare for a permanent mark.",
                 "Consider this legally binding."],
     'derrman': ["I'm dis-ink-lined to acquiesce to your desires.",
             'This will make my point quite clear.',
             'Do you really think that the world is some kind of pen-tomime?',
             "I have a stainless reputation. I'm not going to lose it now!"],
     'derrhand': ['Consider this a negative appraisal.',
            'I know how to corral a roughneck like yourself.',
            'I refuse to abandon this battle!',
            'This battle is going to be a blowout!'],
    'bkeeper': ["Hmm. Sharp enough?",
             "Permanent Record...",
             "Documented...",
             "Let me annotate that."],
     'caseman': ['Let me write that down...',
             'Just need my pen...',
             'This will stain.',
             'What a mess...'],
     None: ['This is going to leave a stain.',
            "Let's ink this deal.",
 ...
 'FreezeAssets': {
        'erfit':["Not warmed up enough? That'll make things tough.",
                "The weather outside is frightful, but those gains will be so delightful.",
                "This workout will be a breeze, as long as you don't freeze.",
                "You won't believe your eyes when your gains crystallize."],
         'liquidr': ["You won't be accessing anything from here on out!",
                  "Let's see how you operate without your resources!",
    ...
    'racket': ["Time to lock up what's mine.",
                    ...
                    "Your portfolio just went on ice.",
                    "Assets stay mine, Toons stay frozen.",
                    "Your credit just took a cold hit."],
     'rainmake': ["You Toons always make me feel blue!",
                    "Mary told me not to take these things so hard...",
                    "You started this! You can end it at any time.",
                    "I wish you would be a little warmer to me.",
                    "Do you like games? How about a round of freeze tag?!"],
     'pcrat': ["Ya feel a draft?",
     ...
     'derrman': ['I wish I could go somewhere warmer - preferably away from you lot!',
             "Sneaking around my lair wasn't an 'ice' thing to do.",
             'My plans for this Toon have been on ice for too long!',
             "I won't let your silliness freeze my trip up the company ladder!"],
     'derrhand': ['Consider this a pay zone, as in "You\'re gonna pay!"',
            'Did you think you were welcome to re-enter this Headquarters?',
            "Looks like I'll have to deepen my resistance.",
            "You're looking a little porous there, Toon."],
     None: ['Your assets are mine.',
            'Do you feel a draft?',
 ...
 'GlowerPower': {
    'cbutcher': ["That fear? That's evaluation kicking in.",
                 "I don't even need the saw for you.",
                 "You feel small yet?",
                 "Look at me when I do this."],
     'ubuster': ["You're backing traffic up for everyone!",
                "I've had enough of these delays!",
                "Move it, Toon!",
                "Do you have any idea how much congestion you're causing?",
                "You're testing my patience!"],
    'ambass': ["You can't escape my gaze.",
            "This look will undo you.",
               "Do I have your attention?",
            "Intimidation is my greatest weapon.",
            "Eyes forward Toon, or down where you belong."],
    'phouse': ["My eyes... see your failure!",
            "Face the glare of authority!",
            "That's fear in your eyes, exactly what I wanted.",
            "That look just cost you your confidence.",
            "You'll never forget this glare."],
    'dopa': ["I'm taking you off the air.",
            "I've got quite the stinger for you.",
            "Let me ramp the antagonism up a bit.",
            "Time to cut to an advertisement.",
            "We'll have to set up a little phantom power!"],
     'dopr': ["How's this- this for expressive eyes- eyes?",
 ...
 'GuiltTrip': {
         'redd':["Your friends are suffering because of your decisions.",
                "Surely you expected a better outcome than this.",
                "You call that leadership? How disappointing.",
                "Failure is a family heirloom you'll wear proudly."],
     'arbit': ["Honestly, I expected better paperwork from you.",
               "Do you even care about corporate efficiency?",
               "You're wasting valuable, billable hours.",
               "All this chaos, and for what?"],
        'dopa': ["Here's some feedback for you.",
                    "I'm sensing some distortion between us.",
                    "This will teach you to meddle in my affairs.",
                    "Weekly listenership has dropped because of Toons like you!",
                    "You wouldn't force me on the beach, would you?"],
     'dopr': ["You had better say- say you're- you're sorry.",
     ...
     'fbed': ["I can't believe you made me do this...",
            'Do you have any idea how hard I work? Zzz...',
            'Wallow in... Zzz...',
            "I'll never forgive you for interrupting my nap..."],
     'whunter': ['Tripping you up is mere bagatelle.',
                 'Impudent vermin must watch their steps.',
                 'Your pride only serves to vaticinate your fall.',
                 'You have been tried and found guilty.',
                 'An individual of my ranking should not be degraded in dealing with the likes of you.'],
     'sgoat': ['This fight is all your fault!!!',
             "You're ruining everything!!!",
             "Why'd you do this, huh???",
             'Of course you blame the little guy!!!'],
     'caseman': ['Hmph!!!',
             'Why...?',
             'You did this.',
             'Your fault.'],
    'wsi': ["Have you ever considered how you make US feel?",
            ...
            "You've caused nothing but anguish for me!",
            "There is much more beyond the surface!"],
     None: ["Are you ready for your trip?",
 ...
 'HalfWindsor': {
     'liquid': ["Presentation matters, doesn't it?",
                "Even enforcement should look refined.",
                "A sloppy fight reflects poorly.",
                "Hold still, this needs to be precise."],
     'mslacker': ['Eh, something something... half effort.',
            "This'll leave you winded.",
            "Laundry? That's, uh... Gizmo's job.",
            "My dad's always tied up with work.",
            "Well, here's another tie."],
     None: ["I bet you've never even SEEN a half Windsor!",
 ...
 'HangUp': {
    'wtapper': ["Line's dead, and so are your chances.",
                    "Consider yourself disconnected.",
                    "Nothing but dead air on your end.",
                "Ha! You didn't even get the last word.",
                    "Silence suits you better."],
     'bellring': ["Right, I'm severin' this link.",
                    "Your time's up, love.",
 ...
 'HeadShrink': {
         'ubuster': ["You clearly didn't read the signs.",
                   "Maybe traffic control is too complicated for you.",
                   "I'll make this simple enough for you to understand.",
                   "Think before you merge, Toon.",
                   "You're not exactly operating at peak capacity."],
     'cdirector': ["We'll realign your priorities.",
                   "Your role is smaller than you think.",
                   "Time to compress expectations.",
                   "Your thoughts are being streamlined for peak efficiency.",
                   "Your influence has been downgraded.",
                   "Control increases as space diminishes."],
     None: ["Looks like you're seeing a shrink.",
 ...
 'HotAir': {
  'liquidr': ["All that buildup... and there's nothing behind it.",
                  "You've been running on empty this whole time.",
                "Inflated numbers, no real value, I'll correct that!",
                   "Let's strip away the illusion and see what's actually there.",],
    'safesupervis': ["Feel that heat? That's the system overloading.",
                    "The higher the pressure, the hotter the blast.",
                    "Breathe carefully... the air's getting volatile.",
                    "Every boiler bursts eventually."],
    'phouse': ["Prepare yourselves for the biggest speech of your small Toon lives.",
                    "You're about to be blown away by corporate greatness.",
                    "Here comes a gust of pure superiority!",
                    "Blowing past your resistance, one breath at a time.",
                    "Nothing stands when I blow through.",
                    "Full of myself? Absolutely, and it's working."],
        'mplayer': ["Clearly you don't own an air fryer, babe.",
                    ...
                    "Burnin up babe?"],
     'mplayer2': ["Clearly you don't own an air fryer, babe.",
                    "Tune so hot, hot hot tune, tune so hot you fry a Toon.",
                    "Come on babe, here's a real hot tune!",
                    "This tune's got some more flare than you can handle!",
                    "Better not dance cold on my floor.",
                    ...
                    "I play this one a little con fuoco!",
                    "Burnin up babe?"],
     'fires': ["Another meeting up in smoke...",
     ...
     'whunter': ["You'll make for satisfactory kindling.",
                 'Those that play with fire will inevitably be burned.',
                 'Whatever stake you have in this fight will be charred at my hand!',
                 'Ashes to ashes, dust to dust.'],
     None: ["We're having a heated discussion.",
...
'PennyPinch': {
    'hustle': ["Every bit counts, I'm taking that!",
                  "Small loss for you, steady gain for me.",
                "Can't leave anything behind!",
                   "That adds up faster than you think!",],
    'racket': ["I can make this hurt.",
               "Every cent wrung dry.",
               "You're worth more broken down.",
               "I'll just squeeze it out of you.",
               "You're more trouble than you're worth",
               "Squeezed dry."],
    None: ["What's that behind your ear?",
                "Let me round that down for you.",
                "Ever heard of the four-finger discount?",
                "What are you gonna do, call the coppers?",
                "You won't have a single penny to your name.",
                "Another for my collection.",
                "You weren't going to use that anyway.",
                "It's my lucky day.",
                "This is quite the pretty penny.",
                "Be careful! This Penny Pinches back!",
                "You're not making cents to me.",
                "A penny pinched is a penny earned."]},
 'Jargon': {
     'stenog': ["Do you understand what I'm saying? Am I talking too fast?",
             "Ah-ah! Don't get smart now!",
             "Is something the matter? Can't you comprehend what I'm saying?",
             'Not proficient in the legal dictionary, are you?'],
     'arbit': ["Allow me to articulate the intricacies of your impending loss.",
                "You're about to get motioned into oblivion!",
                "Let's talk statutory sub-paragraphs.",
                'Time to confuse you into compliance!'],
     None: ['What nonsense.',
 ...
 'LawBook': {
     'whunter': ['Perchance this shall enlighten you to your trespasses.',
                 'The contents of this may surpass your apperception.',
                 'I have resolved to bookend this foppery.',
                 "I've no need for this dravel.",
                 'Quashing you pests is a waste of my time.'],
     'lgator': ['You could use a lesson in law. Study up.',
             "If you'd just read this section here...",
             "Something tells me you didn't study litigation before facing me.",
             'I certainly hope you have a good lawyer, otherwise this might crush you.'],
     None: ['My book from Law School should help.',
 ...
 'Legalese': {
     ...
     'arbit': ["Allow me to clarify... in terms you'll never understand!",
               ...
               "You're about to get talked into submission!"],
     None: ['You must cease and desist.',
 ...
 'Liquidate': {
      'erclaim':["I'll drain your stash without debate. It's time for me to Liquidate!",
                "Your piggy bank has run quite dry. I'll drink it up, oh me, oh my!",
                "No coin, no juice, no strength to spare. I've Liquidated every share!"],
        'redd':["Time to liquidate the underperforming investments.",
                "I'm trimming excess expenses, starting with you.",
                "Your value has depreciated beyond recovery.",
                "Consider yourselves written into the loss column."],
              'liquidr': ["Time to convert everything you have into something useful.",
                  "All assets accounted for. Now I'm turning them into profit!",
                "You held onto this for far too long, I'll make better use of it.",
                   "This is the end of your value, I'm taking what's left!",],
     'liquid': ["You want a liquidation? Fine, I'll make it ugly.",
                "Paperwork says 'terminate'. The weather agrees.",
                "I'm done pretending this is just business!",
                "Rain doesn't stop once the damage is done!",
                "You think I enjoy this? That's the funniest part."],
     'racket': ["Selling you off for scrap!",
                  "The market just closed on you.",
                  "You're worth more broken than whole!",
                  "Your value's dropped to zero.",
                "Consider yourself dissolved.",
                  "Cashin' you out, Toon!"],
     'rainmake': ["Just leave! It'll make things so much easier.",
                    "Faltering? No, I'm not faltering! I'm solid! I swear!",
                    "The rain's getting in my face! Or is that just my eyes?",
                    "Do you really think I came here to rain on your parade?",
                    "You're diluted if you think I'll let you step on me!"],
     'derrman': ["You're diluted if you think I'm handing this Toon over!",
             'You slipped up the second you showed your face in here.',
             "You think you're tough, but you're still wet behind the ears.",
             'The hopes of the Resistance are about to come crashing down!'],
     'derrhand': ["Get out of my way! You're standing on our newest borehole.",
            'I really am a smooth operator, unlike some other Suits.',
            "My central estimate is that you're not long for this battle.",
            'When our plans reach completion, your kind will threaten us no more.'],
     'fbed': ["Look out, you're slipping...",
            'Zzz... oh, are you still afloat?',
            'Sleep well...',
            'Will you float? Or will you sink...',
            'Zzz... huh? My turn already...'],
     None: ['I like to keep things fluid.',
 ...
 'MarketCrash': {
     ...
     'treasure':["There it is, the collapse was unavoidable!",
                ...
                "The market corrects itself... you're the correction!"],
     'dking': ["Markets don't forgive weakness.",
               "I'll buy it all back later.",
               "Desperation lowers price.",
               "Watch the panic spread!",
               "Ruin is opportunity."],
     'cdirector': ["All indicators are flashing red.",
                   "Prepare for a rapid devaluation.",
                   "There will be no soft landing.",
                   "This outcome was forecast.",
                   "Recovery is not projected.",
                   "The system corrects itself."],
    'bkeeper': ["Watch it fall!",
                "And there it goes...",
                "Downturn...",
                "The market corrects."],
    'pcrat': ["Ya better get out quick!",
     ...
     None: ["I'm going to crash your party.",
 ...
 'MoneyTrip': {
        'erfit':["A good team can work out any problem, beyond anything you Toons can fathom.",
                "Did you energize? It's time to metabolize!",
                "Do you feel that energy? It's flowing all through me!",
                "Let's get back to business, and focus on our fitness."],
     'racket': ["When we work together, I win more.",
                 "You can't stop a well-coordinated operation.",
                 "Let's leverage our strengths against you!",
                 "See how much stronger we are together?",
                "Consider this a mandatory deduction!",
                "Open your ledger; I'm about to leave a mark.",
                "Looks like it's time to take a bigger cut.",
                "Don't worry, this'll only hurt your profits."
                ],
     'rkeeper': ["Cooperation is fascinating when it fails!",
                 "Everything is documented, including your efforts..",
                 "The record will reflect who contributed.",
                 "Time to measure group performance.",
                 "Let's see who's actually pulling their weight!"],
     'pcrat': ["I put it to a vote, and ya lost.",
    ...
    'dopa': ["Consider this your cue to leave.",
            "Let me show you how I hit the post.",
            "Looks like we've got some crosstalk going on.",
            "Trying to get on the same wavelength as me? Think again.",
            "You and I are out of sync."],
     'dopr': ["I'm ta-a-a-aking this to committee- committee.",
                "I-I-I put it to a vote- vote, and yo-o-ou lose."],
     None: ["I'm taking this to committee.",
 ...
 'CigarSmoke': {
 'director': ["Roll the fog machines.",
                "Every masterpiece needs atmosphere.",
                "The audience loves dramatic tension.",
                "You'll never see the ending through this smoke.",
                "A little haze makes every production unforgettable."],
     'safesupervis': ["Ahhh... nothing like the smell of success!",
                "Stress burns better with premium tobacco!",
                "You smell that? Burnt morale.",
                "Nothing calms the nerves like executive-grade smoke!",
     ...
     'videog': ["Deals get sealed in smoke-filled rooms.",
               ...
               "You're choking on my influence.",
               "I only smoke the finest... tax write-offs.",
               "Secondhand? More like second-class!",
               "This industry runs on smoke and mirrors."],
     'pcrat': ["It's a good day for me ta have a smoke.",
     ...
     'fires': ["I'll quit tomorrow, I swear...!",
     ...
     None: ['Gentlemen.',
                ...
                'Smoking is a dirty habit.'],},
'SongAndDance': {
    'director': ["Every great production needs a musical number!",
                "Smile for the audience!",
                "Hit your marks, and don't miss a beat!",
                "Let's give them a performance they'll never forget!",
                "You're all dancing exactly as I've directed."],
    'videog': ["All spectacle, no story, just the way I like it.",
                "A flashy number keeps the critics quiet.",
                "This routine always steals the spotlight!",
                "I'll choreograph your downfall.",
                "Big lights, loud noise, zero meaning.",
                "Distract 'em with a tap and a grin.",
                "Cue the chorus line!"],
    'radiog': ["You're gonna love this act, or hate it.",
                "This is my closer, folks!",
                "Theatrics always seal the deal.",
                "Caught in the rhythm of defeat!",
                "Dancing you right into confusion!",
                "Applause isn't necessary, I already know I'm good.",
                "Didn't know I had stage presence, did you?"],
    'mplayer': ["A-one! A-two! A skiddly-diddly-doo-doo dibba de-do-do!",
                "Bop ba bodda bope-Be bop ba bodda bope.",
                "Don't trip up, babe!",
                "It don't mean a thing if it don't got that swing, babe!",
    ...
    'mplayer2': ["A-one! A-two! A skiddly-diddly-doo-doo dibba de-do-do!",
                "Bop ba bodda bope-Be bop ba bodda bope.",
                "Don't trip up, babe!",
                "It don't mean a thing if it don't got that swing, babe!",
                "How's this for a jitterbug jolt!",
                ...
                "Don't start snoozin on me babe!",
                "Tap to the tune, babe, let the music touch your soul."],
    None: ["A-one! A-two! A skiddly-diddly-doo!",
                "I assure you, I'm not dancing around the issue.",
                "I'm afraid I have you beat.",
                ...
                "Woah Woah Woah..."],},
 'MumboJumbo': {
    'wtapper': ["Monetize the static, verticalize the chaos!",
             "This pitch won't make sense... to you!",
             "Heh, didn't catch a word, did you?",
                "Get ready for some real corporate wisdom.",
             "My nonsense makes perfect sense... to me."],
     'stenog': ['Are you listening? I talk fast! Keep up!',
             "What's wrong? I thought Toons loved talking nonsense!",
             'Is this not simple enough to understand?',
             "It's not nonsense, you just aren't paying attention!"],
     None: ['Let me make this perfectly clear.',
 ...
 'ParadigmShift': {
            'ubuster': ["The old roads are closed, adapt or get stuck!",
                "We're implementing a new flow model.",
                "Traffic waits for nobody.",
                "Flow is everything, and you're in the way!",
                "Let's see how well you handle a detour!"],
    'liquid': ["You're still playing by the old rules?",
                "Market conditions have just shifted.",
                "Did you really think it would stay fair?",
                "Adapt or fall behind."],
     'ovt': ['I think this is an interesting paradigm.',
     ...
     'sgoat': ['Look out! Big changes are coming your way!!!',
             "I'll show you what I can do!!!",
             'Is the team watching this???',
             'How about a change of pace?!'],
     'prethink': ["Let's 'shift' things back in my favor, heh.",
                  'My learning model is constantly evolving to best you.',
                  "It'll take more than simple combos to beat me!",
                  'Prepare to change your understanding of me, Toons!'],
     'mslacker': ["Flunk Show's gonna air, so I'll shift you over there... Heh.",
            'Up, up, and away...',
            'Is my shift done...?',
            'Can you see my remote from there?',
            'Wish I could shift you out the door, but...'],
     None: ["Watch out! I'm rather shifty.",
 ...
 'PeckingOrder': {
    'dking': ["Let's establish hierarchy.",
                                     "There's a natural order to things.",
                                    "Low performers are expendable.",
                                     "I didn't create the system, I mastered it.",
                                     "You weren't built for this.",
              "This isn't cruelty, it's structure.",
              "The market eliminates weakness."],
    'racket': ["Let me remind you where you stand in the 'pecking order'.",
                                     "Top executives soar... you Toons stay on the ground.",
                                    "Hierachy is everything, and you're at the bottom.",
                                     "This is what happens when you challenge upper management!",
                                     "One step down the ladder for you, another step up for me."],
     'fbed': ['Get ready for a bird... bath... Zzz...',
            'Fowl or not, it gets the job done.',
            'Hoo... I mean... who asked you to flock in and ruin my nap?',
            'Order... is what everyone needs to succeed.'],
    'wsi': ["You don't realize your cause of action.",
     ...
     None: ["Looks like you're going to hit a birdie.",
            ...
            "Sorry to bom-bird you with questions."]
 },
 'PickPocket': {
         'hustle': ["Too slow.",
                  "Didn't even feel it, huh?",
                "You really should watch your pockets!",
                   "Quick grab, easy profit!",],
     'racket': ["Pleasure doing business.",
               "You won't even notice.",
               "A little off the top.",
               "Every cent counts.",
               "You're friskier than you look.",
               "Too slow."],
     'pcrat': ["I'll hold this for ya.",
     ...
     None: ["Don't mind if I do.",
                ...
                "You'll never see it coming."],},
 'PinkSlip': {
     'cbutcher': ["Sign here, oh wait, you won't live long enough!",
                  "I do this every quarter, you're just this month's loss.",
                  "You never belonged here.",
                  "You should've taken the buyout!"],
     'ubuster': ["Your services are no longer required!",
                 "Signed, sealed, and delivered, you're done!",
                 "Consider yourself terminated!",
                 "The office is cleaner without you.",
                 "File this under 'Failure.'"],
     None: ['Try not to slip up.',
              ...
              "Here's your pink slip, you're outta here!"]},
 'PlayHardball': {
    'liquid': ["You really thought we were negotiating?",
                 "I don't bend policy, I enforce it.",
                 "Let's see how you handle premium penalties!",
                 "You've escalated this to collections!"],
     None: ['So you wanna play hardball?',
 ...
 'Newspaper': ['Hot off the presses, this Toon is in for a real beat down.',
                     "Here, have a read.",
                     'Here take this, but leave the comic section for me.',
                     'Breaking news! This Toon will be defeated by local Cog!'],
 'Novel': ['I hope you enjoy, I poured my heart and soul into this novel.',
                  "Here's an interesting story about my life.",
                  'I hope this story finds you well.'],
 'PoundKey': {
     'rkeeper': ["Let's see if repetition helps you learn!",
                 "I've got all the time in the world to correct you!",
                 "Consider this an official notice.",
                 "Is this a good number to reach you at?",
                 "Each strike counts, as do your failures."],
    'wtapper': ["Scrambling your line with one press.",
                    "Static's coming through loud and clear.",
                    "Ha! Garbled, just like your strategy.",
                    "That button just broke your system.",
                    "Need help? Press # for more punishment.",
                    "You've been dialed out of service.",
                    "Connection scrambled beyond repair."],
     'bellring': ["Ring-a-ling - it's for you, mate!",
     ...
     'stenog': ["Hold on, I'm getting a call. Oh! It's for you!",
             "Now THIS is something I'll have to tell Belle about!",
             'Just a moment, I have to take this.',
             'Hmm? Oh, I see! This call is for you!'],
     None: ["I have a lot of clout.",
 ...
 'PowerTie': {
     'mslacker': ['My dad says I look nice in this tie.',
            "Huh, this one's from Janet. Guess this was a build-day gift?",
            "My dad makes me wear this when we go out to dinner. It's pretty fancy...",
            'Time to, uh... power off.',
            "My dad's a powerful tie, so I... Oops."],
     None: ["I'll call later, you looked tied up.",
 ...
 'PowerTrip': {
    'rainmake': ["You think you're SO powerful just because you have GAGS!",
                    "You have the power to stop this madness!",
                    "I want you to know that I don't like doing this!",
                    "I could crush you between my hands! Okay, maybe not...",
                    "I'm so powerful... Really, I am!"],
    'phouse': ["All power, no limits, let's see you resist this.",
                    "This company runs on my terms!",
                    "Time for a hostile takeover, Toon-style.",
                    "You're on MY clock, and I say you're finished!",
                    "That's why they call me the Powerhouse."],
     'fires': ["You look a little tripped up...",
     ...
     'lgator': ["Let me remind you who's in charge here.",
             "Tripped you up? Well, that's not surprising.",
             "I'm in control, don't forget that.",
             'Did I trip you up? Aw, how pathetic.'],
     'wsi': ["I may just be a replacement, but I assure you, I'm no joke!",
                "A court order has been made.",
                "Take that!",
                "I will not conduct any more mistrials.",
                "Why else do you think I am in charge?"],
    'hrollers': ["Pack your bagff, we're taking a little trip.",
                ...
                "Ffory to trip you up there!"],
    'hroller2': ["Pack your bagff, we're taking a little trip.",
                "Who'ff got the power now?",
                "Power corruptff, effpecially in my handff!",
                "Niffe trip, I gueffff I'll ffee you next fall.",
                "Now you ffee who'ff in power!",
                ...
                "Did you have a niffe trip?",
                "Ffory to trip you up there!"],
    'hroller': ["Pack your bagff, we're taking a little trip.",
                "Who'ff got the power now?",
                "Power corruptff, effpecially in my handff!",
                "Niffe trip, I gueffff I'll ffee you next fall.",
                "Now you ffee who'ff in power!",
                ...
                "Did you have a niffe trip?",
                "Ffory to trip you up there!"],
     None: ["Pack your bags, we're taking a little trip.",
            'Did you have a nice trip?',
 ...
 'Quake': {
             'erfit':["Keep your feet moving and your muscles improving!",
                "Put on your athletic shoes, 'cause we've got some calories to lose!",
                "This workout has such magnitude, but your muscles will feel much gratitude!",
                "Your arms might start to quake, but this exercise has no break."],
                
             'erclaim':["The earth will grown, the walls will break. Now tremble, Toons, it's time to Quake!",
                "The castle shakes from floor to spire. Dance with the stones or dodge the fire.",
                "A rumbling floor, a craking slate! It's too late to vacate!"],
      'ubuster': ["Looks like the road's falling apart!",
                "Watch out for structural instability!",
                "Construction delays ahead!",
                "The whole route's shaking apart!",
                "Careful, Toon. The foundating isn't as solid as it looks."],
    'racket': ["You can't stand when I pull the floor out.",
                "Feelin' that pressure? It's comin' down hard.",
                "The market quakes when I move!",
                "Cracked your foundation clean.",
                "Consider this a shake-down!"],
      'ovt':  ["Hey what's shaking? You...? And me? And the earth?",
     ...
     'dold': ["Pardner, I'm gonna shake that smile right off yer dagnabbed face!",
     ...
     'dola': ["Let's get quakin', rattlin', and rollin'.",
                "I've got a whole lotta quakin' goin' on!",
                "Now the ground 'ill quake!"],
     'gatekeep': ["This one is offeth the Richter scale.",
    ...
    'bellring': ["You're on dodgy ground now!",
    ...
    'mplayer': ["Let the rhythm quake your core, babe.",
    ...
    'mplayer2': ["Let the rhythm quake your core, babe.",
                "Everybody's jumpin', babe.",
                "Shake to the tempo!",
                "Time for the one o' clock jump!",
                "Oh now the crowd is shakin to the tune!",
                ...
                "Babe this song ain't soft.",
                "Let's get shakin' babe."],
     'derrman': ["Your hopes of saving this Toon will be 'shaken' after this.",
             "The Resistance's knees will buckle when they see what I've done to you!",
             "Releasing this Toon is a deal that I won't shake on!",
             'The fault is with your Toon friend for ever stepping in here!'],
     'derrhand': ['Defeating you will be a barrel of monkeys!',
            'I sense your resistance is fracturing.',
            "I'm taking this battle topside.",
            'This will be a real kick in the teeth!'],
     'psetter': ["You'll need to keep steady if you want to keep up!",
             'Time to tear up the dance floor!',
             "It's not a real show unless the walls shake!",
             "You've gotta know how to shake to get into the Pace Place!"],
     None: ["Let's quake, rattle, and roll.",
 ...
 'RazzleDazzle': {
         'director': ["Lights, camera, distraction!",
                "A little spectacle goes a long way.",
                "I'll keep your eyes where I want them.",
                "The critics won't see this twist coming!",
                "Nothing sells a show like smoke and mirrors."],
        'hustle': ["Watch closely, or don't, you'll miss it either way!",
                  "Flashy enough for ya?",
                "Keep your eyes on the presentation!",
                "Let's distract you from the important details.",
                   "You don't need substance when you've got style!",],
     'videog': ["Lights, camera, distraction!",
                "Can't see the flaws if the spotlight's in your eyes.",
                "Dazzling, isn't it? Don't blink.",
                "A little spectacle covers a lot of mistakes.",
                "All flash, no substance... just the way I like it.",
                "You're caught in my lens flare!",
                "The critics will eat this up!",
                "It's all smoke, mirrors, and market share.",
                "Let me blind you with brilliance; mine."],
     'radiog': ["Shiny enough to distract you, cheap enough to sell you!",
                 "Step right up, feast your eyes!",
                "Let me light up your downfall!",
                "Too much shine for your Toon eyes!",
                "Blinded by brilliance, duped by the pitch!",
                 "Flashier than facts, deadlier than truth!",
                 "Don't blink, or you'll miss the fine print!"],
     'psetter': ['Wow, I look GREAT today!',
             'Try not to look directly in the spotlights, capiche?',
             'No autographs until AFTER I beat you.',
             'Almost as shiny as red-hot flames!'],
     None: ['Read my lips.',
 ...
 'RedTape': {
       ...
       'liquidr': ["You'll need approval for that.",
                ...
                "Everything has to go through me now.",
                   "Go ahead, try to act, you won't get past this!",],
     'liquid': ["You'll need clearance in triplicate.",
                "Oh dear... you've triggered a compliance review.",
                "Your progress is indefinitely postponed!",
                "I do love procedural delays."],
     'cdirector': ["All actions are now conditional.",
                   "You'll need approval for that.",
                   "Please submit the proper forms.",
                   "Processing time will be extended.",
                   "This action requires review.",
                   "Your momentum has been suspended."],
    'ovt':  ["Please don't confuse me with that Foreman over there.",
             "I'm on a roll... wait, you are too!!",
             "I'm going to tie you up, hopefully for a while.",
             "This should wrap things up... I think."],
     'safesupervis': ["You're restricted for your own good!",
                      "Safety rules keep you tied down!",
                 "Can't move? Must be working!",
                 "Let's wrap this up in compliance.",
                 "Regulations don't bend... and neither will you!",
                 "All tied up with rules and restrictions."],
    'ubuster': ["You'll need approval before proceeding.",
                "Looks like your permit hasn't been processed.",
                "Stand still.",
              "Sorry, there's some paperwork holding things up.",
                "That's going to require several forms and signatures."],
     'bkeeper': ["Bound by procedure.",
              "Delayed...",
              "Caught in process...",
              "You're not going anywhere.",
              "Approval pending..."],
     'dold': ["Ya can't get outta this one, not by a jugful.",
                "This oughtta tie the barb on that!",
                "Gonna need more than a boot ta step over this tape!",
                "Sorry pardner, I don't much think ya can unravel this con-on-drum. Now, I say, that looks a bad paste!",
    ...
    'gatekeep': ["Looks liketh thou art in a sticky situation.",
     ...
     None: ['This should wrap things up.',
 ...
 'RestrainingOrder': {
    'arbit': ["You're getting a little too close for corporate comfort.",
                "By the power vested in law and litigation...",
                "I hereby issue a mandatory distancing decree.",
                "Approach again, I'll add a harassment clause."],
    'bkeeper': ["Stay away...",
             "Cease. Immediately.",
             "You are restricted...",
            "Keep back.",
             "Maintain distance."],
     'caseman': ['Annoying...',
             'Hmm... Restrain yourself.',
             "...I'll wrap this up quickly.",
             'Look... Your hands are tied.'],
     'wsi': ["I won't allow you to further damage this company.",
                ...
                "Keep back!"],
     None: ['You should show a little restraint.',
 ...
 'Rolodex': {
     'cbutcher': ["I've got a list, and you're on it.",
                  "Everyone gets a turn eventually!",
                  "Weak assets don't survive.",
                  "Let's see, name, title, expiration date..."],
    'wtapper': ["Sharp connections make deep cuts!",
                "You've just been slashed by success.",
                "Need a business card? I've got plenty.",
                "Contacts and contracts, right at you!",
                "I've got a whole deck to burn through!",
                "Networking never felt so sharp."],
     'bellring': ["I'll let my fingers do the knockin'.",
     ...
     'caseman': ['Hmm, hmm...',
             ...
             'Watch for papercuts.',
             "Where's my card...?"],
     None: ["Your card's in here somewhere.",
            "Here's the number for a pest exterminator.",
 ...
 'RubberStamp': {
     'cdirector': ["This decision is final, do not resist.",
                   "This measure is non-negotiable.",
                   "Efficiency demands action, stand ready.",
                   "This action is now binding, take note.",
                   "Authorization granted, follow through.",
                   "All operations are now under my control."],
     'rkeeper': ["Time to make it official!",
                 "Did you even bother to read the fine print?",
                 "This stamp doesn't lie, but you might.",
                 "Let's see what the record says.",
                 "Don't worry, I've done this a thousand times.",
                 "Your fate is officially sealed, Toon."],
     'bkeeper': ["No review necessary.",
              "Processed...",
              "Accepted...",
              "Authorized...",
              "Form ready."],
     None: ['I always make a good impression.',
 ...
 'Sacked': {
     'safesupervis': ["Looks like the pressure finally got to you.",
              "You cracked faster than expected.",
              "I warned you, stress fractures spread quickly!",
            "Another weak link removed from the pipeline."],
     'fbed': ["I'm going to hit the sack.",
            'Goodnight...',
            "Your time is up around here, you're... Zzz...",
            'I think this would make a fine sleeping bag...',
            'What a chore...'],
     'whunter': ['Your services are no longer, and were never, required.',
                 'Bagged and gagged.',
                 'I rid myself of your annoyances henceforth!',
                 "You're not the only one with a bag of tricks.",
                 'I shall expedite your ousting post-haste!'],
     None: ["Looks like you're getting sacked.",
 ...
 'SandTrap': ["Something tells me you're about to get a real sinking feeling.",
              "I think I'll trap you for a while.",
              "Good luck clawing your way out.",
              "This will cost you greatly.",
              "You're well below par."],
 'ReOrg': {
         'ubuster': ["Time for a route adjustment.",
                  "We're changing traffic patterns immediately!",
                "Let's move some things around.",
                "Please follow the updated routing instructions.",
                   "The current layout is highly inefficient.",],
             'hustle': ["Nah, this setup's not working, let's switch it up!",
                  "Gotta stay flexible, this'll work better.",
                "New plan, better angle. Keep up!",
                   "I'll rearrange things to my advantage!",],
     'cdirector': ["This configuration is no longer optimal.",
                  "We'll be making adjustments.",
                "The previous layout was temporary.",
                   "All contingencies remain intact.",
                  "All variables are being reconsidered.",
                  "This arrangement performs better."],
     'dold': ["Mind a peck if I ra-organ-ize ya?",
                ...
                "Reckonded I might give this a fire-new look."],
    'dola': ["Ya got some problem with how I reorganized things?!",
     ...
     'prethink': ['Your composition is frankly perplexing...',
                  "I've devised a model to efficiently bring you down.",
                  'This is a great opportunity to conduct some research.',
                  'Even the Jockeys are built better than this!'],
     None: ["Not a fan of how I reorganized things?",
            ...
            "Perhaps a little organization is in order.",
            "I'll just wait for you to get a little organized."]
 },
 'Schmooze': {
         'hustle': ["You seem like a Toon with great potential!",
     ...
     'videog': ["Smile for the press release!",
                "I'll edit you into a star... or a flop.",
                "Just one more flattering angle!",
                "Your brand image could really use me.",
                "A little charm goes a long way in the final cut.",
                "Everyone loves a good spin, and I'm the best at it."],
     'radiog': ["Did anyone ever tell you you've got star quality?",
              "I'll flatter you right off your feet!",
              "Ohhh, you're looking sharp today, Toon!",
              "Flattery beats slapstick every time.",
              "If words were money, I'd be the richest Cog alive."],
     'dopa': ["I don't have the bandwidth to deal with you, Toon.",
                "The general public will just love you, Toon!",
                "This situation is forcing me to go off script.",
                "You have a voice fit for dead air time.",
                "Your face is absolutely perfect for radio!"],
    'dopr': ["You've earned- earned this- this.",
     ...
     'psetter': ["You're about 0.01% as cool as I am! That's impressive.",
             'I think you deserve a faster pace!',
             "You're pretty slick for a Toon!",
             "Wow, you're SO brave for trying to outpace ME!"],
     None: ["You'll never see this coming.",
...
'Shake': {
 'redd':["Pull yourself together, or I'll do it for you.",
                "Your confidence appears... unstable.",
                "Do try to stand firm, this will only get rougher.",
                "Let's see how steady your footing really is."],
    'liquid': ["Ugh... I'm done being gentle.",
                "I swear, this job shakes me more than it does you.",
               "They think stress builds character.",
                "You feel that? Good.",
                "I'm not paid enough to be careful.",
                "If it broke, it was already weak."],
    None: ["I suggest a good escape plan.",
 ...
 'Shred': {
             'bookkeep': ["This record is unnecessary; I'll remove it.",
                "You don't belong in the ledger, correcting that now.",
                "Erasing entry... clean and final!",
                "Deleted. No trace remains.",],
     None: ['I need to get rid of some hazardous waste.',
 ...
 'Spin': {
     'ovt': ['I think you should use the spin cycle.',
    ...
    'duckshfl': ["Whaddaya thay we go for a little THPIN??",
     ...
     None: ['What do you say we go for a little spin?',
 ...
 'Synergy': ['Might need to consider taking out a second loan, Toon.',
 ...
 'Golf': {
    'ambass': ["Straight down the fairway, into you!",
                "Nothing like a perfect stroke of power.",
                "Consider yourself out of bounds.",
                "That's what I call executive precision.",
                "Golf is all about control, something you'll never have.",
                "Consider this your permanent handicap."],
        'director': ["Places, everyone! It's time for your opening shot!",
                "And... action!",
                "Try not to miss your cue!",
                "Let's see if you can survive the first take.",
                "I'm raising the curtain on your downfall."],
     None: ["You're not up to par.",
            'Fore!',
...
'TeeOff': ["You're not up to par.",
            ...
            'Mind if I play through?'],
 'Tremor': {
         'hustle': ["Looks like the ground floor's getting restless.",
                    "Looks like we're experiencing some market turbulence.",
                "The market isn't the only thing crashing today!",
                "When my schemes fall apart, everybody feels it!",
                "Things get messy when the hustle hits a snag.",
                "I wouldn't call this a 'stable investment'."],
    'liquid': ["You ever feel the stress in the floor?",
                "This place is cracking. I can feel it.",
                "All that pressure has to go somewhere.",
                "They keep piling it on. Eventually, it snaps.",
                "Consider this a stress test."],
     'dola': ["Not afraid of a little tremor now are ya?",
                "You look jittery.",
                "Did ya feel that?",
                "Tremor with fear!",
                "Why are ya tremoring with fear?"],
     'sgoat': ['Gonna shake things up now!',
             'Stomp, stomp, STOMP!!!',
             'What? Tripped up? Ha!!!',
             'What? You scared?? You look shaken up!!!'],
     None: ['Did you feel that?',
 ...
 'Watercooler': {
     'ddiver': ["I wouldn't waste water, but you've left me no choice.",
             'Let me douse those lights for you.',
             'Cool it.',
             'Water break? Gladly.',
             "I'm filtering you out.",
             'Enough of your spouting off.'],
     None: ['This ought to cool you off.',
            "Isn't this refreshing?",
            'I deliver.',
            'Straight from the tap - into your lap.',
            "What's the matter, it's just spring water.",
 ...
 'Withdrawal': {
      'erclaim':["A sip for me, a sigh for you. Your strenth is fading through and through.",
                "Each drop I take, I grow anew. Your pulse says 'tick', mine says 'thank you'.",
                "Withdraw your hope, withdraw your might. They taste much sweeter late at night!"],
           'treasure':["You won't be getting this back.",
                "Your balance is shrinking rapidly!",
                "You're losing more than you can afford.",
                "That amount is no longer yours to hold."],
     'liquid': ["Did you really think that was yours?",
                "Let's check your balance...",
                "Transaction complete, you look lighter.",
                "You're making this more expensive than it needs to be.", ],
     'derrman': ["If you won't withdraw yourself, then I will make you do so!",
             "I'm very interested in the Resistance's response to your impending defeat.",
             "I won't let your kind sidetrack me from my goals.",
             "It's in my interest that your Toon friend stays here!"],
     'derrhand': ["I won't tolerate any sidetracking from your defeat!",
            "I'll shut down your resistance!",
            "We've moved past the development phase - and onto the execution!",
            'Your efforts to stop us will be blocked.'],
     'psetter': ['Oops! Too slow!',
             "If you want to earn your place, you'll need to be faster than THAT!",
             "If you can't keep a balance, you're doomed to fall flat!",
             'You Toons need to HUSTLE to catch up now!'],
     None: ["I believe you're overdrawn.",
 ...
 'WriteOff': {
         'redd':["I've seen enough, you're officially a write-off.",
                "I'll deduct your efforts as operational losses.",
                "Your performance won't survive the quarterly report.",
                "You'll disappear quietly into the accounting records."],
     None: ['Let me increase your losses.',
              ...
              # erclaim and erfit cheats
'ErclaimHemmorage': ["One little bite, one little sting... your health shall make my praises ring!",
                    "A ruby mark upon your hide... your strenth will soon be mine to bide!",
                    "I'll toast tonight with vintage Toon... your wounds shall make me bloom!",
                    "A drop for me, a bruise for you... let's see what crimson magic can do!"],
'ErfitHydrationCheck': ["Did you drink your 8 glasses today? If not, here's one on the house, okay?",
                    "One must hydrate, in order to feel great.",
                    "This workout's getting harsh! You're looking quite parched."],
'ErfitProToonShake': ["Make no mistake this shake has what it takes!",
                    "With double the protein powder for extra fighting power!",
                    "With no silly Payser test, I'll show you who's best!"],
 'ErfitPersonalTrainer': ["Get ready for round 2, bro! It's time for a show!",
                    "No time to rest, it's time to rise to the test!",
                    "Push yourself to the limit and try this for a minute!"],
'ErclaimRiseFromTheScrap': ["All rise under the pale light of the moon."],
'ErfitWringOut': ["Need a towel? Just give me a howl.",
                    "Those sweat stains, they are proof of your gains!",
                    "Wipe off your sweat so it won't be a threat.",
                    "Your sweat may be cooling, but don't let it start pooling!"],
'ErclaimLaffSteal': ["A drink fit for me.",
                    "It will only be a pinch!",
                    "No Toon can stake me down!"],
'ErfitGainsFromTheScrap': ["Time for a much-needed boost! Sorry, bro, but it'll go to a good use!"],
 'ErclaimSacrifice': ["Give forth your power to me and know it will not go in vain!"],
 'ErclaimScopeCreep': ["Do you feel this is too much to handle?",
                    "My power is creeping forward.",
                    "Surely you don't find this overwhelming!",
                    "This isn't even the beginning, Toon!",
                    "You might find things are getting out of hand..."],
            # redd heir-wing cheats
...
'WSIJuryNotice': ["I summon the jury to me!",
                        "All rise!",
...
'LitigatorSnap': ["This may hurt a little, but what comes next will hurt a lot.",
                    ...
                    "These chompers could cut out diamonds!",
                    "My colleagues don't like it when I get snappy."],
'LitigatorBayouBash': ["The party is over here, fellas!",
...
'StenographerSanction': ["I spy with my little eye, a Toon who isn't pulling their weight.",
                            ...
                            "Someone isn't doing their part around here."],
# case manager cheats
'CaseManagerLegalBindings': ["Hmph...",
                            "Hrnhmpf...",
                            "Hrm...",
                            "Hm, hm..."],
'CaseManagerLegalBindings2': ["Hmph...",
                            "Hrnhmpf...",
                            "Hrm...",
                            "Hm, hm..."],
'CaseManagerInsurancePlan': ["Hmph...",
                            "Hrnhmpf...",
                            "Hrm...",
                            "Hm, hm..."],
                    # scapegoat cheats
...
'ScapegoatEnraged': ["I've had enough of all of this!",
                        "You got the goat, Toons!",
                        "You made me maaa-d!"],
'ScapegoatBarnyardBash': ["I can take it!",
                        "My guard is up!",
                        "It's just a scratch!",
                        "Is that the best these Toons have?"],
    #powerhouse cheats
'PowerhouseGroundbreaker': ["You're standing on shaky ground, Toons!",
                        "Let's see how well you handle a little pressure!",
                        "Hope you're ready to 'sink' to my level!",
                            "You think you can shake me? Think again!",
...
'PowerhouseSoakImmune': ["I'm sealed tighter than your bank account.",
                        "I'm not in the mood for a seltzer at the moment."],
'PowerhouseLureImmune': ["You think you can bait me? Think again.",
                         "Sorry, I'm not that easily persuaded.",
                         "I don't chase pennies; I collect fortunes.",
                        "Your offers are beneath my bottom line."],
'PowerhouseZapImmune': ["Hold still, this requires a quick electrical audit.",
                         "Save your sparks. I'm not conducting anything.",
                         "Your current lacks authority. I overrule it.",
                        "Chain effects? Not today."],
'PowerhouseDropImmune': ["I'm afraid your ceiling-based strategies are obsolete.",
                         "Falling objects hold no authority over me.",
                         "If it drops, it flops. Not my problem.",
                        "Gravity is a suggestion. I follow mandates."],
'PowerhouseSyphon': ["I'll drain you dry to keep the company alive.",
                    "You work, I profit; that's the system.",
...
'PowerhouseSnipeVulnerable': ["Careful, Toon... the voltage is still climbing.",
        "That surge is going to keep tearing through your circuits.",
        "You can't stop the current once it starts flowing.",
        "The grid's overloaded, and you're caught in the backlash.",
        "Power like this doesn't fade quietly.",
        "The charge keeps building every second you stand there.",
        "Looks like somebody couldn't handle the output.",
        "You're still conducting all that excess energy."],
'PowerhouseSnipeGagBan': ["Careful, Toon... the voltage is still climbing.",
        "That surge is going to keep tearing through your circuits.",
        "You can't stop the current once it starts flowing.",
        "The grid's overloaded, and you're caught in the backlash.",
        "Power like this doesn't fade quietly.",
        ...
        "Looks like somebody couldn't handle the output.",
        "You're still conducting all that excess energy."],
'PowerhouseSnipeSoaked': ["Careful, Toon... the voltage is still climbing.",
        "That surge is going to keep tearing through your circuits.",
        "You can't stop the current once it starts flowing.",
        "The grid's overloaded, and you're caught in the backlash.",
        "Power like this doesn't fade quietly.",
        ...
        "Looks like somebody couldn't handle the output.",
        "You're still conducting all that excess energy."],
'PowerhouseSnipeBookkept': ["Careful, Toon... the voltage is still climbing.",
        "That surge is going to keep tearing through your circuits.",
        "You can't stop the current once it starts flowing.",
        "The grid's overloaded, and you're caught in the backlash.",
        "Power like this doesn't fade quietly.",
        ...
        "Looks like somebody couldn't handle the output.",
        "You're still conducting all that excess energy."],
'PowerhouseSnipeMulligan': ["Careful, Toon... the voltage is still climbing.",
        "That surge is going to keep tearing through your circuits.",
        "You can't stop the current once it starts flowing.",
        "The grid's overloaded, and you're caught in the backlash.",
        "Power like this doesn't fade quietly.",
        ...
        "Looks like somebody couldn't handle the output.",
        "You're still conducting all that excess energy."],
'PowerhouseSnipeCollectCall': ["I run on limitless energy Toons, and business is booming!",
...
'BookkeeperPaperCut': ["Mmmph... that one.",
                         ...
                         "Hmph... don't move.",
                         "Mmmph... that's yours."],
'BookkeeperPaperCutSoaked': ["You want pressure?!",
                               "You asked for this!",
                               "You don't survive once you're flagged!",
                         "I'll bury you in penalties!",
                         "I don't clear liabilities. I erase them!"],
'BookkeeperMandatoryFiling': ["You don't evade procedure.",
                               "There's no sidestepping this.",
                               "Once it's filed, it cannot be undone."],
'BookkeeperBookkeeping': ['Hrm...', 'Hmph...', 'Hm, hm...', 'Hrnhmpf...'],
'BookkeeperPaperCutMarked': ['Hrm...', 'Hmph...', 'Hm, hm...', 'Hrnhmpf...'],
'BookkeeperBookkeepingRetaliation': ["YOU INSIGNIFICANT LITTLE-",
                                     "I WILL BREAK YOU FOR THAT!",
                                     "YOU WANTED MY ATTENTION?!",
                                     "YOU INTERRUPT ME AND EXPECT MERCY?!",
                                     "YOU THINK THAT WAS CLEVER?!"],
                    #wiretapper cheats
'WiretapperCollectCall': ["I'm charging premium rates now.",
                          "Oh good, I was hoping you'd pick up!",
                            "Let's have a private conversation.",
                            "Don't worry, I won't hang up.",
                            "Wrong number? Nope, the right one for trouble."],
'WiretapperCollectCall2': ["This is operator 44, you have an incoming call from... ME!",
...
'WiretapperCollectCallDamage': ["This call is collect, and you're paying the charges.",
                                ...
                                "Stay on the line, I get richer every second.",
                                "I'll keep it brief, but you'll still pay.",
                                  "The meter's running, and so are you."],
'WiretapperWiretapped': ["I've been listening in, your plans are all mixed up now.",
                         "Looks like your battle plans arrived out of sequence.",
                        "Are you sure that's the plan you agreed on?",
                         "You'd be surprised how easy it is to alter a transmission.",
                        "The signal's breaking up, can you still hear each other?",
                        "Let's see how well you operate with bad information.",
                         "Information is power, and I have all of it."],
'WiretapperVoicemail': ["Looks like I'm out of service...",
                        "Disconnected? That's my specialty.",
                        "I'll put you on hold... permanently.",
                        "I won't pick up; but I'll still collect.",
                        "You've reached my voicemail... gags not accepted.",
                        "Do I hear something? Oh wait, nothing important.",
                        "Sorry, I must've missed your joke."],
'WiretapperBusySignal': ["Let me correct that behavior!",
                        "You freeze when you lose guidance.",
...
'WiretapperBrokenConnection': ["You've forced me into emergency operations.",
                                "I'm losing the feed, so I'll just burn through it.",
                                "You think this gives you an advantage?",
                                "Without my defenses, there's nothing holding me back.",
...
'AmbassadorRefinement': ["I keep my team polished and running.",
                         "Oil is money, and I've got plenty of both.",
                            "You can't outlast a refined workforce.",
                            "Polishing my staff for peak performance.",
                            "You're company property, and I maintain my assets.",
                        "My staff shines brighter under my leadership."],
'AmbassadorRefinementManager': ["Keep standing, the company demands it.",
                         "Productivity restored to maximum levels.",
                        "Bosses stay polished, that's company policy.",
                        "Upper management requires the finest upkeep.",
                        "I'll ensure management shines above the rest."],
'AmbassadorPhase2': ["You toons have me so overworked, you made me blow through my suit! You've forced me to escalate this meeting."],
...
'AmbassadorGhostMentality': ["I've grown tired of you worthless grunts, here's a little motivation to get you working!",
                            "I'm sick of working with a bunch of weaklings! Take this, and destroy those Toons!",
                             "I'll show you what happens when you don't do your part around here!"
                                 ],
...
'AmbassadorAdvancement': ["Promotion comes at a cost, for someone else.",
                        "Someone in my ranks is about to be terminated, for my gain.",
                        "Consider this a hostile takeover, and you're next.",
                        "Sacrifices must be made for corporate growth.",
                        "Efficiency means cutting the weakest link.",
                        "One of these Cogs won't be walking away from this meeting."],
'AmbassadorAdvancement2': ["Promotion comes at a cost, for someone else.",
                        "Someone in my ranks is about to be terminated, for my gain.",
                        "Consider this a hostile takeover, and you're next.",
                        "Sacrifices must be made for corporate growth.",
                        "Efficiency means cutting the weakest link.",
                        "One of these Cogs won't be walking away from this meeting."],
'AmbassadorAdvancement3': ["Promotion comes at a cost, for someone else.",
                        "Someone in my ranks is about to be terminated, for my gain.",
                        "Consider this a hostile takeover, and you're next.",
                        "Sacrifices must be made for corporate growth.",
                        "Efficiency means cutting the weakest link.",
                        "One of these Cogs won't be walking away from this meeting."],
'AmbassadorAdvancement4': ["Promotion comes at a cost, for someone else.",
                        "Someone in my ranks is about to be terminated, for my gain.",
                        "Consider this a hostile takeover, and you're next.",
                        "Sacrifices must be made for corporate growth.",
                        "Efficiency means cutting the weakest link.",
                        "One of these Cogs won't be walking away from this meeting."],
'AmbassadorAdvancement5': ["Promotion comes at a cost, for someone else.",
                        "Someone in my ranks is about to be terminated, for my gain.",
                        "Consider this a hostile takeover, and you're next.",
                        "Sacrifices must be made for corporate growth.",
                        "Efficiency means cutting the weakest link.",
...
'SafetyOverpressured':  ["Pressure makes profits, and I've got plenty to apply.",
                        "High pressure means high performance!",
                        "Push past your limits, the company demands it.",
                        "I don't care if you break, just don't miss a sale."],
'SafetyOverpressured2':  ["Pressure makes profits, and I've got plenty to apply.",
                        "High pressure means high performance!",
                        "Push past your limits, the company demands it.",
                        "I don't care if you break, just don't miss a sale."],
'SafetyOverpressured3':  ["Pressure makes profits, and I've got plenty to apply.",
                        "High pressure means high performance!",
                        "Push past your limits, the company demands it.",
                        "I don't care if you break, just don't miss a sale."],
'SafetyOverpressured4':  ["Pressure makes profits, and I've got plenty to apply.",
                        "High pressure means high performance!",
                        "Push past your limits, the company demands it.",
                        "I don't care if you break, just don't miss a sale."],
'SafetyOverpressured5':  ["Pressure makes profits, and I've got plenty to apply.",
                        "High pressure means high performance!",
                        "Push past your limits, the company demands it.",
                        "I don't care if you break, just don't miss a sale."],
'SafetyHighPressure':  ["This system has deviated beyond tolerance!",
                        "Instability is no longer acceptable.",
                        "This requires a full adjustment.",
                        "We're past minor corrections.",
                        "You've forced escalation!"],
'SafetyHeatWave': ["You're stoking the fire every time you hit me!",
                    "Feel the burn of my relentless drive!",
                    "This deal's heating up into a meltdown for you.",
                    "Keep pushing me, and I'll burn you out.",
...
'SafetyPromotion2': ["It's all about knowing who to throw under the bus.",
                    "I'll let my associate handle this one.",
                    "Step up, take the heat for your superior."],
'SafetyPromotion3': ["It's all about knowing who to throw under the bus.",
                    "I'll let my associate handle this one.",
                    "Step up, take the heat for your superior."],
'SafetyPromotion4': ["It's all about knowing who to throw under the bus.",
                    "I'll let my associate handle this one.",
                    "Step up, take the heat for your superior."],
'SafetyPromotion5': ["It's all about knowing who to throw under the bus.",
                    "I'll let my associate handle this one.",
                    "Step up, take the heat for your superior."],
'HustlerLimitedTimeOfferApprove': ["Excellent choice! A wise investment.",
                    "See? Following directions isn't so hard.",
                    "The market responds exactly as predicted!",
                    "You've made the right purchase."],
'HustlerLimitedTimeOfferDenied': ["You ignored my recommendation? That's bad business.",
                    "A shame. You could've saved yourself the trouble.",
                    "Some customers simply refuse to listen.",
                    "I practically handed you the answer."],
'HustlerSalesPitch': ["I've lowered your projections.",
                    "Allow me to manage those expectations.",
                    "You've been convinced, you just don't know it yet!",
                    "You've bought into my pitch already."],
'HustlerCustomerRetention': ["We value every client relationship.",
                    "Our support team has resolved all outstanding issues.",
                    "I'd hate to lose valuable business partners!",
                    "We're pleased to announce a 100% renewal rate!"],
'HustlerClosingTime': ["We're running out of business hours!",
                    "Let's pick up the pace!",
                    "The quarter ends soon!",
                    "Let's expedite this transaction.",
                    "Move it! I've got numbers to hit!"],
'HustlerBaitAndSwitch': ["That's not what you thought you were buying is it?",
                    "What you ordered and what you received are two different things.",
                    "Surprise! That's premium packaging at work!",
                    "A little product substition would never hurt nobody, would it?"],
'HustlerExclusiveOffer': ["This opportunity is reserved for a valued customer.",
                    "You there! You've been specially selected!",
                    "You won't get another chance like this.",
                    "Consider yourself fortunate."],
'HustlerExclusiveOfferRetaliation': ["I handed you a winning strategy and you fumbled it.",
                    "You couldn't close a deal if I signed the contract for you.",
                    "I don't know whether to be disappointed or impressed.",
                    "I lowered the bar and you brought a shovel.",
                    "Imagine being given the answer and still getting it wrong."],
'HustlerHalfWindsor': ["Having second thoughts already?",
                    "Buyer's remorse is a natural part of the sales process.",
                    "No refunds.",
                    "You looked so confident a moment ago!",
                    "I hope you kept the receipt."],
                    # traffic manager
'TrafficDetour': ["Your intended route has been enthusiastically reassigned!",
                    "That path has been removed from your options. Permanently? We'll see.",
                    "Keep moving, just not where you intended."],
'TrafficCongestionPricing': ["Traffic conditions have changed, your options have not improved!",
                    "Soon you'll be navigating a dead end!",
                    "Infrastructure optimization is underway.",
                    "A perfect traffic system has no unnecessary movement."],
'TrafficRedLight': ["Stop, do not test what happens if you don't.",
                    "The signal is red, it is not a suggestion.",
                    "Motion has been revoked."],
'TrafficRedLightRetaliation': ["You moved during the red light, how unfortunate for you...",
                    "Violation confirmed, enforcement is no longer optional!",
                    "You should have stayed still, now you won't again."
                    "The system does not forgive interruptions to silence!"],
'TrafficGreenLight': ["Flow restored, do not mistake this for safety.",
                    "The road opens for you... briefly.",
                    "Proceed while you are still permitted to do so."],
'TrafficGreenLightRetaliation': ["Nothing tried to stop you, that will be corrected.",
                    "An unchallenged system becomes... bored.",
                    "You were left alone, that is an oversight I will address.",
                    "Enjoy the quiet, it will not last."],
'TrafficYield': ["You are not the priority here.",
                        "Aw, were you just about to do something?",
                        "Your request for advancement has been denied.",
                    "Someone else is coming through."],
#union buster cheats
'UnionBusterUnionDues': ["Unions are bad for business, and I'm here to shut yours down.",
                            "You can't fight the system without paying the price.",
                         "Long hours break bad habits.",
                            "So, you think you can organize? Not on my watch.",
                        "Unions slow productivity. I eliminate inefficiencies.",
                         "Paperwork filed. Your overtime is now mandatory."],
'UnionBusterNoStrikeClause': ["I'm adding a clause to your agreement.",
                            "You're not authorized to avoid this.",
                         "Stand still.",
                            "Compliance is mandatory."],
'UnionBusterUnionCalculator': [""],
'UnionBusterUnionBust': ["Time to thin the workforce.",
                        'Temporary positions come with risks.',
                        "You should've negotiated better terms.",
                        "You were never essential.",
                        "Consider this a corporate restructuring.",
                        'You were replaceable from day one.'],
'UnionBusterUnionBuster': ["Let's check your employment status.",
                             'Hope you like long hours!',
                             "You're on the clock indefinitely!",
                             "This is company policy.",
                             "This is what happens when you don't have representation.",
                             'This assignment never ends.'],
'UnionBusterUnionBusterDamage': ["again nothing here"],
'UnionBusterUnionWages': ["Unions think they deserve fair wages? I think not.",
                          "I'll pocket every paycheck before it reaches your hands!",
                            "You'll never see a paycheck, but you'll see my power!",
                          "I'll just redirect these wages into my power."],
'UnionBusterUnionWages2': ["Unions think they deserve fair wages? I think not.",
                          "I'll pocket every paycheck before it reaches your hands!",
                            "You'll never see a paycheck, but you'll see my power!",
                          "I'll just redirect these wages into my power."],
'UnionBusterUnionWages3': ["Unions think they deserve fair wages? I think not.",
                          "I'll pocket every paycheck before it reaches your hands!",
                            "You'll never see a paycheck, but you'll see my power!",
                          "I'll just redirect these wages into my power."],
'UnionBusterUnionWages4': ["Unions think they deserve fair wages? I think not.",
                          "I'll pocket every paycheck before it reaches your hands!",
                            "You'll never see a paycheck, but you'll see my power!",
                          "I'll just redirect these wages into my power."],
'UnionBusterUnionWages5': ["Unions think they deserve fair wages? I think not.",
                          "I'll pocket every paycheck before it reaches your hands!",
                            "You'll never see a paycheck, but you'll see my power!",
                          "I'll just redirect these wages into my power."],
'UnionBusterBreachOfContract': ["You are not the priority here.",
                        "Aw, were you just about to do something?",
                        "Your request for advancement has been denied.",
                    "Someone else is coming through."],
'UnionBusterBreachOfContract2': ["You are not the priority here.",
                        "Aw, were you just about to do something?",
                        "Your request for advancement has been denied.",
                    "Someone else is coming through."],
'UnionBusterBreachOfContract3': ["You are not the priority here.",
                        "Aw, were you just about to do something?",
                        "Your request for advancement has been denied.",
                    "Someone else is coming through."],
'UnionBusterBreachOfContract4': ["You are not the priority here.",
                        "Aw, were you just about to do something?",
                        "Your request for advancement has been denied.",
                    "Someone else is coming through."],
'UnionBusterContractEnforcement': ["A well-maintained workforce is an efficient workforce!",
                                "Damage is causing delays, I'll have that corrected immediately.",
                                "Can't have you breaking down during business hours!",
                                "Why is maintenance doing all the work around here?"],
'UnionBusterContractEnforcement2': ["A well-maintained workforce is an efficient workforce!",
                                "Damage is causing delays, I'll have that corrected immediately.",
                                "Can't have you breaking down during business hours!",
                                "Why is maintenance doing all the work around here?"],
#racketeer cheats
'RacketeerProfiteering': ["Consider this a corporate tax.",
                          "You're just another revenue stream.",
                            "I always take the lion's share.",
                          "Profits reinvested... directly into me."],
'RacketeerProfiteering2': ["Consider this a corporate tax.",
                          "You're just another revenue stream.",
                            "I always take the lion's share.",
                          "Profits reinvested... directly into me."],
'RacketeerProfiteering3': ["Consider this a corporate tax.",
                          "You're just another revenue stream.",
                            "I always take the lion's share.",
                          "Profits reinvested... directly into me."],
'RacketeerProfiteering4': ["Consider this a corporate tax.",
                          "You're just another revenue stream.",
                            "I always take the lion's share.",
                          "Profits reinvested... directly into me."],
'RacketeerProfiteering5': ["Consider this a corporate tax.",
                          "You're just another revenue stream.",
                            "I always take the lion's share.",
                          "Profits reinvested... directly into me."],
'RacketeerExtortion': ["Hand it over, I take what I'm owed.",
                       "Your health is my profit margin.",
                       "This isn't theft, it's a corporate collection.",
                       "I'll take my cut right out of your hide."],
'RacketeerExtortion2': ["I'm taking everything you owe!",
                       "Let's settle these accounts!",
                       "And that's why you don't stiff the boss.",
                       "Still standing? Impressive.",
                        "You're tougher than my usual clients.",
                        "Looks like you've got some liquidity left."],
'RacketeerCompensation': ["The more they suffer, the stronger they fight.",
                          "Pain is just capital, and I reinvest it.",
                         "I invest in weakness... and profit from strength.",
                          "I'll turn damage into dividends."],
'RacketeerHustling': ["You'll play by my rules, or not at all.",
                      "Consider this a restricted market.",
                      "I decide what sells in this battle.",
                      "I run this racket, your choices are mine to make.",
                      "The market's mine to control."],
'RacketeerRacketeering': ["I shut down businesses before they even start.",
                            "I just pulled your best seller off the shelves!",
                          "Your strategy just went bankrupt!",
                          "I'll corner the market until you're gagless!"],
'RacketeerPeckingOrderRetaliation': ["We're done with the petty ranks; now you answer directly to me!",
                                     "Hierarchy? Forget it. This is dominion.",
                                    "You're all beneath my jurisdiction. Completely.",
                                     "This is no longer a chain of command; this is a monopoly of power!",
                                     "Let me show you what real authority looks like!",
                                     "Do not provoke the birds, if you don't want to get pecked."],
'RacketeerPeckingOrderRetaliationSoak': ["This is just the 'burning' ambition catching up to you.",
...
'SafetySoakRetaliation': ["This is just the 'burning' ambition catching up to you.",
                                         "Unauthorized temperature adjustment detected!",
                                        "You just turned up the heat on yourself, Toons!",
                                         "Under pressure, I don't sweat, I ignite!",
                                         "Consider this a heated performance review.",
                                        "Feel the heat of corporate retaliation!"],
'RacketeerOverextendedLeverage': ["Welcome to my protection program!",
                                         "Everyone operating in my territory pays a fee.",
                                        "You're interfering with my business!",
                                  "Relax, it's just business!",
                                         "Do you know how long that took to build?"],
'RacketeerOverextendedLeverage2': ["Business is booming... maybe a little too much.",
                                         "This racket's getting bigger by the minute!",
                                        "Profits like this don't last forever.",
                                  "Things are getting unstable...",
                                   "This crash won't last!",
...
'RadiographerRadioInfrequency': ["Your big group shows won't reach full volume here.",
                                    ...
                                    "Static? Distortion? That's power where I come from.",
                                    "Your broadcast lost half its audience.",
                                    "Static always drowns out the message.",
                                    "Big attacks sound smaller through my frequency."],
'RadiographerHotTake': [
    "Breaking news: This Toon's under the spotlight!",
    "Ooooh, the audience is waiting for you to fail!",
    "You're live, try not to fall apart.",
    "Hot take: You're the main event... and the target.",
    "All eyes on you. Let's see how long you last."
],
'RadiographerHotTakeRetaliation': ["Your shadow still remembers how to hurt.",
                                     "See? Even broken things have value.",
                                    "What's crushed can still be used.",
                                     "Every strike leaves another shadow.",
                                    "Even after you break, there's residue left behind.",
                                   "Let the aftermath overwhelm you.",
                                     "You can't escape what you leave behind."],
'RadiographerOvermodulated': ["Turn it up, partner, the airwaves are yours!",
                    "Ooooh, didn't expect the encore, did you?",
                    "Double the broadcast, double the pain.",
                    "Let's see if the Toons can handle this broadcast.",
                    "I'm cranking your signal past safe levels!",
                    "Distortion makes for double the destruction!"],
'RadiographerOvermodulated2': ["Turn it up, partner, the airwaves are yours!",
                    "Ooooh, didn't expect the encore, did you?",
                    "Double the broadcast, double the pain.",
                    "Let's see if the Toons can handle this broadcast.",
                    "I'm cranking your signal past safe levels!",
                    "Distortion makes for double the destruction!"],
'RadiographerOvermodulated3': ["Turn it up, partner, the airwaves are yours!",
                    "Ooooh, didn't expect the encore, did you?",
                    "Double the broadcast, double the pain.",
                    "Let's see if the Toons can handle this broadcast.",
                    "I'm cranking your signal past safe levels!",
                    "Distortion makes for double the destruction!"],
'RadiographerOvermodulated4': ["Turn it up, partner, the airwaves are yours!",
                    "Ooooh, didn't expect the encore, did you?",
                    "Double the broadcast, double the pain.",
                    "Let's see if the Toons can handle this broadcast.",
                    "I'm cranking your signal past safe levels!",
                    "Distortion makes for double the destruction!"],
'RadiographerOvermodulated5': ["Turn it up, partner, the airwaves are yours!",
                    "Ooooh, didn't expect the encore, did you?",
                    "Double the broadcast, double the pain.",
                    "Let's see if the Toons can handle this broadcast.",
                    "I'm cranking your signal past safe levels!",
...
'DOLAInkDrain': ["Ya look a liddle drained, Toon.",
                                "Ya don't have an inkline of a chance!",
                                "Ya plans are goin' down the drain!",
                 "Ya hopes are diluted, Toon."],
'DOPRAmbushMarketing': ["It's no-not-not a pyramid sch-scheme, I sw-sw-swear!"],

#high roller phase 1
'HighRollerNoAttack': ["nothing"],
'HighRollerWheelSpin': "Wheel Spin!",
'HighRollerCommercialBreak': ["And... we're back!",
...
'HighRollerPuzzle': ["Alright, alright, let'ff get thoffe efftraff on ffet, baby doll. Bring 'em in.",
...
'HighRollerPuzzleBan': ["My memory iffn't aff good, but let'ff ffee if you can keep up.",
...
'HighRollerGameOver': ["Well, babe, let'ff not keep them waiting! HAHAHA!!!",
...
'HighRollerGameOver2': ["Well, babe, let'ff not keep them waiting! HAHAHA!!!",
                        "Come on, babe, FFHOW UFF THOFFE NUMBERFF!",
                        "Better hope for ffome HIGH ROLLERFF! HAHAHAHA!",
                        "Ready to find out which one of you iff really the weakefft link?!",
                        "WAFFN'T THAT FUN? Let'ff ffee how you did!"
                              ],
'HighRollerGameTimeSpawn': ["Ooo-well, ya know what they ffay: don't hate the Major Player, change the game!",
...
'HighRollerGameTimeCog': ["Pop a look for the camera ffhow, tell me haHAHAHAhow much ya know!",
...
'HighRollerGameTimeCog2': ["Pop a look for the camera ffhow, tell me haHAHAHAhow much ya know!",
                            "Peep your eyeff, we've got ffo much in fftore today for you!",
                            "I bet you're jufft burffting with knowledge! Let'ff find out.",
                            "Let'ff wrack thoffe ffilly brainff of yourff. Quick!"],
'HighRollerGameTimeCog3': ["Pop a look for the camera ffhow, tell me haHAHAHAhow much ya know!",
                            "Peep your eyeff, we've got ffo much in fftore today for you!",
                                "I bet you're jufft burffting with knowledge! Let'ff find out.",
                            "Let'ff wrack thoffe ffilly brainff of yourff. Quick!"],
'HighRollerGameTimeCog4': ["Pop a look for the camera ffhow, tell me haHAHAHAhow much ya know!",
                            "Peep your eyeff, we've got ffo much in fftore today for you!",
                            "I bet you're jufft burffting with knowledge! Let'ff find out.",
                            "Let'ff wrack thoffe ffilly brainff of yourff. Quick!"],
'HighRollerGameTimeCog5': ["Pop a look for the camera ffhow, tell me haHAHAHAhow much ya know!",
                            "Peep your eyeff, we've got ffo much in fftore today for you!",
                                "I bet you're jufft burffting with knowledge! Let'ff find out.",
                            "Let'ff wrack thoffe ffilly brainff of yourff. Quick!"],
'HighRollerGameTimeCog6': ["Pop a look for the camera ffhow, tell me haHAHAHAhow much ya know!",
                            "Peep your eyeff, we've got ffo much in fftore today for you!",
                            "I bet you're jufft burffting with knowledge! Let'ff find out.",
                            "Let'ff wrack thoffe ffilly brainff of yourff. Quick!"],
'HighRollerGameTimeCog7': ["Pop a look for the camera ffhow, tell me haHAHAHAhow much ya know!",
                            "Peep your eyeff, we've got ffo much in fftore today for you!",
                                "I bet you're jufft burffting with knowledge! Let'ff find out.",
                            "Let'ff wrack thoffe ffilly brainff of yourff. Quick!"],
'HighRollerGameTimeCog8': ["Pop a look for the camera ffhow, tell me haHAHAHAhow much ya know!",
                            "Peep your eyeff, we've got ffo much in fftore today for you!",
                            "I bet you're jufft burffting with knowledge! Let'ff find out.",
                            "Let'ff wrack thoffe ffilly brainff of yourff. Quick!"],
'HighRollerGameTimeCog9': ["Pop a look for the camera ffhow, tell me haHAHAHAhow much ya know!",
                            "Peep your eyeff, we've got ffo much in fftore today for you!",
                                "I bet you're jufft burffting with knowledge! Let'ff find out.",
                            "Let'ff wrack thoffe ffilly brainff of yourff. Quick!"],
'HighRollerGameTimeCog10': ["Pop a look for the camera ffhow, tell me haHAHAHAhow much ya know!",
                            "Peep your eyeff, we've got ffo much in fftore today for you!",
                            "I bet you're jufft burffting with knowledge! Let'ff find out.",
                            "Let'ff wrack thoffe ffilly brainff of yourff. Quick!"],
'HighRollerBust': ["No diffe, baby doll! You're cutting into our commerffial block!",
                    "Don't be ffhy, ffweetheart! You're FFUPPOFFED to uffe thoffe pipff!",
                    "Buffted ffuperfftar! I think you've got enouff of thoffe already!"],
# high roller phase 2
'HighRollerPhase3': ["phase 3"],
# high roller phase 3
'HighRollerRolled': ["There'ff no fun in plaHAHAying it ffafe! Live a little!",
...
'HighRollerFreeCruise': ["Watch your headff, folkff, thiff might rock your boat!",
...
'HighRollerConduction': ["Confuffion can go a long way, and thiff act iff no different.",
...
'HighRollerDiceRouletteCogs': ["Hoping we don't land of ffnake eyeff here, right folkff?",
                            "Where the diffe will land, nobody knowff--effept for me!",
                            "Pain iff ffhared equally between all participantff.",
...
'HighRollerDiceRouletteToons': ["Hoping we don't land of ffnake eyeff here, right folkff?",
                                "Where the diffe will land, nobody knowff--effept for me!",
                                "Pain iff ffhared equally between all participantff.",
                                "Lady Luck, you better be on my ffide tonight! Let'ff roll on it!",
                                "Everyone getff a piece of thiff! No FFuit or Toon left unharmed."],
'HighRollerDiceRouletteEveryone': ["Hoping we don't land of ffnake eyeff here, right folkff?",
                                "Where the diffe will land, nobody knowff--effept for me!",
                                "Pain iff ffhared equally between all participantff.",
                                "Lady Luck, you better be on my ffide tonight! Let'ff roll on it!",
                                "Everyone getff a piece of thiff! No FFuit or Toon left unharmed."],
                                'HighRollerDiceRouletteNobody': ["Hoping we don't land of ffnake eyeff here, right folkff?",
                                "Where the diffe will land, nobody knowff--effept for me!",
                                "Pain iff ffhared equally between all participantff.",
                                "Lady Luck, you better be on my ffide tonight! Let'ff roll on it!",
                                "Everyone getff a piece of thiff! No FFuit or Toon left unharmed."],
'HighRollerTrickOfTheLight': ["Every copy of me iff perffonalized.",
                                "One ffhowfftopper jufft iffn't enough! There needff to be more!"],
'HighRollerAceInTheHole': ["I'm a flying affe, fforaring in the fog! Prepare to be ffcared, babe.",
                            "You know, I've alwayff got an affe up my ffleeve! Ffee?",
                            ...
                            "Ffhrouded in mifft, you'll ffoon fee who'ff in control of the ffow now!"],
'HighRollerRaisingTheAnte': ['The night iff fftill young!',
                              'Raiffing the bar, raiffing the fftakeff, raiffing the tenffion, rAHAHAHAiffing the exffitement!',
                              "It ain't over jufft yet.",
                              "Come now, entertain me ffome more. I'm loving thiff!"],
#high roller silhouette cheats
'HighRollerDonation': ['The night iff fftill young!',
                                           "Mr. High Roller iffn't loffing at hiff own game.",
                                           "Thiff one'ff for you, Mr. High Roller!"],
'HighRollerSyphon': ["Let me remind you who'ff the fftar of the ffhow.",
                                         "You're fftealing the ffpotlight! Give it back!"],
'HighRollerBar': ["I'm getting uff all, bar none.",
                                      'You jufft activated my Trap card!',
                                      'Ha-HA! I got youffe where I want youffe!'],
'HighRollerBar2': ["I'm getting uff all, bar none.",
                                      'You jufft activated my Trap card!',
                                      'Ha-HA! I got youffe where I want youffe!'],
'HighRollerLureResistance': ["No no no, babe! You can't keep the audience asleep during MY ffhow!",
    "Hook, line, and ffinker? Not tonight, doll!",
    "Thiff actiff officially lure-proof! Better luck next ffegment!",
    "You think a little charm trick iff enough to fool a profeffional?",
    "No more cheap hypnotiffm in MY ffpotlight!",
    "The crowd wantff ACTION, not nap time!",
    "Forry, sweetheart, but my performerff don't fall for party trickff.",
    "No pulling the wool over THEIR eyeff anymore!",
    "Every good ffhow needff a little audience participation! Wake up, folkff!",
    "Aw, don't look ffo down, babe! You'll need a NEW gimmick now!"],
'HighRollerLureResistance2': ["No no no, babe! You can't keep the audience asleep during MY ffhow!",
    "Hook, line, and ffinker? Not tonight, doll!",
    "Thiff actiff officially lure-proof! Better luck next ffegment!",
    "You think a little charm trick iff enough to fool a profeffional?",
    "No more cheap hypnotiffm in MY ffpotlight!",
    ...
    "Every good ffhow needff a little audience participation! Wake up, folkff!",
    "Aw, don't look ffo down, babe! You'll need a NEW gimmick now!"],
'HighRollerSingingBlues': ["I think you're fftarting to get hoarffe, babe.",
                                               'Fighting takeff a lot out of ya, huh? Remember to breathe.'],
# 'HighRollerDamageReduction': ["I think you'll find thiff to be ffeverely cruffhing.",
...
'HighRollerDamageReduction': ["Whoopth! The desk got all thhuffled!",
                                                  ...
                                                  "The cardth have been resuffled."],
'HighRollerSplashback': ['Your chanffeff of winning are fflipping and ffliding away.',
                                             "'Water' ya think you're doing, doll? That won't work aff well aff you'd hope."],
'HighRollerCheerRetaliation': ["Hey, you're ffheering for the wrong team!",
                                                   'Your happineff iff getting a bit muffh, even for me. Pipe it down ffome.'],
'HighRollerVulnerable': ["WHAT A TWIFFT!!!"],
                    # universal cheats
    # Videographer Cheats
'VideographerRisingStars': ["Time for the supporting cast!",
                            "Every great production needs a bigger cast!",
                            "Cue my supporting actors.",
                            "You can't film a blockbuster without a crew!",
                            "Send in the stunt doubles; I don't do my own work.",
                            "You're outnumbered; just like bad reviews.",
                            "Every star needs an entourage."],
'VideographerRisingStars2': ["Time for the supporting cast!",
                            "Every great production needs a bigger cast!",
                            "Cue my supporting actors.",
                            "You can't film a blockbuster without a crew!",
                            "Send in the stunt doubles; I don't do my own work.",
                            "You're outnumbered; just like bad reviews.",
                            "Every star needs an entourage."],
'VideographerRisingStarsSacrifice': ["Cut, cut, CUT! You're out of the picture.",
                            "Your role's been slashed from the script.",
                            "Every flop needs to be recast.",
                            "No budget for extras, you're fired.",
                            "I'll cut the dead weight to make myself shine.",
                            "This scene only has room for one star, me.",
                            "You've served your purpose. Deleted.",
                            "I'll edit you out and keep the profits.",
                            "Your performance? Straight to the trash bin!"],
'VideographerRisingStarsSilhouette': ["I'll flood the screen with talent... mine!",
                                      "I'll just add another frame to the reel!",
                                      "Every production needs a stand-in!",
                                      "I'm duplicating the footage!",
                                      "The sequel's always bigger; here's the bigger cast."],
'VideographerVideoStatic': ["!"],
'VideographerHardCut': ["Let's try a different angle next take.",
                        "Time for a little editing magic!",
                        "Hold it! That shot needs a rewrite!",
                        "Let's keep this footage fresh.",
                        "This production runs on my direction.",
                        "Something about this footage isn't working..."],
'VideographerElectricShock': ["Time to make a star out of you yet!",
                            "Give 'em the spotlight, and make it blinding!",
                            "This extra just became the main act.",
                              "Pump up those production values!",
                              "It's not art, it's a blockbuster.",
                              "All eyes on you, kid. Don't disappoint!",
                            "You're my new headliner, don't blow it!"],
'VideographerElectricShock2': ["Time to make a star out of you yet!",
                            "Give 'em the spotlight, and make it blinding!",
                            "This extra just became the main act.",
                              "Pump up those production values!",
                              "It's not art, it's a blockbuster.",
                              "All eyes on you, kid. Don't disappoint!",
                            "You're my new headliner, don't blow it!"],
'VideographerElectricShock3': ["Time to make a star out of you yet!",
                            "Give 'em the spotlight, and make it blinding!",
                            "This extra just became the main act.",
                              "Pump up those production values!",
                              "It's not art, it's a blockbuster.",
                              "All eyes on you, kid. Don't disappoint!",
                            "You're my new headliner, don't blow it!"],
'VideographerElectricShock4': ["Time to make a star out of you yet!",
                            "Give 'em the spotlight, and make it blinding!",
                            "This extra just became the main act.",
                              "Pump up those production values!",
                              "It's not art, it's a blockbuster.",
                              "All eyes on you, kid. Don't disappoint!",
                            "You're my new headliner, don't blow it!"],
'VideographerAttackRewind': ["You just ruined my shot!",
                            "Do you know how much that extra cost?!",
                            "Nobody cuts my cast but me!",
                            "That Cog was under contract!",
                            "You just trashed the scene, now I'll trash you.",
                            "This isn't in the script!",
                            "You'll pay for messing up my production."],
'VideographerDeath': ["Ooo-well, ya know what they ffay: don't hate the Major Player, change the game!",
                        "I can jufft hear the crowd going wild for thiff intermiffion!",
                        "Let'ff get the hip hop ffhop right on top, a-one a-two-let'ff play true!",
                        "We'll be back after a ffhort break, but I'm ffure you'll fftay occupied in the meantime."],
'VideographerDirectorCuts': ["You're about to get notes from every angle.",
                             "A bigger team makes a bigger show!",
                             "You'll answer to the higher-ups now!",
                             "Time for the executive review!",
                             "My directors never miss a scene."],
    # Broadcaster Cheats
'BroadcasterDonation': ["A good production requires sacrifices!",
                            "Every masterpiece needs a generous cast!",
                            "Let's crowd-fund this comeback!",
                            "Light's camera... contribution!"],
'BroadcasterDonation2': ["A good production requires sacrifices!",
                            "Every masterpiece needs a generous cast!",
                            "Let's crowd-fund this comeback!",
                            "Light's camera... contribution!"],
...
'ChoreoChoreography': ["This is a performance, not a free-for-all!",
                            ...
                            "Keep up, or face the music!"],
    # Filmmaker Cheats
'FilmmakerCameraFlash': ["Blinded by the headlines!",
                            "You'll never see the story coming.",
                         "Caught in the spotlight, Toon?",
                         "That dazed look is perfect for my ratings.",
                            "Flash first, questions later."],
...
'DirectorCut': ["Cut!"],
'DirectorAction': ["Action!"],
'DirectorActionRetaliation': ["Prepare for pain."],
'DirectorBackToOnes': ["Back To Ones!"],
'ForemanUnionized': [ "Congratulations! You're all officially represented!",
                                "Mandatory cooperation is still cooperation.",
                                "Group bargaining? I control both sides."],
'ForemanContributing': ["To the Don!",
                                "In honor of my fallen allies.",
                                "Suits like us gotta look out for each other."],
'ForemanPolishing': ["I keep my team polished and running.",
                         "Oil is money, and I've got plenty of both.",
                            "You can't outlast a refined workforce.",
                            "Polishing my staff for peak performance.",
                            "You're company property, and I maintain my assets.",
                        "My staff shines brighter under my leadership."],
'ForemanExtortion': ["Hand it over, I take what I'm owed.",
                       "Your health is my profit margin.",
                       "This isn't theft, it's a corporate collection.",
                       "I'll take my cut right out of your hide."],
    'ForemanSnipe': ["Prepare for pain."],
    'ForemanRedTape': ['This should wrap things up.',
             "I'm going to tie you up for awhile.",
             "You're on a roll.",
             'See if you can cut through this.',
             'This will get sticky.',
             ...
             'Just try to unravel this.',
             'I want this meeting to stick with you.'],
    'ForemanBurning': ["Allow me to turn up the heat.",
                              "Now we're cooking with gas.",
                              "Are you feeling the heat yet, Toon?",
                              "Looks like this battle is going up in smoke!",
                              "Can't take the heat?"],
    'ForemanCompensation': ["Do you have any idea how much paperwork I will have to file after this?"],
    'ForemanCompensation2': ["Do you have any idea how much paperwork I will have to file after this?"],
    'ForemanCompensation3': ["Do you have any idea how much paperwork I will have to file after this?"],
    'ForemanCompensation4': ["Do you have any idea how much paperwork I will have to file after this?"],
    'ForemanCompensation5': ["Do you have any idea how much paperwork I will have to file after this?"],
    'MintLifeInsurance': ["While I still have assets, I am insured."],
    'MintUsury': ["These rates are astronomical!",
                                "Consider this a fiscal 'black hole', if ya will.",
                                "Ya gonna be light-years away from paying your debts."],
    'MintPolicyTerminated': ["While I still have assets, I am insured."],
    'MintFraudulentDamage': ["While I still have assets, I am insured."],
    'MintAbacusAbove15': ["Your attacks will now be counted toward my correction cycle. Threshold: Above 15 gag levels."],
    'MintAbacusBelow15': ["Your attacks will now be counted toward my correction cycle. Threshold: Below 15 gag levels."],
    'MintCompoundingInterest': ["Might need to consider taking out a second loan, Toon.",
            "Money makes the man, as I unmake you, Toon.",
            "The house is coming down on you, Toon.",
            "Anybody tells you that money is the root of all evil doesn't have any.",
           "Deadlines, deadlines, deadlines, Toon. Can you keep up the pace?"],
     'MintScheming': ["It's not a pyramid scheme, I swear!"],
    'MintAccountant1': ["Attention: I'm now logging Suits that I manage to 'account for'. Quota: 1 Target."],
    'MintAccountant2': ["Attention: I'm now logging Suits that I manage to 'account for'. Quota: 2 Targets."],
    'MintAccountant3': ["Attention: I'm now logging Suits that I manage to 'account for'. Quota: 3 Targets."],
    'MintAccountant4': ["Attention: I'm now logging Suits that I manage to 'account for'. Quota: 4 Targets."],
    'MintAccountant5': ["Attention: I'm now logging Suits that I manage to 'account for'. Quota: 5 Targets."],
    'MintApprove': ["Congratulations! You did it.",
                    "Everybody is so proud of you.",
                    "You're giving Brian a run for his money.",
                    "This math DOES add up!"],
    'MintDisapprove': ["According to my calculations, you're in trouble.",
                    "Not everyone can be as gifted as I am.",
                    "This math doesn't quite add up.",
                    "Unfortunate."],
    'MintHurrySickness': ["I think you got that one wrong, unfortunately."],
    # 'MintMovingGoalposts': ["Please don't use that gag against me: it'll hurt you I think?",
    #                     "I don't think you got the upperhand, unfortunately...",
    #                     "This might increase the difficulty...",
    #                     "Am I the source of your destruction?",
    #                     "You might be in the danger zone!"],
 'MintMovingGoalposts': ["Wait, isn't this the name of a core mechanic rather than an ability?",
                        "This is the actual correct order... I think.",
                        "Want to see a magic trick?",
                        "I don't think you're really paying attention."],
'MintLureResistance': ["Nobody leaves the line while I'm supervising. Stay focused, and ignore the bait.",
    "This Mint runs on discipline, not daydreams. Shake it off!",
    "Remain at your stations. Any Cog caught wandering will answer to me.",
    "The Toons are trying to stall production, don't fall for it."],
'MintLureResistance2': ["Nobody leaves the line while I'm supervising. Stay focused, and ignore the bait.",
    "This Mint runs on discipline, not daydreams. Shake it off!",
    "Remain at your stations. Any Cog caught wandering will answer to me.",
    "The Toons are trying to stall production, don't fall for it."],
'MintSynergy': ["I'm taking this to committee.",
             "Your project's been cancelled.",
             "Your budget's been cut.",
             "We're restructuring your division.",
             'I put it to a vote, and you lose.',
             ...
             "Let's get right to business.",
             'Consider this a Synergy crisis.'],
'MintLedger': ["Careful, you're striking the bell itself.",
                             "The toll cuts both ways.",
                            "The ledger records strain, not strength.",
                            "You've found a pressure point."
                      ],
'MintAudit': ["Alright, let's go through this again...",
                              "Audits are cyclical for a reason.",
                              "Nothing resets; It accumulates.",
                            "The longer this runs, the clearer it gets."],
'AttorneyDizzy': ["The record's becoming unclear; allow me to tidy it up.",
                            "Ah there it is. Confusion, the purest form of silence.",
                            "When words blur together, clarity becomes optional.",
                            "The wind carries away intent, and what remains is only error.",
                            "Consider this an editorial correction, one you won't soon forget.",
                        ...
                        "A few misplaced pages should make things more... unpredictable."],
'AttorneyObjection': {
    'ovt': ["Objection! The plaintiffs can use combo damage, but I don't think I can."],
    None: ["Objection! Why can the plaintiff utilize combo damage when we, the defendants, cannot?"]},
'AttorneyObjectionSustained': {
    'ovt': ["I guess I have a counter argument."],
    None: ["Now for my counter argument."]},
'AttorneyObjectionOverruled': {
    'ovt': ["Oh, I guess I was just confused."],
    None: ["Unbelievable."]},
'AttorneyRushJob': ["Eyes on the prize!",
                        "Think fast!",
                        "Pump up those reflexes!",
                        "Follow the groove!"],
                        'RushJobTrap': {
                                 'hustle': ["Act now! This opportunity won't last forever!",
                                 "Use this recommended product, or miss out entirely!",
                                 "I've already done the market research for you!",
                                 "This offer expires at the end of the turn!"],
                                None:["Eyes on the prize!",
                        "Think fast!",
                        "Pump up those reflexes!",
                        "Follow the groove!"]},
                        'RushJobLure': {
                        ...
                        "Pump up those reflexes!",
                        "Follow the groove!"]},
'AttorneyRemand': ["I'm taking this opportunity to sequester my client."],
'AttorneyDrainingPower': ["How refreshing.",
                        "One Toon's ink is another Cog's fuel.",
                        "Your drain is my gain!"],
'AttorneyInkDrain': ["You don't have an inkling of a chance!",
                        "You look a little drained, Toon.",
                        "Your hopes are diluted, Toon.",
                        "Your plans are going down the drain!"],
'AttorneyChrono': ["Think fast!",
                    "Move it!",
                    "You've gotta be quicker than that!",
                    "Step on it!",
                    "Hurry it up!"],
'AttorneyHurrySickness': ["Dizzy yet?",
                        "Time's up!",
                        "You managed to make me disappointed.",
                        "I am barely breaking a sweat."],
'AttorneyShakedownCooldown': ["Let's shake things up.",
...
'AttorneyShakedownVulnerable': ["Let's shake things up.",
                    "Maybe this'll shake some sense into ya.",
                    "Ya look a little shaken up, Toon.",
                    "No one ever gave ya the rundown on how this place works, ey?"],
'WhistleCompensation': ["It's coming out of your paycheck, Toon."],

'LiquidatorOilRain': ["Does this remind you of anyone?",
                      "You Toons are real roustabouts."],
'LiquidatorTornado': ["I hope you like turbulence.",
                      "I can do this all day, unfortunately.",
                      "Can't tell which way's up now, can you?",
                      "You feel that pressure building?",
                      "This job? It makes storms like this."],
'LiquidatorFreezingRain': ["Why don't you Toons take a chill pill?",
                      "I hope you weren't expecting sunshine."],
'LiquidatorHeavyRain': ["I'm not crying, you're crying!",
                      "Water, water, everywhere!"],
'LiquidatorHeavyRainDamage': ["I think this is called 'delayed physical aggression.'",
                      "I'm only going to hit back as hard as you do!"],
'LiquidatorStormCell': ["I heard you Toons like roughhousing, can I play too?",
                      "I can weather the storm, Toons."],
'LiquidatorStormCellDamage': ["I bet this one will 'shock' you! See, I can make puns too.",
                                ...
                                "Look at what you've made me do! Now we're all going to suffer.",
                                "I didn't join this company to hurt you!",
                                "I invite you to play Ip Dip, and this is how you treat me?!",
                                "It's fight-or-flight time, and I've got fight left in me... Yeah!",
                                "I guess you could consider this a 'bolt from the blue.'"],
'LiquidatorInversion': ["You should really invert that frown... Or, you know, however that saying goes.",
                        "We all need a little healing sometimes."],
'LiquidatorMonsoon': ["I really wish I could just disappear right now.",
                        "Do you feel invisible sometimes?"],
'DividendZapRetaliation': [ "The market has it's eyes on me!",
                            "High risk, higher returns.",
                            "My portfolio is drawing quite the attention.",
                            "A true investor knows when to double down!"],
'DividendPeckingOrder': ["Let's see how much power these circuits can handle!",
                              "I'm pushing my workforce beyond it's limits!",
                              "Feel the power coursing through your circuits!",
                              "Consider this a company-wide investment.",
                            "I'm redirecting power to my workforce!"],
'DividendPeckingOrderZapped': ["Let me correct that imbalance.",
                              "Funds require proper management.",
                              "I believe that belongs in executive hands!",
                            "Hard to focus when you're losing value, isn't it?",
                              "Try thinking straight without resources!",
                               "I've improved your portfolio.",
                              "You were mismanaging it anyway."],
'DividendLiquidationEvent': ["We're entering a liquidation phase!",
                              "Non-performing holdings must be reduced.",
                              "This won't be immediate, but it will be thorough.",
                            "Let's strip this down to value!",
                              "It's amazing how quickly value disappears!",
                             "Collapse is most elegant when paced!",
                              "Struggle all you like, the market always closes."],
'DividendTotalMarketMeltdown': ["We are restructuring immediately!",
                              "No more shared exposure!",
                              "Broad spending is no longer permitted!",
                            "Didn't you hear the announcement?",
                              "You can't rely on collective leverage.",
                             "If I can't control the market, I'll crush it!",
                              "Struggle all you like, the market always closes."],
'DividendTotalMarketMeltdown2': ["We are restructuring immediately!",
                              "No more shared exposure!",
                              "Broad spending is no longer permitted!",
                            "Didn't you hear the announcement?",
                              "You can't rely on collective leverage.",
                             "If I can't control the market, I'll crush it!",
                              "Struggle all you like, the market always closes."],
'RecordkeeperRevisedFiling': ["Now everyone can see you properly.",
...
'RecordkeeperRedlinedClause': ["This is temporary... though I doubt you'll last that long.",
                              "I'm afraid that action is temporarily suspended.",
                               ...
                               "There's a restriction here you failed to notice.",
                            "You don't qualify anymore."],
'RecordkeeperAuditCycle': ["Alright, let's go through this again...",
                              "Audits are cyclical for a reason.",
                              "Nothing resets; It accumulates.",
                            "The longer this runs, the clearer it gets."],

'RecordkeeperMinutesTaken': ["Everything you've done has been documented.",
                              "The documentation is quite extensive.",
                              "These files paint quite a picture!",
                              "Nothing escapes documentation!",
                              "Your history is catching up with you.",
                            "The records speak for themselves."],
'RecordkeeperMinutesTakenContingency': ["Your violations have become required reading.",
                              "The evidence no longer fits on paper alone.",
                              "This case needed an entire volume.",
                            "The books are especially damning."],
'RecordkeeperMinutesTakenDamage': ["You've run the clock far too long.",
                              "Let's see what all that time is going to cost you.",
                              "Alright, I've waited long enough!",
                            "Each one of these minutes matters."],
'RecordkeeperPaperTrail': ["That's strange... you appear twice in my files.",
                              "One of these entries doesn't belong.",
                              "Which one of you is the correct version?",
                                "You look confused, that's appropriate.",
                            "You'd be amazed what follows people around."],
'RecordkeeperPhantomEntrySpawn': ["I prefer to audit from multiple angles.",
                              "Mirrored documentation reduces error.",
                              "You'll find we are quite thorough.",
                                  "Redundancy ensures compliance.",
                                  "Accuracy improves with replication.",
                            "Some entries refuse to stay singular."],
'ButcherRevvingUp': ["DAMAGE TO SHELL IDENTIFIED. RETALIATION WILL BE MET WITH EQUAL FORCE.",
                              "OUTER LAYERS AT RISK. TAKING DEFENSIVE ACTION.",
                              "THREATS HAVE BEGUN TO ADVANCE. BEGIN INCREASING ATTACK POWER."],
'ButcherRevvingUpWhipsaw': ["DAMAGE TO SHELL IDENTIFIED. RETALIATION WILL BE MET WITH EQUAL FORCE.",
                              "OUTER LAYERS AT RISK. TAKING DEFENSIVE ACTION.",
                              "THREATS HAVE BEGUN TO ADVANCE. BEGIN INCREASING ATTACK POWER."],
'ButcherOffboarding': ["IRREPARABLE DAMAGE TO EMPLOYEE SUSTAINED. REDIRECTING USEFULNESS.",
...
'ButcherOffboarding2': ["IRREPARABLE DAMAGE TO EMPLOYEE SUSTAINED. REDIRECTING USEFULNESS.",
                        "DAMAGED EMPLOYEE IS NO LONGER OF VALUE TO THE COMPANY.",
                        "OFFENSIVE INACTION ANALYZED. REDUCING PROBABILITY OF TREND CONTINUATION.",
                        "ANOMALOUS TARGETING OBSERVED. REDIRECTION OF AGGRESSION SEQUENCE INITIATED.",
                        "PROJECTIONS WILL BE EXCEEDED ON CURRENT TRAJECTORY. ACTIVATING EXPENSE REDUCTION PROTOCOL.",
...
'ButcherOffboarding3': ["IRREPARABLE DAMAGE TO EMPLOYEE SUSTAINED. REDIRECTING USEFULNESS.",
                        "DAMAGED EMPLOYEE IS NO LONGER OF VALUE TO THE COMPANY.",
                        "OFFENSIVE INACTION ANALYZED. REDUCING PROBABILITY OF TREND CONTINUATION.",
                        "ANOMALOUS TARGETING OBSERVED. REDIRECTION OF AGGRESSION SEQUENCE INITIATED.",
                        "PROJECTIONS WILL BE EXCEEDED ON CURRENT TRAJECTORY. ACTIVATING EXPENSE REDUCTION PROTOCOL.",
...
'ButcherOffboarding4': ["IRREPARABLE DAMAGE TO EMPLOYEE SUSTAINED. REDIRECTING USEFULNESS.",
                        "DAMAGED EMPLOYEE IS NO LONGER OF VALUE TO THE COMPANY.",
                        "OFFENSIVE INACTION ANALYZED. REDUCING PROBABILITY OF TREND CONTINUATION.",
                        "ANOMALOUS TARGETING OBSERVED. REDIRECTION OF AGGRESSION SEQUENCE INITIATED.",
                        "PROJECTIONS WILL BE EXCEEDED ON CURRENT TRAJECTORY. ACTIVATING EXPENSE REDUCTION PROTOCOL.",
...
'ButcherOffboarding5': ["IRREPARABLE DAMAGE TO EMPLOYEE SUSTAINED. REDIRECTING USEFULNESS.",
                        "DAMAGED EMPLOYEE IS NO LONGER OF VALUE TO THE COMPANY.",
                        "OFFENSIVE INACTION ANALYZED. REDUCING PROBABILITY OF TREND CONTINUATION.",
                        "ANOMALOUS TARGETING OBSERVED. REDIRECTION OF AGGRESSION SEQUENCE INITIATED.",
                        "PROJECTIONS WILL BE EXCEEDED ON CURRENT TRAJECTORY. ACTIVATING EXPENSE REDUCTION PROTOCOL.",
...
'ButcherMarkedWood': ["OFFENSIVE ANOMALY HAS BEEN DETECTED, PUNISHING FROM POINT OF GREATEST RESISTANCE.",
...
'ButcherAggrandize': ["FODDER HAS SURVIVED, ADMIRABLE ACTION REWARDED.",
                        "ADDITIONAL SUPPORT EXTENDED TO DAMAGED EMPLOYEE.",
                        "SOLE FODDER DETECTED, PROVIDING WITH INCREASED FURNISHINGS.",
                        "UNSUPPORTED EMPLOYEE HAS BEEN PROMOTED.",
                      ],
'ButcherAggrandize2': ["FODDER HAS SURVIVED, ADMIRABLE ACTION REWARDED.",
                        "ADDITIONAL SUPPORT EXTENDED TO DAMAGED EMPLOYEE.",
                        "SOLE FODDER DETECTED, PROVIDING WITH INCREASED FURNISHINGS.",
                        "UNSUPPORTED EMPLOYEE HAS BEEN PROMOTED.",
                      ],
'ButcherAggrandize3': ["FODDER HAS SURVIVED, ADMIRABLE ACTION REWARDED.",
                        "ADDITIONAL SUPPORT EXTENDED TO DAMAGED EMPLOYEE.",
                        "SOLE FODDER DETECTED, PROVIDING WITH INCREASED FURNISHINGS.",
                        "UNSUPPORTED EMPLOYEE HAS BEEN PROMOTED.",
                      ],
'ButcherAggrandize4': ["FODDER HAS SURVIVED, ADMIRABLE ACTION REWARDED.",
                        "ADDITIONAL SUPPORT EXTENDED TO DAMAGED EMPLOYEE.",
                        "SOLE FODDER DETECTED, PROVIDING WITH INCREASED FURNISHINGS.",
                        "UNSUPPORTED EMPLOYEE HAS BEEN PROMOTED.",
                      ],
'ButcherAggrandize5': ["FODDER HAS SURVIVED, ADMIRABLE ACTION REWARDED.",
                        "ADDITIONAL SUPPORT EXTENDED TO DAMAGED EMPLOYEE.",
                        "SOLE FODDER DETECTED, PROVIDING WITH INCREASED FURNISHINGS.",
                        "UNSUPPORTED EMPLOYEE HAS BEEN PROMOTED.",
                      ],
'ButcherSparkPlug': ["FALLBACK PROCEDURE ACTIVATED.",
                    "OTHER ACTIONS UNAVAILABLE.",
                      ],
'ButcherScabbard': ["DECREASED OFFENSIVE PUSH AGAINST FODDER DETECTED.",
                        "OVERFLOW OF ASSETS NOTICED.",
                      ],
'ButcherLayoffs': ["MASS PRODUCTION OF TERMINATION NOTICES REQUESTED.",
                    "UNDERPERFORMING DIVISIONS WILL BE ELIMINATED AT-WILL.",
                      ],
'TollmasterMandatoryToll': ["This is mandatory, you will pay it, whether you prepared for it or not.",
                    "Every crossing has a cost, this one is non-negotiable.",
                            "Did you think you could pass without paying?",
                            "The toll is due, and I'm collecting."
                      ],
'TollmasterMandatoryTollFinal': ["You've delayed long enough, I will take what is owed.",
                    "The longer you linger, the higher the price becomes.",
                            "All debts mature eventually, yours has reached its limit.",
                            "You should've settled earlier."
                      ],
'TollmasterResonanceTax': ["You've increased my portfolio.",
                    "Such loyalty, even in death!",
                            "Do you feel that? That's leverage.",
                            "The higher the position, the greater the gain!",
                           "Every casualty pays dividends.",
                           "You're liquidating into my hands!"
                      ],
'TollmasterResonanceTax2': ["You've increased my portfolio.",
                    "Such loyalty, even in death!",
                            "Do you feel that? That's leverage.",
                            "The higher the position, the greater the gain!",
                           "Every casualty pays dividends.",
...
'TollmasterResonanceTax3': ["You've increased my portfolio.",
                    "Such loyalty, even in death!",
                            "Do you feel that? That's leverage.",
                            "The higher the position, the greater the gain!",
                           "Every casualty pays dividends.",
...
'TollmasterResonanceTax4': ["You've increased my portfolio.",
                    "Such loyalty, even in death!",
                            "Do you feel that? That's leverage.",
                            "The higher the position, the greater the gain!",
                           "Every casualty pays dividends.",
...
'TollmasterResonanceTax5': ["You've increased my portfolio.",
                    "Such loyalty, even in death!",
                            "Do you feel that? That's leverage.",
                            "The higher the position, the greater the gain!",
                           "Every casualty pays dividends.",
...
'TollmasterMissedPayment': ["Unscathed? Then you owe the first toll.",
                    "The gate opens only after payment.",
                            "Every gatekeeper collects.",
                            "You should've arrived prepared to pay.",
                            "The bell takes what is owed."
                      ],
'TollmasterRushHour': ["Everyone pays more when the roads are crowded.",
                    "You should have arrived earlier.",
                            "The busiest hours are the most profitable.",
                            "Congestion benefits the gatekeeper.",
                            "You arrived at the worst time."
                      ],
'TollmasterLedgerOfSound': ["Careful, you're striking the bell itself.",
                             "The toll cuts both ways.",
                            "The ledger records strain, not strength.",
                            "You've found a pressure point."
                      ],
'TollmasterBalanceTheLedger': ["This account has grown inefficient.",
                    "The ledger grows heavier with each toll.",
                            "You're contributing more than you realize.",
                            "This record will follow you."
                      ],
'TollmasterBalanceTheLedger2': ["This account has grown inefficient.",
                    "The ledger grows heavier with each toll.",
                            "You're contributing more than you realize.",
                            "This record will follow you."
                      ],
'TollmasterBalanceTheLedger3': ["This account has grown inefficient.",
                    "The ledger grows heavier with each toll.",
                            "You're contributing more than you realize.",
                            "This record will follow you."
                      ],
'TollmasterBalanceTheLedger4': ["This account has grown inefficient.",
                    "The ledger grows heavier with each toll.",
                            "You're contributing more than you realize.",
                            "This record will follow you."
                      ],
'TollmasterBalanceTheLedger5': ["This account has grown inefficient.",
                    "The ledger grows heavier with each toll.",
                            "You're contributing more than you realize.",
                            "This record will follow you."
                      ],
 'ContingencySelfRepair': [
        "A proper contingency plan accounts for operational setbacks!",
        "Did you really think I came unprepared for this scenario?",
        "Every risk has a backup procedure in place!",
        "The Board does not tolerate unstable investments!",
        "Emergency reserves authorized. Resuming operations.",
        "Damage projections exceeded acceptable margins. Corrective measures deployed.",
        "I always allocate additional resources for worst-case outcomes!",
        "Operational continuity has been restored.",
    ],
'ContingencyFailsafeProtocol': ["This situation is now back under my authority!",
                    "You've reached the limit of tolerance!",
...
'ContingencyRiskThresholdBreach75': ["You've exceeded acceptable risk!",
                    "Excess liabilities will be removed.",
                                 ...
                                 "Sacrifice is simply accounting.",
                      ],
'ContingencyRiskThresholdBreach50': ["Your progress funds my response.",
...
'ContingencyRiskThresholdBreach': ["This scenario just escalated.",
                    "You've crossed a line.",
                                 ...
                                 "Containment protocols expanding.",
                                 "This board approves escalation!",
                      ],
'ContingencyRiskThresholdBreach25': ["I'm done preserving you!",
                    "You're already failing, I don't need to rush any further.",
                                 "You forced my hand, now suffer the grip!",
                                     "You should've stopped a long time ago, Toons!",
                                 "Every safeguard exists because of threats like you!",
                      ],
'ContingencyContingencyClause': ["I've accounted for every scenario.",
                    "This clause is non-negotiable.",
                                 "Prepare to operate under new terms.",
                                     "You are now operating under my conditions, Toons.",
                                 "Rules are now adjusted... in my favor!",
                      ],
'ContingencyContingencyClauseRetaliation': ["Unfortunate.",
                    "I don't overlook violations!",
                                 "Compliance is learned through pain!",
                                     "You're exhausting my patience!",
                                 "Unacceptable.",
                      ],
'ContingencyForecastCollapse': ["I'll maintain control where it is necessary!",
                    "Consider this reinforcement mandatory.",
                                 "Do not falter under my supervision!",
                                     "Your function continues... under my command!",
                                 "You owe your continued function to my oversight!",
                                  "Failure is not an option while I oversee it!",
                      ],
'ContingencyRedundantAuthority': ["I'll redistribute resources... my own if necessary.",
                    "Your function is more important than my comfort.",
                                 "Hierarchy must be preserved!",
                                     "I absorb the cost, you continue the work.",
                                 "Dependence is unavoidable!",
                                  "I do what is necessary for control.",
                      ],
'ContingencyOperationalFreeze': ["I've made a few adjustments.",
                    "Your priorities have been reassigned.",
                                 "Flexibility is a cornerstone of success.",
                                 "I determine what moves and when.",
                                     "A good contingency covers every possibility!",
                                 "Predictability is a weakness!",
                                 "You are constrained by my order!",
                      ],
'PresidentMandatoryFiling': ["You don't evade procedure.",
                               "There's no sidestepping this.",
                               "Once it's filed, it cannot be undone."],
'PresidentSensational': ["Babe, I'm passing this verse to you; you know what to skibidibbi-do!",
                               "Spotlight's on you, Baby Blue!",
                               "You haven't seen anything yet, babe! Listen to this!",
                               "Time for a swingin' solo! Take it away, Joe!"],
'PresidentLiability': ["Mmmph... that one.",
                               "Mm-hmm... you...",
                               "Mmm... yeah. You.",
                         "Hmph... don't move.",
                         "Mmmph... that's yours."],
'PresidentLiability2': ["You want pressure?!",
                               "You asked for this!",
                               "You don't survive once you're flagged!",
                         "I'll bury you in penalties!",
                         "I don't clear liabilities. I erase them!"],
'PresidentDeepFreeze': ["Y'know what? It's 'bout time you take a chill pill.",
...
'PresidentSnipe': ["Prepare for pain."],
'PresidentSyphon': ["Hand it over, I take what I'm owed.",
                       "Your health is my profit margin.",
                       "This isn't theft, it's a corporate collection.",
                       "I'll take my cut right out of your hide."],
'PresidentSnap': ["This may hurt a little, but what comes next will hurt a lot.",
                        "I've had enough with you!",
                        "These chompers could cut out diamonds!",
                        "My colleagues don't like it when I get snappy."],
'PresidentHighStakes': ["Let's raise the stakes, shall we?",
                        "Hope you're feeling lucky, Toons, your damage is on the table.",
                        "In my club, every hit's a gamble. Time to up the ante.",
                        "Fortune favors the bold, unfortunately, you're Toons."],
'PresidentMulligan': ['I certainly will take a mulligan.',
                        "Let's try this again.",
                        "I won't let you dodge that.",
                        "That last shot didn't go the way I wanted it to.",
                        'Let me just make this quick adjustment...'],
    'PresidentExtraTip': ["You've done great work today. Here's an extra tip."],
    'PresidentExtraTip2': ["You've done great work today. Here's an extra tip."],
    'PresidentExtraTip3': ["You've done great work today. Here's an extra tip."],
    'PresidentExtraTip4': ["You've done great work today. Here's an extra tip."],
    'PresidentExtraTip5': ["You've done great work today. Here's an extra tip."],
    'PresidentExtraTip6': ["You've done great work today. Here's an extra tip."],
    'PresidentDriver': ["You're not up to par.",
            'Fore!',
            "I'm getting teed off.",
            "Caddie, I'll need my driver!",
            'Just try and avoid this hazard.',
            ...
            'Mind if I play through?'],
    # Universal Cheats
'SynergyFees': ["Litigation is expensive, can you pay the price?",
...
'BanLevel45': {
    ...
    'ubuster': ["Per company policy, Level 4 and 5 Gags are now in violation of contract agreements."],
    'cdirector': ["Level 4 and 5 Gags have been removed from approved operations."],
...
'BanLevel46': {
    ...
    'ubuster': ["Per company policy, Level 4 and 6 Gags are now in violation of contract agreements."],
    'cdirector': ["Level 4 and 6 Gags have been removed from approved operations.",],
...
'BanLevel47': {
    ...
    'ubuster': ["Per company policy, Level 4 and 7 Gags are now in violation of contract agreements."],
    'cdirector': ["Level 4 and 7 Gags have been removed from approved operations.",],
...
'BanLevel48': {
    ...
    'ubuster': ["Per company policy, Level 4 and 8 Gags are now in violation of contract agreements."],
    'cdirector': ["Level 4 and 8 Gags have been removed from approved operations.",],
...
'BanLevel56': {
    ...
    'ubuster': ["Per company policy, Level 5 and 6 Gags are now in violation of contract agreements."],
    'cdirector': ["Level 5 and 6 Gags have been removed from approved operations.",],
...
'BanLevel57': {
    'wtapper': ["Intercepted and denied... Level 5 and 7 Gags are dead weight."],
     'ubuster': ["Per company policy, Level 5 and 7 Gags are now in violation of contract agreements."],
    'cdirector': ["Level 5 and 7 Gags have been removed from approved operations.",],
...
'BanLevel58': {
    'wtapper': ["Intercepted and denied... Level 5 and 8 Gags are dead weight."],
     'ubuster': ["Per company policy, Level 5 and 8 Gags are now in violation of contract agreements."],
    'cdirector': ["Level 5 and 8 Gags have been removed from approved operations.",],
...
'BanLevel67': {
    ...
    'ubuster': ["Per company policy, Level 6 and 7 Gags are now in violation of contract agreements."],
    'cdirector': ["Level 6 and 7 Gags have been removed from approved operations.",],
...
'BanLevel68': {
    ...
    'ubuster': ["Per company policy, Level 6 and 8 Gags are now in violation of contract agreements."],
    'cdirector': ["Level 6 and 8 Gags have been removed from approved operations.",],
...
'BanLevel78': {
    ...
    'ubuster': ["Per company policy, Level 7 and 8 Gags are now in violation of contract agreements."],
    'cdirector': ["Level 7 and 8 Gags have been removed from approved operations.",],
...
'BanToonupTrap': {
    ...
    'cdirector': ["Toon-Up and Trap Gags have been removed from approved operations.",],
...
'BanToonupLure': {
    ...
    'cdirector': ["Toon-Up and Lure Gags have been removed from approved operations.",],
...
'BanToonupThrow': {
    ...
    'cdirector': ["Toon-Up and Throw Gags have been removed from approved operations.",],
...
'BanToonupSquirt': {
    ...
    'cdirector': ["Toon-Up and Squirt Gags have been removed from approved operations.",],
...
'BanToonupZap': {
    ...
    'cdirector': ["Toon-Up and Zap Gags have been removed from approved operations.",],
...
'BanToonupSound': {
    ...
    'cdirector': ["Toon-Up and Sound Gags have been removed from approved operations.",],
...
'BanToonupDrop': {
    ...
    'cdirector': ["Toon-Up and Drop Gags have been removed from approved operations.",],
...
'BanTrapLure': {
    ...
    'cdirector': ["Trap and Lure Gags have been removed from approved operations.",],
...
'BanTrapThrow': {
    ...
    'cdirector': ["Trap and Throw Gags have been removed from approved operations.",],
...
'BanTrapSquirt': {
    ...
    'cdirector': ["Trap and Squirt Gags have been removed from approved operations.",],
...
'BanTrapZap': {
    ...
    'cdirector': ["Trap and Zap Gags have been removed from approved operations.",],
...
'BanTrapSound': {
    ...
    'cdirector': ["Trap and Sound Gags have been removed from approved operations.",],
...
'BanTrapDrop': {
    ...
    'cdirector': ["Trap and Drop Gags have been removed from approved operations.",],
...
'BanLureThrow': {
    ...
    'cdirector': ["Lure and Throw Gags have been removed from approved operations.",],
...
'BanLureSquirt': {
    ...
    'cdirector': ["Lure and Squirt Gags have been removed from approved operations.",],
...
'BanLureZap': {
    ...
    'cdirector': ["Lure and Zap Gags have been removed from approved operations.",],
...
'BanLureSound': {
    ...
    'cdirector': ["Lure and Sound Gags have been removed from approved operations.",],
...
'BanLureDrop': {
    ...
    'cdirector': ["Lure and Drop Gags have been removed from approved operations.",],
...
'BanThrowSquirt': {
    ...
    'cdirector': ["Throw and Squirt Gags have been removed from approved operations.",],
...
'BanThrowZap': {
    ...
    'cdirector': ["Throw and Zap Gags have been removed from approved operations.",],
...
'BanThrowSound': {
    ...
    'cdirector': ["Throw and Sound Gags have been removed from approved operations.",],
...
'BanThrowDrop': {
    ...
    'cdirector': ["Throw and Drop Gags have been removed from approved operations.",],
...
'BanSquirtZap': {
    ...
    'cdirector': ["Squirt and Zap Gags have been removed from approved operations.",],
...
'BanSquirtSound': {
    ...
    'cdirector': ["Squirt and Sound Gags have been removed from approved operations.",],
...
'BanSquirtDrop': {
    ...
    'cdirector': ["Squirt and Drop Gags have been removed from approved operations.",],
...
'BanZapSound': {
    ...
    'cdirector': ["Zap and Sound Gags have been removed from approved operations.",],
...
'BanZapDrop': {
    ...
    'cdirector': ["Zap and Drop Gags have been removed from approved operations.",],
...
'BanSoundDrop': {
    ...
    'cdirector': ["Sound and Drop Gags have been removed from approved operations.",],
...
'DisableLevel48': ["A new mandate has passed. Level 4 and 8 Gags are now disabled."],
'DisableLevel56': ["A new mandate has passed. Level 5 and 6 Gags are now disabled."],
'DisableLevel57': ["A new mandate has passed. Level 5 and 7 Gags are now disabled."],
'DisableLevel58':  ["A new mandate has passed. Level 5 and 8 Gags are now disabled."],
'DisableLevel67':  ["A new mandate has passed. Level 6 and 7 Gags are now disabled."],
'DisableLevel68':  ["A new mandate has passed. Level 6 and 8 Gags are now disabled."],
'DisableLevel78':  ["A new mandate has passed. Level 7 and 8 Gags are now disabled."],
'DisableToonupTrap': ["A new mandate has passed. Toon-Up and Trap Gags are now disabled."],
'DisableToonupLure':  ["A new mandate has passed. Toon-Up and Lure Gags are now disabled."],
'DisableToonupThrow': ["A new mandate has passed. Toon-Up and Throw Gags are now disabled."],
'DisableToonupSquirt':  ["A new mandate has passed. Toon-Up and Squirt Gags are now disabled."],
'DisableToonupZap': ["A new mandate has passed. Toon-Up and Zap Gags are now disabled."],
'DisableToonupSound':  ["A new mandate has passed. Toon-Up and Sound Gags are now disabled."],
'DisableToonupDrop':  ["A new mandate has passed. Toon-Up and Drop Gags are now disabled."],
'DisableTrapLure':  ["A new mandate has passed. Trap and Lure Gags are now disabled."],
'DisableTrapThrow':  ["A new mandate has passed. Trap and Throw Gags are now disabled."],
'DisableTrapSquirt': ["A new mandate has passed. Trap and Squirt Gags are now disabled."],
'DisableTrapZap':  ["A new mandate has passed. Trap and Zap Gags are now disabled."],
'DisableTrapSound': ["A new mandate has passed. Trap and Sound Gags are now disabled."],
'DisableTrapDrop':  ["A new mandate has passed. Trap and Drop Gags are now disabled."],
'DisableLureThrow': ["A new mandate has passed. Lure and Throw Gags are now disabled."],
'DisableLureSquirt':  ["A new mandate has passed. Lure and Squirt Gags are now disabled."],
'DisableLureZap': ["A new mandate has passed. Lure and Zap Gags are now disabled."],
'DisableLureSound':  ["A new mandate has passed. Lure and Sound Gags are now disabled."],
'DisableLureDrop': ["A new mandate has passed. Lure and Drop Gags are now disabled."],
'DisableThrowSquirt': ["A new mandate has passed. Throw and Squirt Gags are now disabled."],
'DisableThrowZap':  ["A new mandate has passed. Throw and Zap Gags are now disabled."],
'DisableThrowSound': ["A new mandate has passed. Throw and Sound Gags are now disabled."],
'DisableThrowDrop': ["A new mandate has passed. Throw and Drop Gags are now disabled."],
'DisableSquirtZap':  ["A new mandate has passed. Squirt and Zap Gags are now disabled."],
'DisableSquirtSound': ["A new mandate has passed. Squirt and Sound Gags are now disabled."],
'DisableSquirtDrop':  ["A new mandate has passed. Squirt and Drop Gags are now disabled."],
'DisableZapSound': ["A new mandate has passed. Zap and Sound Gags are now disabled."],
'DisableZapDrop': ["A new mandate has passed. Zap and Drop Gags are now disabled."],
'DisableSoundDrop': ["A new mandate has passed. Sound and Drop Gags are now disabled."],
'GagBanRetaliationHeal': {
    'racket': ["We're done with the petty ranks; now you answer directly to me!",
                                     "Hierarchy? Forget it. This is dominion.",
                                    "You're all beneath my jurisdiction. Completely.",
                                     "This is no longer a chain of command; this is a monopoly of power!",
                                     "Let me show you what real authority looks like!",
                                     "Do not provoke the birds, if you don't want to get pecked."],
    'cdirector': ["Unfortunate.",
                    "I don't overlook violations!",
                                 "Compliance is learned through pain!",
                                     "You're exhausting my patience!",
                                 "Unacceptable.",
    ...
    'ubuster': [
            "Consider this a formal disciplinary action.",
            "Unauthorized gag usage? That's grounds for immediate retaliation.",
            "Policy violations come with penalties. This one hurts.",
            "You broke the agreement. I'm just enforcing the terms.",
            "That's corporate misconduct, and now you're paying for it."
    ],
    None: ["Improper Toon-Up usage has been recorded."]
},
...
'GagBanRetaliationTrap': {
    ...
    None: ["Improper Trap usage has been recorded."]
},
...
'GagBanRetaliationLure': {
    ...
    None: ["Improper Lure usage has been recorded."]
},
...
'GagBanRetaliationThrow': {
  ...
  'ubuster': [
    ...
    None: ["Improper Throw usage has been recorded."]
},
...
'GagBanRetaliationSquirt': {
  ...
  'ubuster': [
    ...
    None: ["Improper Squirt usage has been recorded."]
},
...
'GagBanRetaliationZap': {
 ...
 'ubuster': [
    ...
    None: ["Improper Zap usage has been recorded."]
},
...
'GagBanRetaliationSound': {
  ...
  'ubuster': [
    ...
    None: ["Improper Sound usage has been recorded."]
},
...
CountDefeatDialogDefaults = [["Upon entrance, you witnessed a vampire reborn...",
                              "And now you've whittled down this skeletal form.",
                              "Hearken to me, creatures of the night!",
                              "Away from these Toons, I must take flight!"],
                             ["This cold feeling, I have felt this before.",
                              "However, I will not let the darkness appear once more.",
                              "You may have won this time, Toons.",
                              "But I will rise once again in the full moon!"]]
...
MusicDgNbrhood = "Daffodil Gardens"
...
SuitBaseNameWithLevelFired = '%(name)s\nLevel %(level)s'
...
InventroyCeaseAndDesist = '1 C & D'
InventoryDelete = 'DELETE'
InventoryDeleteAll = 'DELETE ALL'
InventoryDeleteConfirm = "Are you sure you want to delete all your gags? Don't worry, your level 8 gags will be safe"
InventoryDone = 'DONE'
...
'Bowling Ball',
  ...
  'Boulder',
  'Grand Piano'))
BattleGlobalAvPropStringsSingular = (('Feather',
  'Megaphone',
  'Lipstick',
  'Bamboo Cane',
  'Pixie Dust',
...
'Bowling Ball',
  ...
  'Boulder',
  'Grand Piano'))
BattleGlobalAvPropStringsPlural = (('Feather',
  'Megaphone',
  'Lipstick',
  'Bamboo Cane',
  'Pixie Dust',
...
SueCogTitle = "C & D ' S LEFT: %s\nSUE WHICH COG?"
SueCogLowTitle = "C & D ' S LEFT: %s\nNOT ENOUGH C & D ' S!"
...
PlayGame = 'CLICK TO ENTER TOONTOWN'
DiscordButton = 'News'
...
LitigatorChat1 = "Don't worry, the Litigation Team has this under control."
LawbotBossTempIntro0 = "Hmmmph, what's on the docket today?"
LawbotBossTempIntro1 = "Well let's see, the C.L.O. decided to take a little vacation."
LawbotBossTempIntro2 = "The Chairman has asked me to step in while she is away."
LawbotBossTempIntro3 = 'We will be running things slightly different while I am here.'
LawbotBossTempIntro4 = "I know you're toons you can take off your disguises now."
...
LawbotBossDefenseWins1 = "Unbelievable, you Toons are relentless. I knew I shouldn't have come out of retirement."
LawbotBossDefenseWins2 = "There's a reason people leave this company and never return, but you Toon's wouldn't understand."
LawbotBossDefenseWins3 = "I've had enough of this nonsense, Diane clearly has her work cut out for her."
LawbotBossDefenseWins4 = "And now here comes a painful reminder of what it's like to work for this company."
...
LawbotBossPassExam = "Looks like I'm going to have to bring out the big guns."
LawbotBossTaunts = ['%s, I find you in contempt of court!',
 'Objection sustained!',
 'Strike that from the record.',
 'Your appeal has been rejected. I sentence you to sadness!',
 'Order in the court!']
LawbotBossAreaAttackTaunt = "I've had enough of this nonsense!"
CashbotBossAreaAttackTaunt = "I told you Toons to get away from those cranes!"
WitnessToonName = 'Bumpy Bumblebehr'
OCLOMovie1 = "You toons have no decency! Do you realize how much that security system was worth?"
OCLOMovie2 = "It's going to cost a fortune to restore it and I am NOT going to bother asking Chris for a loan."
OCLOMovie3 = "Are you bots just going to sit there while these Toons interrupt our meeting, or are you going to do your JOBS?"
WitnessToonPrepareBattleTwo = "You toons have no decency! Do you realize how much that security system was worth?"
WitnessToonNoJuror = 'Looks like the Chief Justice has had enough of our antics!\x07He is about to take us on himself.'
...
ElevatorCashBotMiniBoss = 'HOPEFULLY THIS WORKS!'
ElevatorRenegade = 'AHHHHHHHHHHH!'
...
CountErfitBattle = 'Count Erfit Elevator'
ElevatorSellBotBossMini = 'Sellbot Towers'
...
ElevatorMajorPlayer = 'Theatre Room'
DaysToGo = 'Wait\n%s Days'
...
SendCogBossTaunts = {
 's': [
  "We're going door to door to give you a spectacular offer.",
 ...
 'l': [
  'Order in the court!',
  'Justice is blind.',
  'Toons do not understand the importance of law and order.',
  "Bah! Don't you tell me how to run a trial!"
 ],
 't': [
  'System.out.println("Get them!")',
  'if toon != sad:\n    self.invokeSuitPlanner(34, 1, skelecogRandom=1)',
  '10 print Make them sad!\n 20 goto 10'
 ]
}
VPRampMessage = "I don't have time for this, I'm late for my meeting!"
VPDeathTaunt = "WAAAH! YOU HAVEN'T SEEN THE LAST OF ME!"
SuperHardVPDeathTaunt = "OH! I DON'T THINK SO TOONS!"
SuperHardVPHealerBegin = 'GADZOOKS!'
SuperHardVPHealerSecond = 'Yowzas! Is that the C.S.O?'
SuperHardVPSpeakBegin = 'SENIOR Vice President!'
SuperHardVPHealerEnd = 'Ok, whatever. I got some whole cream pies toons, let\'s pie this bot!'
CashbotBossJumpWarning = 'I told you toons to get away from those cranes!'
BossLeaderboardLabel = 'Leaderboard'
HitP = ' Hits'
HitS = ' Hit'
DirectedAttackBossTaunts = {
 ...
 'l': [
 'Order! Order!',
 "I'll have you held in contempt %(toon)s!",
 'Justice will never fail!']
}
KilledToonTaunts = {
 's': [
  'Another satisfied customer!',
  'Looks like we have sealed the deal.'
 ],
 'm': [
  "Such a shame, %(toon)s could have been an investor.",
  'Don\'t worry, we will have a commerative coin for %(toon)s.'
 ],
 'c': [
  'You\'re fired!',
  "I'll be expecting your letter of resignation, %(toon)s",
  'Boy, do I love being the boss.'
 ],
 'l': [
 'Take %(toon)s away, Bailiff!',
 "I'm holding you in contempt %(toon)s!"]
}
VPSpinMessages = [
...
JumpBossTaunts = {
 ...
 'c': [
 "That's enough!",
 "That's it! I'm sending you back to the playground!",
 'You are gonna be FLOORED by this proposition!',
