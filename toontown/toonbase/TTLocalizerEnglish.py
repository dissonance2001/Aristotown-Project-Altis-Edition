...
SuitFaceoffTaunts = {'b': ['Do you have a donation for me?',
 ...
 'ssm': ["You don't know who you're mingling with.",
...
'nc': ["I'm always swindling from the bottom to the top.",
...
'tw': [
 ...
 'kpn': ["I'm swissly surprised you came to someone my level.",
...
'cps': ["Let's make this quick. I am late for the board meeting.",
...
'sw': ["'Zere are many cons to fighting me, but 'zey only affect you.",
 ...
 'ssr': ['Are you ready for my take?',
        ...
        "I hope you don't forget your lines."],
                     'jb': ['Are you ready for my take?',
                             ...
                             "There's no business like Hollywood!",
                             "I hope you don't forget your lines."],
 'bfh' :['Prepare for a Nuclear meltdown.',
         ...
         'Steer Nu-clear!'],
                     'bkp': ['Prepare for a Nuclear meltdown.',
                             'My attacks are toxic to Toons.',
                             "Some say my personality is quite 'explosive.'",
                             "My leadership skils are rather 'toxic.'",
                             "I've got my \"ion\" you, toon.",
...
'sdb': [
		"I know something will work for you.",
...
'sys': [
		"I am a Titan in this department.",
...
'rus': [
		"Time to plant you in the ground.",
...
'kbc': ["Get ready for this flame war."],
                     'skd': [
		"I'm going to steal your script!",
		...
		"As we speak, I'm spoofing your scripts."
                     ...
                     'cmk': [
		"No one can keep up with my algorithm.",
 ...
 'rb': ['Looks like your number is up.',
 ...
 'ptr': ["It's time to collect on your loan.",
 ...
 'ad': ['Time to bring in the big bags.',
        'I can bag this.',
        'Paper or plastic?',
 ...
 'bdb': ["Music is well said to be the speech of angels.",
        "Fools rush in where angels fear to tread."],
'ant': ["I'm the Security Supervisor."],
'sya': ["I'm the Administrator."],
 'pht': ["You've been robbed.",
 ...
 'dfh': ["Any fin is possible if I don't trout myself.",
         ...
         "I'm a Big Fish in a little pond, toon."],
                     'mld': ["Any fin is possible if I don't trout myself.",
                             "You're just fishing for trouble.",
                             'You will find me swimming in cash.',
                             "I won't feel gillty after defeating you.",
                             "I'm bigger than any fish you will ever catch.",
                             "Something's rather fishy in here. No, it's just me!",
                             "I'm a Big Fish in a little pond, toon."],
                     'mdm': ["I have a sneaking suspicion this won't go well for you...",
...
'cn': ["You'll crumple under the pressure.",
...
'mg': ["It's about time I cut your cord!",
...
'hho': ["The secret to my success? That's under lock and key.",
...
'bgh': ["These waters are not for you.",
...
'rng': ["From heron, you will respect my authority.",
...
"You're a sitting duck, Toon."],
 'arb': ["Careful, my legal isn't very tender.",
        'I soar, then I score.',
...
'tld': ["Don't underestimate me. I graduated head of my class.",
...
"You're my ticket to getting ahead of this company."],
 'sb': ["You'll never know when I'll stop.",
 ...
 'mm': ["I'm positive you're not going to like this.",
 ...
 'hh': ["I'm going to get into your business!",
...
'txm': ["Whether you're left or right, I'll always be in the middle.",
 ...
 'gh': ['In my opinion, your name is mud.',
 ...
 'bc': ['Things are about to get very tight.',
 ...
 'mka': ["It's time to face-off!",
        ...
        "My eyes are on you."],
 'ac': ["I'm gonna give you double the trouble.",
...
'ka': ["Vote for me, and I shall make Cog Nation great again!",
    'I will build a great great wall across the border of Cog Nation, so no Toon shall ever invade our home again!'],
                     'ds': ["Get out of my way! No? I'll have to move you by force.",
                            "You're forcing me to take extreme measures."],
                     'cr': ["Don't get in over your head now.",
                            "You'll find this encounter very overwhelming.",
                            "You'll find that I am not a pushover.",
                            "You're overstepping your boundaries.",
                            'If you cooperate, this can be over quickly.'],
                     'trb': ["Does it smell a little moldy around here? Or is it just me?", "I think it's my turn to stomp you."],
'trm': ["Sorry we have to fight, my boss is making me.",
...
'msr': ["This is a waste of my time.",
"You toons have such unrefined tastes.",
"You need to refine your approach.",
"I thought I smelled something extra crude!"],
'bg': ["I'm the Club President."],
'jdg': ["You won't be able to afford these dues."],
'jur': ["I'm the Head Attorney."],
'tlr': ["I'm the Arbitrator."],
'crf': ["Who'ff ready for ffome cartoon violenffe?!",
...
'dsf': ["Who'ff ready for ffome cartoon violenffe?!",
"Come on, babe, FFHOW UFF THOFFE NUMBERFF!",
"Oooo-hooo-hooo, ratingff are ffkyrocketing!",
"WHAT A TWIFFT, BUTTERCUP BLUE!",
"Ooo-well, ya know what they ffay: don't hate the Major Player, change the game!",
...
"Where the diffe will land, nobody knowff--effept for me!",
"You know, I've alwayff got an affe up my ffleeve! Ffee?"],
'cm': ["I'm the Secretary."],
'csh': ["I'm the Mint Auditor."],
'bgr': ["I'm the Mint Supervisor."],
'tr': ["I'm Count Erclaim."],
 'fas': ["I'm watching every move you make.",
         "Watch where you're going!"],
'mdr': ["I'm the Factory Foreman."],
'mp': ["I'm Redd 'Heir' Wing."],
'prr': ["You aren't a good fit for this show.",
"Apologies, but I am changing the station.",
"Goodnight, Toon. Goodnight.",
"There's only static between us."],
'blr': ["You aren't a good fit for this show.",
"Apologies, but I am changing the station.",
"Goodnight, Toon. Goodnight.",
"There's only static between us."],
'fd': ["You aren't a good fit for this show.",
"Apologies, but I am changing the station.",
"Goodnight, Toon. Goodnight.",
"There's only static between us."],
'laa': ["I summon the jury to me!",
"All rise!",
"Court is still in session.",
"The jury is to reach a verdict.",
"Don't get too ahead of yourself.",
"I'm going to have to stop you right there, Toon.",
"Not so fast!",
...
'mad': ["Who'ff ready for ffome cartoon violenffe?!",
"Come on, babe, FFHOW UFF THOFFE NUMBERFF!",
"Ooo-well, ya know what they ffay: don't hate the Major Player, change the game!",
"Oooo-hooo-hooo, ratingff are ffkyrocketing!",
"WHAT A TWIFFT, BUTTERCUP BLUE!",
...
"Where the diffe will land, nobody knowff--effept for me!",
"You know, I've alwayff got an affe up my ffleeve! Ffee?"],
'drm': ["ENTERING EMPLOYEE TERMINATION MODE.",
"If you worked for this company, you'd be out in a cannon.",
"I'm kind of busy right now, can you go away?",
"You don't want to see what happens when I get angry."],
'gm': [
		"You Toons have me working overtime, this is outrageous!",
		"You're working well over your allotted 40 hours this week, pack up your office.",
	],
'cvy': [
...
'ls': [
		"Money is the art of purrfection.",
...
'm': [
		"In a matter of minutes, I think you'll be sent back to the playground.",
...
'nd': [
		"I say, a good ol' rowdy play is in order!",
...
'ffm': [
		"I hope you dressed appropriately, it's going to be a hot one today."
	],
'gkp': [
...
'cp': ["You don't want to see me angry.",
"Let's see how powerful you Toons really are."],
'frs': ["You won't be able to afford my rates.",
"Ring-a-ling it's for you!"],
'gtk': ["You Toons won't give it a rest will you?",
"You'll regret this encounter."],
'dt': ["Clearly, you've been outmatched.",
...
'brv': ["I'm quite versed in paw and order.",
...
'cfp': ["Perhaps I could let you in on a little secret...",
...
'sjg': ["You and I are polar opposites, Toon.",
...
"Consider yourself blocked."],
 'sd': ["I'm going to chase you out of town!",
        'Do you hear a siren?',
        "I'm going to enjoy this.",
...
SuitCheatNames = ('PowerhouseAbsorb', 'PowerhouseSoakImmune', 'PowerhouseLureImmune', 'PowerhouseSyphon', 'PowerhouseSyphonDesperation',
                  ...
                  'WiretapperBrokenConnection', 'AmbassadorHeadRoller', 'AmbassadorHeadRollerGroup', 'AmbassadorRefinement', 'AmbassadorPhase2', 'AmbassadorDamageUp',
...
'ScapegoatBarnyardBash' : "The Scapegoat syphons health from the toons\nwhile he is in desperation!",
#powerhouse cheats
...
'WiretapperBrokenConnection': "The Wiretapper has lost connection and is now vulnerable!",
#ambassador cheats
'AmbassadorHeadRoller': "The Ambassador sacrifices a random cog!",
...
'AmbassadorManagerialProtectionImmunity': "The Ambassador is now immune to all gags!",
'AmbassadorMulligan': "The Ambassador takes another shot!",
#safe-ty supervisor cheats
'SafetyHighPressure': "Everyone in battle is overworked!",
...
'UnionBusterUnionBusterDamage': "Union Busted toons are forced to take damage every round!",
...
'UnionBusterBreachOfContract2': "The Union Buster retaliates against Toons who used soak!",
'UnionBusterBreachOfContract3': "The Union Buster retaliates when hot take is used!",
'UnionBusterBreachOfContract4': "The Union Buster retalites against Toons who chose\nbanned gags!",
...
'RacketeerExtortion2': "The Racketeer syphons health from the Toons who could not\nfollow his instructions!",
'RacketeerCompensation': "The Racketeer strengthens cogs who have taken damage!",
'RacketeerHustling': "The Racketeer requires Toons to use specific gag tracks!",
'RacketeerRacketeering': "The Racketeer bans the gag track that was last used!",
...
SuitAttackNames = {'Audit': 'Audit!',
 ...
 'Usury': 'Usury!',
    'Usury2': 'Usury!',
'Tribute2': 'Tribute!',
'SlushFund2': 'Slush Fund!',
'Shakedown': 'Shakedown!',
'Shakedown2': 'Shakedown!',
'KickUp': 'Kick Up!',
'StandUpGuy': 'Stand-up Guy!',
'Sitdown': 'Sitdown!',
                   'ChainsawCanned': 'Canned!',
 'TvBlast': 'Tv Blast!',
 'Snap': 'Snap!',
                   'Chomp': 'Chomp!',
 'CigarSmoke': 'Cigar Smoke!',
 'ClipOnTie': 'Clip On Tie!',
 'ClockChange': 'Overclocked!',
 'Crunch': 'Crunch!',
                   ...
                   'CourtMandate1': 'Court Mandate!',
                   'CourtMandate2': 'Court Mandate!',
                   'CourtMandate3': 'Snipe!',
                   'Snap2': 'Snap!',
                   'WheelSpin': 'Wheel Spin!',
                   'Accusations': 'Piercing Intellect!',
'Accusations2': 'The Accused!',
                   'GameShow': 'Trick Of The Light!',
 ...
 'Demotion': 'Demotion!',
 'Downsize': 'Downsize!',
 'WhitePowder': 'Bayou Bash!',
 'DoubleTalk': 'Double Talk!',
 'InsurancePlan': 'Insurance Plan!',
                   'EvictionNotice': 'Eviction Notice!',
                   'MPHotAir': 'Hot Air!',
                   'ReArrange': 'Rearrange!',
                   'MPSongAndDance': 'Song And Dance!',
                   'LifeInsurance': 'Life Insurance!',
                   'Refinement': 'Oil Refinement!',
                   'ExtraTip': 'Bayou Bash!',
                   'WorkersCompensation': "Worker's Compensation!",
                   'HRPowerTrip': 'Power Trip!',
 'ThrowMoney': 'Throw Money!',
 'AmandasDoughnuts': 'Dunkin Doughnuts!',
 'NotThrowPiano': 'Not Throw Piano!',
                   'Drowning': 'Drowning!',
                   'HeavyRainfall': "Heavy Rainfall!",
                   'AfterShock': "Aftershock!",
                   'FreezingRain': "Freezing Rain!",
                   'LegalBindings': "Legal Bindings!",
 'BombCake': 'Bomb Cake!',
 'Bomb': 'Bomb!',
 'EvilEye': 'Evil Eye!',
 ...
 'GlowerPower': 'Glower Power!',
                   'ChainsawGlowerPower': 'Glower Power!',
...
'CourtRecord2': 'Court Record!',
'CourtRecord3': 'Court Record!',
'CourtRecord4': 'Court Record!',
'CourtRecord5': 'Court Record!',
...
'Detonate': 'Offboarding!',
 'Detonate2': 'Offboarding!',
                   'RainOfFire': 'Rain of Fire!',
 'Detonate3': 'Offboarding!',
'ChainsawDetonate': 'Offboarding!',
 'ChainsawDetonate2': 'Offboarding!',
 'ChainsawDetonate3': 'Offboarding!',
                   'ConeOfShame': 'Safe-ty Violation!',
'HeadRoller': 'Off With Your Head!',
 'HeadRoller2': 'Off With Your Head!',
 'HeadRoller3': 'Off With Your Head!',
'UnionBust': 'Union Buster!',
 'UnionBust2': 'Union Buster!',
 'UnionBust3': 'Union Buster!',
 'MumboJumbo': 'Mumbo Jumbo!',
 'ParadigmShift': 'Paradigm Shift!',
 'PoisonSpray': 'Shields Up!',
                   'PositiveReinforcement': 'Positive Reinforcement!',
 'WaterSpray': 'Water Spray!',
 'PeckingOrder': 'Pecking Order!',
 'PickPocket': 'Pick Pocket!',
 'CourtSanction': 'Court Sanction!',
                   'Spotlight': 'Spotlight!',
 'StealSafe': 'Countermeasures!',
 'PinkSlip': 'Pink Slip!',
...
'Bash': 'Bash!',
 ...
 'HypnoEyes': 'Slush Fund!',
 'RestrainingOrder': 'Restraining Order!',
 'Rolodex': 'Rolodex!',
                   'RevvingUp': 'Revving Up!',
                   'ChainsawRolodex': 'Rolodex!',
                   'LDReOrg': 'Reorganize!',
                   'Inject': 'Injection!',
                   'InkDrain': 'Caress!',
 ...
 'Shake': 'Shake!',
 'Shred': 'Shred!',
                   'UnionBuster': 'Union Buster!',
                   'UnionDues': 'Calculating Dues!',
 'SongAndDance': 'Song And Dance!',
 'Spin': 'Spin!',
 'RaisingTheAnte': 'Raising the Ante!',
 'SwirlBath': 'Rolled!',
                   'Conduction': 'Con-duck-tion!',
                   'FreeCruise': 'Free Cruise!',
                   'DuckSpin': 'Spin!',
                   'DiceRoulette': 'Dice Roulette!',
                   'Bar': 'Bar!',
                   'LDAfterShock': 'Aftershock!',
                   'LDRedTape': 'Red Tape!',
 'Synergy': 'Calculating Interest!',
 'Snow': 'Snow!',
 'HeatWave': 'Heat Wave!',
 'Tabulate': 'Tabulate!',
 'Golf': 'Tee Off!',
...
'CollectCall': "Collect Call!",
'ExplodingBill': "Exploding Bill!",
'GoodMorningToontown': "Trick Of The Light!",
'FireCog': "Whirlwind!",
'Caress': "Snipe!",
'RadioInfrequency': "Radio Infrequency!",
'MobMentality': "Mob Mentality!",
'SlushFund': "Tribute!",
'CeaseAndDesist': "Cease And Desist!",
'JuryNotice': "Jury Notice!",
'FieldPromotion': "Field Promotion!",
'ManagerialProtection': "Manager Protection!",
'Investment': "Kamikaze!",
'CollectCallFees': "Calculating Calling Fees!",
'QualityLvlControl': "Quality Control!",
    'QualityLvlControl1': "Quality Control!",
'QualityLvlControl2': "Quality Control!",
    'QualityLvlControl3': "Quality Control!",
'QualityControl': "Quality Control!",
    'QualityControl1': "Quality Control!",
    'QualityControl2': "Quality Control!",
    'QualityControl3': "Quality Control!",
                   'BlueChip': "Blue Chip!",
...
'PowerhouseSnipeVulnerable' : "Snipe!",
'PowerhouseSnipeGagBan' : "Snipe!",
'PowerhouseSnipeSoaked' : "Snipe!",
'PowerhouseSnipeBookkept' : "Snipe!",
'PowerhouseSnipeMulligan' : "Snipe!",
'PowerhouseSnipeCollectCall' : "Snipe!",
#bookkeeper cheats
'BookkeeperPaperCutSoaked': "Paper Cut!",
'BookkeeperPaperCutMarked': "Paper Cut!",
'BookkeeperPaperCut': "Paper Cut!",
'BookkeeperExplodingDocument': "Exploding Document!",
...
'HighRollerGameTimeCog2': "Game Time!",
'HighRollerBust': "Bust!",
# high roller phase 2
'HighRollerPhase3': "phase 3",
# high roller phase 3
...
'HighRollerVulnerable': "Show Time!",
...
'ElectrostaticEnergy': ["Electricity is dangerous.",
 ...
 'Bite': {
     'scg': ["My bite's worse than my bleat!!!",
 ...
 'BuzzWord': {
     'ste': ['Have you heard the buzz? No? That stings!',
 ...
 'Calculator': ["What is 5 plus 5?",
                "Add your math up, you'll need it!",
                "That is the wrong answer!",
                "I don't accept failures, here's your punishment.",
                "What is 121142987914274298714298742981742891427981427981427149287142987421827827149871428941278 * 0?"],
...
"I hope you don't mind - EXCESS TRAFFIC!",
 ...
 'Snap': ["My colleagues don't like it when I get snappy.",
           'These chompers could cut out diamonds!',
            'This may hurt a little, but what comes next will hurt a lot.',
           "I've had enough with you!"],
                    'Snap2': ["My colleagues don't like it when I get snappy.",
                             'These chompers could cut out diamonds!',
                             'This may hurt a little, but what comes next will hurt a lot.',
                             "I've had enough with you!"],
                    'LegalBindings': ["You can't escape this one, Toon."],
 'Chomp': {
     'lit': ["This'll leave a mark.",
...
'MPQuake': ["Let the rhythm quake your core, babe.",
...
'MPHotAir': ["Tune so hot, hot hot tune, tune so hot you fry a Toon.",
...
"It ain't a Summer Tune without some sun, babe!",
"How're these for some fire notes, babe?",
"Don't care for the blues? Let's heat it up!"],
'MPSongAndDance': ["A-one! A-two! A skiddly-diddly-doo-doo dibba de-do-do!",
...
'ChainsawCanned': ["ACTIVATING TOON-A CAN SEALING PROCESS.",
...
"ORDER TO ATTACK HAS BEEN RECEIVED AND PROCESSED."],
 'ClipOnTie': {
     'jr': ['I like these... No knots to tie.',
     ...
     None: ['Better dress for our meeting.',
            ...
            "I think I'll tie you up."]
                    ...
                    'Bar': ["Watch your HEADTH!",
"INCOMIN'!",
"DON'T TRIP!",
"I'm raithin' the BAR! HA!!"],
  'Accusations': ['Let me loop you in on how things work.',
 ...
 "Now I'm closing in on you!"],
  'Accusations2': ["According to my calculations, this toon has been accused. Court is now in session.",
"All rise, this toon is being put on trial for misusing gags against the defense."],
                    'DuckSpin': ["Whaddaya thay we go for a little THPIN??",
...
"I'LL take ya for a thpin!"],
 'WheelSpin': ["There'ff no fun in plaHAHAying it ffafe! Live a little!",
...
'NickelAndDime': ["There'ff no fun in plaHAHAying it ffafe! Live a little!",
"What'ff life without a little riffk here and there?",
"You'd befft go big or GO HOME!",
"It'ff all or nothing, doll!",
"But what if the fftakeff were EVEN HIGHER?!"],
'AfterShock': ["I heard you Toons like roughhousing, can I play too?", 'I can weather the storm, Toon.'],
'FreezingRain': ["It looks like you're starting to freeze up.", "Why don't you take a chill pill?"],
'Drowning': ["Don't hold your breath.", 'You better hold your breath.'],
'HeavyRainfall': ['You better take shelter, Toon.', 'The rain is coming down hard, can you weather the storm?', 'I can weather the storm, Toon.', 'Water, water, everywhere!'],
'OilRain': ['I can weather the storm, Toon.', 'You Toons are real roustabouts.', 'Does this remind you of anyone?'],
'Cage': ['Who said you Toons could have the upperhand?',
 ...
 'ClockChange': ['SYSTEM MALFUNCTION, ALL GAGS HAVE BEEN GIVEN A DAMAGE BOOST FOR THE DURATION OF THE BATTLE!'],
 ...
 'DoubleTalk': ["Your services are no longer required here.",
...
"Why don't I introduce you to my value proposition?"],
                    'GameShow': ["Every copy of me iff perffonalized.",
...
'HRPowerTrip': ["Pack your bagff, we're taking a little trip.",
...
"Let's get down to business."],
 'WhitePowder': ["OOOOOOOOOOOOOOOOOOOOO."],
                    'Spotlight': ["Babe, I'm passing this verse to you; you know what to skibidibbi-do!",
                                  "Spotlight's on you, Baby Blue!",
                                  "You haven't seen anything yet, babe! Listen to this!",
                                  "Time for a swingin' solo! Take it away, Joe!"],
 'InsurancePlan': ["You're not the only one who's in need of healing.",
                    "You thought toons were the only one's who could heal themselves?",
 ...
 'ThrowMoney': ["Money is coming your way!",
                    'Would you like some cash?',
                    'Get ready, the bills are coming your way.',
                    "I have 10 dollars in my pocket.",
                    "Did I ever tell you how much money is really worth?"],
 'AmandasDoughnuts': ["Hey! Why did you eat our doughnuts?! >:("],
 'NotThrowPiano': ["Now look who's got the drop gag track.",
                    "Why don't you refund that throw for drop?",
                    "Cogs using drop? Unbelieveable.",
                    "Can throw do this? No, I didn't think so.",
                    "Drop is a very powerful gag."],
 'FallingKnife': ["Don't bring a Gag to a knife fight.",
"Get to the point!",
...
'BlueChip': ["I'm investing in your downfall.",
...
'Embezzle': ["I'll just write that off as a business expense.",
        ...
        'Gavel': ['Any gags used against the defense can and will be held against them in a court of law.', 'Any gags used against the defense can and will be held against them in a court of law.'],
 'Bomb': ["Bombs away!",
                    "Hot! Hot Hot!",
                    'Look out!',
                    "Incoming!"],
                    'FloodTheMarket': ["I'll put out a Flood Watch.",
...
'UnionBust': ["I won't have any unionizing while I'm on the payroll, got that?",
...
'UnionBust2': ["I won't have any unionizing while I'm on the payroll, got that?",
              'Corporate is giving me a lot of pressure to break this up!',
              "Looks like you're all busted up!",
              "Can't handle the pressure?",
              "I'm not paying your union dues.",
              'This whole operation is a bust.'],
'UnionDues': ["I won't have any unionizing while I'm on the payroll, got that?",
              "I'm not paying your union dues."],
'WireCut': ["Hobbies like this can be a great bonding experience, wouldn't you say?",
              "A little tip for you, darling; strong connections will help you go far!"],
'PaperCut': ["I would be lying if I said this wasn't going to hurt a lot.",
              "What's the matter? Afraid of getting a little paper cut?"],
'Wiretapped': ["You really got your wires crossed this time.",
"You should tell that 'Toon Resistance' of yours to invest in some phone security.",
              "I'm tapped into your line."],
'Voicemail': ["Sorry, I can't hear you!",
"What's that? You better speak up.",
"Hmm, looks like our connection was dropped.",
              "Huh? What? Are you there?"],
'CollectCall': ["This is operator 372, you have an incoming call from.....ME!",
"Ring-a-ling it's for you! Better pick it up before it's too late!",
              "Hmm, looks like our connection was dropped."],
'CollectCallFees': ["10 Dollars, 20 Dollars, 30 Dollars, I think it's time you hang up the phone.",
"You can't handle these expenses.",
              "You are receiving a collect call from me, do you accept the charges?"],
'SlushFund': ["There'ff no fun in plaHAHAying it ffafe! Live a little!",
"What'ff life without a little riffk here and there?",
"You'd befft go big or GO HOME!",
"It'ff all or nothing, doll!",
"But what if the fftakeff were EVEN HIGHER?!"],
'ExplodingBill': ["You better look out, this bill is HOT HOT HOT!",
"Is it me, or is it getting hot in here?"],
'GoodMorningToontown': ["Can't ffquaffh and fftretch your way out of thiff one, Toonff!",
...
'Caress': ["Prepare for pain.",
"Yikes, that one's gotta hurt."],
'FieldPromotion': ["You better put this promotion to good use!",
"This is not a one man show."],
'ManagerialProtection': ["Alright lackies, you're going to have to take it from here.",
"This is not a one man show."],
'Investment': ["Oh my, what a twist!",
"Everybody take cover, here comes the big one!"],
'MobMentality': ["These infidels must be exiled at once!",
"You are not welcome in our communities.",
                 "Fellow Suits, YOU may be next!"],
'CeaseAndDesist': ["I spy with my little eye, a Toon who isn't pulling their weight.",
"What happened to your little strategy called 'teamwork'?",
                 "Someone isn't doing their part around here."],
'JuryNotice': ["Confuffion can go a long way, and thiff act iff no different.",
...
'RadioInfrequency': ["You better cover your ears, this attack will make your ears bleed!",
"There's only static between us.",
...
"Apologies, but I'm changing this station."],
'UnionBuster': ["I won't have any unionizing while I'm on the payroll, got that?",
              'Corporate is giving me a lot of pressure to break this up!',
              "Looks like you're all busted up!",
              "Can't handle the pressure?",
              "I'm not paying your union dues.",
              'This whole operation is a bust.'],
'UnionBust3': ["I won't have any unionizing while I'm on the payroll, got that?",
              'Corporate is giving me a lot of pressure to break this up!',
              "Looks like you're all busted up!",
              "Can't handle the pressure?",
              "I'm not paying your union dues.",
              'This whole operation is a bust.'],
'HeadRoller': ['Your heads will roll for this one.', "Your services are no longer required.", "Let's put this cog's health to good use shall we?"],
'HeadRoller2': ['Your heads will roll for this one.', "Your services are no longer required.", "Let's put this cog's health to good use shall we?"],
'HeadRoller3': ['Your heads will roll for this one.', "Your services are no longer required.", "Let's put this cog's health to good use shall we?"],
'CourtMandate': ['Any Squirt or Zap Gags Toons use can and will be held against them in a court of law.'],
'CourtMandate1': ['Any Toon-Up or Sound Gags Toons use can and will be held against them in a court of law.'],
'CourtMandate2': ['Any Lure or Throw Gags Toons use can and will be held against them in a court of law.'],
'CourtMandate3': ['Prepare for pain.', "Yikes, that one's gotta hurt."],
'QualityControl': ['Quality Control dictates that all Squirt and Zap Gags are now classified as defective.'],
'QualityControl1': ['Quality Control dictates that all Toon-Up and Sound Gags are now classified as defective.'],
'QualityControl2': ['Quality Control dictates that all Lure and Throw Gags are now classified as defective.'],
'QualityControl3': ['Quality Control dictates that all Trap and Drop Gags are now classified as defective.'],
'QualityLvlControl': ['Quality Control dictates that all Level 6 and 7 Gags are now classified as defective.'],
'QualityLvlControl1': ['Quality Control dictates that all Level 5 and 7 Gags are now classified as defective.'],
'QualityLvlControl2': ['Quality Control dictates that all Level 7 and 8 Gags are now classified as defective.'],
'QualityLvlControl3': ['Quality Control dictates that all Level 6 and 8 Gags are now classified as defective.'],
                    'MudSling': ['In my opinion, your face is mud.',
                                 'This goes well with your shirt.'],
                    'Mulligan2': ["You're not up to par.",
            'Fore!',
 ...
 'Filibuster': {
     'ste': ['This conversation will be prolonged! Now pay attention!',
 ...
 'Fired': {
     ...
     None: ["Can you say ouch?",
            ...
            "You're outta here."]
                    ...
                    'Conduction': ["Confuffion can go a long way, and thiff act iff no different.",
"Quack! Can you relate, babe? No? Well, now you can.",
"Ffee, you're going to get well acquainted with what'ff on my head! And that'ff duckieff!",
"And the crowd goeff wild for thiff act! A real pecking order iff in action... now.",
"You know, I really like bread! And ffo do my little friendff here, iffn't that right!"],
                    'FreeCruise': ["Watch your headff, folkff, thiff might rock your boat!",
...
"Congraffulaffionff, you won! Congraffulaffionff, you won! Congraffulaffionff, you won! Congraffulaffionff, you won! Congraffulaffionff, you won! Congraffulaffionff, you won!"],
 'FountainPen': {
     'msr': ["I'm dis-ink-lined to acquiesce to your desires.",
 ...
 'FreezeAssets': {
     'msr': ['I wish I could go somewhere warmer - preferably away from you lot!',
     ...
     'kb': ['Consider this a pay zone, as in "You\'re gonna pay!"',
     ...
     None: ['Your assets are mine.',
            ...
            "I'm very cold blooded."]
                    ...
                    'DiceRoulette': ["Can't ffquaffh and fftretch your way out of thiff one, Toonff!",
"Who'ff ready for ffome cartoon violenffe?!",
"FForry, babe, but the ratingff don't lie! Thiff iff what the viewerff want!",
"And the ratingff FFKYROCKET!!!",
"WHAT A TWIFFT!!!",
...
"Look into my eyes...",
                 ...
                 'Shall we take a peek at your future?'],
                    'ChainsawGlowerPower': ["UPDATING PROCESSES... MUST STAY ON THE CUTTING EDGE!!",
                                    "PIERCING EYES HAVE BEEN ESTABLISHED.",
                                    "EMPLOYEES ARE RESISTING TERMINATION, CONTINGENCY PROCEDURES ARE IN EFFECT.",
'WARNING: "GAG" HAS NO DEFINITION. IGNORING...',
"ADDITIONAL DAMAGE TO SUIT DETECTED, CONTINUITY PLAN ACTIVATED.",
"ORDER TO ATTACK HAS BEEN RECEIVED AND PROCESSED."],
  'SlushFund2': ["Do I gotta provide the muscle for ya?!",
...
"No one ever gave ya the rundown on how this place works, ey?"],
 'Shakedown2': ["Let's shake things up.",
"Maybe this'll shake some sense into ya.",
"Ya look a little shaken up, Toon.",
"No one ever gave ya the rundown on how this place works, ey?"],
 'KickUp': ["We'll get a kick out of this.",
...
"I can't stand seeing the rest of 'em get hurt!"],
 'GuiltTrip': {
     ...
     'scg': ['This fight is all your fault!!!',
 ...
 'HalfWindsor': {
     'jr': ['Eh, something something... half effort.',
            "This'll leave you winded.",
            "Laundry? That's, uh... Gizmo's job.",
            "My dad's always tied up with work.",
            "Well, here's another tie."],
...
"A penny pinched is a penny earned."],
 'Jargon': {
     'ste': ["Do you understand what I'm saying? Am I talking too fast?",
 ...
 'LawBook': {
     ...
     'lit': ['You could use a lesson in law. Study up.',
 ...
 'Liquidate': {
     'msr': ["You're diluted if you think I'm handing this Toon over!",
     ...
     'kb': ["Get out of my way! You're standing on our newest borehole.",
 ...
 'MoneyTrip': ["I'm taking this to committee.",
 ...
 'RaisingTheAnte': ['The night iff fftill young!',
                    "Raiffin' the bar, raiffin' the fftakeff, raiffin' the tenffion, rAHAHAHAiffin' the exffitement!",
                    "It ain't over jufft yet.",
                    "Come now, entertain me ffome more. I'm lovin' thiff!"],
'SongAndDance': ["A-one! A-two! A skiddly-diddly-doo!",
...
"Woah Woah Woah..."],
'FireCog': ['You better take shelter, Toon. The storm is starting to pick up.',
                  "There's a storm of legal trouble coming your way.",
                  "You're stirring up a whirlwind of lawsuits, Toon."],
 'MumboJumbo': {
     'ste': ['Are you listening? I talk fast! Keep up!',
 ...
 'ParadigmShift': {
     'scg': ['Look out! Big changes are coming your way!!!',
     ...
     'jr': ["Flunk Show's gonna air, so I'll shift you over there... Heh.",
            'Up, up, and away...',
            'Is my shift done...?',
 ...
 'PeckingOrder': {
     'tg': ['Get ready for a bird... bath... Zzz...',
...
"You won't be needing this...",
"You'll never see it coming."],
                    'RevvingUp': ["THREATS HAVE BEGUN TO ADVANCE. BEGIN INCREASING ATTACK POWER.",
...
"EMPLOYEE WAS DISMISSED BY UNAUTHORIZED PARTY."
 ...
 'CourtSanction': ["I spy with my little eye, a Toon who isn't pulling their weight.",
                "What happened to your little strategy called, teamwork?",
				"Someone isn't doing their part around here."],
 'StealSafe': ["Someone isn't doing their part around here."],
                    'ConeOfShame': ["Someone isn't doing their part around here."],
...
"Here's your pink slip, you're outta here!",
 ...
 'PowerTie': {
     'jr': ['My dad says I look nice in this tie.',
...
"Did you have a niffe trip?",
"Ffory to trip you up there!"],
'crf': ["Pack your bagff, we're taking a little trip.",
"Who'ff got the power now?",
"Power corruptff, effpecially in my handff!",
"Niffe trip, I gueffff I'll ffee you next fall.",
"Now you ffee who'ff in power!",
...
"Did you have a niffe trip?",
"Ffory to trip you up there!"],
'dsf': ["Pack your bagff, we're taking a little trip.",
"Who'ff got the power now?",
"Power corruptff, effpecially in my handff!",
"Niffe trip, I gueffff I'll ffee you next fall.",
"Now you ffee who'ff in power!",
...
"Ffory to trip you up there!"],
 ...
 'Quake': {
     'msr': ["Your hopes of saving this Toon will be 'shaken' after this.",
     ...
     None: ["Let's quake, rattle, and roll.",
            ...
            "You're on shaky ground now!"]
                    ...
                    'ChainsawQuake': ["EMPLOYEES ARE RESISTING TERMINATION, CONTINGENCY PROCEDURES ARE IN EFFECT.",
'WARNING: "GAG" HAS NO DEFINITION. IGNORING...',
"ADDITIONAL DAMAGE TO SUIT DETECTED, CONTINUITY PLAN ACTIVATED.",
"ORDER TO ATTACK HAS BEEN RECEIVED AND PROCESSED.",
 ...
 'HypnoEyes': ["Do I have to provide the muscle for you?",
           "Consider this your share for this operation."],
 'RestrainingOrder': {
     'csm': ['Annoying...',
 ...
 'Rolodex': {
     ...
     None: ["Your card's in here somewhere.",
            ...
            'I want to make sure we stay in touch.']
                    ...
                    'ChainsawRolodex': ["PROTOCOL FOR PEST EXTERMINATION HAS BEEN TRIGGERED.",
...
"ORDER TO ATTACK HAS BEEN RECEIVED AND PROCESSED."],
 ...
 'Blast': ["In just a snap.",
"In just a snap."],
'CourtRecord1': ["Any Level 6 and 7 Gags Toons use can and will be held against them in a court of law."],
'CourtRecord2': ["Any Level 5 and 7 Gags Toons use can and will be held against them in a court of law."],
'CourtRecord3': ["Any Level 5 and 8 Gags Toons use can and will be held against them in a court of law."],
'CourtRecord4': ["I spy with my little eye, a Toon who isn't pulling their weight.",
                "What happened to your little strategy called, teamwork?",
				"Someone isn't doing their part around here."],
'CourtRecord5': ["Any Level 7 and 8 Gags Toons use can and will be held against them in a court of law."],
'BookKeeping': ["Your strategies will go up in smoke, Toon.",
                "You'll never see it coming."],
 'Schmooze': {
     'sft': ["You're about 0.01% as cool as I am! That's impressive.",
...
"You're standing on a fault line."],
 ...
 'SwirlBath': [ "There'ff no fun in plaHAHAying it ffafe! Live a little!",
                "What'ff life without a little riffk here and there?",
		   "You'd befft go big or GO HOME!",
          "It'ff all or nothing, doll!",
                "But what if the fftakeff were EVEN HIGHER?!"],
 ...
 'CourtCosts': ["Consider this a litigation expense.",
 ...
 'Snow': ["Snow? I don't see any snow.",
		  "Have you ever seen and experienced snow?",
		  "Do you want to build a snowman?",
		  "It's a snowy day out here!",
...
'TeeOff': ["You're not up to par.",
 ...
 'Enraged': ['You made me maaa-d!!!',
            "You got the goat, Toons!",
            "I've had enough of all of this!",
            'You made me maaa-d!!!',
            "You got the goat, Toons!"],
 'Watercooler': {
     'dty': ["I wouldn't waste water, but you've left me no choice.",
 ...
 'Withdrawal': {
     'msr': ["If you won't withdraw yourself, then I will make you do so!",
     ...
     'kb': ["I won't tolerate any sidetracking from your defeat!",
     ...
     None: ["I believe you're overdrawn.",
            ...
            "It's a reversal of fortune."]
                    ...
                    'ExtraTip': ["You've done great work today. Here's an extra tip."],
'LifeInsurance': ["As long as I still have assets, I am insured."],
'Refinement': ["It's important to stay adequately oiled when defeating Toons.",
               "Freshly drilled to keep us in working order."],
'WorkersCompensation': ["Do you realize how much paperwork I have to file for this?"],
 'SnowBalls': ["Freeze up the Toons!",
               "Snowball fight!",
		"Here, have some snowballs.",
		"Do you want to build a snowman?",
		"Here's all the snowballs you need for your decoration.",
		"It requires 32F* to create snow, then reform them into balls, then what do you have? Snowballs."],
'LDReOrg': ["Mind a peck if I ra-organ-ize ya?",
...
'LDRedTape': ["Ya can't get outta this one, not by a jugful.",
...
'Inject': ["You seem to be corrupted.",
            "If I were you, I'd install a firewall.",
		"You're data is corrupted."],
'InkDrain': ["Ya look much too drained ta be on the saddle.",
"Ink says yer wanted.",
"Sorry ta siphon yer hopes!",
"Yer farm looks drained."],
'LDEvictionNotice': ["Best start beatin' the road.",
"Cut a path, pardner.",
"Off my land, pardner.",
"Outta my dice house, pardner.",
"Dontcha start coolin' ya heels.",
"Find the linerider, pardner."],
'LDQuake': ["Pardner, I'm gonna shake that smile right off yer dagnabbed face!",
...
'LDAftershock': ["What's wrong? You look worse than a cat n' a room full a' rockers.",
...
"See a ghost? Ya look shakin' up."],
 'FireBalls': ["Ooooooooo, hot hot hot!!!",
               "Ooooooooo, hot hot hot!!!",
		 "Ooooooooo, hot hot hot!!!",
		 "Ooooooooo, Gentlemen.",
		 "Ooooooooo, Gentlemen.",
		 "Ooooooooo, Gentlemen.",
...
"Hm, hm..."],
                    # scapegoat cheats
                    'ScapegoatGavel': ["Any gags Toons use can and will be held against them in the court of law."],
...
"Is that the best these Toons have?"],
    #powerhouse cheats
 'PowerhouseAbsorb': ["I can't stand seeing the rest of my allies getting hurt.",
"Don't worry, I got your back.",
"Woah, you didn't think we were going down that easily did you?"],
 'PowerhouseSoakImmune': ["I just bought this suit, don't get it wet.",
"I'm not in the mood for a seltzer at the moment."],
 'PowerhouseLureImmune': ["I won't fall for your mind tricks this time, Toons.", "You won't be able to attract my metal now, Toon.",
"There's no such thing as 'free money' in today's world."],
 'PowerhouseSyphon': ["I'm not ready to give up quite yet.", "Time to give myself that much needed bonus.", "Your health is mine.",
"You hit me, I hit you back even harder."],
 'PowerhouseSyphonDesperation': ["Your attacks will be more enlightening from now on."],
'PowerhouseSnipeVulnerable': ["Prepare for pain.", "The first attack may have hurt a little, but this will hurt a lot more.", "I always stay on the cutting edge.", "My 'piercing intellect' may surprise you.", "I've had enough of you!"],
'PowerhouseSnipeGagBan': ["Prepare for pain.", "The first attack may have hurt a little, but this will hurt a lot more.", "I always stay on the cutting edge.", "My 'piercing intellect' may surprise you.", "I've had enough of you!"],
'PowerhouseSnipeSoaked': ["Prepare for pain.", "The first attack may have hurt a little, but this will hurt a lot more.", "I always stay on the cutting edge.", "My 'piercing intellect' may surprise you.", "I've had enough of you!"],
'PowerhouseSnipeBookkept': ["Prepare for pain.", "The first attack may have hurt a little, but this will hurt a lot more.", "I always stay on the cutting edge.", "My 'piercing intellect' may surprise you.", "I've had enough of you!"],
'PowerhouseSnipeMulligan': ["Prepare for pain.", "The first attack may have hurt a little, but this will hurt a lot more.", "I always stay on the cutting edge.", "My 'piercing intellect' may surprise you.", "I've had enough of you!"],
'PowerhouseSnipeCollectCall': ["Prepare for pain.", "The first attack may have hurt a little, but this will hurt a lot more.", "I always stay on the cutting edge.", "My 'piercing intellect' may surprise you.", "I've had enough of you!"],
                    #wiretapper cheats
'WiretapperCollectCall': ["This is operator 44, you have an incoming call from.....ME!", "You are receiving a collect call from me. Do you accept the charges?",
"Ring-a-ling it's for you! Better pick it up before it's too late!",
              "Hmm, looks like our connection was dropped."],
'WiretapperWiretapped': ["You really got your wires crossed this time.",
"You should tell that 'Toon Resistance' of yours to invest in some phone security.",
              "I'm tapped into your line."],
'WiretapperVoicemail': ["Sorry, I can't hear you!",
"What's that? You better speak up.",
"Hmm, looks like our connection was dropped."],
'WiretapperBrokenConnection': ["Hmm, looks like our connection was dropped.",
"You really got your wires crossed this time."],
                    #ambassador cheats
'AmbassadorHeadRoller': ['Your heads will roll for this one.', "Your services are no longer required.", "Let's put this cog's health to good use shall we?"],
'AmbassadorHeadRollerGroup': ["Such a shame, you can't find good help these days,"],
'AmbassadorRefinement': ["It's important to stay adequately oiled when defeating Toons.", "I'm suspending this well.",
"Freshly drilled to keep us in working order."],
'AmbassadorPhase2': ["You toons have me so overworked, you made me blow through my suit! Now it's time to bring out the big guns."],
'AmbassadorDamageUp': ["You hit me, I hit you back even harder.", "Do you have any idea how much it costs to manufacture those suits?!",
                                 "You didn't think I'd make it easier for you to defeat me did you?"
                                 ],
'AmbassadorManagerialProtection': ["In just a snap.", "How many suits is it going to take to get rid of these Toons?!",
                                 "This is not a one suit show.",  "I do NOT have time for this, come take care of these Toons!."
                                 ],
'AmbassadorManagerialProtectionImmunity': ["Lackies, take care of these Toons for me, I've had enough of this nonsense."
                                 ],
'AmbassadorMulligan': ["You're not up to par.",
            'Fore!',
            "I'm getting teed off.",
            "Caddie, I'll need my driver!",
            'Just try and avoid this hazard.',
            ...
            'Mind if I play through?'],
#safe-ty supervisor cheats
'SafetyHighPressure':  ["Oh my, what a twist!",
"Everybody take cover, here comes the big one!"],
'SafetyHeatWave': ["You're about to have a meltdown, Toons.", "Hope you wore sunscreen, this battle is about to get even hotter!",
         "If you can't handle the heat, stay out of the kitchen.", "Let's crank up the heat!", "The heat is on.",
         "Can you handle the heat, Toons?"],
'SafetyHeatWaveCalculation': ["idk if this needs a phrase in here"],
'SafetyViolation': ["Someone isn't doing their part around here.",
"Quality Control restrictions are in place for a reason, you are no exception!"],
'SafetyPromotion': ["You've done great work today, here's a raise.",
"This is the only way you're gonna get that promotion!"],
#union buster cheats
'UnionBusterUnionDues': ["I won't have any unionizing while I'm on the payroll, got that?",
              "I'm not paying your union dues."],
'UnionBusterUnionCalculator': ["uh i dont think i need one here either"],
...
'UnionBusterUnionWages': ["The harder your Union crashes, the stronger I become.", 'Corporate is giving me a lot of pressure to break this up!', "Let's put these unused wages to good use."],
'UnionBusterBreachOfContract': ["Someone isn't doing their part around here.", "This company will not tolerate any breach of contract, you will be punished.",
         "Your contract has been terminated, now suffer the consequence!"],
'UnionBusterBreachOfContract2': ["Someone isn't doing their part around here.", "This company will not tolerate any breach of contract, you will be punished.",
         "Your contract has been terminated, now suffer the consequence!"],
'UnionBusterBreachOfContract3': ["Someone isn't doing their part around here.", "This company will not tolerate any breach of contract, you will be punished.",
         "Your contract has been terminated, now suffer the consequence!"],
'UnionBusterBreachOfContract4': ["Someone isn't doing their part around here.", "This company will not tolerate any breach of contract, you will be punished.",
         "Your contract has been terminated, now suffer the consequence!"],
'UnionBusterContractEnforcement': ["We all need a little healing sometimes.", "The union ensures that all employees receive health benefits, we must shut them down.",
         "All employees are receiving a raise, effective immediately."],
#racketeer cheats
'RacketeerProfiteering': ["Give your power to me, and know it will not go in vain!", "Let's put this health to more use.", "Don't worry, your health will be put to much further use."],
'RacketeerExtortion': ["You're in way over your head!", "It will only be a pinch!", "You're health is now mine, Toons!", "A drink fit for me."],
'RacketeerExtortion2': ["You're in way over your head!", "It will only be a pinch!", "You're health is now mine, Toons!", "A drink fit for me."],
'RacketeerCompensation': ["You've had a rough day, take this bonus you're not finished yet!", "This is not over for you yet!",
         "Do I have to provide the muscle for you?!", "We're not going down that easily!"],
'RacketeerHustling': ["Let's see if you can comprehend this.", "Think fast!", "Eyes on the prize!",
         "Follow the groove!", "Let's check that attention span!",
         "Let's crank up the difficulty."],
'RacketeerRacketeering': ["Let's see if you can comprehend this.", "Don't bother trying THAT again!", "You won't fool me again, Toons!", "You're awfully reliant on your gags, let's see how you do with a few less choices."],
'RacketeerPeckingOrderRetaliation': ["Why don't you 'peck' on someone your own size?", "The real pecking order is now in action!",
...
'RacketeerPeckingOrderRetaliationSoak': ["Why don't you 'peck' on someone your own size?", "The real pecking order is now in action!",
         "If you weren't at the bottom of the pecking order before, this one will put you there.", "Birds of a feather strike together, again!",
         "Do not provoke the birds, if you don't want to get pecked."],
#radiographer cheats
'RadiographerRadioInfrequency': ["There's only static between us.",
"It appears our show's runtime has been cut short! I suppose we can move on to the weather.",
"Sounds like your broadcast is ending; all I'm hearing is dead air.",
"Apologies, but I'm changing this station."],
'RadiographerHotTake': ["Now we're cooking with gas.",
                    "Careful, this weeks takes are HOT HOT HOT!",
                    "Look out, there are some HOT new takes, coming your way!"],
'RadiographerHotTakeRetaliation': ["Now we're cooking with gas.",
                    "Careful, this weeks takes are HOT HOT HOT!",
                    "Look out, there are some HOT new takes, coming your way!"],
...
'HighRollerCommercialBreak': ["Ooo-well, ya know what they ffay: don't hate the Major Player, change the game!",
...
'HighRollerGameTimeSpawn': ["My memory iffn't aff good, but let'ff ffee if you can keep up.",
...
"I don't work pro bono, Toon."],
                    ...
                    'BanLevel4': {
                    'frs': ['Any Level 4 Gags Toons use will be cut from the budget.'],
                    None: ["Any Level 4 Gags Toons use can and will be held against them in a court of law."]},
                    'BanLevel5': {
                    'frs': ['Any Level 5 Gags Toons use will be cut from the budget.'],
                    None: ["Any Level 5 Gags Toons use can and will be held against them in a court of law."]},
                    'BanLevel6':  {
                    'frs': ['Any Level 6 Gags Toons use will be cut from the budget.'],
                    None: ["Any Level 6 Gags Toons use can and will be held against them in a court of law."]},
                    'BanLevel7': {
                    'frs': ['Any Level 7 Gags Toons use will be cut from the budget.'],
                    None: ["Any Level 7 Gags Toons use can and will be held against them in a court of law."]},
                    'BanLevel8': {
                    'frs': ['Any Level 8 Gags Toons use will be cut from the budget.'],
                    None: ["Any Level 8 Gags Toons use can and will be held against them in a court of law."]},
                    'BanLevel45': ["Any Level 4 and 5 Gags Toons use can and will be held against them in a court of law."],
                    'BanLevel46': ["Any Level 4 and 6 Gags Toons use can and will be held against them in a court of law."],
                    'BanLevel47': ["Any Level 4 and 7 Gags Toons use can and will be held against them in a court of law."],
                    'BanLevel48': ["Any Level 4 and 8 Gags Toons use can and will be held against them in a court of law."],
                    'BanLevel56': ["Any Level 5 and 6 Gags Toons use can and will be held against them in a court of law."],
                    'BanLevel57': ["Any Level 5 and 7 Gags Toons use can and will be held against them in a court of law."],
                    'BanLevel58':  ["Any Level 5 and 8 Gags Toons use can and will be held against them in a court of law."],
                    'BanLevel67':  ["Any Level 6 and 7 Gags Toons use can and will be held against them in a court of law."],
                    'BanLevel68':  ["Any Level 6 and 8 Gags Toons use can and will be held against them in a court of law."],
                    'BanLevel78':  ["Any Level 7 and 8 Gags Toons use can and will be held against them in a court of law."],
                    'BanToonup': {
                        'frs': ['Any Toon-Up Gags Toons use will also be cut from the budget.'],
                    None: ["Any Toon-Up Gags Toons use can and will be held against them in a court of law."]},
                    'BanTrap': {
                    'frs': ['Any Trap Gags Toons use will also be cut from the budget.'],
                    None: ["Any Trap Gags Toons use can and will be held against them in a court of law."]},
                    'BanLure':  {
                        'frs': ['Any Lure Gags Toons use will also be cut from the budget.'],
                    None: ["Any Lure Gags Toons use can and will be held against them in a court of law."]},
                    'BanThrow': {
                        'frs': ['Any Throw Gags Toons use will also be cut from the budget.'],
                    None: ["Any Throw Gags Toons use can and will be held against them in a court of law."]},
                    'BanSquirt':  {
                        'frs': ['Any Squirt Gags Toons use will also be cut from the budget.'],
                    None: ["Any Squirt Gags Toons use can and will be held against them in a court of law."]},
                    'BanZap':  {
                    'frs': ['Any Zap Gags Toons use will also be cut from the budget.'],
                    None: ["Any Zap Gags Toons use can and will be held against them in a court of law."]},
                    'BanSound':  {
                        'frs': ['Any Sound Gags Toons use will also be cut from the budget.'],
                    None: ["Any Sound Gags Toons use can and will be held against them in a court of law."]},
                    'BanDrop': {
                    'frs': ['Any Drop Gags Toons use will also be cut from the budget.'],
