...
'ubuster': ["Collective action? Not on my watch.",
            "Unions slow productivity. I eliminate inefficiences.",
            "You stand together now; let's see how long that lasts!",
            "I've shut down bigger movements than you.",
            "Hope you like mandatory overtime.",
            "Strikes end the moment I arrive."],
...
'PowerhouseSnipeCollectCall': "The Powerhouse becomes stronger every turn he is zapped!",
'PowerhouseGeneration': "The Powerhouse becomes stronger every turn he is soaked!",
...
'UnionBusterBreachOfContract': "The Union Buster applies a damage debuff to the least dangerous Toon!",
'UnionBusterBreachOfContract2': "The Union Buster retaliates against Toons with existing vulnerabilities!",
'UnionBusterBreachOfContract3': "The Union Buster retaliates against bombed Toons!",
'UnionBusterBreachOfContract4': "The Union Buster retaliates against Toons who chose banned gags!",
'UnionBusterContractEnforcement': "The Union Buster unionizes cogs!",
'UnionBusterContractEnforcement2': "The Union Buster unionizes cogs!",
    # Racketeer Cheats
...
'RacketeerExtortion': "The Racketeer syphons health from the Toons!",
...
'ChairmanSnipe': "The Chairman gains another attack when under half health!",
 ...
 'RecordkeeperPhantomEntryDamage': "The Recordkeeper takes damage when phantom entries are defeated!",
 ...
 'DividendLiquidationEventDamage': "Drowned Toons take extra damage every turn!",
 'DividendTotalMarketMeltdown': "The market has taken a huge hit!",
 'DividendTotalMarketMeltdown2': "The market has taken a huge hit!",
...
'HighRollerBar': "The Red Silhouette retaliates when left unlured or a trap is placed!",
'HighRollerSingingBlues': "The Blue Silhouette applies the winded effect to all Toons!",
'HighRollerDamageReduction': "The Light Blue Silhouette applies a damage down to Toons at random!",
'HighRollerSplashback': "The Pink Silhouette retaliates against Toons who soaked the Silhouettes!",
'HighRollerCheerRetaliation': "The Purple Silhouette retaliates against Toons with cheer!",
 ...
 'MintMovingGoalposts': "The Mint Supervisor randomizes blocked gag levels and tracks every round!",
...
SuitAttackNames = {
    ...
    'UnionBusterBreachOfContract': "Breach Of Contract!",
    'UnionBusterBreachOfContract2': "Breach Of Contract!",
    'UnionBusterBreachOfContract3': "Breach Of Contract!",
    'UnionBusterBreachOfContract4': "Breach Of Contract!",
    'UnionBusterContractEnforcement': "Mandatory Unionization!",
    'UnionBusterContractEnforcement2': "Mandatory Unionization!",
    # Racketeer Cheats
    ...
    # Factory Foreman Cheats
     ...
     'MintDisapprove': "",
     'MintSynergy': "Synergy!",
     'MintMovingGoalposts': "Moving Goalposts!",
    ...
    'HighRollerDamageReduction': "Joker!",
...
'cbutcher': ["You should've read the fine print!",
     ...
     'safesupervis': ["Time to take out the trash.",
                "You're a waste of workplace space!",
                "Unsafe material detected.",
...
'ShortSqueeze': {
       'hustle': ["Feel that? Space is closing in fast.",
                  "You're running out of room, and time!",
                "The market's turning on you!",
...
'FloodTheMarket': {
 ...
 'FingerWag': {
    ...
    'safesupervis': ["Unsafe behavior will NOT be tolerated!",
                "Stop right there, hazard!",
                "That's a proper correction!",
                "My finger points out every violation.",
                "Nothing escapes my inspection.",
 ...
 'Fired': {
     ...
     'safesupervis': ["You're unsafe for this workplace!",
                 "Consider this a mandatory discharge!",
                 "Toons like you are a hazard!",
                "My clipboard's filling with dismissals!",
                 "One less risk on the floor.",
                 "Unsafe behavior has consequences."],
...
'rkeeper': ["Time to put it in writing, permanently!",
 ...
 'GlowerPower': {
    'cbutcher': ["That fear? That's evaluation kicking in.",
     ...
     'ubuster': ["My stare cuts deeper than paperwork.",
                "Management is always... watching.",
                "Don't blink, Toon. You'll regret it.",
                "Still think you've got a backbone?",
                "Eyes forward, feel the pressure."],
 ...
 'HotAir': {
  'liquidr': ["All that buildup... and there's nothing behind it.",
    ...
    'safesupervis': ["Warning: prolonged exposure to me is hazardous!",
                    "This is for your own safety!",
                    "The safest workplace is a Cog-only workplace!",
                    "I'll bore you into compliance!",
                    "Time to blow some rules your way.",
                    "Attention, safety briefing in progress."],
...
'SongAndDance': {
 ...
 'RedTape': {
    ...
    'ubuster': ["Every strip pulls you tighter.",
                "Strangled in policy!",
                "Stand still.",
              "You're not getting through this.",
                "You're disappearing under policy.",
                "Union bound? No, Cog bound.",
                "Consider this your permanent restriction.",
              "Let's wrap this up, literally.",
              "The tighter it gets, the weaker you are."],
 ...
 'Sacked': {
     'safesupervis': ["Hazards belong in containment!",
              "Bagged and tagged for safety!",
              "Secured for disposal!",
            "Safer without you running around.",
              "Unsafe Toons must be contained.",
              "Time for a clean-up operation."],
...
'PowerhouseSnipeVulnerable': ["Let's see how long you last under real pressure!",
                              ...
                              "Do you feel that? That's power."],
'PowerhouseSnipeGagBan': ["Let's see how long you last under real pressure!",
                              "I don't need speed, I need results!",
                              "Let's apply pressure where it hurts!",
                              "Still standing? Not for long.",
                              "Do you feel that? That's power."],
'PowerhouseSnipeSoaked': ["Let's see how long you last under real pressure!",
                              "I don't need speed, I need results!",
                              "Let's apply pressure where it hurts!",
                              "Still standing? Not for long.",
                              "Do you feel that? That's power."],
'PowerhouseSnipeBookkept': ["Let's see how long you last under real pressure!",
                              "I don't need speed, I need results!",
                              "Let's apply pressure where it hurts!",
                              "Still standing? Not for long.",
                              "Do you feel that? That's power."],
'PowerhouseSnipeMulligan': ["Let's see how long you last under real pressure!",
                              "I don't need speed, I need results!",
                              "Let's apply pressure where it hurts!",
                              "Still standing? Not for long.",
                              "Do you feel that? That's power."],
...
'WiretapperWiretapped': ["Your health plan has been compromised.",
                         "I'll just reroute this signal, and your strength.",
                        "Tapped, tracked, and taxed!",
                         "Wiretap initiated... syphoning Toon health.",
                        "Your power is now... my connection.",
                        "Time to tap into your resources.",
                         "Your calls aren't private, and neither is your health."],
...
'UnionBusterUnionWages5': ["Unions think they deserve fair wages? I think not.",
                          "I'll pocket every paycheck before it reaches your hands!",
                            "You'll never see a paycheck, but you'll see my power!",
                          "I'll just redirect these wages into my power."],
'UnionBusterBreachOfContract': ["I'll find the loopholes, and you'll pay the penalties.",
                                "Don't bother reading the fine print, it's already against you.",
                                "This is what happens when you don't read the paperwork.",
                                "Consider this a lawsuit on your damage output.",
                                "You signed away your strength when you crossed me!"],
'UnionBusterBreachOfContract2': ["I'll find the loopholes, and you'll pay the penalties.",
                                "Don't bother reading the fine print, it's already against you.",
                                "This is what happens when you don't read the paperwork.",
                                "Consider this a lawsuit on your damage output.",
                                "You signed away your strength when you crossed me!"],
'UnionBusterBreachOfContract3': ["I'll find the loopholes, and you'll pay the penalties.",
                                "Don't bother reading the fine print, it's already against you.",
                                "This is what happens when you don't read the paperwork.",
                                "Consider this a lawsuit on your damage output.",
                                "You signed away your strength when you crossed me!"],
'UnionBusterBreachOfContract4': ["I'll find the loopholes, and you'll pay the penalties.",
                                "Don't bother reading the fine print, it's already against you.",
                                "This is what happens when you don't read the paperwork.",
                                "Consider this a lawsuit on your damage output.",
                                "You signed away your strength when you crossed me!"],
'UnionBusterContractEnforcement': ["Fine. If you won't fall in line, I'll make a union myself!",
                                "Congratulations! You're all officially represented!",
                                "Mandatory cooperation is still cooperation.",
                                "You answer to me now, collectively.",
                                "Group bargaining? I control both sides.",
                                   "Together, you're easier to manage!",
                                    "Your demands have been... overridden."],
'UnionBusterContractEnforcement2': ["Fine. If you won't fall in line, I'll make a union myself!",
                                "Congratulations! You're all officially represented!",
                                "Mandatory cooperation is still cooperation.",
                                "You answer to me now, collectively.",
                                "Group bargaining? I control both sides.",
...
'ContingencyOperationalFreeze': ["You won't act without my permission!",
                    "Operations are temporarily suspended.",
                                 "Obedience is mandatory.",
                                 "I determine what moves and when.",
                                     "Efficiency requires compliance.",
                                 "Your freedom ends at my discretion!",
                                 "You are constrained by my order!",
                      ],

'PresidentDeepFreeze': ["You've hit me thrice, now prepare to become ice."],
