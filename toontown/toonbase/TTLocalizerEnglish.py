...
'shy': ["Oh, don't be so shy.",
		"We need to lock about your lack of payment.",
		"I think you came a little shy of your payment.",
		"Payment is key to my success.",
		"You picked on the wrong lock.",
		"Remember, knowledge is key to the openings of success.",
		"Sorry, but our deal rates are locked.",
		"There's no shying away now.",
		"I lost the keys, so there is no escaping me.",
		"You're not my type."],
...
'cnd': ["Vote for me, and I shall defend our nation once again!"],
...
'UnionBusterContractEnforcement2': "The Union Buster binds cogs to a contract!",
    # Racketeer Cheats
'RacketeerOverextendedLeverage': "The Racketeer exposes himself when extortion is used!",
...
'RacketeerExtortion2': "The Racketeer retaliates against Toons who did not\nfollow his instructions!",
'RacketeerCompensation': "The Racketeer strengthens damaged cogs every turn he\nis unlured!",
...
'ChairmanSnipe': "The Chairman gains another attack when under\nhalf health!",
 ...
 'DividendPeckingOrder': "The Dividend King charges grunt cogs!",
...
SuitAttackNames = {
    ...
    # Racketeer Cheats
    'RacketeerOverextendedLeverage': "Overextended Leverage!",
    ...
    'TollmasterMissedPayment': "Missed Payment!",
...
'RacketeerExtortion2': ["Hand it over, I take what I'm owed.",
                       "Your health is my profit margin.",
                       "This isn't theft, it's a corporate collection.",
                       "I'll take my cut right out of your hide."],
...
'RacketeerOverextendedLeverage': ["I may have pushed a little too hard.",
                                         "Leverage comes with risk.",
                                        "Risk is all apart of the game.",
...
'TollmasterMissedPayment': ["That attempt does not count as payment.",
                    "Did you think dodging absolved you?",
                            "The toll does not disappear when ignored.",
                            "Avoidance noted, the penalty will be severe."
                      ],
