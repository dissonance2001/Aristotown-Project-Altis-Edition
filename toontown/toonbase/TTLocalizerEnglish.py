...
'enf': ["Get out of my way! No? I'll have to move you by force.",
           "You're forcing me to take extreme measures."],
...
'dc': ["You've crossed the line.",
		"You better keep your fingers crossed.",
		"Crossing you will be quite easy.",
		"Warning, you're subject to cross-examination.",
		"I think you look quite cross.",
		"I always come back for doubles.",
		"You know, I'd rather go for a Double Cheeseburger.",
		"Would you like it double wrapped?",
		"I deliver quite the double WHAMMY.",
		"Let's double-check our plans."],
...
'CaseManagerInsurancePlan2':  "The Case Manager ensures that cogs are healed\nevery round!",
...
'PowerhouseGeneration': "The Powerhouse becomes stronger every turn he is\nsoaked!",
'PowerhouseGeneration2': "The Powerhouse becomes stronger after every\ntransition!",
'PowerhouseBurnDamage': "",
    # Bookkeeper Cheats
'BookkeeperPaperCutSoaked': "The Vaultmaster retaliates against marked Toons!",
'BookkeeperPaperCutMarked': "The Vaultmaster gains a damage boost when not attacked\nduring Closed Session!",
'BookkeeperPaperCut': "The Vaultmaster marks a Toon to take extra damage!",
'BookkeeperExplodingDocument': "The Vaultmaster restricts all high leveled gags from\na Toon!",
'BookkeeperMandatoryFiling': "The Vaultmaster removes your defense!",
'BookkeeperBookkeepingRetaliation': "The Vaultmaster retaliates against toons who attacked\nhim while in Closed Session!",
'BookkeeperBookkeeping': "The Vaultmaster is focusing, if left unattacked, he will\nbecome stronger!",
    # Wiretapper Cheats
...
'AmbassadorRefinement': "The Ambassador drowns cogs in oil to make them\nstronger!",
'AmbassadorRefinementManager': "The Ambassador heals all manager cogs!",
'AmbassadorGhostMentality': "The Ambassador virtualizes all cogs and supplies\na damage boost!",
...
'SafetyOverpressureDeath': "The Pressurizer takes damage when overpressured cogs are\ndestroyed!",
    # Union Buster Cheats
'UnionBusterUnionDues': "The Union Buster overworks all Toons when the battle is\nfull!",
'UnionBusterUnionCalculator': "The Union Buster increases the amount of overtime hours\nwhen cogs are sacrificed!",
'UnionBusterUnionBust': "The Union Buster sacrifices cogs at will!",
'UnionBusterUnionBuster': "The Union Buster forces Toons to take damage every\nround!",
'UnionBusterUnionBusterDamage': "Employed toons are forced to take damage every round!",
'UnionBusterNoStrikeClause': "The Union Buster removes the Toon's ability to\ndodge all incoming cog attacks!",
'UnionBusterUnionWages': "The Union Buster becomes stronger for every cog that\n is sacrificed!",
'UnionBusterUnionWages2': "The Union Buster becomes stronger for every cog that\n is sacrificed!",
'UnionBusterUnionWages3': "The Union Buster becomes stronger for every cog that\n is sacrificed!",
'UnionBusterUnionWages4': "The Union Buster becomes stronger for every cog that\n is sacrificed!",
'UnionBusterUnionWages5': "The Union Buster becomes stronger for every cog that\n is sacrificed!",
'UnionBusterBreachOfContract': "The Union Buster applies a damage debuff to the least\ndangerous Toon!",
'UnionBusterBreachOfContract2': "The Union Buster retaliates against Toons with existing\nvulnerabilities!",
...
'RacketeerOverextendedLeverage2': "The Racketeer exposes himself when the Racket\noverinflates!",
'RacketeerProfiteering': "The Racketeer strengthens himself by stealing resources\nfrom other cogs!",
'RacketeerProfiteering2': "The Racketeer strengthens himself by stealing resources\nfrom other cogs!",
'RacketeerProfiteering3': "The Racketeer strengthens himself by stealing resources\nfrom other cogs!",
'RacketeerProfiteering4': "The Racketeer strengthens himself by stealing resources\nfrom other cogs!",
'RacketeerProfiteering5': "The Racketeer strengthens himself by stealing resources\nfrom other cogs!",
'RacketeerExtortion': "The Racketeer syphons health from the Toons!",
'RacketeerExtortion2': "The Racketeer collects his dues when the Racket is\nfull!",
...
'RadiographerHotTake': "The Radiographer applies a dangerous vulnerability to\nToons at random!",
'RadiographerHotTakeRetaliation': "The Pressurizer uses resources from the ashes to\ncreate an evil Toon!",
'RadiographerOvermodulated': "The Radiographer unlures a cog and gives them an\nextra attack!",
'RadiographerOvermodulated2': "The Radiographer unlures a cog and gives them an\nextra attack!",
'RadiographerOvermodulated3': "The Radiographer unlures a cog and gives them an\nextra attack!",
'RadiographerOvermodulated4': "The Radiographer unlures a cog and gives them an\nextra attack!",
'RadiographerOvermodulated5': "The Radiographer unlures a cog and gives them an\nextra attack!",
'RadiographerDanceSession': "The Radiographer is now taking and dealing less\ndamage while in this mode!",
    # Derrick Man Cheats
'DerrickManRefinement': "The Derrick Man heals all cogs for 40% of\ntheir max HP!",
    # DOLA Cheats
'DOLAInkDrain': "All gags are 25% less effective for 2 rounds!",
    # DOPR Cheats
'DOPRAmbushMarketing': "The D.O.P.R. gains another attack every turn they are\nnot hit!",
...
'OttomanRedPenReview': "The Ottoman retaliates against the least dangerous\ntoon!",
...
'OttomanPerformanceReviewRevert': "The Ottoman completes his review!",
    # Crystalline Cheats
'CrystalShatteringClarity': "Crystalline confuses the most dangerous Toon and\nstrengthens all damaged cogs!",
'CrystalRefractDamage': "Crystalline is redirecting damage dealt towards her\nallies!",
...
'CrystalFracturedLimitsRetaliation': "Crystalline retaliates against Toons who chose\nbanned gags!",
'CrystalPrismaticDistortion': "Crystalline randomizes the Toons damage output!",
    # Chairman Cheats
'ChairmanTrapRetaliation': "The Chairman retaliates against toons who used Trap\nagainst him!",
'ChairmanLureRetaliation': "The Chairman retaliates against toons who used Lure\nagainst him!",
'ChairmanThrowRetaliation': "The Chairman retaliates against toons who used Throw\nagainst him!",
'ChairmanSquirtRetaliation': "The Chairman retaliates against toons who used Squirt\nagainst him!",
'ChairmanZapRetaliation': "The Chairman retaliates against toons who used Zap\nagainst him!",
'ChairmanSoundRetaliation': "The Chairman retaliates against toons who used Sound\nagainst him!",
'ChairmanDropRetaliation': "The Chairman retaliates against toons who used Drop\nagainst him!",
...
'ChairmanSnipe': "The Chairman gains another attack when under\nhalf health!",
    # Liquidator Cheats
 ...
 'LiquidatorMonsoon': "The weather is changing!",
    # Tollmaster Cheats
 'TollmasterMandatoryToll': "The Tollmaster increases the Toll cost for Toons that\nattacked him!",
 'TollmasterMandatoryTollFinal': "The Tollmaster collects his dues!",
 'TollmasterMissedPayment': "The Tollmaster strips the defense and grants a damage\nboost to full Laff Toons!",
 ...
 'TollmasterBalanceTheLedger': "The Tollmaster destroys damaged cogs and distributes\ntheir resources to all manager cogs!",
 'TollmasterBalanceTheLedger2': "The Tollmaster destroys damaged cogs and distributes\ntheir resources to all manager cogs!",
 'TollmasterBalanceTheLedger3': "The Tollmaster destroys damaged cogs and distributes\ntheir resources to all manager cogs!",
 'TollmasterBalanceTheLedger4': "The Tollmaster destroys damaged cogs and distributes\ntheir resources to all manager cogs!",
 'TollmasterBalanceTheLedger5': "The Tollmaster destroys damaged cogs and distributes\ntheir resources to all manager cogs!",
    # Recordkeeper Cheats
 'RecordkeeperMinutesTaken': "The Recordkeeper increases the audit when attacked or\nwhen banned gags are used!",
 'RecordkeeperMinutesTakenContingency': "The Recordkeeper increases the audit when the\nContingency Director gains an ability!",
 'RecordkeeperMinutesTakenDamage': "The minutes are adding up!",
 'RecordkeeperPaperTrail': "The Phantom Recordkeeper creates a shadow entity\nof a Toon!",
 'RecordkeeperRevisedFiling': "Toons will now receive and deal more damage at\nrandom!",
 ...
 'RecordkeeperPhantomEntryDamage': "The Recordkeeper takes damage when phantom entries are\ndefeated!",
 'RecordkeeperPhantomEntrySpawn': "The Recordkeeper creates a shadow entity of herself!",
 'RecordkeeperPhantomEntrySacrifice': "The Phantom Recordkeeper donates her remaining health\nto the Recordkeeper!",
 ...
 'ButcherRevvingUpWhipsaw': "The Corporate Butcherer gains RPM when attacked!\n(Whipsaw: +4,000 RPM)",
 'ButcherKickback': "The Corporate Butcherer is now vulnerable for 2 turns!",
 'ButcherMarkedWood': "The Corporate Butcherer marks the most dangerous\ntoon for termination!",
 ...
 'ButcherSparkPlug': "The Corporate Butcherer inflicts damage over time\nto a Toon!",
 'ButcherSparkPlugDamage': "",
 ...
 'ContingencyRiskThresholdBreach25': "The Contingency Director retaliates against marked\nToons!",
 ...
 'TollmasterResonanceTax': "The Dividend King becomes stronger for every cog\ndefeated!",
 'TollmasterResonanceTax2': "The Dividend King becomes stronger for every cog\ndefeated!",
 'TollmasterResonanceTax3': "The Dividend King becomes stronger for every cog\ndefeated!",
 'TollmasterResonanceTax4': "The Dividend King becomes stronger for every cog\ndefeated!",
 'TollmasterResonanceTax5': "The Dividend King becomes stronger for every cog\ndefeated!",
...
'HighRollerGameTimeCog': "The High Roller asks a contestant to answer a\ntrivia question!",
...
'HighRollerBar': "The Red Silhouette retaliates when left unlured or a\ntrap is placed!",
...
'HighRollerCheerRetaliation': "The Purple Silhouette retaliates against Toons with\ncheer!",
    # Videographer Cheats
 'VideographerHardCut': "The Videographer takes random gag levels off the\nscript!",
 ...
 'BroadcasterDonation2': "The Videographer Silhouette donates part of his health\nto the Videographer!",
 ...
 'FilmmakerCameraRewind': "The Filmmaker heals damaged producers and\nstrengthens undamaged producers!",
 ...
 'DirectorActionRetaliation': "The Director retaliates against Toon's who did not follow\nhis orders!",
 'DirectorBackToOnes': "The Director goes back to full health while all\nproducer's are still standing!",
 'DirectorBudgetExpansion': "The Director inflates the budget whenever cogs are\ndestroyed!",
 'DirectorProductionBudget': "The budget is inflating!",
    # Factory Foreman Cheats
 'ForemanSnipe': "not needed",
 'ForemanRedTape': "The Factory Foreman places 2 Toons on cooldown at\nrandom!",
 ...
 'ForemanSleepyOvercharge': "",
 'ForemanExplosion': "",
 'ForemanCompensation': "The Factory Foreman will get stronger with each\ncog defeated!",
 'ForemanCompensation2': "The Factory Foreman will get stronger with each\ncog defeated!",
 'ForemanCompensation3': "The Factory Foreman will get stronger with each\ncog defeated!",
 'ForemanCompensation4': "The Factory Foreman will get stronger with each\ncog defeated!",
 'ForemanCompensation5': "The Factory Foreman will get stronger with each\ncog defeated!",
    # Mint Supervisor Cheats
 'MintLifeInsurance': "If other cogs are alive, The Mint Supervisor will\nheal and get a damage boost!",
 'MintPolicyTerminated': "",
 'MintFraudulentDamage': "",
 ...
 'MintAccountant1': "The Mint Supervisor requires a certain number of\ntargets!",
 'MintAccountant2': "The Mint Supervisor requires a certain number of\ntargets!",
 'MintAccountant3': "The Mint Supervisor requires a certain number of\ntargets!",
 'MintAccountant4': "The Mint Supervisor requires a certain number of\ntargets!",
 'MintAccountant5': "The Mint Supervisor requires a certain number of\ntargets!",
 'MintApprove': "",
 'MintDisapprove': "",
 'MintSynergy': "The Mint Supervisor punishes the Toons for not following\nhis calculations!",
 'MintMovingGoalposts': "The Mint Supervisor randomizes blocked gag levels\nand tracks every round!",
 'MintHurrySickness': "The Mint Supervisor punishes Toons that chose banned\ngags!",
 ...
 'AttorneyObjectionOverruled': "The Head Attorney has no evidence to support his\nclaim!",
 'AttorneyOverseerHeal': "",
 'AttorneyChrono': "",
 'AttorneyOverseer': "",
 'AttorneyRushJob': "The Head Attorney requires certain gag usage!",
 'AttorneyHurrySickness': "The Head Attorney punishes the Toons for not following\nhis orders!",
 'WhistleCompensation': "The Whistleblower supplies a damage boost to all\ndamaged cogs!",
 ...
 'PresidentSnap': "The Club President places a damage vulnerability on\na random Toon!",
 'PresidentSyphon': "The Club President syphons health from the Toons!",
 'PresidentBayouBellow': "The Club President removes all negative effects from\nthe cogs!",
 ...
 'PresidentDriver': "The Club President applies a damage debuff to 2 Toons\nat random!",
...
'RadiographerHotTake': ["Breaking news: This Toon couldn't handle the heat!",
                    "Ooooh, the audience doesn't like you!",
                    "The hotter it gets, the quicker you'll melt.",
                    "Hot take: You won't survive the next punchline.",
                    "Shining the spotlight on YOU, Toon."],
