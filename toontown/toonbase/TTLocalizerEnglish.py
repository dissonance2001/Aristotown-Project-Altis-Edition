...
SuitBaseNameWithLevelHP = '%(currHP)s'
...
SuitCheatNames = ('CourtCosts', 'Cage', 'PaperCut', 'WireCut', 'Wiretapped', 'Voicemail', 'CollectCall', 'CollectCallFees', 'ExplodingBill', 'FireCog', 'GoodMorningToontown', 'Caress', 'RadioInfrequency', 'MobMentality', 'SlushFund', 'CeaseAndDesist', 'JuryNotice', 'Investment', 'ManagerialProtection', 'QualityControl3', 'QualityLvlControl2', 'QualityLvlControl1', 'QualityLvlControl', 'QualityLvlControl3', 'FieldPromotion', 'QualityControl1', 'QualityControl2', 'QualityControl', 'WheelSpin', 'Snap2', 'Accusations', 'Accusations2', 'GameShow', 'OilRain', 'Embezzle', 'Spotlight', 'ConeOfShame', 'UnionBuster', 'UnionDues', 'Drowning', 'HeadRoller', 'HeadRoller2', 'HeadRoller3', 'UnionBust', 'UnionBust2', 'UnionBust3', 'CourtMandate', 'CourtMandate1', 'CourtMandate2', 'CourtMandate3', 'LegalBindings', 'HeavyRainfall', 'InkDrain', 'SwirlBath', 'AfterShock', 'FreezingRain', 'CourtSanction', 'Bomb', 'Gavel', 'CourtRecord1', 'CourtRecord2', 'CourtRecord3', 'CourtRecord4', 'CourtRecord5', 'BookKeeping', 'Enraged', 'Blast', 'RevvingUp', 'Detonate', 'Detonate2', 'Detonate3', 'ChainsawDetonate', 'ChainsawDetonate2', 'ChainsawDetonate3', 'WhitePowder', 'PoisonSpray', 'InsurancePlan', 'Snap', 'ClockChange', 'StealSafe', 'Synergy', 'HeatWave', 'Refinement', 'ExtraTip', 'LifeInsurance', 'WorkersCompensation')
SuitCheatDescription = {
'Blast': 'All toons take a huge loss!',
    'Gavel': 'All gags have been banned for 1 turn!',
'UnionBuster': 'Retaliates against the least dangerous toon!',
'Spotlight': 'Heals all cogs that can perform!',
    'UnionDues': 'The dues are racking up!',
    'SwirlBath': 'All gags have been given an massive damage boost!',
    'LegalBindings': "The Case Manager binds a toon to take\nextra damage for 2 turns!",
  'CourtCosts': 'The fees are racking up!',
...
'Accusations2': "This toon is about to stand trial!",
    'GameShow': "A random cog is chosen to participate in\nthe game show!",
    ...
    'Embezzle': "Steals the toon's health!",
...
'ExtraTip': "One cog receives a health bonus and has all\n negative effects removed!",
...
'Synergy': 'The interest fees are racking up!',
'WhitePowder': 'The Litigator removes all negative affects\nfrom the cogs!',
...
'PoisonSpray': "The Scapegoat's temperature has cooled down\nand is now protecting cogs again!" ,
'InsurancePlan': 'Insures that all cogs in battle receive\na health bonus!',
'Bomb': "You better take cover!",
'InkDrain': 'All gags are now less effective!',
...
'SlushFund': "Makes a manager immune for 1 turn!",
...
'CollectCallFees': "The fees are racking up!",
...
"Ring-a-ling it's for you! Better pick it up before it's too late!",
              "Hmm, looks like our connection was dropped."],
'CollectCallFees': ["10 Dollars, 20 Dollars, 30 Dollars, 40 Dollars, I think it's time you hang up the phone.",
"You can't handle the expenses.",
              "I don't accept payment plans for collect calls."],
'SlushFund': [ "Guess we gotta make use of this raise somehow!",
"Consider this your share for this operation.",
"Money can't provide happiness above the family, but it'll do for now!",
...
"ORDER TO ATTACK HAS BEEN RECEIVED AND PROCESSED.",
 ...
 'HypnoEyes': ["Do I gotta provide the muscle for ya?!",
