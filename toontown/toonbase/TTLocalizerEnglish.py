...
'HighRollerGameTimeSpawn','HighRollerGameTimeCog',
...
'HighRollerWheelSpin': "The High Roller spins the wheel!",
...
'HighRollerSplashback': "The Pink Silhouette retaliates against Toons who soaked the\nSilhouettes",
...
'HighRollerConduction': "Con-Duck_Tion!",
...
#high roller silhouette cheats
'HighRollerDonation': ["There'ff no fun in plaHAHAying it ffafe! Live a little!",
"What'ff life without a little riffk here and there?",
"You'd befft go big or GO HOME!",
"It'ff all or nothing, doll!",
"But what if the fftakeff were EVEN HIGHER?!"],
'HighRollerSyphon': ["Can't ffquaffh and fftretch your way out of thiff one, Toonff!",
"Who'ff ready for ffome cartoon violenffe?!",
"FForry, babe, but the ratingff don't lie! Thiff iff what the viewerff want!",
"And the ratingff FFKYROCKET!!!",
"If it meanff anything, thiff iff gonna hurt me a lot more than it hurtff you!",
"'Ker-ffplat!' HahaHAHA!!! You Toonff really are funny!"],
'HighRollerBar': ["Watch your HEADTH!",
"INCOMIN'!",
"DON'T TRIP!",
"I'm raithin' the BAR! HA!!"],
'HighRollerSingingBlues': ["Can't ffquaffh and fftretch your way out of thiff one, Toonff!",
"Who'ff ready for ffome cartoon violenffe?!",
"FForry, babe, but the ratingff don't lie! Thiff iff what the viewerff want!",
"And the ratingff FFKYROCKET!!!",
"If it meanff anything, thiff iff gonna hurt me a lot more than it hurtff you!",
"'Ker-ffplat!' HahaHAHA!!! You Toonff really are funny!"],
'HighRollerDamageReduction': ["WHAT A TWIFFT!!!",
"'FFLAM!' What a ffweet ffound!",
"Now, you ffigned up for thiff!"],
'HighRollerSplashback': ["WHAT A TWIFFT!!!",
"Now, you ffigned up for thiff!"],
'HighRollerCheerRetaliation': ["WHAT A TWIFFT!!!",
"'FFLAM!' What a ffweet ffound!",
"Now, you ffigned up for thiff!"],
                    # universal cheats
