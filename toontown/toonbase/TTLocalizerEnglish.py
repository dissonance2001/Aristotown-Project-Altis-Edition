...
'ang': ["Music is well said to be the speech of angels.",
...
'liquid': ["You've reached the toll.",
            "Every step forward carries a price.",
            "You are out of time.",
            "This delay will be costly."],
'rkeeper': ["Please stand still... I need an accurate record.",
            "Interesting. You don't look like your file.",
            "Everything you do will be documented."],
'cbutcher': ["Please stand still... I need an accurate record.",
            "Interesting. You don't look like your file.",
            "Everything you do will be documented."],
'cdirector': ["This encounter has already been resolved. You're just late.",
              "You are now operating outside acceptable risk.",
...
'SongAndDance': {
 ...
 'PlayHardball': {
    'liquid': ["You really thought we were negotiating?",
                 "You pushed this too far, now deal with it!",
                 "This is what resistance earns.",
                 "Was compliance that difficult?"],
 ...
 'RedTape': {
     'liquid': ["Did you submit the proper request?",
                "Stand by, and keep standing.",
                "Denied. Refile. Denied again.",
                "This is why the board doesn't ask."],
