...
'videog': ["You aren't a good fit for this show.",
            "Apologies, but I am changing the station.",
            "Goodnight, Toon. Goodnight.",
            "There's only static between us."],
...
'PowerhouseBurnDamage': "",
    # Bookkeeper Cheats
'BookkeeperPaperCutSoaked': "The Chief Archivist retaliates when soaked!",
'BookkeeperPaperCutMarked': "The Chief Archivist retaliates when marked!",
'BookkeeperPaperCut': "The Chief Archivist applies a damage vulnerability to the\nmost dangerous Toon!",
'BookkeeperExplodingDocument': "The Chief Archivist applies a damage debuff to a Toon!",
'BookkeeperMandatoryFiling': "The Chief Archivist removes a Toon's defense!",
'BookkeeperBookkeepingRetaliation': "The Chief Archivist retaliates against toons who attacked\nhim while in Closed Session!",
'BookkeeperBookkeeping': "The Chief Archivist is focusing, and must not be\ntargeted!",
    # Wiretapper Cheats
'WiretapperCollectCall': "The Wiretapper doubles the dues for the most dangerous\nToon!",
...
'WiretapperBusySignal': "The Wiretapper redirects her profits to buff her\nteam!",
...
SuitAttackNames = {
    ...
    'CaseManagerLegalBindings2': "Legal Bindings!",
    ...
    'BookkeeperPaperCutMarked': "Paper Cut!",
    'BookkeeperPaperCut': "Paper Cut!",
    'BookkeeperMandatoryFiling': "Mandatory Filing!",
    'BookkeeperExplodingDocument': "Cook The Books!",
    ...
    'WiretapperBusySignal': "Accrued Call Dues!",
    # Ambassador Cheats
    ...
    'AmbassadorManagerialProtectionImmunity': "Fore!",
    'AmbassadorMulligan': "Fore!",
    # Safety Supervisor Cheats
...
'PennyPinch': {
 ...
 'MarketCrash': {
    ...
    'bkeeper': ["Bankrupt... and broken.",
                "Hmm. Stocks... falling.",
                "Hmm. Recession... for you.",
                "Your value... dropped.",
                "Market... against you."],
...
'SongAndDance': {
 ...
 'RedTape': {
    ...
    'ubuster': ["Every strip pulls you tighter.",
     ...
     'bkeeper': ["Hmm. Paperwork... binding.",
              "Wrapped... in policy.",
              "Trapped... in process.",
              "Strangled... in procedure.",
...
'WiretapperBusySignal': ["Every minute you stay connected, the bill keeps climbing.",
                        "Collect calls aren't cheap, and someone's paying.",
                        "I've been on the line long enough. Time to collect.",
                         "All fees rerouted to corporate accounts.",
                        "Let's reinvest those dues into productivity.",
                         "Time on the line converted into power.",],
'WiretapperBrokenConnection': ["Signal lost... my defenses are down!",
                                "Even with a bad signal, I pack a punch.",
                                "I may drop calls, but I won't drop charges.",
