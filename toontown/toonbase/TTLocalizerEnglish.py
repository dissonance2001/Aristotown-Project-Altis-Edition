 ...
 'bfh' :['Prepare for a Nuclear meltdown.',
         ...
         'Steer Nu-clear!'],
                     'bkp': ['Prepare for a Nuclear meltdown.',
                             ...
                             'The only poison needed to take you down is from me.',
                             'Steer Nu-clear!'],
                     'vpr': ["Your knowledte doesn't go beyond this.",
...
'sdb': ["Oh good, I was starting to get bored."],
'sys': ["Oh good, I was starting to get bored."],
'pyc': ["Oh good, I was starting to get bored."],
'kyl': ["Oh good, I was starting to get bored."],
'gry': ["Oh good, I was starting to get bored."],
'shp': ["I can 'see' your defeat."],
'phs': ["Does something smell 'phishy' around here? No, it's just me!"],
'inw': ["Welcome to the installation wizard!"],
'rus': ["I will get to the root of this problem."],
'kbc': ["Get ready for this flame war."],
                     'skd': ['Just a second, I need to download those first.',
                             'Watch my skills!'],
                     'cmk': ["Glad I've brought my Disassembler today!",
                             "You're not going to like my code."],
 ...
 'bdb': ["Even 'Legal Eagle' is terrified of me.",
...
'txm': ["Whether you're left or right, I'll always be in the middle.",
 ...
 'ac': ["I'm gonna give you double the trouble.",
        ...
        'Doubles anyone??'],
                     'ym': ["Hmph.",
                            'Hmph.'],
                     'isw': ["You're way over your hours this week, I'm going to need you to clock out and go home.",
                            '5 day work week? Never heard of em.'],
'ka': ["Vote for me, and I shall make Cog Nation great again!",
    'I will build a great great wall across the border of Cog Nation, so no Toon shall ever invade our home again!'],
                     ...
                     'trb': ["Does it smell a little moldy around here? Or is it just me?"],
'trm': ["You have no right to assembly here."],
'dvg': ["No matter how hard you try, you will never be as successful as I am.",
        "The way you're trying to hard is utterly pathetic."],
...
'ts': ["I'll be sure to drill in the point.",
"I'm suspending this well, Toon.",
"This will be a spinning success.",
"You seem to be getting a bit dizzy."],
...
'frs': ["Hello? Are you going to pick up?",
