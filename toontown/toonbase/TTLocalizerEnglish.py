...
'PowerhouseSnipeMulligan': "The Powerhouse retaliates against toons who were targeted\nby the Mulligan!",
'PowerhouseSnipeCollectCall': "The Powerhouse retaliates against toons who owe collect\ncall dues!",
    # Bookkeeper Cheats
...
SuitAttackTaunts = {
    'AcidRain': ["It's sulfur you.",
                ...
                'pHew, that was close.'],
'Beguile': ["It's two for the price of one!",
...
'PowerhouseLureImmune': ["I won't fall for your mind tricks this time, Toons.",
                         "You won't be able to attract my metal now, Toon.",
                        "There's no such thing as 'free money' in today's world."],
'PowerhouseSyphon': ["I'm not ready to give up quite yet.", "Time to give myself that much needed bonus.",
                     "Your health is mine.",
                        "You hit me, I hit you back even harder."],
'PowerhouseSyphonDesperation': ["Your attacks will be more enlightening from now on."],
'PowerhouseSnipeVulnerable': ["Prepare for pain.",
                              "The first attack may have hurt a little, but this will hurt a lot more.",
                              "I always stay on the cutting edge.",
                              "My 'piercing intellect' may surprise you.",
                              "I've had enough of you!"],
'PowerhouseSnipeGagBan': ["Prepare for pain.",
                          "The first attack may have hurt a little, but this will hurt a lot more.",
                          "I always stay on the cutting edge.",
                          "My 'piercing intellect' may surprise you.",
                          "I've had enough of you!"],
'PowerhouseSnipeSoaked': ["Prepare for pain.",
                          "The first attack may have hurt a little, but this will hurt a lot more.",
                          "I always stay on the cutting edge.", "My 'piercing intellect' may surprise you.",
                          "I've had enough of you!"],
'PowerhouseSnipeBookkept': ["Prepare for pain.",
                            "The first attack may have hurt a little, but this will hurt a lot more.",
                            "I always stay on the cutting edge.", "My 'piercing intellect' may surprise you.",
                            "I've had enough of you!"],
'PowerhouseSnipeMulligan': ["Prepare for pain.",
                            "The first attack may have hurt a little, but this will hurt a lot more.",
                            "I always stay on the cutting edge.", "My 'piercing intellect' may surprise you.",
                            "I've had enough of you!"],
'PowerhouseSnipeCollectCall': ["Prepare for pain.",
                               "The first attack may have hurt a little, but this will hurt a lot more.",
                               "I always stay on the cutting edge.", "My 'piercing intellect' may surprise you.",
                               "I've had enough of you!"],
                    #wiretapper cheats
'WiretapperCollectCall': ["This is operator 44, you have an incoming call from.....ME!",
...
'WiretapperBrokenConnection': ["Hmm, looks like our connection was dropped.",
                    ...
                    #ambassador cheats
'AmbassadorHeadRoller': ['Your heads will roll for this one.', "Your services are no longer required.",
                         "Let's put this cog's health to good use shall we?"],
'AmbassadorHeadRollerGroup': ["Such a shame, you can't find good help these days,"],
'AmbassadorRefinement': ["It's important to stay adequately oiled when defeating Toons.",
                         "I'm suspending this well.",
                        "Freshly drilled to keep us in working order."],
'AmbassadorRefinementManager': ["You've done great work today. Here's an extra tip.",
...
'AmbassadorMulligan': ['I certainly will take a mulligan.',
...
'SafetyHighPressure':  ["Can you handle the pressure?",
                        "I've had enough of all of this, your output rate is not high enough!",
                        "We don't have enough coverage, I'm going to need you to work even harder!"],
'SafetyHeatWave': ["You're about to have a meltdown, Toons.",
                    "Hope you wore sunscreen, this battle is about to get even hotter!",
...
'SafetyPromotion2': ["You've done great work today, here's a raise.",
                    "This is the only way you're gonna get that promotion!"],
'SafetyPromotion3': ["You've done great work today, here's a raise.",
                    "This is the only way you're gonna get that promotion!"],
'SafetyPromotion4': ["You've done great work today, here's a raise.",
                    "This is the only way you're gonna get that promotion!"],
'SafetyPromotion5': ["You've done great work today, here's a raise.",
                    "This is the only way you're gonna get that promotion!"],
#union buster cheats
...
'UnionBusterUnionWages': ["The harder your Union crashes, the stronger I become.",
                          'Corporate is giving me a lot of pressure to break this up!',
                          "Let's put these unused wages to good use."],
'UnionBusterBreachOfContract': ["Someone isn't doing their part around here.",
                                "Did you think the Union was going to protect you from this?",
                                "This company will not tolerate any breach of contract, you will be punished.",
                                "You can't stop production."],
'UnionBusterBreachOfContract2': ["Someone isn't doing their part around here.",
                                    "Did you think the Union was going to protect you from this?",
                                 "This company will not tolerate any breach of contract, you will be punished.",
                                 "You can't stop production."],
'UnionBusterBreachOfContract3': ["Someone isn't doing their part around here.",
                                    "Did you think the Union was going to protect you from this?",
                                 "This company will not tolerate any breach of contract, you will be punished.",
                                 "You can't stop production."],
'UnionBusterBreachOfContract4': ["Someone isn't doing their part around here.",
                                    "Did you think the Union was going to protect you from this?",
                                 "This company will not tolerate any breach of contract, you will be punished.",
                                 "You can't stop production."],
'UnionBusterContractEnforcement': ["We all need a little healing sometimes.",
                                   "The union ensures that all employees receive health benefits, we must shut them down.",
                                    "All employees are receiving a raise, effective immediately."],
#racketeer cheats
'RacketeerProfiteering': ["Give your power to me, and know it will not go in vain!",
                          "Let's put this health to more use.",
                          "Don't worry, your health will be put to much better use."],
'RacketeerProfiteering2': ["Give your power to me, and know it will not go in vain!",
                          "Let's put this health to more use.",
                          "Don't worry, your health will be put to much better use."],
'RacketeerProfiteering3': ["Give your power to me, and know it will not go in vain!",
                          "Let's put this health to more use.",
                          "Don't worry, your health will be put to much better use."],
'RacketeerProfiteering4': ["Give your power to me, and know it will not go in vain!",
                          "Let's put this health to more use.",
                          "Don't worry, your health will be put to much better use."],
'RacketeerProfiteering5': ["Give your power to me, and know it will not go in vain!",
                          "Let's put this health to more use.",
                          "Don't worry, your health will be put to much better use."],
'RacketeerExtortion': ["You're in way over your head!",
                       "It will only be a pinch!",
                       "You're health is now mine, Toons!",
                       "A drink fit for me."],
'RacketeerExtortion2': ["You're in way over your head!",
                        "It will only be a pinch!",
                        "You're health is now mine, Toons!",
                        "A drink fit for me."],
'RacketeerCompensation': ["You've had a rough day, take this bonus you're not finished yet!",
                          "This is not over for you yet!",
                         "Do I have to provide the muscle for you?!",
                          "We're not going down that easily!"],
'RacketeerHustling': ["Let's see if you can comprehend this.",
                      "Think fast!",
                      "Eyes on the prize!",
                        "Follow the groove!",
                      "Let's check that attention span!",
                        "Let's crank up the difficulty."],
'RacketeerRacketeering': ["Let's see if you can comprehend this.",
                          "Don't bother trying THAT again!",
                          "You won't fool me again, Toons!",
                          "Fool me once... you know the rest.",
                          "You're awfully reliant on your gags, let's see how you do with a few less choices."],
...
'RadiographerOvermodulated2': ["Are you trying to insult me? Wake up and pay attention!",
                    "You won't be slacking in my presence!",
                    "It looks like you'll be working overtime today."],
'RadiographerOvermodulated3': ["Are you trying to insult me? Wake up and pay attention!",
                    "You won't be slacking in my presence!",
                    "It looks like you'll be working overtime today."],
'RadiographerOvermodulated4': ["Are you trying to insult me? Wake up and pay attention!",
                    "You won't be slacking in my presence!",
                    "It looks like you'll be working overtime today."],
'RadiographerOvermodulated5': ["Are you trying to insult me? Wake up and pay attention!",
                    "You won't be slacking in my presence!",
                    "It looks like you'll be working overtime today."],
...
'BanToonup': {'wtapper': ['Any Toon-Up Gags Toons use will also be cut from the budget.'],
                    None: ["Any Toon-Up Gags Toons use can and will be held against them in a court of law."]},
'BanTrap': {'wtapper': ['Any Trap Gags Toons use will also be cut from the budget.'],
                    None: ["Any Trap Gags Toons use can and will be held against them in a court of law."]},
'BanLure':  {'wtapper': ['Any Lure Gags Toons use will also be cut from the budget.'],
                    None: ["Any Lure Gags Toons use can and will be held against them in a court of law."]},
'BanThrow': {'wtapper': ['Any Throw Gags Toons use will also be cut from the budget.'],
                    None: ["Any Throw Gags Toons use can and will be held against them in a court of law."]},
'BanSquirt':  {'wtapper': ['Any Squirt Gags Toons use will also be cut from the budget.'],
                    None: ["Any Squirt Gags Toons use can and will be held against them in a court of law."]},
'BanZap':  {'wtapper': ['Any Zap Gags Toons use will also be cut from the budget.'],
                    None: ["Any Zap Gags Toons use can and will be held against them in a court of law."]},
'BanSound':  {'wtapper': ['Any Sound Gags Toons use will also be cut from the budget.'],
                    None: ["Any Sound Gags Toons use can and will be held against them in a court of law."]},
'BanDrop': {'wtapper': ['Any Drop Gags Toons use will also be cut from the budget.'],
