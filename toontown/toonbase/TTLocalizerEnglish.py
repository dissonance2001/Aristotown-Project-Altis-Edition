...
SuitAttackCheats = {'TestCheat': ("wouldnt it be great if this worked!",
                                            'titties!'),}
NonUnLureCheats = ('PowerhouseAbsorb', 'PowerhouseSoakImmune', 'PowerhouseGeneration', 'PowerhouseBurnDamage', 'PowerhouseLureImmune', 'PowerhouseSyphon', 'PowerhouseSyphonDesperation',
...
'BookkeeperBookkeeping': "The Bookkeeper is focusing, and must not be targeted!",
    # Wiretapper Cheats
'WiretapperCollectCall': "The Wiretapper doubles the dues for a random Toon!",
...
'RadiographerHotTakeRetaliation': "The Racketeer gains another attack when zapped!",
...
SuitAttackNames = {
    ...
    'RadiographerHotTakeRetaliation': "Corporate Dominion!",
...
'HostileTakeover': ["I think I'll just take what I want.",
...
'CloudStorage': ["Pied Piper's gonna hide behind this one.",
                "I forecast rain.",
...
'Shake': ["I suggest a good escape plan.",
...
'RadiographerHotTakeRetaliation': ["We're done with the petty ranks; now you answer directly to me!",
                                     "Hierarchy? Forget it. This is dominion.",
                                    "You're all beneath my jurisdiction. Completely.",
                                     "This is no longer a chain of command; this is a monopoly of power!",
                                    "Let me show you what real authority looks like!",
