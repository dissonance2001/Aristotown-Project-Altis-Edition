...
'HighRollerCheerRetaliation': "The Purple Silhouette retaliates against Toons with\ncheer!",
 ...
 'AttorneyHurrySickness': "The Family punishes the Toons for not following their\norders!",
...
SuitAttackNames = {
    ...
    # Factory Foreman Cheats
     ...
     'MintPolicyTerminated': "",
     'MintFraudulentDamage': "",
     'MintAbacusAbove15': "Abacus!",
     'MintAbacusBelow15': "Abacus!",
     'MintAccountant1': "Accountant!",
     'MintAccountant2': "Accountant!",
     'MintAccountant3': "Accountant!",
     'MintApprove': "",
     'MintDisapprove': "",
     'MintSynergy': "Synergy!",
        # Head Attorney Cheats
