...
SuitCheatNames = ('CourtCosts', 'Drowning', 'HeavyRainfall', 'SwirlBath', 'AfterShock', 'FreezingRain', 'CourtSanction', 'Bomb', 'Gavel', 'CourtRecord1', 'CourtRecord2', 'BookKeeping', 'Tremor', 'Blast', 'RevvingUp', 'Detonate', 'Detonate2', 'Detonate3', 'ChainsawDetonate', 'ChainsawDetonate2', 'ChainsawDetonate3', 'WhitePowder', 'PoisonSpray', 'EvictionNotice', 'Chomp', 'ClockChange', 'StealSafe', 'Synergy', 'HeatWave')
SuitCheatDescription = {
'Blast': 'All Toons take a huge loss!',
    'Gavel': 'The Stenographer has banned all gags for\n1 turn!',
...
'EvictionNotice': 'Insures that all cogs in battle receive\na health bonus!',
'Bomb': 'Gives this toon a massive debuff!',
'ClockChange': 'All gags have been given a massive damage boost!',
'Chomp': 'The Litigator retaliates against the most\ndangerous toon!',
'StealSafe': "Syphons the least dangerous toon's health!",
'RevvingUp': "Reduces the least dangerous toon's gag power!",
'Tremor': "The Scapegoat syphons your health!",
...
SuitAttackTaunts = {'AcidRain': ["It's sulfur you.",
 ...
 'Chomp': ["My colleagues don't like when I get snappy.",
...
'DoubleWindsor': ["This is the fanciest tie you'll ever see!",
 ...
 'WhitePowder': ["OOOOOOOOOOOOOOOOOOOOO.",
		   ...
		   "OOOOOOOOOOOOOOOOOOOOO.",
                 ...
                 "OOOOOOOOOOOOOOOOOOOOO.",
                 "OOOOOOOOOOOOOOOOOOOOO."],
 'EvictionNotice': ["You're not the only one who's in need of healing.",
...
'BookKeeping': ["You're strategies will go up in smoke, Toon.",
 ...
 'SwirlBath': [ "Oooooo It's time to spin the wheel.",
           "Oooooo It's time to spin the wheel.",
		   "Oooooo It's time to spin the wheel.",
          "Oooooo It's time to spin the wheel."],
