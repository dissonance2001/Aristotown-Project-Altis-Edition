...
SuitCheatNames = ('CourtCosts', 'Cage', 'PaperCut', 'WireCut', 'Wiretapped',
                  ...
                  'MobMentality', 'SlushFund', 'CeaseAndDesist', 'JuryNotice',
                  'Investment', 'ManagerialProtection', 'QualityControl3',
                  'QualityLvlControl2', 'QualityLvlControl1', 'QualityLvlControl',
                  'QualityLvlControl3', 'FieldPromotion', 'QualityControl1',
                  'QualityControl2', 'QualityControl', 'WheelSpin', 'Snap2',
                 'GameShow', 'OilRain', 'Spotlight',
                  'ConeOfShame', 'UnionBuster', 'UnionDues', 'Drowning', 'HeadRoller',
                  'HeadRoller2', 'HeadRoller3', 'UnionBust', 'UnionBust2', 'UnionBust3',
                  'CourtMandate', 'CourtMandate1', 'CourtMandate2', 'CourtMandate3',
                  'LegalBindings', 'HeavyRainfall', 'InkDrain', 'RaisingTheAnte', 'SwirlBath', 'AfterShock',
'Usury', 'Usury2', 'Tribute2', 'SlushFund2', 'Shakedown', 'Shakedown2', 'StandUpGuy', 'KickUp', 'Sitdown',
                  'FreezingRain', 'CourtSanction', 'Bomb', 'Gavel', 'CourtRecord1', 'CourtRecord2',
                  'CourtRecord3', 'CourtRecord4', 'CourtRecord5', 'BookKeeping', 'Enraged', 'Blast',
                  'RevvingUp', 'Detonate', 'Detonate2', 'Detonate3', 'ChainsawDetonate', 'ChainsawDetonate2',
                  'ChainsawDetonate3', 'WhitePowder', 'PoisonSpray', 'InsurancePlan', 'Snap', 'ClockChange',
                  'StealSafe', 'Synergy', 'HeatWave', 'Refinement', 'ExtraTip', 'LifeInsurance', 'WorkersCompensation',
                  'PowerhouseAbsorb', 'PowerhouseSoakImmune', 'PowerhouseLureImmune', 'PowerhouseSyphon', 'PowerhouseSyphonDesperation',
                  ...
                  'AmbassadorManagerialProtection', 'AmbassadorManagerialProtectionImmunity', 'AmbassadorMulligan',
...
SuitCheatDescription = {
    'Usury': 'Styx steals health from all cogs!',
    'Usury2': 'Styx steals health from a cog!',
'Tribute2': 'Kerberos donates part of his health to\nthe Plutocrat!',
'SlushFund2': 'The Investor buffs the defense of all\nother cogs!',
'Shakedown': 'Nix applies a reward cooldown to a random toon!',
'Shakedown2': 'Nix applies a damage vulnerability to a\nrandom toon!',
'KickUp': 'Hydra applies a damage buff to a random Investor!',
'StandUpGuy': 'Charon is protecting his allies!',
'Sitdown': 'Styx summons a cog!',
'Blast': 'All toons take a huge loss!',
    'Gavel': 'The Scapegoat has banned all gags for 1 turn!',
...
'Spotlight': 'The Major Player heals all cogs that can perform!',
 ...
 'RaisingTheAnte': 'All gags have been given a massive damage boost for\nthe duration of the battle!',
    'SwirlBath': 'All gags have been given a massive damage boost for\nthe duration of the battle!',
    'LegalBindings': "The Case Manager binds a toon to take\nextra damage for 2 turns!",
  'CourtCosts': 'An audit is approaching!',
 'CourtSanction': "The Stenographer retaliates against the\nleast dangerous toon!",
    'CourtMandate': "Squirt and Zap gags are now off-limits!",
    'CourtMandate1': "Toon-Up and Sound gags are now off-limits!",
    'CourtMandate2': "Lure and Throw gags are now off-limits!",
    'CourtMandate3': "The Powerhouse releases a devastating attack!",
    'Snap2': "The Litigator retaliates when soaked!",
    'GameShow': "The High Roller overcharges a random silhouette!",
    'WheelSpin': "The High Roller has banned all gags for 1 turn!",
    'Cage': "This toon has been locked up for 1 turn!",
    'OilRain': "All offensive gags are less effective!",
    'CourtRecord1': "Level 6 and 7 gags are now off-limits!",
    'CourtRecord2': "Level 5 and 7 gags are now off-limits!",
'CourtRecord3': "Level 5 and 8 gags are now off-limits!",
    'CourtRecord4': "Level 6 and 8 gags are now off-limits!",
'CourtRecord5': "Level 7 and 8 gags are now off-limits!",
    'BookKeeping': "The Bookkeeper bans all gags for 1 turn!",
'ExtraTip': "The Litigator absolutely  swamps you with cogs!",
'ConeOfShame': "Retaliates against the least dangerous toon.",
'Refinement': "All cogs receive a health bonus!",
'WorkersCompensation': "The Facility Manager gains a health bonus!",
'LifeInsurance': "The Facility Manager gains a health bonus!",
    'Drowning': "Toon-Up and Sound gags are off-limits!",
    'HeavyRainfall': "The rain is starting to pick-up!",
    'AfterShock': "Reduces this toon's gag power by half!",
    'FreezingRain': "You're starting to freeze up!",
'Synergy': 'An audit is approaching!',
'WhitePowder': 'The Litigator absolutely swamps you with cogs!',
...
'ChainsawDetonate': 'The Cog is set to explode! Take cover!',
  'ChainsawDetonate2': 'The Cog is set to explode! Take cover!',
  'ChainsawDetonate3': 'The Cog is set to explode! Take cover!',
'UnionBust': "Steals a random cog's health.",
 'UnionBust2': "Steals a random cog's health.",
 'UnionBust3': "Steals a random cog's health.",
'HeadRoller': "Steals a random cog's health.",
  'HeadRoller2': "Steals a random cog's health.",
  'HeadRoller3': "Steals a random cog's health.",
'PoisonSpray': "The Scapegoat's temperature has cool and is\nprotecting cogs again!" ,
'InsurancePlan': 'The Case Manager insures that all cogs in\nbattle receive a health bonus!',
'Bomb': "You better take cover! Your rewards are off-limits!",
'InkDrain': "The Major Player makes you feel uncomfortable\nand like you don't feel the need to participate next round.",
'ClockChange': 'All gags have been given a massive damage boost!',
'Snap': 'The Litigator retaliates against the\nmost dangerous toon!',
...
'Voicemail': "I can't hear you!",
'CollectCall': "Don't answer the phone!",
'ExplodingBill': "The Bookkeeper retaliates against the\nmost dangerous toon!",
'GoodMorningToontown': "The High Roller Silhouette syphons your health!",
'FireCog': "You're becoming very dizzy!",
'Caress': "This cog is releasing a devastating attack!",
'RadioInfrequency': "Lure and Sound gags have become less effective!",
'MobMentality': "All cogs are given a second chance!",
'SlushFund': "Part of this cog's health goes to their ally!",
'CeaseAndDesist': "The Witness Stand-In unlures all cogs!",
'JuryNotice': "Overcharges a random cog!",
'FieldPromotion': "Overcharges a random cog!",
'ManagerialProtection': "I am now immune!",
'Investment': "Everyone in the battle takes a huge loss!",
'CollectCallFees': "An audit is approaching!",
'QualityLvlControl': "Level 6 and 7 gags are now off-limits!",
    'QualityLvlControl1': "Level 5 and 7 gags are now off-limits!",
'QualityLvlControl2': "Level 7 and 8 gags are now off-limits!",
    'QualityLvlControl3': "Level 6 and 8 gags are now off-limits!",
'QualityControl': "Squirt and Zap gags are now off-limits!",
    'QualityControl1': "Toon-Up and Sound gags are now off-limits!",
    'QualityControl2': "Lure and Throw gags are now off-limits!",
    'QualityControl3': "Trap and Drop gags are now off-limits!",
    #litigator cheats
