...
SuitAttackNames = {
    ...
    'HighRollerGameTimeCog3': "Game Time!",
    'HighRollerGameTimeCog4': "Game Time!",
    'HighRollerBust': "Bust!",
    # High Roller Phase 2
    'HighRollerPhase3': "!",
    # High Roller Phase 3
...
'VideographerVideoStatic': ["!"],
'VideographerElectricShock': ["This attack may 'shock' you.",
...
InventroyCeaseAndDesists = '%s Cease And Desists'
InventroyCeaseAndDesist = '1 Cease And Desists'
...
SueCogTitle = 'CEASE & DESISTS LEFT:%s\nSUE WHICH COG?'
SueCogLowTitle = "CEASE & DESISTS LEFT:%s\nNOT ENOUGH C&D'S!"
