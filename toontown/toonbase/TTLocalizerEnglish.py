...
'HighRollerCheerRetaliation': "The Purple Silhouette retaliates against Toons with\ncheer!",
 ...
 'VideographerDirectorCuts': "The Videographer is now immune until all directors\nand filmmakers are destroyed!",
 'VideographerDeath': "The High Roller removes all cogs from the battle!",
    # Broadcaster Cheats
 'BroadcasterDonation': "The Broadacaster donates part of his health to the\nVideographer!",
    # Filmmaker Cheats
 'FilmmakerCameraFlash': "The Filmmaker disrupts a random Toon's vision!",
 'FilmmakerCameraRewind': "The Filmmaker heals all damaged cogs!",
 'FilmmakerBudgetCuts': "The Filmmaker attacks again when damaged!",
    # Director Cheats
...
SuitAttackNames = {
    ...
    'VideographerElectricShock': "Electric Shock!",
    'VideographerElectricShock2': "Electric Shock!",
    'VideographerElectricShock3': "Electric Shock!",
    'VideographerElectricShock4': "Electric Shock!",
    'VideographerAttackRewind': "Put It On Replay!",
    'VideographerDirectorCuts': "Director Cuts!",
    'VideographerDeath': "Intermission!",
    # Broadcaster Cheats
    'BroadcasterDonation': "Video Refresh!",
    # Filmmaker Cheats
    'FilmmakerCameraFlash': "Camera Flash!",
    'FilmmakerCameraRewind': "Footage Rewind!",
    'FilmmakerBudgetCuts': "Budget Cuts!",
    # Director Cheats
    'DirectorCut': "Cut!",
...
'HighRollerVulnerable': ["WHAT A TWIFFT!!!"],
                    # universal cheats
    # Videographer Cheats
'VideographerRisingStars': ["Hope you practiced your steps, babe, 'cause this song ain't a solo.",
...
'VideographerRisingStars2': ["Hope you practiced your steps, babe, 'cause this song ain't a solo.",
                            ...
                            "Oh-oh-oh! This stage is hot! Why don't we add more wood to the fire?",
                            "Keep it cool, keep it chic! Babe, it's time to dance, cheek-to-cheek!"],
'VideographerRisingStarsSacrifice': ["Sorry babe, it's finito!",
...
'VideographerRisingStarsSilhouette': ["One showstopper isn't enough! There needs to be more!"],
'VideographerVideoStatic': ["!"],
'VideographerElectricShock': ["This may 'shock' you.",
                            "Come on you bags of bolts, keep yourselves together!",
                            "You're not done for yet!",
                            "If you think this is the end for you, think again!"],
'VideographerElectricShock2': ["This may 'shock' you.",
                            "Come on you bags of bolts, keep yourselves together!",
                            "You're not done for yet!",
                            "If you think this is the end for you, think again!"],
'VideographerElectricShock3': ["This may 'shock' you.",
                            "Come on you bags of bolts, keep yourselves together!",
                            "You're not done for yet!",
                            "If you think this is the end for you, think again!"],
'VideographerElectricShock4': ["This may 'shock' you.",
                            "Come on you bags of bolts, keep yourselves together!",
                            "You're not done for yet!",
                            "If you think this is the end for you, think again!"],
'VideographerAttackRewind': ["This will teach you to meddle in my affairs.",
                            "I'm sensing some distortion between us.",
                            "This situation is forcing me to go off script.",
                            "You have a voice fit for dead air time.",
...
'VideographerDeath': ["Ooo-well, ya know what they ffay: don't hate the Major Player, change the game!",
                        ...
                        "Let'ff get the hip hop ffhop right on top, a-one a-two-let'ff play true!",
                        "We'll be back after a ffhort break, but I'm ffure you'll fftay occupied in the meantime."],
'VideographerDirectorCuts': ["This is not a one man show. If you thought those were the only tricks up my sleeve, think again, Toons."],
    # Broadcaster Cheats
'BroadcasterDonation': ["This showstopper isn't quite done for yet!",
                            ...
                            "We'll have to set up a little phantom power!"],
    # Filmmaker Cheats
'FilmmakerCameraFlash': ["Smile for the camera!",
                            "You have the perfect face for camera!",
                            "Watch for the flash!"],
'FilmmakerCameraRewind': ["I think it's time for a rewind.",
                            "Who said you Toons could have the upperhand?",
                            "Oh no no no, this footage isn't ready to be released quite yet."],
'FilmmakerBudgetCuts': ["Actor expenses are through the roof!",
                            "I'm sorry Toon, it is far too pricey for you to remain in this battle.",
