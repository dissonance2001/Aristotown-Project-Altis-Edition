...
SuitAttackNames = {
    ...
    'RacketeerExtortion2': "Pecking Order!",
...
'SongAndDance': {
 ...
 'PeckingOrder': {
    'racket': ["Why don't you 'peck' on someone your own size?",
...
'RacketeerExtortion2': ["Why don't you 'peck' on someone your own size?",
                                     "A real pecking order is now in action!",
                                    "If you weren't at the bottom of the pecking order before, this one will put you there.",
                                     "Birds of a feather strike together, again!",
                                     "Do not provoke the birds, if you don't want to get pecked."],
...
'RacketeerRacketeering': ["I shut down businesses before they even start.",
                          "That gag track? Consider it out of business.",
                            "I just pulled your best seller off the shelves.",
                          "Shut down! You won't be using that again.",
                          "Your strategy just went bankrupt.",
                          "I'll corner the market until you're gagless!"],
'RacketeerPeckingOrderRetaliation': ["Why don't you 'peck' on someone your own size?",
                                     "A real pecking order is now in action!",
                                    "If you weren't at the bottom of the pecking order before, this one will put you there.",
                                     "Birds of a feather strike together, again!",
                                     "Do not provoke the birds, if you don't want to get pecked."],
...
'RadiographerHotTakeRetaliation': ["Breaking news: This Toon couldn't handle the heat!",
                    "Ooooh, the audience doesn't like you!",
                    "The hotter it gets, the quicker you'll melt.",
                    "Hot take: You won't survive the next punchline.",
                    "Shining the spotlight on YOU, Toon."],
