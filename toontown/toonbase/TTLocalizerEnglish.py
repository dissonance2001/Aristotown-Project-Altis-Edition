...
'PowerhouseBurnDamage': "",
    # Bookkeeper Cheats
'BookkeeperPaperCutSoaked': "The Vaultmaster retaliates against marked Toons!",
'BookkeeperPaperCutMarked': "The Vaultmaster gains a damage boost when not attacked during Closed Session!",
'BookkeeperPaperCut': "The Vaultmaster marks a Toon to take extra damage!",
'BookkeeperExplodingDocument': "The Vaultmaster restricts all high leveled gags from a Toon!",
'BookkeeperMandatoryFiling': "The Vaultmaster removes your defense!",
'BookkeeperBookkeepingRetaliation': "The Vaultmaster retaliates against toons who attacked him while in Closed Session!",
'BookkeeperBookkeeping': "The Vaultmaster is focusing, if left unattacked, he will become stronger!",
    # Wiretapper Cheats
...
'UnionBusterUnionBust': "The Union Buster sacrifices cogs at will!",
...
'UnionBusterContractEnforcement': "The Union Buster binds cogs to a contract!",
'UnionBusterContractEnforcement2': "The Union Buster binds cogs to a contract!",
    # Racketeer Cheats
...
SuitAttackNames = {
    ...
    'UnionBusterContractEnforcement': "Contract Enforcement!",
    'UnionBusterContractEnforcement2': "Contract Enforcement!",
    # Racketeer Cheats
...
'FloodTheMarket': {
 ...
 'FillWithLead': ["I think you've had your fill of fun.",
...
'SafetyOverpressured5':  ["Pressure makes profits, and I've got plenty to apply.",
                        ...
                        "Push past your limits, the company demands it.",
                        "I don't care if you break, just don't miss a sale."],
'SafetyHighPressure':  ["Pressure makes profits, and I've got plenty to apply.",
                        "High pressure means high performance!",
                        "Push past your limits, the company demands it.",
                        "I don't care if you break, just don't miss a sale."],
...
'UnionBusterBreachOfContract': ["I'll find the loopholes, and you'll pay the penalties.",
                                ...
                                "Clause 47B states: you lose your bite.",
...
'UnionBusterBreachOfContract4': ["I'll find the loopholes, and you'll pay the penalties.",
                                ...
                                "Clause 47B states: you lose your bite.",
                                "You signed away your strength when you crossed me!"],
'UnionBusterContractEnforcement': ["I've filed the paperwork, you're now protected!",
                                "Back on your feet, company policy requires it.",
                                "The contract states: we don't fall for cheap tricks.",
                                "Health restored, you're contractually obligated to keep fighting!",
                                "Sign here... and watch your strength return!",
                                    "All employees are receiving a raise, effective immediately."],
'UnionBusterContractEnforcement2': ["I've filed the paperwork, you're now protected!",
                                "Back on your feet, company policy requires it.",
                                "The contract states: we don't fall for cheap tricks.",
                                "Health restored, you're contractually obligated to keep fighting!",
                                "Sign here... and watch your strength return!",
