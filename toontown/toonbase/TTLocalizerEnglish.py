...
'SafetyViolation': "The Safety Supervisor retaliates against Toons who chose banned\ngags!",
'SafetyPromotion': "The Safety Supervisor promotes a random cog to absorb damage dealt\nto him!",
#union buster cheats
...
'UnionBusterUnionWages': "The Union Buster gets stronger for every cog that is sacrificed!",
...
'UnionBusterBreachOfContract3': "The Union Buster retaliates against Toons who have taken\nthe heat!",
'UnionBusterBreachOfContract4': "The Union Buster retalites against Toons who chose banned gags!",
'UnionBusterContractEnforcement': "The Union Buster heals all cogs for 125 HP and binds them\nto a contract!",
#racketeer cheats
...
'RadiographerHotTake': "The Radiographer applies a dangerous vulnerability to a random\nToon!",
...
"Hm, hm..."],
                    # scapegoat cheats
                    'ScapegoatGavel': ["Gonna shake things up now!", "How about a change of pace!?", "Look out! Big changes are coming your way!!!"],
...
"Everybody take cover, here comes the big one!"],
'SafetyHeatWave': ["Look out, the heat wave is coming!",
              "Now we're cooking with gas.",
              "Feel the might light power.",
              "The heat is on."],
...
'UnionBusterUnionWages': ["The harder your Union crashes, the stronger I become."],
