...
'kc': ["I've no warmth in my heart for you.",
...
"I can't stand seeing the rest of 'em get hurt!"],
 'GuiltTrip': {
     'kc': ['Tripping you up is mere bagatelle.',
 ...
 'HotAir': {
     'kc': ["You'll make for satisfactory kindling.",
...
"A penny pinched is a penny earned."],
 ...
 'LawBook': {
     'kc': ['Perchance this shall enlighten you to your trespasses.',
...
"ORDER TO ATTACK HAS BEEN RECEIVED AND PROCESSED."],
 ...
 'Sacked': {
     'kc': ['Your services are no longer, and were never, required.',
            'Bagged and gagged.',
