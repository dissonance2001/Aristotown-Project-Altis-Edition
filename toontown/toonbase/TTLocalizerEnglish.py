...
'BookkeeperPaperCut': "The Bookkeeper applies a damage vulnerability to the most\ndangerous Toon!",
'BookkeeperExplodingDocument': "The Bookkeeper applies a damage debuff to a Toon!",
'BookkeeperMandatoryFiling': "The Bookkeeper removes a Toon's defense!",
'BookkeeperBookkeepingRetaliation': "The Bookkeeper retaliates against toons who targeted him\nwhile Bookkeeping!",
'BookkeeperBookkeeping': "The Bookkeeper is focusing, and must not be targeted!",
    # Wiretapper Cheats
...
SuitAttackNames = {
    ...
    'BookkeeperBookkeepingRetaliation': "Bookkeeping!",
    'BookkeeperBookkeeping': "Bookkeeping!",
    # Wiretapper Cheats
