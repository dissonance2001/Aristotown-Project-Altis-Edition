...
ValidStatusConditions = (
    ...
    'sparkplugcalculator',
    'layoffscalculator',
    'markedwoodcalculator',
    'offboardingcalculator',
    'overridecalculator',
    'kickback',
    'override',
    'aggrandizecalculator',
    'scabbardcalculator',
    'kickbackcalculator',
    'alreadyDesperation',
    'dazedcalculator',
    ...
    'contentSync1',
                    ...
                    'dropRushJob',
                    'soundRushJob',
                    'alreadyHurrySickness',
                    'unstableTransform',
                    'contentSyncCalculator',
                    'alreadyContent',
                    'healer',
                    'redLight',
                    'greenLight',
