...
('inventory_buzzer', 'inventory_rug', 'inventory_balloon', 'inventory_cart_battery', 'inventory_tazer', 'inventory_television', 'inventory_tesla_coil', 'inventory_lightning'),
('inventory_bikehorn', 'inventory_whistle', 'inventory_kazoo', 'inventory_bugle', 'inventory_aoogah', 'inventory_elephant','inventory_fog_horn', 'inventory_opera_singer'),
