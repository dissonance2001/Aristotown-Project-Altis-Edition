...
SuitBuildingInfo = (((1, 1), (1, 30), (31, 31), (100, 150), (1,)), # Buildings
 ((1, 2), (1, 30), (31, 31), (100, 150), (1, 1.2)), # # Buildings
 ((1, 3), (1, 30), (31, 31), (100, 150), (1, 1.3, 1.6)), # # Buildings
 ((2, 3),  (1, 30), (31, 31), (100, 150), (1, 1.4, 1.8)), # # Buildings
 ((2, 4),  (1, 30), (31, 31), (100, 150), (1, 1.6, 1.8, 2)), # # Buildings
 ((3, 4),  (1, 30), (31, 31), (100, 150), (1, 1.6, 2, 2.4)), # # Buildings
 ((3, 5),  (1, 30), (31, 31), (100, 150), (1, 1.6, 1.8, 2.2, 2.4)), # # Buildings
 ((4, 5), (1, 30), (31, 31), (100, 150), (1, 1.8, 2.4, 3, 3.2)), # # Buildings
 ((5, 6),  (1, 30), (31, 31), (100, 150), (1.4, 1.8, 2.6, 3.4, 4, 4.8)), # # Buildings
 ((6, 6),  (1, 30), (31, 31), (100, 150), (1.8, 2.6, 3.4, 4, 4.8, 5.6)), # # Buildings
 ((1, 1), (12, 30), (31, 31), (300, 300), (1, 1, 1, 1, 1)), # VP Round 1
 ((1, 1), (12, 30), (31, 31), (300, 300), (1, 1, 1, 1, 1)), # VP Round 2
 ...
 ((1, 1), (12, 30), (31, 31), (300, 300), (1, 1, 1, 1, 1)), # Chairman Cogs
 ((1, 1), (12, 30), (31, 31), (300, 300), (1, 1, 1, 1, 1)), # Chairman Skelecogs
 ((1, 1), (12, 30), (31, 31), (300, 300), (1, 1, 1, 1, 1)), # VP Round 1 Easy
 ((1, 1), (12, 30), (31, 31), (300, 300), (1, 1, 1, 1, 1)), # VP Round 2 Easy
 ((1, 1), (12, 30), (31, 31), (300, 300), (1, 1, 1, 1, 1)), # VP Round 1 Hard
 ((1, 1), (12, 30), (31, 31), (300, 300), (1, 1, 1, 1, 1))) # VP Round 2 Hard
...
buildingMinMax = {
    ...
    ToontownGlobals.KnightKnoll: (config.GetInt('knight-knoll-building-min', 0),
                                     config.GetInt('knight-knoll-building-max', 3)),
    ToontownGlobals.NobleNook: (config.GetInt('noble-nook-building-min', 0),
                                     config.GetInt('noble-nook-building-max', 3)),
    ToontownGlobals.WizardWay: (config.GetInt('wizzard-way-building-min', 0),
                                     config.GetInt('wizard-way-building-max', 3)),
    ToontownGlobals.BuccaneerBoulevard: (config.GetInt('barnacle-boulevard-building-min', 1),
    ...
    ToontownGlobals.AnchorAvenue: (config.GetInt('ahoy-avenue-building-min', 1),
                                   config.GetInt('ahoy-avenue-building-max', 5)),
    ToontownGlobals.PetuniaPlace: (config.GetInt('elm-street-building-min', 2),
                                config.GetInt('elm-street-building-max', 6)),
    ToontownGlobals.DaisyDrive: (config.GetInt('maple-street-building-min', 2),
                                  config.GetInt('maple-street-building-max', 6)),
    ToontownGlobals.SunflowerStreet: (config.GetInt('rose-valley-building-min', 0),
                                  config.GetInt('rose-valley-building-max', 0)),
    ToontownGlobals.TulipTerrace: (config.GetInt('oak-street-building-min', 2),
                                config.GetInt('oak-street-building-max', 6)),
    ToontownGlobals.SunflowerStreet: (config.GetInt('rose-valley-building-min', 2),
                                config.GetInt('rose-valley-building-max', 6)),
    ToontownGlobals.AlmondAvenue: (config.GetInt('acorn-avenue-building-min', 3),
...
buildingChance = {
    ...
    ToontownGlobals.BuccaneerBoulevard: config.GetFloat('barnacle-boulevard-building-chance', 75.0),
    ...
    ToontownGlobals.AnchorAvenue: config.GetFloat('ahoy-avenue-building-chance', 50.0),
    ToontownGlobals.PetuniaPlace: config.GetFloat('elm-street-building-chance', 90.0),
    ToontownGlobals.DaisyDrive: config.GetFloat('maple-street-building-chance', 90.0),
    ToontownGlobals.DaisyDrive: config.GetFloat('rose-valley-building-chance', 0.0),
    ToontownGlobals.TulipTerrace: config.GetFloat('oak-street-building-chance', 90.0),
    ToontownGlobals.KnightKnoll: config.GetFloat('knight-knoll-building-chance', 90.0),
    ToontownGlobals.NobleNook: config.GetFloat('noble-nook-building-chance', 90.0),
    ToontownGlobals.WizardWay: config.GetFloat('wizard-way-building-chance', 90.0),
    ToontownGlobals.SunflowerStreet: config.GetFloat('rose-valley-building-chance', 90.0),
    ToontownGlobals.AlmondAvenue: config.GetFloat('acorn-avenue-building-chance', 75.0),
