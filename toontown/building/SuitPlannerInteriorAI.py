...
class SuitPlannerInteriorAI:
    ...
    def genSuitsForEmptyPlanner(self, specialCode):
        ...
        if specialCode == 'ffm':
            ...
            miniboss2 = self.__genSuitObject(self.zoneId, 20, 's', 20, 2)
            miniboss3 = self.__genSuitObject(self.zoneId, 20, 's', 20, 2)
            miniboss4 = self.__genSuitObject(self.zoneId, 20, 's', 20, 2)
            miniboss5 = self.__genSuitObject(self.zoneId, 20, 's', 20, 2)
            activeSuits.append(miniboss)
