...
def getRideElevatorInterval(type = ELEVATOR_NORMAL):
    if type == ELEVATOR_VP or type == ELEVATOR_CFO or type == ELEVATOR_CJ:
        ...
        zMid = 8
        zMax = 8.2
    elif type == ELEVATOR_BB or type == ELEVATOR_DIRECTORS or type == ELEVATOR_CM:
        yValue = 21
        zMin = 7
        zMid = 7.2
        zMax = 7.4
    elif type == ELEVATOR_ERCLAIM:
        yValue = 12
        zMin = 3.8
        zMid = 4
        zMax = 4.2
        ...
        zMid = 7.2
        zMax = 7.4
    if type in (ELEVATOR_VP, ELEVATOR_DIRECTORS, ELEVATOR_CM, ELEVATOR_ERCLAIM,
     ELEVATOR_CFO,
     ELEVATOR_CJ,
     ELEVATOR_BB):
