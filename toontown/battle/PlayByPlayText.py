...
class PlayByPlayText(OnscreenText.OnscreenText):
    ...
    def getShowInterval(self, text, duration):
        return Sequence(LerpColorScaleInterval(self, 0, Vec4(1, 0, 0, 1.0)), Func(self.hide), Func(self.setScale, 0.16),
                        LerpScaleInterval(self, duration=0, scale=(0, 0, 0)),
                        self.posInterval(0, (0, 0, .675)), Func(self.setText, text),
                        Func(self.show),
                        Wait(0.5),
    ...
    def getShowIntervalOvercharged(self, text, duration):
        return Sequence(LerpColorScaleInterval(self, 0, Vec4(0.988, 0., 1.0, 1.0)), Func(self.hide), Wait(duration * 0.1), Func(self.setScale, 0.16),
                        LerpScaleInterval(self, duration=0, scale=(0, 0, 0)),
                        self.posInterval(0, (0, 0, 0.675)), Func(self.setText, text),
                        Func(self.show),
                        Wait(0.5),
                        Parallel(self.scaleInterval(0.25, (1.2, 1.1, 1.1)),
                                 self.posInterval(0.25, (0, 0, 0))),
    ...
    def getShowIntervalDesc(self, text, duration):
        return Sequence(Wait(0.5), LerpColorScaleInterval(self, 0, Vec4(0.847, 0.784, 0.992, 1.0)), Func(self.hide), Func(self.setWordwrap, None), Func(self.setPos, 0.0, 0.65),
                        Func(self.setScale, 0.09), Wait(duration * 0.1),
                        Func(self.setText, text),
                        LerpScaleInterval(self, duration=0, scale=(0, 0, 0)),
                        self.posInterval(0, (0, 0, 0.5)), Func(self.setText, text),
                        Func(self.show),
                        Wait(0.5),
                        Parallel(self.scaleInterval(0.25, (1.2, 1.1, 1.1)),
                                 self.posInterval(0.25, (0, 0, 0))),
