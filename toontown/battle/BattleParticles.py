...
def createParticleEffect(name = None, file = None, numParticles = None, color = None):
    ...
    if name == 'GearExplosion':
        ...
        return loadParticleFile('quash.ptf')
