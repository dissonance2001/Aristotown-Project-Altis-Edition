...
def doSynergy2(attack):
    ...
    waterfallEffect = BattleParticles.createParticleEffect(file='synergyWaterfall')
    suitTrack = Sequence(getSuitAnimTrack(attack))
    suitTrack.append(Parallel(Sequence(Wait(3.85), Func(suit.showHpText, "+50 Court Costs", 10)),
    ...
    if hitAtleastOneToon > 0:
        ...
        return Parallel(suitTrack, partTrack, waterfallTrack, synergySoundTrack, toonTracks, notifyTrack)
...
def doHeatWave(attack):
    ...
    suitTrack = Sequence(getSuitAnimTrack(attack))
    suitTrack.append(Parallel(Sequence(Wait(3.85), Func(suit.showHpText, "+50 HeatWave", 10)),
                              Func(suit.setChatAbsolute,
...
def doWhitePowder(attack):
    ...
    for suit in battle.suits:
        ...
        suitTrack.append(Parallel(Sequence(Wait(3 + 1), Func(suit.showHpText, "BELLOW!", 10)),
...
def doRevvingUp(attack):
    ...
    suitTrack = getSuitTrack(attack)
    suitTrack.append(Parallel(Sequence(Wait(1.0), Func(suit.showHpText, "PUNISHED!", 10)),
                              Func(suit.setChatAbsolute,
...
def doCourtSanction(attack):
    ...
    toonTrack = getToonTrack(attack, 0.8, ['conked'], 0.2, ['sidestep'])
    suitTrack = getSuitTrack(attack)
    suitTrack.append(Parallel(Sequence(Wait(1.0), Func(suit.showHpText, "SANCTION!", 10)),
                              Func(suit.setChatAbsolute,
    ...
    notifyTrack = Sequence(Wait(1.0 + 0.75), Func(toon.showHpText, "SANCTIONED!", 10))
...
def doEnraged(attack):
    ...
    suitTrack = Sequence(getSuitAnimTrack(attack))
    suitTrack.append(Parallel(Sequence(Wait(0.85 + 5), Func(suit.showHpText, "ENRAGED!", 10), Func(suit.showHpText, "HEALTH BOOST!", 10)),
...
def doSnap(attack):
    ...
    notifyTrack = Sequence(Wait(6), Func(toon.showHpText, "VULNERABLE!", 10))
    suitTrack = Sequence(getSuitAnimTrack(attack))
