...
class BanGags(StatusEffect):
    ...
    def __init__(self, roundsLeft, bannedGags, pickable = True):
        ...
        StatusEffect.__init__(self, roundsLeft, False, name='Gag Ban', icon='backfire_icon')
...
class MarkedWood(StatusEffect):
    ...
    def __init__(self):
        StatusEffect.__init__(self, 1, False, name='Marked Wood', desc=u'The Chainsaw Consultant has marked this Toon, and unless interrupted by a different Toon, will target them this turn! They will take 75\u0025 more damage from his next attack.', icon='marked_wood_icon', defenseMod=0.25)
...
class ForwardThinking(StatusEffect):
    ...
    def __init__(self):
        StatusEffect.__init__(self, -1, True, name='Forward Thinking', desc='The Prethinker and his peers will brainstorm your demise at the end of every turn!', icon='brain_icon')
...
class MovingGoalposts(BanGags):
    ...
    def updateEffect(self):
        ...
        for track in [HEAL_TRACK, TRAP_TRACK, LURE_TRACK, THROW_TRACK, SQUIRT_TRACK, ZAP_TRACK, SOUND_TRACK, DROP_TRACK]:
            self.bannedGags.append((track, random.randint(5, 8)))
