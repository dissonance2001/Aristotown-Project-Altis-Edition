...
def doSyphon(attack):
    ...
    for t in targets:
        ...
        partTrack4 = getPartTrack(sprayEffect, 1.0, 4.0, (sprayEffect2, toon, 0), softStop=-1.0)
        partTracks4.append(partTrack4)
...
def doDeepFreeze(attack):
    ...
    for t in targets:
        ...
        partTrack4 = getPartTrack(sprayEffect, 4.0, 3.0, (sprayEffect2, toon, 0), softStop=-1.0)
...
def doInkDrain(attack):
    ...
    suitTrack = getSuitAnimTrack(attack)
    partTrack: Sequence = getPartTrack(particleEffect, 1e-05, suitTrack.getDuration() + 5.2, (particleEffect, suit, 0), softStop=-1.0)
    partTrack2: Sequence = getPartTrack(particleEffect2, 1e-05, suitTrack.getDuration() + 5.2, (particleEffect2, suit, 0), softStop=-1.0)
    partTrack3: Sequence = getPartTrack(particleEffect3, 1e-05, suitTrack.getDuration() + 5.2, (particleEffect3, suit, 0), softStop=-1.0)
    partTrack4: Sequence = getPartTrack(particleEffect4, 1e-05, suitTrack.getDuration() + 5.2, (particleEffect4, suit, 0), softStop=-1.0)
    toonTracks = Parallel()
