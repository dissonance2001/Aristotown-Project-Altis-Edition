...
def doPayrollProcessing(attack):
    ...
    for suit in battle.activeSuits:
        ...
        liftTracks.append(getPartTrack(liftEffect, 4.0, 4.0, (liftEffect, battle, 0), softStop=-1.0))
        suitTrack = Sequence()
...
def doExtortion2(attack):
    ...
    for t in targets:
        ...
        partTrack4 = getPartTrack(sprayEffect, 4.0, 2.0, (sprayEffect2, toon, 0), softStop=-1.0)
