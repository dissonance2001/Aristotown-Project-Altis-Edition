...
def getSuitAnimTrack(attack, delay = 0, splicedAnims = None, playRate = 1.0):
    ...
    if attack[
        ...
        track.append(Func(suit.setChatAbsolute, random.choice(['Hrm...', 'Hmph...', 'Hm, hm...', 'Hrnhmpf...']),
                          CFSpeech | CFTimeout))
    elif attack['suitName'] == 'radiog' and attack[
...
def doOverheat(attack):
    ...
    suitTrack = Parallel(getSuitAnimTrack(attack), MovieUtil.createSuitFirestarterCigarSmokeInterval2(suit))
...
def doMandatoryCompliance(attack):
    ...
    for t in targets:
        ...
        toonTrack = Parallel(getToonTrackCheat2(attack, 3.25, ['conked'], 3.1, ['conked']))
