...
SpecialCogDict = ('ddv', 'sya', 'dty', 'dar', 'dsf', 'nhy', 'wrt', 'auh', 'dfg', 'msp', 'dfr', 'bsh', 'ghd', 'tyh', 'jgd', 'dsf', 'bby', 'dvk', 'otm', 'cry', 'tcm', 'bg', 'msr', 'kb', 'ts', 'tc', 'tg', 'tb', 'adc', 'drm', 'cp', 'fbd', 'frs', 'gtk', 'jur', 'tlr', 'cm', 'ggm', 'th', 'kc', 'tr', 'mp', 'laa', 'scg', 'csm', 'ste', 'lit', 'bgr', 'mes', 'dm', 'tcc', 'fb', 'jl', 'gb', 'lbs', 'trk', 'mad', 'crf', 'mdr', 'nar', 'fd', 'fm', 'jg', 'jr', 'prr', 'blr', 'dvp', 'dsk', 'ffm', 'sft')
...
SuitAttributes = {'f': {'name': 'Flunky', # cog name
 ...
 'cr': {'name': 'Overseer',
        ...
        'level': 6,
         'hp':(21, 31, 43, 57, 73, 91, 111),
        'def':(43,43,43,43,43,43,43),
        'freq':(30,35,40,45,50,50,50),
        'acc':(30,35,40,45,50,50,50),
        'attacks':
            (('GlowerPower',
 ...
 'tbc': {'name': 'Downsizer',
         ...
         'level': 7,
         'hp': (42, 56, 72, 90, 110, 132),
         'def': (23, 23, 23, 23, 23, 23),
 ...
 'dot': {'name': 'Head Hunter',
		...
		'def':(65,65,65,65,65,65,65),
		'freq':(30,35,40,45,50,50,50),
		'acc':(60,65,70,75,75,75,75),
		'attacks':
            (('HeadShrink',
...
'cpl': {'name': 'Corporate\nRaider',
        ...
        'def': (56, 56, 56, 56, 56, 56, 56, 56, 56),
         ...
         'attacks':
             (('GuiltTrip',
              ...
              ('CigarSmoke',
               ...
               (30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30)))},
 'jdg': {'name': 'Magistrate',
        'singularname': 'a Magistrate',
		'pluralname': 'Magistrates',
		'level': 14,
...
SuitAttacks = {'AcidRain': ('magic1', ATK_TGT_SINGLE),
 ...
 'BounceCheck': ('throw-paper', ATK_TGT_SINGLE),
               ...
               'Mulligan2': ('golf-club-swing', ATK_TGT_SINGLE),
               'Quash': ('magic3', ATK_TGT_GROUP),
               'NickelAndDime': ('magic2', ATK_TGT_GROUP),
'Usury': ('nothing', ATK_TGT_SINGLE),
'Usury2': ('nothing', ATK_TGT_SINGLE),
'Tribute2': ('nothing', ATK_TGT_SINGLE),
'SlushFund2': ('mob-mentality', ATK_TGT_SINGLE),
'Shakedown': ('magic3', ATK_TGT_SINGLE),
'Shakedown2': ('magic3', ATK_TGT_SINGLE),
'StandUpGuy': ('defense', ATK_TGT_SINGLE),
'KickUp': ('rake', ATK_TGT_SINGLE),
'Sitdown': ('sit-hungry-left', ATK_TGT_SINGLE),
...
'Accusations2': ('speak', ATK_TGT_SINGLE),
 ...
 'RubOut': ('hold-eraser', ATK_TGT_SINGLE),
               'ConeOfShame': ('snap', ATK_TGT_SINGLE),
...
MULLIGAN = list(SuitAttacks.keys()).index('Mulligan2')
USURY = list(SuitAttacks.keys()).index('Usury')
USURY_2 = list(SuitAttacks.keys()).index('Usury2')
TRIBUTE_2 = list(SuitAttacks.keys()).index('Tribute2')
SLUSHFUND_2 = list(SuitAttacks.keys()).index('SlushFund2')
SHAKEDOWN = list(SuitAttacks.keys()).index('Shakedown')
SHAKEDOWN_2 = list(SuitAttacks.keys()).index('Shakedown2')
STAND_UP_GUY = list(SuitAttacks.keys()).index('StandUpGuy')
KICK_UP = list(SuitAttacks.keys()).index('KickUp')
SITDOWN = list(SuitAttacks.keys()).index('Sitdown')
