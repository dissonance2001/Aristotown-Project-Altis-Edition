...
SpecialCogDict = ('ddv', 'dty', 'dfg', 'dfr', 'bsh', 'ghd', 'tyh', 'jgd', 'bby', 'dvk', 'otm', 'cry', 'tcm', 'bg', 'msr', 'kb', 'ts', 'tc', 'tg', 'tb', 'adc', 'drm', 'cp', 'fbd', 'frs', 'gtk', 'jur', 'tlr', 'cm', 'ggm', 'th', 'kc', 'tr', 'mp', 'laa', 'scg', 'csm', 'ste', 'lit', 'csh', 'bgr', 'mes', 'dm', 'tcc', 'fb', 'jl', 'gb', 'lbs', 'trk', 'dsf', 'msp', 'mad', 'crf', 'fas', 'mdr', 'nar', 'fd', 'fm', 'jg', 'jr', 'prr', 'blr', 'dvp', 'dsk', 'ffm', 'sft')
        ...
        'attacks':
            (('BuzzWord',
             ...
             ('FountainPen',
              ...
              (85, 85, 85, 85, 85, 85, 85, 85, 85),
              (20, 20, 20, 20, 20, 20, 20, 20, 20)))},
 'cr': {'name': 'The Overseer',
        'singularname': 'a The Overseer',
        'pluralname': 'The Overseers',
        'level': 6,
...
('Accusations',
             ...
             ('AfterShock',
              ...
              (100,),
              (0,)))},
 'fbd': {'name': 'Shareholder',
        'singularname': 'a Shareholder',
		'pluralname': 'Shareholders',
		'level': 25,
		'hp':(4525,),
		'def':(60,),
		'freq':(0,),
...
'CourtMandate3': ('objection-in', ATK_TGT_GROUP),
               'Snap2': ('throw-paper', ATK_TGT_SINGLE),
'GameShow': ('song-and-dance', ATK_TGT_SINGLE),
'WheelSpin': ('wheelspin', ATK_TGT_SINGLE),
'Accusations': ('summon', ATK_TGT_SINGLE),
'Accusations2': ('summon', ATK_TGT_SINGLE),
