...
Props = ((5, 'partyBall', 'partyBall'),
 (5,
  'CogNationChopper',
  'CogNationChopper-mod',
  'CogNationChopper-chan'),
         (5,
          'cogChopper_ctc',
          'cogChopper_ctc-mod',
          'cogChopper_ctc-chan'),
 ...
 (5,
  ...
  '1dollar-bill-chan'),
         ...
         (5,
          ...
          'wheel2-chan'),
 (5, 'big-magnet', 'magnet'),
  (5, 'backpack_pacesetter', 'backpack_pacesetter'),
 (5,
  'hypno-goggles',
  'hypnotize-mod',
  'hypnotize-chan'),
 ...
 (3.5, 'tazer', 'tazer'),
 (3.5, 'tesla', 'tesla'),
         (5, 'cc_m_prp_bat_rubberStamp', 'cc_m_prp_bat_rubberStamp'),
         (5, 'cc_m_prp_bat_rubberStamp_pad', 'cc_m_prp_bat_rubberStamp_pad'),
 (5,
  'banana',
  'banana-peel-mod',
  'banana-peel-chan'),
...
(5,
          'cc_m_chr_ene_highroller2',
          'cc_m_chr_ene_highroller2-mod',
          'cc_m_chr_ene_highroller2-chan'),
...
class PropPool:
    ...
    def __init__(self):
        ...
        self.propTypes[propName] = 'model'
        propName = 'lightning_battle'
        self.propStrings[propName] = ('phase_5/models/props/lightning_battle',)
        self.propTypes[propName] = 'model'
        propName = 'black-orb'
