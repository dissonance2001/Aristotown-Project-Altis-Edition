...
class HoodMgr(DirectObject.DirectObject):
    ...
    dropPoints = {
        ...
        ToontownGlobals.YeOlde: (
            ...
            [-62.952, 151.194, -3.482, -45.000, 0, 0],
        ),
        ...
        ToontownGlobals.OutdoorZone: (
            [25.547,  99.710,  8.964, 72.383, 0, 0],
            [-78.741,  71.775,  8.964, 196.805, 0, 0],
            [-135.158,  -20.213,  0.025, 203.036, 0, 0],
            [-87.052,  -40.952,  3.193, 233.572, 0, 0],
            [-5.977,  -154.818,  -0.023, 377.474, 0, 0],
            [27.806,  -99.778,  0.019, 393.726, 0, 0],
            [5.564,  -16.627,  0.025, 497.982, 0, 0],
            [36.150,  -53.483,  0.021, 480.479, 0, 0]
        ),
        ...
        ToontownGlobals.CashbotHQ: (
            [132, 508.992, 32.2462, 180, 0, 0],
        ),
        ToontownGlobals.LawbotHQ: (
            [-73.6027, 116.538, 9.71396, -450, 0, 0],
            [0.542,  208.290,  19.403, -181.110, 0, 0],
            [-38.124,  133.472,  0.025, -134.053, 0, 0]
        ),
        ToontownGlobals.BossbotHQ: (
            [345.747, 16.0043, -6.59667, 90, 0, 0],
        ),
        ToontownGlobals.BoardbotHQ: (
            [368.063, -200.006, -64.475, 90, 0, 0],
        ),
