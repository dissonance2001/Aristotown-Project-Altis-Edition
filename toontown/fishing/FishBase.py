...
class FishBase:
    ...
    def getValue(self):
        """
        :return: the monetary value of this fish using a delicately balanced formula
    ...
    def getRarity(self):
        """
        :return: the rarity of this fish, based on the genus and species.
    ...
    def getPhase(self):
        """
        :return: the download phase of the fish model and anim (int)
        """
    ...
    def getActor(self):
        """
        :return: an actor comprised of the fish model and it's swim cycle.
    ...
    def getSound(self):
        ...
        :return: (sound, loop, delay, playRate) | None
        """
        sound = None
        loop = None
        delay = None
        playRate = None
        if ConfigVariableBool('want-fish-audio', True).getValue():
