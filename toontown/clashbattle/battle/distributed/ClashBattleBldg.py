...
class ClashBattleBldg(ClashBattleBase):
    CAMERA_CLASS = BuildingBattleCamera
    camFOFov = 30.0
    camFOPos = Point3(0, -10, 4)

    # Add a new reward state to the battle FSM
    defaultTransitions = ClashBattleBase.defaultTransitions.copy()
    ...
    def __init__(self, cr):
        ...
        ClashBattleBase.__init__(self, cr, townBattle)

        self.streetBattle = 0

    def generate(self):
        ClashBattleBase.generate(self)
