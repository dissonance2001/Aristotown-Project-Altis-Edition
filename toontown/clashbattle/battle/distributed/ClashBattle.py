...
class ClashBattle(ClashBattleBase.ClashBattleBase):
    ...
    def __init__(self, cr):
        ...
        ClashBattleBase.ClashBattleBase.__init__(self, cr, townBattle)
    ...
    def generate(self):
        ClashBattleBase.ClashBattleBase.generate(self)

    def announceGenerate(self):
        ClashBattleBase.ClashBattleBase.generate(self)

    def disable(self):
        ClashBattleBase.ClashBattleBase.disable(self)
        self.ignore(self.PlayGameSetPlaceEvent)

    def delete(self):
        ClashBattleBase.ClashBattleBase.delete(self)
        self.ignore(self.PlayGameSetPlaceEvent)
    ...
    def __faceOff(self, ts, name, callback):
        ...
        if faceoffTime > self.FLY_IN_CUTOFF_DUR:
            ...
            # incoming copypaste stuff from ClashBattleDiners
