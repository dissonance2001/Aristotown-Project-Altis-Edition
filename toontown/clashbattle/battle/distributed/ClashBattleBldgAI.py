...
class ClashBattleBldgAI(ClashBattleBaseAI):
    # Add a new reward state to the battle FSM
    defaultTransitions = ClashBattleBaseAI.defaultTransitions.copy()
    ...
    def __init__(self, air, zoneId, roundCallback=None, finishCallback=None, maxSuits=4, bossBattle=0, floor=None, maxFloor=None):
        ...
        ClashBattleBaseAI.__init__(self, air, zoneId, finishCallback, maxSuits, bossBattle)

        self.elevatorPos = Point3(0, -30, 0)
        self.resumeNeedUpdate = 0

    def announceGenerate(self):
        ClashBattleBaseAI.announceGenerate(self)
        self.registerToons()
    ...
    def enterFaceOff(self):
        ...
        self.joinable = True
        self.runable = False
        # From here on out ClashBattleAI only controls ClashSuitAI
        # ClashBattle controls ClashSuit
    ...
    def enterResume(self):
        ...
        ClashBattleBaseAI.enterResume(self)
        self.finishCallback(self.zoneId, activeToons)

    def exitResume(self):
        ClashBattleBaseAI.exitResume(self)
