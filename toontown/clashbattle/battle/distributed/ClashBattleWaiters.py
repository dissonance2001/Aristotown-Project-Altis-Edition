...
class ClashBattleWaiters(ClashBattleFinal.ClashBattleFinal):
    ...
    def announceGenerate(self):
        ClashBattleFinal.ClashBattleFinal.announceGenerate(self)
    ...
    def showSuitsFalling(self, suits, ts, name, callback):
        ...
        for suit in suits:
            ...
            suitTrack.append(Track((delay, Sequence(Func(suit.show), flyIval, Func(suit.loop, 'neutral')))))
            delay += 1
