...
def shred(self):
    ...
    p0.emitter.setOffsetForce(Vec3(0.0000, 8.5000, 0.0000))
    p0.emitter.setExplicitLaunchVector(Vec3(1.0000, 0.0000, 0.0000))
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearVectorForce(Vec3(0.0000, -3.0000, 5.0000), 1.0000, 0)
    force0.setActive(1)
    f0.addForce(force0)
...
def numberSpray(self):
    ...
    p0.emitter.setOffsetForce(Vec3(0.0000, 9.1000, -5.0000))
    p0.emitter.setExplicitLaunchVector(Vec3(1.0000, 0.0000, 0.0000))
    p0.emitter.setRadiateOrigin(Point3(0.0000, -4.0000, 0.0000))
    # Sphere Volume parameters
...
def fillWithLeadSpray(self):
    ...
    p0.renderer.setFinalXScale(0.0425)
    p0.renderer.setInitialYScale(0.02)
    p0.renderer.setFinalYScale(0.0425)
    p0.renderer.setNonanimatedTheta(5.0000)
    p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPBLENDLINEAR)
    p0.renderer.setAlphaDisable(0)
    # Emitter parameters
    ...
    p0.emitter.setAmplitude(5.0000)
    p0.emitter.setAmplitudeSpread(1.0000)
    p0.emitter.setOffsetForce(Vec3(0.6000, 5.8000, 0.5000))
    p0.emitter.setExplicitLaunchVector(Vec3(1.0000, 0.0000, 0.0000))
    p0.emitter.setRadiateOrigin(Point3(0.0000, -10.0000, 0.0000))
    # Sphere Volume parameters
    ...
    force1.setActive(1)
    f0.addForce(force1)
    force2 = LinearNoiseForce(2.7000, 0)
    force2.setActive(1)
    f0.addForce(force2)
    force3 = LinearJitterForce(12.5698, 0)
    force3.setActive(1)
...
def pixieExplode(self):
    ...
    p0.renderer.setEdgeColor(Vec4(1.00, 1.00, 0.00, 1.00))
...
def soundWaveQuick(self):
    ...
    p0.factory.setMassBase(0.0010)
    p0.factory.setMassSpread(0.0000)
    p0.factory.setTerminalVelocityBase(3.2000)
    p0.factory.setTerminalVelocitySpread(0.0000)
    # Point factory parameters
    # Renderer parameters
    p0.renderer.setAlphaMode(BaseParticleRenderer.PRALPHAOUT)
    ...
    p0.renderer.setAnimAngleFlag(0)
    p0.renderer.setInitialXScale(0.0000)
    p0.renderer.setFinalXScale(2.1000)
    p0.renderer.setInitialYScale(0.0000)
    p0.renderer.setFinalYScale(2.1000)
    p0.renderer.setNonanimatedTheta(0.0000)
    p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPBLENDLINEAR)
    p0.renderer.setAlphaDisable(1)
    p0.renderer.setColorBlendMode(ColorBlendAttrib.MAdd, ColorBlendAttrib.OIncomingAlpha, ColorBlendAttrib.OOne)
...
def soundWaveQuickTaunt(self):
    ...
    p0.renderer.setTextureFromNode("phase_5/models/props/uberSoundEffects", "**/Circle")
    # p0.renderer.addTextureFromFile('maps/Circle.tif')
    p0.renderer.setColor(Vec4(1.00, 0.20, 0.20, 0.40))
    p0.renderer.setXScaleFlag(1)
    p0.renderer.setYScaleFlag(1)
    p0.renderer.setAnimAngleFlag(0)
    p0.renderer.setInitialXScale(0.0000)
...
@particle
def legalBindingsDamageEffect(self):
    self.reset()
    self.setScale(0.040, 0.040, 0.040)
    p0 = Particles.Particles('particles-1')
    # Particles parameters
    ...
    # Sprite parameters
    p0.renderer.setIgnoreScale(1)
    tex = loader.loadTexture('phase_11/maps/paper_rain.png')
    ...
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearJitterForce(20.0000, 0)
    force1.setActive(1)
    f0.addForce(force1)
    self.addForceGroup(f0)
...
def resistanceEffectSprite(self):
    ...
    p6 = Particles.Particles('particles-7')
    # Particles parameters
    p6.setFactory("PointParticleFactory")
    p6.setRenderer("SpriteParticleRenderer")
    p6.setEmitter("SphereVolumeEmitter")
    p6.setPoolSize(50)
    p6.setBirthRate(0.1000)
    p6.setLitterSize(50)
    p6.setLitterSpread(0)
    p6.setSystemLifespan(0.0000)
    p6.setLocalVelocityFlag(1)
    p6.setSystemGrowsOlderFlag(0)
    # Factory parameters
    p6.factory.setLifespanBase(3.0000)
    p6.factory.setLifespanSpread(0.0000)
    p6.factory.setMassBase(1.0000)
    p6.factory.setMassSpread(0.0000)
    p6.factory.setTerminalVelocityBase(400.0000)
    p6.factory.setTerminalVelocitySpread(0.0000)
    # Point factory parameters
    # Renderer parameters
    p6.renderer.setAlphaMode(BaseParticleRenderer.PRALPHAUSER)
    p6.renderer.setUserAlpha(1.00)
    # Sprite parameters
    p6.renderer.setColor(Vec4(1.00, 1.00, 1.00, 1.00))
    p6.renderer.setXScaleFlag(0)
    p6.renderer.setYScaleFlag(0)
    p6.renderer.setAnimAngleFlag(0)
    p6.renderer.setInitialXScale(0.5000)
    p6.renderer.setFinalXScale(0.5000)
    p6.renderer.setInitialYScale(0.5000)
    p6.renderer.setFinalYScale(0.5000)
    p6.renderer.setNonanimatedTheta(0.0000)
    p6.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPBLENDLINEAR)
    p6.renderer.setAlphaDisable(0)
    # Emitter parameters
    p6.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
    p6.emitter.setAmplitude(20.0000)
    p6.emitter.setAmplitudeSpread(0.0000)
    p6.emitter.setOffsetForce(Vec3(0.0000, 0.0000, 20.0000))
    p6.emitter.setExplicitLaunchVector(Vec3(1.0000, 0.0000, 0.0000))
    p6.emitter.setRadiateOrigin(Point3(0.0000, 0.0000, 0.0000))
    # Sphere Volume parameters
    p6.emitter.setRadius(2.0000)
    self.addParticles(p6)
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0.0000, 0.0000, -79.0000), LinearDistanceForce.FTONEOVERRSQUARED, 15.9701, 95.0000, 1)
    force0.setActive(1)
...
def waterfallSplash(self):
    ...
    p0.renderer.setYScaleFlag(1)
    p0.renderer.setAnimAngleFlag(0)
    p0.renderer.setInitialXScale(0.0150)
    p0.renderer.setFinalXScale(0.0125)
    p0.renderer.setInitialYScale(0.0150)
    p0.renderer.setFinalYScale(0.0125)
    p0.renderer.setNonanimatedTheta(0.0000)
    p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPNOBLEND)
    p0.renderer.setAlphaDisable(0)
    # Emitter parameters
    ...
    p0.emitter.setRadiateOrigin(Point3(0.0000, 0.0000, 0.0000))
    # Disc parameters
    p0.emitter.setRadius(7.0000)
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('splashBack')
    # Force parameters
    force0 = LinearVectorForce(Vec3(0.0000, 0.0000, 3.0000), 1.0000, 0)
    force0.setVectorMasks(1, 1, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def rain(self):
    ...
    p0.renderer.setUserAlpha(1.00)
    # Line parameters
    p0.renderer.setHeadColor(Vec4(0.31, 0.40, 0.55, 1.00))
    p0.renderer.setTailColor(Vec4(0.31, 0.40, 0.55, 1.00))
    ...
    f0 = ForceGroup.ForceGroup('gravity')
    # Force parameters
    force0 = LinearVectorForce(Vec3(0.0000, 0.0000, -32.0000), 1.0000, 0)
    force0.setVectorMasks(1, 1, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def paperRain(self):
    ...
    p0.setSystemGrowsOlderFlag(0)
    # Factory parameters
    p0.factory.setLifespanBase(13.0000)
    p0.factory.setLifespanSpread(0.0000)
    p0.factory.setMassBase(1.0000)
    p0.factory.setMassSpread(0.0000)
    p0.factory.setTerminalVelocityBase(400.0000)
    ...
    p0.renderer.setYScaleFlag(0)
    p0.renderer.setAnimAngleFlag(1)
    p0.renderer.setInitialXScale(0.003125)
    p0.renderer.setFinalXScale(0.003125)
    p0.renderer.setInitialYScale(0.003125)
    p0.renderer.setFinalYScale(0.003125)
    p0.renderer.setNonanimatedTheta(0.0000)
    p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPNOBLEND)
    p0.renderer.setAlphaDisable(0)
    # Emitter parameters
...
def paperRainCLO(self):
    ...
    p0.setSystemGrowsOlderFlag(0)
    # Factory parameters
    p0.factory.setLifespanBase(18.0000)
    p0.factory.setLifespanSpread(0.0000)
    p0.factory.setMassBase(1.0000)
    p0.factory.setMassSpread(0.0000)
    p0.factory.setTerminalVelocityBase(400.0000)
...
def paperRainDocketCLO(self):
    ...
    f0 = ForceGroup.ForceGroup('gravity')
    # Force parameters
    force0 = LinearVectorForce(Vec3(0.0000, 0.0000, -35.0000), 1.5000, 0)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearJitterForce(2.0000, 0)
    force1.setActive(1)
...
@particle
def bossCogPaperFrontAttack(self):
    self.reset()
    self.setPos(0.000, 0.000, 4.600)
    self.setHpr(0.000, 0.000, 0.000)
    self.setScale(1.000, 1.000, 1.000)
    ...
    p0.renderer.setFinalXScale(0.0040)
    p0.renderer.setInitialYScale(0.0020)
    p0.renderer.setFinalYScale(0.0040)
    p0.renderer.setNonanimatedTheta(0.0000)
    p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPBLENDLINEAR)
    p0.renderer.setAlphaDisable(0)
    # Emitter parameters
...
def snap(self):
    ...
    p0.setLitterSize(1)
    p0.setLitterSpread(0)
    p0.setSystemLifespan(60.0000)
    p0.setLocalVelocityFlag(1)
    p0.setSystemGrowsOlderFlag(0)
    # Factory parameters
    p0.factory.setLifespanBase(180.0000)
    p0.factory.setLifespanSpread(0.0000)
    p0.factory.setMassBase(1.0000)
    p0.factory.setMassSpread(0.0000)
    p0.factory.setTerminalVelocityBase(400.0000)
    ...
    p0.renderer.setUserAlpha(1.00)
    # Sprite parameters
    p0.renderer.addTextureFromNode('phase_3.5/models/gui/battlegui/status_effects', '**/vulnerable_icon')
    p0.renderer.setColor(Vec4(1.00, 1.00, 1.00, 1.00))
    p0.renderer.setXScaleFlag(0)
    p0.renderer.setYScaleFlag(0)
    p0.renderer.setAnimAngleFlag(1)
    p0.renderer.setInitialXScale(0.4000)
    p0.renderer.setFinalXScale(0.0000)
    p0.renderer.setInitialYScale(0.4000)
    p0.renderer.setFinalYScale(0.0000)
    p0.renderer.setNonanimatedTheta(90.0000)
    p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPBLENDLINEAR)
    p0.renderer.setAlphaDisable(0)
    ...
    p0.emitter.setAmplitude(1.0000)
    p0.emitter.setAmplitudeSpread(0.0000)
    p0.emitter.setOffsetForce(Vec3(1.6000, 0.0000, 0.0000))
    p0.emitter.setExplicitLaunchVector(Vec3(0.0000, 0.0000, 0.0000))
    p0.emitter.setRadiateOrigin(Point3(0.0000, 0.0000, 0.0000))
    # Point parameters
    p0.emitter.setLocation(Point3(0.0000, 1.0000, 0.3000))
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('source')
    # Force parameters
    force0 = LinearSinkForce(Point3(0.0000, 0.0000, 2.0000), LinearDistanceForce.FTONEOVERR, 1.0000, 2.0000, 1)
    force0.setVectorMasks(1, 1, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def scapegoatEnraged(self):
    ...
    p0.renderer.getColorInterpolationManager().addConstant(0.0, 1.0,
                                                           Vec4(1.0, 0.5882353186607361, 0.7843137383460999, 1.0), True)
    # Emitter parameters
    p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
...
def raindisk(self):
    ...
    p0.emitter.setOffsetForce(Vec3(11.3, 0.0, -69.0))
...
@particle
def underwaterRipples(self):
    self.reset()
    self.setPos(0.000, 0.000, 0.020)
    self.setHpr(0.000, 0.000, 0.000)
    self.setScale(2.000, 2.000, 2.000)
    p0 = Particles.Particles('particles-1')
    # Particles parameters
    ...
    p0.renderer.setUserAlpha(1.00)
    # Geom parameters
    geomRef = loader.loadModel("phase_4/models/props/ripples")
    p0.renderer.setGeomNode(geomRef.node())
    p0.geomReference = "phase_4/models/props/ripples"
    p0.renderer.setXScaleFlag(0)
    p0.renderer.setYScaleFlag(0)
    ...
    p0.renderer.setInitialZScale(0.6000)
    p0.renderer.setFinalZScale(0.6000)
    p0.renderer.getColorInterpolationManager().addConstant(0.0, 1.0, Vec4(0.47058823704719543, 1.0, 1.0, 1.0), True)
    # Emitter parameters
    p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
    p0.emitter.setAmplitude(1.0000)
    p0.emitter.setAmplitudeSpread(0.0000)
...
def healSpinEffect(self):
    ...
    p0.renderer.setIgnoreScale(1)
    p0.renderer.setTextureFromNode("phase_3.5/models/props/suit-particles", "**/snow-particle")
    p0.renderer.setColor(Vec4(0.10, 0.70, 0.10, 1.00))
    p0.renderer.setXScaleFlag(1)
    p0.renderer.setYScaleFlag(1)
    p0.renderer.setAnimAngleFlag(0)
    p0.renderer.setInitialXScale(0.05)
...
@particle
def schoolhouseClassroomChalkboardDust(self):
    self.reset()
    self.setPos(0.000, 0.000, 0.000)
    self.setHpr(0.000, 90.000, 90.000)
    self.setScale(0.4, 0.4, 0.4)
    p0 = Particles.Particles('particles-1')
    # Particles parameters
    p0.setFactory("PointParticleFactory")
    p0.setRenderer("SpriteParticleRenderer")
...
def whirlwind1(self):
    ...
    p0.renderer.setFinalXScale(0.2000)
    p0.renderer.setInitialYScale(0.1000)
    p0.renderer.setFinalYScale(0.2000)
    p0.renderer.setNonanimatedTheta(0.0000)
    p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPBLENDLINEAR)
    p0.renderer.setAlphaDisable(0)
    p0.renderer.getColorInterpolationManager().addConstant(0.0, 1.0, Vec4(0.6705882549285889, 0.6823529601097107,
                                                                          0.7254902124404907, 1.0), True)
    # Emitter parameters
    p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
    p0.emitter.setAmplitude(1.0000)
    p0.emitter.setAmplitudeSpread(0.0000)
    ...
    p0.emitter.setRadius(1.0000)
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('force')
    # Force parameters
    force0 = LinearCylinderVortexForce(1.0000, 1.0000, 3.0000, 1.5000, 0)
    force0.setVectorMasks(1, 1, 1)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearVectorForce(Vec3(0.0000, 0.0000, 10.0000), 1.0000, 0)
    force1.setVectorMasks(1, 1, 1)
    force1.setActive(1)
    f0.addForce(force1)
    self.addForceGroup(f0)
...
def whirlwind2(self):
    ...
    f0 = ForceGroup.ForceGroup('force')
    # Force parameters
    force0 = LinearCylinderVortexForce(1.0000, 1.0000, 3.0000, 3.5000, 0)
    force0.setVectorMasks(1, 1, 1)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearVectorForce(Vec3(0.0000, 0.0000, 10.0000), 0.7000, 0)
    force1.setVectorMasks(1, 1, 1)
    force1.setActive(1)
    f0.addForce(force1)
    self.addForceGroup(f0)
...
@particle
def prethinkerForwardThinkingBrainStorm(self):
    self.reset()
    self.setPos(0.000, 0.000, 0.000)
    self.setHpr(0.000, 0.000, 0.000)
    self.setScale(1.000, 1.000, 1.000)
...
def chainsawScabbardDown(self):
    ...
    p0.emitter.setAmplitudeSpread(0.0000)
    p0.emitter.setOffsetForce(Vec3(0.0000, 0.0000, 0.0000))
    p0.emitter.setExplicitLaunchVector(Vec3(0.0000, 0.0000, -3.0000))
    p0.emitter.setRadiateOrigin(Point3(0.0000, 0.0000, 0.0000))
    # Sphere Volume parameters
    p0.emitter.setRadius(2.0000)
    self.addParticles(p0)
...
def shortSqueezeCrush(self):
    ...
    p0.renderer.setYScaleFlag(1)
    p0.renderer.setAnimAngleFlag(0)
    p0.renderer.setInitialXScale(0.8500)
    p0.renderer.setFinalXScale(0.3000)
    p0.renderer.setInitialYScale(0.8500)
    p0.renderer.setFinalYScale(0.3000)
    p0.renderer.setNonanimatedTheta(0.0000)
    p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPBLENDLINEAR)
    p0.renderer.setAlphaDisable(1)
    ...
    # Emitter parameters
    p0.emitter.setEmissionType(BaseParticleEmitter.ETEXPLICIT)
    p0.emitter.setAmplitude(0.6000)
    p0.emitter.setAmplitudeSpread(0.0000)
    p0.emitter.setOffsetForce(Vec3(0.0000, 0.0000, 0.0000))
    p0.emitter.setExplicitLaunchVector(Vec3(0.0000, 0.0000, 0.0000))
    p0.emitter.setRadiateOrigin(Point3(0.0000, 0.0000, 0.0000))
...
def shortSqueezeSpray(self):
    ...
    p0.factory.enableAngularVelocity(1)
    p0.factory.setFinalAngle(0.0000)
    p0.factory.setFinalAngleSpread(120.0000)
    # Renderer parameters
    p0.renderer.setAlphaMode(BaseParticleRenderer.PRALPHANONE)
    p0.renderer.setUserAlpha(1.00)
    # Geom parameters
    ...
    p0.renderer.setFinalXScale(1.8)
    p0.renderer.setInitialYScale(0.6)
    p0.renderer.setFinalYScale(1.8)
    # Emitter parameters
    p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
    p0.emitter.setAmplitude(8.0000)
    p0.emitter.setAmplitudeSpread(0.0000)
    p0.emitter.setOffsetForce(Vec3(0.0000, 0.0000, 8.0000))
    p0.emitter.setExplicitLaunchVector(Vec3(1.0000, 0.0000, 0.0000))
    p0.emitter.setRadiateOrigin(Point3(0.0000, 0.0000, 0.0000))
    # Sphere Volume parameters
    p0.emitter.setRadius(2.0000)
    ...
    p1.factory.setInitialAngleSpread(40.0000)
    p1.factory.enableAngularVelocity(1)
    p1.factory.setFinalAngle(0.0000)
    p1.factory.setFinalAngleSpread(120.0000)
    # Renderer parameters
    p1.renderer.setAlphaMode(BaseParticleRenderer.PRALPHANONE)
    p1.renderer.setUserAlpha(1.00)
    # Geom parameters
    ...
    p1.renderer.setInitialXScale(0.6)
    p1.renderer.setFinalXScale(1.8)
    p1.renderer.setInitialYScale(0.6)
    p1.renderer.setFinalYScale(1.8)
    # Emitter parameters
    p1.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
    p1.emitter.setAmplitude(8.0000)
    p1.emitter.setAmplitudeSpread(0.0000)
    p1.emitter.setOffsetForce(Vec3(0.0000, 0.0000, 8.0000))
    p1.emitter.setExplicitLaunchVector(Vec3(1.0000, 0.0000, 0.0000))
    p1.emitter.setRadiateOrigin(Point3(0.0000, 0.0000, 0.0000))
    # Sphere Volume parameters
    p1.emitter.setRadius(2.0000)
    ...
    p2 = Particles.Particles('particles-3')
    # Particles parameters
    p2.setFactory("ZSpinParticleFactory")
    p2.setRenderer("GeomParticleRenderer")
    p2.setEmitter("SphereVolumeEmitter")
    p2.setPoolSize(512)
    p2.setBirthRate(0.2000)
    p2.setLitterSize(1)
    p2.setLitterSpread(0)
    p2.setSystemLifespan(0.0000)
    p2.setLocalVelocityFlag(1)
    ...
    p2.factory.setTerminalVelocitySpread(0.0000)
    # Z Spin factory parameters
    p2.factory.setInitialAngle(0.0000)
    p2.factory.setInitialAngleSpread(40.0000)
    p2.factory.enableAngularVelocity(1)
    p2.factory.setFinalAngle(0.0000)
    p2.factory.setFinalAngleSpread(720.0000)
    # Renderer parameters
    p2.renderer.setAlphaMode(BaseParticleRenderer.PRALPHANONE)
    p2.renderer.setUserAlpha(1.00)
    # Geom parameters
    p2.renderer.setXScaleFlag(1)
    p2.renderer.setYScaleFlag(1)
    p2.renderer.setInitialXScale(0.6)
    p2.renderer.setFinalXScale(1.8)
    p2.renderer.setInitialYScale(0.6)
    p2.renderer.setFinalYScale(1.8)
    # Emitter parameters
    p2.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
    p2.emitter.setAmplitude(8.0000)
    p2.emitter.setAmplitudeSpread(0.0000)
    p2.emitter.setOffsetForce(Vec3(0.0000, 0.0000, 8.0000))
    p2.emitter.setExplicitLaunchVector(Vec3(1.0000, 0.0000, 0.0000))
    p2.emitter.setRadiateOrigin(Point3(0.0000, 0.0000, 0.0000))
    # Sphere Volume parameters
    p2.emitter.setRadius(2.0000)
...
def fallingKnifeSpray(self):
    ...
    # Emitter parameters
    p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
    p0.emitter.setAmplitude(14.0000)
    p0.emitter.setAmplitudeSpread(0.0000)
    p0.emitter.setOffsetForce(Vec3(0.0000, 0.0000, 14.0000))
    p0.emitter.setExplicitLaunchVector(Vec3(1.0000, 0.0000, 0.0000))
    p0.emitter.setRadiateOrigin(Point3(0.0000, 0.0000, 0.0000))
    # Sphere Volume parameters
    p0.emitter.setRadius(2.0000)
