...
class WordPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.acc2Page.hide()
        self.title = DirectLabel(parent=self, relief=None, text='Toon Customization', text_scale=0.12, pos=(0, 0, 0.6))
        normalColor = (1, 1, 1, 1)
        clickColor = (0.8, 0.8, 0, 1)
        rolloverColor = (0.15, 0.82, 1.0, 1)
        disabledColor = (1.0, 0.98, 0.15, 1)
        gui = loader.loadModel('phase_3.5/models/gui/fishingBook')
        self.clothingTab = DirectButton(parent=self, relief=None, text='Clothing', text_scale=0.06,
                                        text_align=TextNode.ACenter, text_pos=(0.12, 0.035, 0),
                                        ...
                                        extraArgs=[PageMode.IDs], pos=(-0.58, 0, 0.77))
        self.acc1Tab = DirectButton(parent=self, relief=None, text='Head Accessories', text_scale=0.045,
                                    text_align=TextNode.ACenter, text_pos=(0.125, 0.035, 0),
                                    image=gui.find('**/tabs/polySurface2'), image_pos=(0.12, 1, -0.91),
                                    image_hpr=(0, 0, -90), image_scale=(0.033, 0.033, 0.035),
                                    image_color=normalColor, image1_color=clickColor,
                                    image2_color=rolloverColor, image3_color=disabledColor,
                                    text_fg=Vec4(0.2, 0.1, 0, 1), command=self.setMode,
                                    extraArgs=[PageMode.Acc1], pos=(-0.1, 0, 0.77))
        self.acc2Tab = DirectButton(parent=self, relief=None, text='Body Accessories', text_scale=0.045,
                                    text_align=TextNode.ACenter, text_pos=(0.125, 0.035, 0),
                                    image=gui.find('**/tabs/polySurface2'), image_pos=(0.12, 1, -0.91),
                                    image_hpr=(0, 0, -90), image_scale=(0.033, 0.033, 0.035),
                                    image_color=normalColor, image1_color=clickColor,
                                    image2_color=rolloverColor, image3_color=disabledColor,
                                    text_fg=Vec4(0.2, 0.1, 0, 1), command=self.setMode,
                                    extraArgs=[PageMode.Acc2], pos=(0.38, 0, 0.77))
        gui.removeNode()

    def enter(self):
        self.setMode(PageMode.IDs, 1)
    ...
    def unload(self):
        ...
        self.clothingTab.destroy()
        self.acc1Tab.destroy()
        self.acc2Tab.destroy()
        self.title.destroy()
        ShtikerPage.ShtikerPage.unload(self)

    def setMode(self, mode, updateAnyways=0):
        if not updateAnyways and self.mode == mode:
            return
        self.mode = mode
        self.clothingTabPage.exit()
        self.acc1Page.exit()
...
class ClothingTabPage(DirectFrame):
    ...
    def createModel(self):
        ...
        dna.armColor = ToonDNA.allColorsList[27]
        dna.gloveColor = ToonDNA.allColorsList[27]
        toon.setDNA(dna)
    ...
    def setAsClothing(self):
        ...
        av.sendUpdate('requestSetClothing', [newDNA.makeNetString()])
...
class AccTabPage1(DirectFrame):
    ...
    def load(self):
        ...
        self.hat = currentHat[0]
        self.hatTex = currentHat[1]
        self.glasses = currentGlasses[0]
        self.glassesTex = currentGlasses[1]
    ...
    def createModel(self):
        ...
        dna.headColor = ToonDNA.allColorsList[27]
        dna.gloveColor = ToonDNA.allColorsList[27]
        dna.armColor = ToonDNA.allColorsList[27]
        dna.legColor = ToonDNA.allColorsList[27]
        toon.setDNA(dna)
    ...
    def setAsClothing(self):
        av = base.cr.doId2do.get(base.localAvatar.doId)
        hat = (self.hat, self.hatTex, 0)
        glasses = (self.glasses, self.glassesTex, 0)
        backpack = av.getBackpack()
        shoes = av.getShoes()
        av.sendUpdate('requestSetAccessories', [hat[0], hat[1], hat[2], glasses[0], glasses[1], glasses[2], backpack[0], backpack[1], backpack[2], shoes[0], shoes[1], shoes[2]])
...
class AccTabPage2(DirectFrame):
    ...
    def setAsClothing(self):
        av = base.cr.doId2do.get(base.localAvatar.doId)
        hat = av.getHat()
        glasses = av.getGlasses()
        backpack = (self.backpack, self.backpackTex, 0)
        shoes = (self.shoes, self.shoesTex, 0)
        av.sendUpdate('requestSetAccessories', [hat[0], hat[1], hat[2], glasses[0], glasses[1], glasses[2], backpack[0], backpack[1], backpack[2], shoes[0], shoes[1], shoes[2]])
