...
class MapPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        for hood in ToontownGlobals.Hoods:
            if hood not in [ToontownGlobals.GolfZone, ToontownGlobals.TechbotHQ, ToontownGlobals.FunnyFarm, ToontownGlobals.PartyHood, ToontownGlobals.GoofySpeedway, ToontownGlobals.Toonseltown, ToontownGlobals.SkyClan]:
