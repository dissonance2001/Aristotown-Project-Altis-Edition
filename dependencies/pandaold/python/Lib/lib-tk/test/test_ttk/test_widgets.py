...
class WidgetTest(AbstractTkTest, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.widget = tkinter.ttk.Button(self.root, width=0, text="Text")
        self.widget.pack()
...
class FrameTest(AbstractToplevelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Frame(self.root, **kwargs)
...
class LabelFrameTest(AbstractToplevelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.LabelFrame(self.root, **kwargs)
    ...
    def test_labelwidget(self):
        widget = self.create()
        label = tkinter.ttk.Label(self.root, text='Mupp', name='foo')
...
class LabelTest(AbstractLabelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Label(self.root, **kwargs)
...
class ButtonTest(AbstractLabelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Button(self.root, **kwargs)
    ...
    def test_invoke(self):
        success = []
        btn = tkinter.ttk.Button(self.root, command=lambda: success.append(1))
        btn.invoke()
...
class CheckbuttonTest(AbstractLabelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Checkbutton(self.root, **kwargs)
    ...
    def test_invoke(self):
        ...
        cbtn = tkinter.ttk.Checkbutton(self.root, command=cb_test)
...
class EntryTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Entry(self.root, **kwargs)
...
class ComboboxTest(EntryTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Combobox(self.root, **kwargs)
    ...
    def test_values(self):
        ...
        combo2 = tkinter.ttk.Combobox(self.root, values=[1, 2, ''])
...
class PanedWindowTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.PanedWindow(self.root, **kwargs)
    ...
    def test_add(self):
        ...
        label = tkinter.ttk.Label(self.paned)
        child = tkinter.ttk.Label(label)
        self.assertRaises(tkinter.TclError, self.paned.add, child)
        label.destroy()
        child.destroy()
        # another attempt
        label = tkinter.ttk.Label(self.root)
        child = tkinter.ttk.Label(label)
        self.assertRaises(tkinter.TclError, self.paned.add, child)
        child.destroy()
        label.destroy()

        good_child = tkinter.ttk.Label(self.root)
        self.paned.add(good_child)
        # re-adding a child is not accepted
        self.assertRaises(tkinter.TclError, self.paned.add, good_child)

        other_child = tkinter.ttk.Label(self.paned)
    ...
    def test_forget(self):
        ...
        self.paned.add(tkinter.ttk.Label(self.root))
        self.paned.forget(0)
        self.assertRaises(tkinter.TclError, self.paned.forget, 0)
    ...
    def test_insert(self):
        ...
        child = tkinter.ttk.Label(self.root)
        child2 = tkinter.ttk.Label(self.root)
        child3 = tkinter.ttk.Label(self.root)
    ...
    def test_sashpos(self):
        ...
        child = tkinter.ttk.Label(self.paned, text='a')
        self.paned.add(child, weight=1)
        self.assertRaises(tkinter.TclError, self.paned.sashpos, 0)
        child2 = tkinter.ttk.Label(self.paned, text='b')
...
class RadiobuttonTest(AbstractLabelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Radiobutton(self.root, **kwargs)
    ...
    def test_invoke(self):
        ...
        cbtn = tkinter.ttk.Radiobutton(self.root, command=cb_test,
                               variable=myvar, value=0)
        cbtn2 = tkinter.ttk.Radiobutton(self.root, command=cb_test,
...
class MenubuttonTest(AbstractLabelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Menubutton(self.root, **kwargs)
...
class ScaleTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Scale(self.root, **kwargs)
...
class ProgressbarTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Progressbar(self.root, **kwargs)
...
class ScrollbarTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Scrollbar(self.root, **kwargs)
...
class NotebookTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.child1 = tkinter.ttk.Label(self.root)
        self.child2 = tkinter.ttk.Label(self.root)
        self.nb.add(self.child1, text='a')
        self.nb.add(self.child2, text='b')

    def create(self, **kwargs):
        return tkinter.ttk.Notebook(self.root, **kwargs)
    ...
    def test_add_and_hidden(self):
        ...
        self.assertRaises(tkinter.TclError, self.nb.add, tkinter.ttk.Label(self.root),
            unknown='option')
...
class TreeviewTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Treeview(self.root, **kwargs)
...
class SeparatorTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Separator(self.root, **kwargs)
...
class SizegripTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        return tkinter.ttk.Sizegrip(self.root, **kwargs)
