...
class build_ext (Command):
    ...
    def check_extensions_list(self, extensions):
        ...
        for i, ext in enumerate(extensions):
            ...
            if not isinstance(ext, tuple) or len(ext) != 2:
                raise DistutilsSetupError("each element of 'ext_modules' option must be an "
            ...
            if not (isinstance(ext_name, str) and
                ...
                raise DistutilsSetupError("first element of each tuple in 'ext_modules' "
                       "must be the extension name (a string)")

            if not isinstance(build_info, dict):
                raise DistutilsSetupError("second element of each tuple in 'ext_modules' "
    ...
    def find_swig (self):
        ...
        if os.name == "posix":
            ...
            raise DistutilsPlatformError(("I don't know how to find (much less run) SWIG "
