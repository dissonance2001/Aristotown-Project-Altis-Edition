...
class TopologyDescription(object):
    def __init__(self,
        ...
        for s in list(self._server_descriptions.values()):
    ...
    def known_servers(self):
        ...
        return [s for s in list(self._server_descriptions.values())
                if s.is_server_type_known]

    @property
    def has_known_servers(self):
        """Whether there are any Servers of types besides Unknown."""
        return any(s for s in list(self._server_descriptions.values())
                   if s.is_server_type_known)

    @property
    def readable_servers(self):
        """List of readable Servers."""
        return [s for s in list(self._server_descriptions.values()) if s.is_readable]
    ...
    def __repr__(self):
        ...
        servers = sorted(list(self._server_descriptions.values()),
