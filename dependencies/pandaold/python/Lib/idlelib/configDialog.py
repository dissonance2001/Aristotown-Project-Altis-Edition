...
class ConfigDialog(Toplevel):
    ...
    def CreatePageFontTab(self):
        ...
        self.editFont = tkinter.font.Font(parent, ('courier', 10, 'normal'))
    ...
    def GetColour(self):
        ...
        rgbTuplet, colourString = tkinter.colorchooser.askcolor(
    ...
    def SetFontSample(self, event=None):
        ...
        fontWeight = tkinter.font.BOLD if self.fontBold.get() else tkinter.font.NORMAL
