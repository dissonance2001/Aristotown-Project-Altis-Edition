    ...
    def store_file_breaks(self):
        ...
        try:
            ...
            if not getattr(self.root, "breakpoint_error_displayed", False):
                ...
                tkinter.messagebox.showerror(title='IDLE Error',
...
class ModifiedInterpreter(InteractiveInterpreter):
    ...
    def runsource(self, source):
        ...
        if isinstance(source, str) and IOBinding.encoding != 'utf-8':
            try:
                source = '# -*- coding: %s -*-\n%s' % (
                        IOBinding.encoding,
...
##        self.config(usetabs=1, indentwidth=8, context_use_ps1=1)
    ...
    def toggle_debugger(self, event=None):
        if self.executing:
            tkinter.messagebox.showerror("Don't debug now",
    ...
    def open_stack_viewer(self, event=None):
        ...
        try:
            ...
            tkinter.messagebox.showerror("No stack trace",
...
class PseudoOutputFile(PseudoFile):
    ...
    def write(self, s):
        ...
        if type(s) not in (str, str, bytearray):
            # See issue #19481
            if isinstance(s, str):
                s = str.__getitem__(s, slice(None))
