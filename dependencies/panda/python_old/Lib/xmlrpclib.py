    ...
    def dump_struct(self, value, write, escape=escape):
        ...
        for k, v in value.items():
            ...
            if type(k) is StringType:
                k = escape(k)
            elif six.text_type and type(k) is UnicodeType:
...
class Transport:
        ...
        for i in (0, 1):
            try:
                ...
                if i or e.errno not in (errno.ECONNRESET, errno.ECONNABORTED, errno.EPIPE):
                    raise
            except six.moves.http_client.BadStatusLine: #close after we sent request
                if i:
                    raise
    ...
    def make_connection(self, host):
        ...
        self._connection = host, six.moves.http_client.HTTPConnection(chost)
        return self._connection[1]
...
class ServerProxy:
    ...
    def __init__(self, uri, transport=None, encoding=None, verbose=0,
        ...
        if six.text_type and isinstance(uri, six.text_type):
