...
class Decimal(object):
    ...
    def __new__(cls, value="0", context=None):
        ...
        if isinstance(value, (list,tuple)):
            ...
            if not (isinstance(value[0], six.integer_types) and value[0] in (0,1)):
            ...
            if value[2] == 'F':
                ...
                for digit in value[1]:
                    if isinstance(digit, six.integer_types) and 0 <= digit <= 9:
                        # skip leading zeros
                ...
                if value[2] in ('n', 'N'):
                    ...
                    self._exp = value[2]
                    self._is_special = True
                elif isinstance(value[2], six.integer_types):
    ...
    def from_float(cls, f):
        ...
        """
        if isinstance(f, six.integer_types):        # handle integer inputs
            return cls(f)
...
class Context(object):
    ...
    def create_decimal(self, num='0'):
        ...
        if isinstance(num, six.string_types) and num != num.strip():
...
def _parse_format_specifier(format_spec, _localeconv=None):
    ...
    try:
        format_dict['unicode'] = isinstance(format_spec, six.text_type)
    except NameError:
