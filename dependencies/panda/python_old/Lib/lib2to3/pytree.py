...
class Base(object):
    ...
    if sys.version_info < (3, 0):
        def __str__(self):
            return six.text_type(self).encode("ascii")
...
class Node(Base):
    ...
    def __unicode__(self):
        ...
        """
        return u"".join(map(six.text_type, self.children))
...
class LeafPattern(BasePattern):
    ...
    def __init__(self, type=None, content=None, name=None):
        ...
        if content is not None:
            assert isinstance(content, six.string_types), repr(content)
        self.type = type
...
class NodePattern(BasePattern):
    ...
    def __init__(self, type=None, content=None, name=None):
        ...
        if type is not None:
            assert type >= 256, type
        if content is not None:
            assert not isinstance(content, six.string_types), repr(content)
