...
def urlopen(url, data=None, timeout=defaults.TIMEOUT, ca_certs=None,
    ...
    class ValidHTTPSHandler(six.moves.urllib.request.HTTPSHandler):
    ...
    if verify_ssl:
        ...
        try:
            handlers = [six.moves.urllib.request.HTTPSHandler(
                context=ssl._create_unverified_context())]
        except AttributeError:
            handlers = []

    opener = six.moves.urllib.request.build_opener(*handlers)
