...
class PyMongoError(Exception):
    ...
    if sys.version_info[0] == 2:
        def __str__(self):
            if isinstance(self._message, six.text_type):
        ...
        def __unicode__(self):
            ...
            return six.text_type(self._message, 'utf-8', errors='replace')
...
def _format_detailed_error(message, details):
    if details is not None:
        ...
        if sys.version_info[0] == 2 and isinstance(message, six.text_type):
