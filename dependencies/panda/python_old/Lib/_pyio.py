...
try:
    ...
    from six.moves._dummy_thread import allocate_lock as Lock
...
class BlockingIOError(IOError):
    ...
    def __init__(self, errno, strerror, characters_written=0):
        ...
        if not isinstance(characters_written, six.integer_types):
...
def open(file, mode="r", buffering=-1,
    ...
    * On output, if newline is None, any '\n' characters written are
    ...
    """
    if not isinstance(file, (six.string_types, int, int)):
        raise TypeError("invalid file: %r" % file)
    if not isinstance(mode, six.string_types):
        raise TypeError("invalid mode: %r" % mode)
    if not isinstance(buffering, six.integer_types):
        raise TypeError("invalid buffering: %r" % buffering)
    if encoding is not None and not isinstance(encoding, six.string_types):
        raise TypeError("invalid encoding: %r" % encoding)
    if errors is not None and not isinstance(errors, six.string_types):
...
class IOBase(six.with_metaclass(abc.ABCMeta)):
    ...
    def readline(self, limit=-1):
        ...
        if limit is None:
            limit = -1
        elif not isinstance(limit, six.integer_types):
    ...
    def readlines(self, hint=None):
        ...
        """
        if hint is not None and not isinstance(hint, six.integer_types):
...
class TextIOWrapper(TextIOBase):
    ...
    def __init__(self, buffer, encoding=None, errors=None, newline=None,
                 line_buffering=False):
        if newline is not None and not isinstance(newline, six.string_types):
...
class StringIO(TextIOWrapper):
    ...
    def __init__(self, initial_value="", newline="\n"):
        ...
        if initial_value:
            if not isinstance(initial_value, six.text_type):
                initial_value = six.text_type(initial_value)
