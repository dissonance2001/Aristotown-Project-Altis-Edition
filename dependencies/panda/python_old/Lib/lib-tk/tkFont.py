    ...
    def __init__(self, root=None, font=None, name=None, exists=False, **options):
        ...
        if exists:
            ...
            if self.name not in tk.splitlist(tk.call("font", "names")):
                raise six.moves.tkinter._tkinter.TclError("named font %s does not already exist" % (self.name,))
...
if __name__ == "__main__":
    ...
    w = six.moves.tkinter.Label(root, text="Hello, world", font=f)
    w.pack()

    w = six.moves.tkinter.Button(root, text="Quit!", command=root.destroy)
    w.pack()
