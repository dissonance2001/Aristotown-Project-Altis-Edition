...
class LabeledScaleTest(AbstractTkTest, unittest.TestCase):
    ...
    def test_widget_destroy(self):
        ...
        x = six.moves.tkinter_ttk.LabeledScale(self.root)
        ...
        name = myvar._name
        x = six.moves.tkinter_ttk.LabeledScale(self.root, variable=myvar)
        x.destroy()
        if self.wantobjects:
        ...
        six.moves.tkinter_ttk.LabeledScale(self.root, variable=myvar)
    ...
    def test_initialization_no_master(self):
        ...
        with swap_attr(tkinter, '_default_root', None), \
            ...
            try:
                x = six.moves.tkinter_ttk.LabeledScale()
    ...
    def test_initialization(self):
        ...
        x = six.moves.tkinter_ttk.LabeledScale(master)
        ...
        for pair in passed_expected:
            x = six.moves.tkinter_ttk.LabeledScale(self.root, from_=pair[0])
            self.assertEqual(x.value, pair[1])
            x.destroy()
        x = six.moves.tkinter_ttk.LabeledScale(self.root, from_='2.5')
        self.assertRaises(ValueError, x._variable.get)
        x.destroy()
        x = six.moves.tkinter_ttk.LabeledScale(self.root, from_=None)
        self.assertRaises(ValueError, x._variable.get)
        x.destroy()
        ...
        x = six.moves.tkinter_ttk.LabeledScale(self.root, variable=myvar, from_=0.5)
        ...
        x = six.moves.tkinter_ttk.LabeledScale(self.root, compound='top')
        check_positions(x.scale, 'bottom', x.label, 'n')
        x.destroy()
        x = six.moves.tkinter_ttk.LabeledScale(self.root, compound='bottom')
        check_positions(x.scale, 'top', x.label, 's')
        x.destroy()
        # invert default positions
        x = six.moves.tkinter_ttk.LabeledScale(self.root, compound='unknown')
        check_positions(x.scale, 'top', x.label, 's')
        x.destroy()
        x = six.moves.tkinter_ttk.LabeledScale(self.root) # take default positions
        check_positions(x.scale, 'bottom', x.label, 'n')
        x.destroy()

        # extra, and invalid, kwargs
        self.assertRaises(tkinter.TclError, six.moves.tkinter_ttk.LabeledScale, master, a='b')


    def test_horizontal_range(self):
        lscale = six.moves.tkinter_ttk.LabeledScale(self.root, from_=0, to=10)
        lscale.pack()
...
class OptionMenuTest(AbstractTkTest, unittest.TestCase):
    ...
    def test_widget_destroy(self):
        ...
        optmenu = six.moves.tkinter_ttk.OptionMenu(self.root, var)
        name = var._name
    ...
    def test_initialization(self):
        self.assertRaises(tkinter.TclError,
            six.moves.tkinter_ttk.OptionMenu, self.root, self.textvar, invalid='thing')

        optmenu = six.moves.tkinter_ttk.OptionMenu(self.root, self.textvar, 'b', 'a', 'b')
    ...
    def test_menu(self):
        items = ('a', 'b', 'c')
        default = 'a'
        optmenu = six.moves.tkinter_ttk.OptionMenu(self.root, self.textvar, default, *items)
        found_default = False
        ...
        def cb_test(item):
            ...
            success.append(True)
        optmenu = six.moves.tkinter_ttk.OptionMenu(self.root, self.textvar, 'a', command=cb_test,
            *items)
    ...
    def test_unique_radiobuttons(self):
        ...
        optmenu2 = six.moves.tkinter_ttk.OptionMenu(self.root, textvar2, default, *items)
        optmenu.pack()
        optmenu.wait_visibility()
        optmenu2.pack()
