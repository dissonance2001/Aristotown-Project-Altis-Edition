...
class MenubuttonTest(AbstractLabelTest, unittest.TestCase):
    ...
    test_highlightthickness = StandardOptionsTests.test_highlightthickness.__func__
...
class ListboxTest(AbstractWidgetTest, unittest.TestCase):
    ...
    test_justify = requires_tcl(8, 6, 5)(StandardOptionsTests.test_justify.__func__)
