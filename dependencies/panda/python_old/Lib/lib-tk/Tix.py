...
from six.moves.tkinter import _flatten, _cnfmerge
...
class Tk(six.moves.tkinter.Tk, tixCommand):
    """Toplevel widget of Tix which represents mostly the main window
    of an application. It has an associated Tcl interpreter."""
    def __init__(self, screenName=None, baseName=None, className='Tix'):
        six.moves.tkinter.Tk.__init__(self, screenName, baseName, className)
    ...
    def destroy(self):
        ...
        six.moves.tkinter.Tk.destroy(self)
...
six.moves.tkinter.Widget.__bases__ = six.moves.tkinter.Widget.__bases__ + (Form,)

class TixWidget(six.moves.tkinter.Widget):
    ...
    def image_create(self, imgtype, cnf={}, master=None, **kw):
        if not master:
            master = six.moves.tkinter._default_root
            if not master:
