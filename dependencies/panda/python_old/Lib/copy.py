...
try:
    d[six.text_type] = _deepcopy_atomic
except NameError:
    pass
try:
    ...
    if state is not None:
        ...
        if hasattr(y, '__setstate__'):
            ...
            if slotstate is not None:
                for key, value in six.iteritems(slotstate):
                    setattr(y, key, value)
...
def _test():
    ...
    print(list(map(six.moves.reprlib.repr, l)))
    print(list(map(six.moves.reprlib.repr, l1)))
    print(list(map(six.moves.reprlib.repr, l2)))
    print(list(map(six.moves.reprlib.repr, l3)))
    l3 = deepcopy(l)
    import six.moves.reprlib
    print(list(map(six.moves.reprlib.repr, l)))
    print(list(map(six.moves.reprlib.repr, l1)))
