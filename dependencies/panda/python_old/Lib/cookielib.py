...
import re, six.moves.urllib.parse, copy, time, six.moves.urllib.request, six.moves.urllib.parse, six.moves.urllib.error
try:
    import threading as _threading
except ImportError:
    import dummy_threading as _threading
import six.moves.http_client  # only for the default HTTP port
...
DEFAULT_HTTP_PORT = str(six.moves.http_client.HTTP_PORT)
...
def escape_path(path):
    ...
    path = six.moves.urllib.parse.quote(path, HTTP_PATH_SAFE)
