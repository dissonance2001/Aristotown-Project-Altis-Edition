...
class UserDict:
    ...
    def iteritems(self): return six.iteritems(self.data)
    def iterkeys(self): return six.iterkeys(self.data)
    def itervalues(self): return six.itervalues(self.data)
