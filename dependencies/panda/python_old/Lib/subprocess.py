...
class Popen(object):
    ...
    def __init__(self, args, bufsize=0, executable=None,
        ...
        try:
            ...
            six.reraise(exc_type, exc_value, exc_trace)
    ...
    if mswindows:
        ...
        def _get_handles(self, stdin, stdout, stderr):
            ...
            elif isinstance(stdin, six.integer_types):
            ...
            elif isinstance(stdout, six.integer_types):
            ...
            if stderr is None:
                ...
                errwrite = c2pwrite
            elif isinstance(stderr, six.integer_types):
