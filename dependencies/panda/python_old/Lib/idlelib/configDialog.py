...
import six.moves.tkinter_messagebox, six.moves.tkinter_colorchooser, six.moves.tkinter_font
...
class ConfigDialog(Toplevel):
    ...
    def CreatePageFontTab(self):
        ...
        self.editFont = six.moves.tkinter_font.Font(parent, ('courier', 10, 'normal'))
    ...
    def DeleteCustomKeys(self):
        ...
        if not six.moves.tkinter_messagebox.askyesno(
    ...
    def GetColour(self):
        ...
        rgbTuplet, colourString = six.moves.tkinter_colorchooser.askcolor(
    ...
    def SetFontSample(self, event=None):
        ...
        fontWeight = six.moves.tkinter_font.BOLD if self.fontBold.get() else six.moves.tkinter_font.NORMAL
    ...
    def LoadFontCfg(self):
        ...
        fonts = list(six.moves.tkinter_font.families(self))
        fonts.sort()
        for font in fonts:
