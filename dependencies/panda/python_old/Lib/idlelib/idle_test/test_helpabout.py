...
class Dummy_about_dialog():
    ...
    idle_credits = About.ShowIDLECredits.__func__
    idle_readme = About.ShowIDLEAbout.__func__
    idle_news = About.ShowIDLENEWS.__func__
    # Called by the above
    display_file_text = About.display_file_text.__func__
...
class DisplayFileTest(unittest.TestCase):
    ...
    def tearDownClass(cls):
        ...
        textview.view_text = cls.orig_view.__func__
