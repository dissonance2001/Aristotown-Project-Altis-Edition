...
six.moves.copyreg.pickle(types.CodeType, pickle_code, unpickle_code)
# copy_reg.pickle(types.FunctionType, pickle_function, unpickle_function)

BUFSIZE = 8*1024
LOCALHOST = '127.0.0.1'

class RPCServer(six.moves.socketserver.TCPServer):

    def __init__(self, addr, handlerclass=None):
        if handlerclass is None:
            handlerclass = RPCHandler
        six.moves.socketserver.TCPServer.__init__(self, addr, handlerclass)
...
objecttable = {}
request_queue = six.moves.queue.Queue(0)
response_queue = six.moves.queue.Queue(0)
...
class RPCHandler(six.moves.socketserver.BaseRequestHandler, SocketIO):
    ...
    def __init__(self, sock, addr, svr):
        ...
        six.moves.socketserver.BaseRequestHandler.__init__(self, sock, addr, svr)
