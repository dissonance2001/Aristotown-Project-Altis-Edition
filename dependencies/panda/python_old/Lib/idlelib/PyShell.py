    ...
    def store_file_breaks(self):
        ...
        try:
            ...
            if not getattr(self.root, "breakpoint_error_displayed", False):
                ...
                six.moves.tkinter_messagebox.showerror(title='IDLE Error',
...
class ModifiedInterpreter(InteractiveInterpreter):
    ...
    def runsource(self, source):
        ...
        if isinstance(source, six.text_type) and IOBinding.encoding != 'utf-8':
            try:
                source = '# -*- coding: %s -*-\n%s' % (
                        IOBinding.encoding,
    ...
    def runcode(self, code):
        ...
        try:
            ...
            if not self.tkconsole.closing:
                if six.moves.tkinter_messagebox.askyesno(
                    "Exit?",
...
##        self.config(usetabs=1, indentwidth=8, context_use_ps1=1)
    ...
    def toggle_debugger(self, event=None):
        if self.executing:
            six.moves.tkinter_messagebox.showerror("Don't debug now",
    ...
    def close(self):
        ...
        if self.executing:
            response = six.moves.tkinter_messagebox.askokcancel(
                "Kill?",
    ...
    def begin(self):
        ...
        six.moves.tkinter._default_root = None # 03Jan04 KBK What's this?
        return True
    ...
    def open_stack_viewer(self, event=None):
        ...
        try:
            ...
            six.moves.tkinter_messagebox.showerror("No stack trace",
...
class PseudoOutputFile(PseudoFile):
    ...
    def write(self, s):
        ...
        if type(s) not in (six.text_type, str, bytearray):
            # See issue #19481
            if isinstance(s, six.text_type):
                s = six.text_type.__getitem__(s, slice(None))
