...
class EditorWindow(object):
    ...
    def __init__(self, flist=None, filename=None, key=None, root=None):
        ...
        self.askyesno = six.moves.tkinter_messagebox.askyesno
        self.askinteger = six.moves.tkinter_tksimpledialog.askinteger
        self.showerror = six.moves.tkinter_messagebox.showerror

    def _filename_to_unicode(self, filename):
        """convert filename to unicode in order to display it in Tk"""
        if isinstance(filename, six.text_type) or not filename:
            return filename
        else:
            try:
    ...
    def python_docs(self, event=None):
        if sys.platform[:3] == 'win':
            try:
                ...
                six.moves.tkinter_messagebox.showerror(title='Document Start Failure',
    ...
    def goto_line_event(self, event):
        text = self.text
        lineno = six.moves.tkinter_tksimpledialog.askinteger("Goto",
    ...
    def open_module(self, event=None):
        ...
        try:
            ...
            name = name.strip()
        name = six.moves.tkinter_tksimpledialog.askstring("Module",
        ...
        try:
            ...
            six.moves.tkinter_messagebox.showerror("Import error", str(msg), parent=self.text)
            return
        if mtype != imp.PY_SOURCE:
            six.moves.tkinter_messagebox.showerror("Unsupported type",
    ...
    def update_recent_files_list(self, new_file=None):
        ...
        try:
            ...
            if not getattr(self.root, "recentfilelist_error_displayed", False):
                ...
                six.moves.tkinter_messagebox.showwarning(title='IDLE Warning',
