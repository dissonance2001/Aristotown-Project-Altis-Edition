...
class IOBinding:
    ...
    def loadfile(self, filename):
        try:
            ...
            six.moves.tkinter_messagebox.showerror("I/O Error", str(msg), parent=self.text)
            return False
        ...
        if firsteol:
            ...
            if isinstance(self.eol_convention, six.text_type):
    ...
    def decode(self, chars):
        ...
        if enc:
            try:
                return six.text_type(chars, enc)
            except UnicodeError:
                pass
        # If it is ASCII, we need not to record anything
        try:
            return six.text_type(chars, 'ascii')
        except UnicodeError:
            pass
        # Finally, try the locale's encoding. This is deprecated;
        # the user should declare a non-ASCII encoding
        try:
            chars = six.text_type(chars, encoding)
    ...
    def maybesave(self):
        ...
        confirm = six.moves.tkinter_messagebox.askyesnocancel(
                  title="Save On Close",
                  message=message,
                  default=six.moves.tkinter_messagebox.YES,
                  parent=self.text)
        if confirm:
            reply = "yes"
            self.save(None)
    ...
    def writefile(self, filename):
        ...
        try:
            ...
            six.moves.tkinter_messagebox.showerror("I/O Error", str(msg),
                                   parent=self.text)
            return False
    ...
    def print_window(self, event):
        confirm = six.moves.tkinter_messagebox.askokcancel(
                  title="Print",
                  message="Print to Default Printer",
                  default=six.moves.tkinter_messagebox.OK,
                  parent=self.text)
        if not confirm:
            self.text.focus_set()
            return "break"
        ...
        if printPlatform:  #we can try to print for this platform
            ...
            if output:
                ...
                six.moves.tkinter_messagebox.showerror("Print status", output, parent=self.text)
        else:  #no printing for this platform
            message = "Printing is not enabled for this platform: %s" % platform
            six.moves.tkinter_messagebox.showinfo("Print status", message, parent=self.text)
        if tempfilename:
            os.unlink(tempfilename)
        return "break"
    ...
    def askopenfile(self):
        ...
        if not self.opendialog:
            self.opendialog = six.moves.tkinter_filedialog.Open(parent=self.text,
    ...
    def asksavefile(self):
        ...
        if not self.savedialog:
            self.savedialog = six.moves.tkinter_filedialog.SaveAs(
                    parent=self.text,
                    filetypes=self.filetypes,
...
def _io_binding(parent):  # htest #
    from six.moves.tkinter import Toplevel, Text
