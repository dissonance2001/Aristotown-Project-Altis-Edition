...
class GetHelpSourceDialog(Toplevel):
    ...
    def browseFile(self):
        ...
        if path:
            ...
            if sys.platform[:3] == 'win':
                ...
                dir = os.getcwd()
        opendialog = six.moves.tkinter_filedialog.Open(parent=self, filetypes=filetypes)
    ...
    def MenuOk(self):
        ...
        menu.strip()
        if not menu:
            six.moves.tkinter_messagebox.showerror(title='Menu Item Error',
    ...
    def PathOk(self):
        ...
        if not path: #no path specified
            six.moves.tkinter_messagebox.showerror(title='File Path Error',
