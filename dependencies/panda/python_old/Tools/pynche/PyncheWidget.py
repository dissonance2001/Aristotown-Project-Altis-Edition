...
class PyncheWidget:
    def __init__(self, version, switchboard, master=None, extrapath=[]):
        ...
        if modal:
            ...
            tkroot = None
            try:
                from six.moves.tkinter import _default_root
    ...
    def __popup_about(self, event=None):
        ...
        six.moves.tkinter_messagebox.showinfo('About Pynche ' + __version__,
                              '''\
Pynche %s
...
email:   bwarsaw@python.org''' % __version__)
    ...
    def __load(self, event=None):
        while 1:
            ...
            file = six.moves.tkinter_filedialog.askopenfilename(
            ...
            try:
                ...
                six.moves.tkinter_messagebox.showerror('Read error', '''\
Could not open file for reading:
%s''' % file)
                continue
            if colordb is None:
                six.moves.tkinter_messagebox.showerror('Unrecognized color file type', '''\
