...
class Sucker(webchecker.Checker):
    ...
    def savefilename(self, url):
        type, rest = six.moves.urllib.parse.splittype(url)
        host, path = six.moves.urllib.parse.splithost(rest)
        path = path.lstrip("/")
        user, host = six.moves.urllib.parse.splituser(host)
        host, port = six.moves.urllib.parse.splitnport(host)
        host = host.lower()
