...
class FindContainers(Job):
    ...
    def __init__(self, name, leakDetector):
        ...
        ref = ObjectRef(Indirection(evalStr='__builtin__.__dict__'), id(six.moves.builtins.__dict__))
        self._id2baseStartRef[id(six.moves.builtins.__dict__)] = ref
                    ...
                    for key in keys:
                        ...
                        if hasLength or notDeadEnd:
                            ...
                            for goesThrough in parentObjRef.goesThroughGen(curObj[key]):
                                ...
                                pass
                            if not goesThrough:
                                if curObj is six.moves.builtins.__dict__:
